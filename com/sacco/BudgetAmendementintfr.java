...
public class BudgetAmendementintfr extends javax.swing.JInternalFrame {
  ...
  javax.swing.table.TableModel tableModel = null;
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
      crset1.setCommand("select distinct department from sectional_budget where month ='"+jComboBox1.getSelectedItem()+"' ORDER BY department ");
        try {
            crset1.execute();
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
      ...
      // this.jLabel7.setText("");
       ...
       try {
        ...
        crset4.setCommand("select section,activity,activity_code,sum(debit) AS debit,sum(credit) AS credit,null as new_debit,null as new_credit,null as total,null as comment from sectional_budget where department ='"+jComboBox2.getSelectedItem().toString()+"' AND month = '"+jComboBox1.getSelectedItem().toString()+"' GROUP BY activity,activity_code,section");
        crset4.setConnectionSource(pConnDB);
