 ...
 * @author  root
 */
public class CasbookYearintfr extends javax.swing.JInternalFrame {
    ...
    public CasbookYearintfr(java.sql.Connection connDB, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setBorder(new javax.swing.border.BevelBorder(javax.swing.border.BevelBorder.RAISED, java.awt.Color.blue, java.awt.Color.yellow, java.awt.Color.blue, null));
        setClosable(true);
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Close Year");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //        datenowSql - java.util.Calendar.YEAR
        ...
        try {
            ...
            java.sql.ResultSet rst1 = ps1.executeQuery("select gl_code,sum(debit - credit),bank from cash_book where closed = 'false' group by gl_code,bank");
            while (rst1.next()){
                
                debitNo = rst1.getFloat(2);
                // creditNo = rst1.getObject(3).toString();
                glCode = rst1.getObject(1).toString();
                String bName = rst1.getObject(3).toString();
                ...
                pstmt.setString(2,"Opening Balance ");
                pstmt.setString(3,null);
                pstmt.setString(4,"Opening Balance");
                ...
                if (debitNo < 0) {
                    float credits = (debitNo * -1);
                    pstmt.setFloat(19,credits);
                    System.out.println(credits);
                }else{
                    pstmt.setFloat(19,00);
                }
                if (debitNo > 0) {
                    
                    pstmt.setFloat(18,debitNo);
                    
                }else {
                    pstmt.setFloat(18,00);
                }
            ...
            java.sql.ResultSet rst7 = ps7.executeQuery("select activity_code,description,sum(debit - credit) from other_transactions where closed = 'false' group by activity_code,description,activity_code");
            ...
            while (rst7.next()){
                ...
                float Debit = rst7.getFloat(3);
                String descrip = rst7.getObject(2).toString();
                ...
                pstmt1.setString(2,""+descrip+"");
                pstmt1.setString(3,"Opening Balance");
                ...
                pstmt1.setString(13,"");
                if (Debit < 0) {
                    float credits1 = (Debit * -1);
                    pstmt1.setFloat(15,credits1);
                    //System.out.println(credits);
                }else{
                    pstmt1.setFloat(15,00);
                }
                if (Debit > 0) {
                    
                    pstmt1.setFloat(14,Debit);
                    
                }else {
                    pstmt1.setFloat(14,00);
                }
                //  pstmt1.setString(14,""+Debit+"");
                //  pstmt1.setString(15,"00");
            ...
            java.sql.ResultSet rst6 = ps6.executeQuery("select activity_code,sum(debit - credit),share_type,member_code,member_name from shares_transactions where closed = 'false' group by member_code,member_name,activity_code,share_type");
            ...
            while (rst6.next()){
                ...
                shareTyp = rst6.getObject(3).toString();
                //glNo = rst6.getObject(1).toString();
                actNo = rst6.getObject(1).toString();
                debit = rst6.getFloat(2);
                // credit = rst6.getObject(3).toString();
                mCode = rst6.getObject(4).toString();
                mName = rst6.getObject(5).toString();
                ...
                if (debit < 0) {
                    float credits2 = (debit * -1);
                    pstmt7.setFloat(12,credits2);
                    //  System.out.println(credits);
                }else{
                    pstmt7.setFloat(12,00);
                }
                if (debit > 0) {
                    
                    pstmt7.setFloat(11,debit);
                    
                }else {
                    pstmt7.setFloat(11,00);
                }
                //  pstmt7.setString(11,""+debit+"");
                // pstmt7.setString(12,"00");
            ...
            java.sql.ResultSet rsts = pss.executeQuery("select lt.activity_code,sum(lt.debit - lt.credit),lt.loan_purpose,lt.member_no,lt.member_name,lt.loan_account_no,sum(lt.principal) as principal,sum(lt.principal_paid) as principal_paid,sum(lt.interest) as interest,sum(lt.monthly_repayment) from loan_transactions lt where lt.closed = 'false' group by lt.activity_code,lt.loan_purpose,lt.loan_purpose,lt.member_no,lt.member_name,lt.loan_account_no");
            while (rsts.next()){
                ...
                String Lpup = rsts.getObject(3).toString();
                //String GeCode = rsts.getString(2);
                String ActCode = rsts.getString(1);
                String memName = rsts.getObject(5).toString();
                float Crdit = rsts.getFloat(2);
                String Loanacc = rsts.getObject(6).toString();
                String memNo = rsts.getObject(4).toString();
                String principal = rsts.getObject(7).toString();
                String prinpaid = rsts.getObject(8).toString();
                String intr = rsts.getObject(9).toString();
                String montrepay = rsts.getObject(10).toString();
                // System.out.println(rst6.getObject(1).toString());
                
                java.sql.PreparedStatement pstmts = connectDB.prepareStatement("insert into loan_transactions values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                pstmts.setString(1,""+Loanacc+"");
                pstmts.setString(2,""+memName+"");
                pstmts.setString(3,""+memNo+"");
                ...
                pstmts.setString(10,"");
                pstmts.setString(11,"");
                pstmts.setString(12,""+principal+"");
                pstmts.setString(13,""+montrepay+"");
                pstmts.setString(14,""+intr+"");
                pstmts.setString(15,""+prinpaid+"");
                pstmts.setString(16,"00");
                if (Crdit < 0) {
                    float credits4 = (Crdit * -1);
                    pstmts.setFloat(18,credits4);
                    //System.out.println(credits);
                }else{
                    pstmts.setFloat(18,00);
                }
                if (Crdit > 0) {
                    
                    pstmts.setFloat(17,Crdit);
                    
                }else {
                    pstmts.setFloat(17,00);
                }
                
                //   pstmts.setString(17,""+Crdit+"");
                // pstmts.setString(18,"00");
            ...
            java.sql.PreparedStatement pstmts2 = connectDB.prepareStatement("update loan_transactions set closed = 'true' WHERE date < date('now')");
            
            pstmts2.executeUpdate();
            
            java.sql.PreparedStatement pstmt10 = connectDB.prepareStatement("update other_transactions set closed = 'true' WHERE date < date('now')");
            
            pstmt10.executeUpdate();
            java.sql.PreparedStatement pstmt5 = connectDB.prepareStatement("update shares_transactions set closed = 'true' WHERE date < date('now')");
            
            pstmt5.executeUpdate();
            java.sql.PreparedStatement pstmt9 = connectDB.prepareStatement("update cash_book set closed = 'true' WHERE date < date('now')");
