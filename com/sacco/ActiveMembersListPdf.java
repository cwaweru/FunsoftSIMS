...
public class ActiveMembersListPdf implements java.lang.Runnable {
	...
	public void ActiveMembersListPdf(java.sql.Connection connDb) {
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Active Members List - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        table.setWidthPercentage((100));
           ...
           Phrase phrase = new Phrase("Active Members List As At:" +endDate, pFontHeader);
         ...
         try {
          ...
          java.sql.Statement st = connectDB.createStatement();
            ...
            java.sql.ResultSet rset = st.executeQuery("select admission_date,m_number::int4,payroll_no,initcap(first_name),initcap(middle_name),initcap(last_name), bbf_status from member where active = true order by m_number");
