...
public class ApprovedLoansPdf implements java.lang.Runnable {
  ...
  public java.lang.String dbUserName = null;
	...
	public void ApprovedLoansPdf(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate) {
                connectDB = connDb;
                beginDate = begindate;
                endDate = endate;
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Approved Loans - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        int headerwidths[] = {15,10,10,25,15,10,15};
        ...
        Phrase phrase = new Phrase("Approved Loans as at: " +endDate, pFontHeader);
        ...
        //    table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
         ...
         try {
          ...
          //  java.sql.Connection conDb1 = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
            ...
            java.sql.ResultSet rset = st.executeQuery("select date_approved,approval_no,member_no, initcap(member_name),initcap(loan_type),loan_approved,monthly_instal from approved_loans WHERE date_approved BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY approval_no");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
            
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(loan_approved) from approved_loans WHERE date_approved BETWEEN '"+beginDate+"' AND '"+endDate+"'"); 
