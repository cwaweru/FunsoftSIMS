  ...
  */
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("select payroll_no from process_sacco WHERE allocated = 'false' and payroll_no between '"+this.jTextField3.toString()+"' and '"+this.jTextField4.toString()+"' and DATE BETWEEN '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker21.getDate().toString()+"'");
                    ...
                    if(jTable1.getValueAt(i,7) != null){
                        if (Boolean.valueOf(jTable1.getModel().getValueAt(i, 9).toString()) == java.lang.Boolean.TRUE) {
                            ...
                            if (jTable1.getModel().getValueAt(i, 6).toString().equalsIgnoreCase("shares")){
                                double shareAmt = java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 7).toString());
                                double AmtDue = java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 5).toString());
    ...
    private void populateTable1() {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select mbr_no,  mbr_names, payroll_no::int4,  deduction,interest::numeric, total_due::numeric, trans_type from process_sacco WHERE allocated = 'false' and payroll_no between '"+this.jTextField3.getText().toString()+"' and '"+this.jTextField4.getText().toString()+"' and DATE BETWEEN '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker21.getDate().toString()+"'");// '"+listofStaffNos[j]+"'order by ld.staff_no  ");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
