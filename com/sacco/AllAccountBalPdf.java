...
public class AllAccountBalPdf implements java.lang.Runnable {
    ...
    java.lang.String acrobatPath = null;
	...
	public void AllAccountBalPdf(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate, java.lang.String combox) {
	...
	//	new AllAccountBalPdf().AllAccountBalPdf(args[0]);
    ...
    //      java.sql.Connection conDb = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("All Acc.Balances - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        table.setWidthPercentage((100));
           ...
           Phrase phrase = new Phrase("All Account Balances as at : "   +endDate, pFontHeader);
     ...
     */
      ...
      //        java.sql.Connection conDb1 = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
          ...
          //  java.sql.ResultSet rset = st.executeQuery("select DISTINCT member_code, member_name,date from shares_transactions order by member_code");
             java.sql.ResultSet rset = st.executeQuery("select lpad(m_number,9,0),initcap(first_name||' '||middle_name||' '||last_name),present_address,present_town,tel_no from member where m_number = '"+memNo+"'");
             java.sql.ResultSet rset1 = st1.executeQuery("select share_type,sum(credit - debit) from shares_transactions where member_code = '"+memNo+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' GROUP BY share_type");
           java.sql.ResultSet rset2 = st2.executeQuery("select sum(credit - debit) from shares_transactions where member_code = '"+memNo+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
   ...
   // }
        ...
        wait_for_Pdf2Show = rt.exec(acrobatPath+tempFile);
