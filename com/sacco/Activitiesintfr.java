...
public class Activitiesintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset1.setCommand("select  description from accounts_setup ORDER BY description  ");
        crset1.setConnectionSource(pConnDB);
        crset11.setCommand("select  description from sub_activities ORDER BY description  ");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Main Code", "Description", "Account Class"
            }
        ));
        ...
        jTabbedPane1.addTab("Main Activities", jPanel1);
        ...
        jLabel6.setText("Main Activity Code");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weightx = 1.0;
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sub Activity Code", "Description", "Identifier", "A Member's Account?"
            }
        ) {
        ...
        jTabbedPane1.addTab("Sub Activities", jPanel11);
        ...
        jTable21.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sub Activity Code", "Description", "Payment Mode"
            }
        ));
        ...
        jTabbedPane1.addTab("Activities", jPanel111);
    ...
    private void jButton211ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton211ActionPerformed
             javax.swing.JFrame lpay = new Activities(connectDB, pConnDB);
             lpay.setVisible(true); // Add your handling code here:
    }//GEN-LAST:event_jButton211ActionPerformed

    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
//     javax.swing.JFrame lpay = new SubActivities(connectDB, pConnDB);
//     lpay.setVisible(true); // Add your handling code here:
...
//     lpay.setVisible(true); // Add your handling code here:
    ...
    private void jButton111ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton111ActionPerformed
       ...
       try {
           java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into activity values( ?,?,initcap(?),?,?,initcap(?))");
    ...
    private void jComboBox11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox11ActionPerformed
       ...
       try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("select sub_code from sub_activities where description ='"+jComboBox11.getSelectedItem()+"'");
            while (rset.next())
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select main_code from accounts_setup where description ='"+jComboBox1.getSelectedItem()+"'");
            while (rset.next())
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into accounts_setup values( ?, initcap(?),initcap(?))");
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        try {
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into sub_activities values( ?, ?, initcap(?),?,initcap(?),?)");
