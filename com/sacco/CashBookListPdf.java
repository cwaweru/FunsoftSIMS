...
public class CashBookListPdf implements java.lang.Runnable {
	...
	public void CashBookListPdf(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate, java.lang.String combox) {
 ...
 */
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        Phrase phrase = new Phrase("Cash Book Acc. No.  " +bank    +"  as at : "  +endDate, pFontHeader);
         ...
         try {
          ...
          //  java.sql.Connection conDb1 = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
            ...
            java.sql.Statement st2 = connectDB.createStatement();            
              ...
              java.sql.ResultSet rset = st.executeQuery("select date,code,initcap(member_name),initcap(description),debit,credit from cash_book WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND account_no = '"+bank+"' ORDER BY gl_code");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
            
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(debit),SUM(credit) from cash_book WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND account_no = '"+bank+"'"); 
