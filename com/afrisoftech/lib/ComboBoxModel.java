 ...
 *
 *  Copyright System Partners Limited 2001 - 2005. All rights reserved.
 *
 *  Copying this class is hereby granted as long as this and the above paragraph 
 *  are included in the distribution and the 
 *  source code as is made freely available to anyone wanting to use the code.
 *
 */
public class ComboBoxModel {
    ...
    /** 
     *
     * Contructs a class for the JComboBox component. This memthod statically collect data from the database.
     *
     * @param connectDB : The database connection referenced from the calling class.
     *
    ...
    /**
     * The submitQuery method is responsible for buliding up the resultset as a vector that is returned to the ComboBoxModel() method.
     *
