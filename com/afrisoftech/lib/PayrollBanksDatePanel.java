...
public class PayrollBanksDatePanel extends javax.swing.JDialog {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset1.setCommand("select DISTINCT bank as bank_name from master_file WHERE (bank IS NOT NULL OR bank !='') order by bank_name");
        ...
        jComboBox1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset1, "bank_name", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        setSize(new java.awt.Dimension(419, 209));
        setLocation((screenSize.width-419)/2,(screenSize.height-209)/2);
