 ...
 * @author  root
 */
public class HosReceiptsPatDatePanel extends javax.swing.JDialog {
    ...
    public HosReceiptsPatDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder("Select receipt no. here"));
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
     try {
                    searchRowSet1.execute("select trim(receipt_no) as scheme,date from ac_cash_collection where receipt_no not like 'A%' and receipt_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY receipt_no");
                    ...
                    jSearchTable1.setModel(new org.netbeans.lib.sql.models.TableModel(searchRowSet1, new org.netbeans.lib.sql.models.TableModel.Column[] {
                        new org.netbeans.lib.sql.models.TableModel.Column("scheme", "Receipt", false),
