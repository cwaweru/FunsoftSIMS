 ...
 * @author  root
 */
public class SubAccDatePanel extends javax.swing.JDialog {
    ...
    public SubAccDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder(null, "Select procedure here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(153, 0, 153)));
...
if(this.jTextField1111.getCaretPosition() < 2){
        ...
        try {
                    searchRowSet1.execute("select trim(service_type) as scheme,gl_account from pb_operating_parameters where service_type ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY service_type");
                    ...
                    //    new org.netbeans.lib.sql.models.TableModel.Column("name", "Payer", false),
                         new org.netbeans.lib.sql.models.TableModel.Column("gl_account", "Acc No.", false)
                    }));
                    jSearchTable1.setShowHorizontalLines(false);
                    jSearchScrollPane1.setViewportView(jSearchTable1);
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
                ...
                
            {
                ...
                policy.CashSalesBrdPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField36.getText(),this.jTextField2.getText());
