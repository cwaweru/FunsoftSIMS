 ...
 * @author  root
 */
public class HosChqsPanel extends javax.swing.JDialog {
    ...
    public HosChqsPanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder(null, "Select Cheque here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(0, 0, 255)));
 ...
 try {
                    searchRowSet1.execute("select distinct cheque_no as scheme,acc_no from db_allocation where cheque_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY cheque_no");
                    ...
                    jSearchTable1.setModel(new org.netbeans.lib.sql.models.TableModel(searchRowSet1, new org.netbeans.lib.sql.models.TableModel.Column[] {
                        new org.netbeans.lib.sql.models.TableModel.Column("scheme", "Cheque No", false),
                        //new org.netbeans.lib.sql.models.TableModel.Column("name", "Payer", false),
                         new org.netbeans.lib.sql.models.TableModel.Column("acc_no", "Scm Acc No.", false)
                    }));
                    jSearchTable1.setShowHorizontalLines(false);
                    jSearchScrollPane1.setViewportView(jSearchTable1);
...
this.dispose();        // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
//                com.afrisoftech.accounting.AllocByChqPdf policy = new com.afrisoftech.accounting.AllocByChqPdf();
//                
//                policy.AllocByChqPdf(connectDB, jTextField36.getText(),this.jTextField2.getText());
