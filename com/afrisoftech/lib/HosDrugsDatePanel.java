 ...
 * @author  root
 */
public class HosDrugsDatePanel extends javax.swing.JDialog {
    ...
    public HosDrugsDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
...
if(this.jTextField1111.getCaretPosition() < 2){
        ...
        try {
                    searchRowSet1.execute("select distinct product as scheme from st_stock_prices where product ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY product");
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
                ...
                
            {
                ...
                policy.DrugFlowPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField36.getText(),this.jTextField2.getText());
            ...
            {
                com.afrisoftech.hospinventory.SuppliesPerDrugPdf policy = new com.afrisoftech.hospinventory.SuppliesPerDrugPdf();
                
                policy.SuppliesPerDrugPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField36.getText());
