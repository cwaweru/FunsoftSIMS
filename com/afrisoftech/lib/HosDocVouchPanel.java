 ...
 * @author  root
 */
public class HosDocVouchPanel extends javax.swing.JDialog {
    ...
    public HosDocVouchPanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
 ...
 try {
                    searchRowSet1.execute("select distinct(voucher_no) as scheme from ac_doctors_ledger where voucher_no ILIKE '"+jTextField1111.getText().toString()+"%' and voucher_no !='' and voucher_no is not null ORDER BY voucher_no");
        ...
        switch (reportName) {
           ...
           */
           case 112:
            ...
            {
                com.afrisoftech.reports.DoctorsVoucherPdf policy = new com.afrisoftech.reports.DoctorsVoucherPdf();
                
                policy.DoctorsVoucherPdf(connectDB,jTextField36.getText());
                ...
                
            {
                ...
                policy.DoctorsVouchDetPdf(connectDB,jTextField36.getText());
