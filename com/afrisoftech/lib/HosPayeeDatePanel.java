 ...
 * @author  root
 */
public class HosPayeeDatePanel extends javax.swing.JDialog {
    ...
    public HosPayeeDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
 ...
 try {
                    searchRowSet1.execute("select distinct dealer  from ac_cash_book where dealer ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY dealer");
...
this.dispose();        // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.reports.PymtPerCreditorDetPdf policy = new com.afrisoftech.reports.PymtPerCreditorDetPdf();
                
                policy.PymtPerCreditorDetPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField36.getText());
