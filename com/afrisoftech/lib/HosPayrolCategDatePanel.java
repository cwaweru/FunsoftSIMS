...
public class HosPayrolCategDatePanel extends javax.swing.JDialog {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset1.setCommand("select DISTINCT scheme from member order by scheme");
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder("Select Scheme here"));
        ...
        jComboBox1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset1, "scheme", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
...
this.dispose();        // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
//                com.afrisoftech.sacco.ProcessingPayroll processingPayroll = new com.afrisoftech.sacco.ProcessingPayroll(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jComboBox1.getSelectedItem().toString());
//                
