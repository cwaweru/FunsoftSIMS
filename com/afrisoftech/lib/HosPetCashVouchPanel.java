 ...
 * @author  root
 */
public class HosPetCashVouchPanel extends javax.swing.JDialog {
    ...
    public HosPetCashVouchPanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder(null, "Select Voucher here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(0, 0, 255)));
        ...
        jCheckBox2.setText("Requisitions");
...
if(this.jCheckBox1.isSelected()){
        try {
                    searchRowSet1.execute("select (voucher_no) as scheme from ac_petty_cash where voucher_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY date");
                    ...
                    jSearchTable1.setModel(new org.netbeans.lib.sql.models.TableModel(searchRowSet1, new org.netbeans.lib.sql.models.TableModel.Column[] {
                        new org.netbeans.lib.sql.models.TableModel.Column("scheme", "Voucher no.", false),
     ...
     try {
                    searchRowSet1.execute("select (requisition_no) as scheme from ac_petty_cash_requisition where requisition_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY date_required");
        ...
        switch (reportName) {
          ...
          // }
            ...
            ///{
                ...
                policy.PettyPayVoucherPdf(connectDB,jTextField36.getText());
