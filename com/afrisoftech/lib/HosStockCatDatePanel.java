 ...
 * @author  root
 */
public class HosStockCatDatePanel extends javax.swing.JDialog {
    ...
    public HosStockCatDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset1.setCommand("select DISTINCT sub_cat_code from st_stock_item order by sub_cat_code");
        ...
        jComboBox1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset1, "sub_cat_code", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        ...
        setLocation((screenSize.width-350)/2,(screenSize.height-196)/2);
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
                ...
                
            {
                ...
                policy.StoresBalPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jComboBox1.getSelectedItem().toString());
            ...
            {
                com.afrisoftech.hospinventory.SalesReportStoresPdf policy = new com.afrisoftech.hospinventory.SalesReportStoresPdf();
                
                policy.SalesReportStoresPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jComboBox1.getSelectedItem().toString());
                ...
                
            {
                ...
                policy.StoresStockBelowReorderLevPdf(connectDB, jComboBox1.getSelectedItem().toString());
            ...
            {
                com.afrisoftech.hospinventory.StockCategoryPdf policy = new com.afrisoftech.hospinventory.StockCategoryPdf();
                
                policy.StockCategoryPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jComboBox1.getSelectedItem().toString());
