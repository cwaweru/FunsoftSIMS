 ...
 * @author  root
 */
public class HosScemesDatePanel2 extends javax.swing.JDialog {
    ...
    public HosScemesDatePanel2(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder(null, "SelectMember Details here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(153, 0, 153)));
...
if(this.jTextField1111.getCaretPosition() < 2){
        ...
        if(this.jCheckBox1.isSelected()){
        try {
                    searchRowSet1.execute("select staff_no, staff_name as name,loan_no,balance from loan_details_stmt_view where staff_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY staff_no");
            ...
            try {
                    searchRowSet1.execute("select staff_no, staff_name as name,loan_no, balance from loan_details_stmt_view where staff_name ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY staff_name");
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
          ...
          */ 
            ...
            {
                com.afrisoftech.sacco.LoanStatementAccDetailPdf policy = new com.afrisoftech.sacco.LoanStatementAccDetailPdf();
                
                policy.LoanStatementAccDetailPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField36.getText(),this.jTextField2.getText(),this.jTextField22.getText());
