...
public class HosInPatientDatePanel extends javax.swing.JDialog {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder(null, "Select inpatient no. here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(0, 0, 255)));
        ...
        setLocation((screenSize.width-399)/2,(screenSize.height-218)/2);
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(this.jTextField1111.getCaretPosition() < 2){
            ...
            if(this.jCheckBox1.isSelected()){
                ...
                try {
                    searchRowSet1.execute("select trim(patient_no) as scheme,second_name||' '||first_name||' '||last_name as name,adm_date from hp_inpatient_register where patient_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY second_name");
                ...
                try {
                    searchRowSet1.execute("select trim(patient_no) as scheme,second_name||' '||first_name||' '||last_name as name,adm_date from hp_inpatient_register where second_name||' '||first_name||' '||last_name ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY second_name");
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
                ...
                
            {
                ...
                policy.PatientBillPdf(connectDB,jTextField36.getText(),this.datePicker1.getDate());
