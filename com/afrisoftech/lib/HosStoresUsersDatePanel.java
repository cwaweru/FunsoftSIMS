 ...
 * @author  root
 */
public class HosStoresUsersDatePanel extends javax.swing.JDialog {
    ...
    public HosStoresUsersDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset1.setCommand("select DISTINCT user_name from st_sub_stores order by user_name ");
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder("Select User here"));
        ...
        jComboBox11.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset1, "user_name", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
...
this.dispose();            // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.hospinventory.SalesByUserPdf policy = new com.afrisoftech.hospinventory.SalesByUserPdf();
                
                policy.SalesByUserPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jComboBox11.getSelectedItem().toString());
