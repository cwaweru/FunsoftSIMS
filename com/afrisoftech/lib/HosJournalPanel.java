 ...
 * @author  root
 */
public class HosJournalPanel extends javax.swing.JDialog {
    ...
    public HosJournalPanel(java.awt.Frame parent, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel3.setText("Enter Journal Range");
        gridBagConstraints = new java.awt.GridBagConstraints();
 ...
 /*
  ...
  
            {
                ...
                policy.FinalInvoiceByinvPdf(connectDB, this.jTextField2.getText(), this.jTextField3.getText());
  ...
  */
            ...
            {
                com.afrisoftech.reports.JournalsIndvPdf policy = new com.afrisoftech.reports.JournalsIndvPdf();
  
                policy.JournalsIndvPdf(connectDB, this.jTextField2.getText(), this.jTextField3.getText());
