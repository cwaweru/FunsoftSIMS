 ...
 * @author  root
 */
public class EarningBySourcePanel extends javax.swing.JDialog {
  ...
  //  public ResignByReasonPanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
       public EarningBySourcePanel(java.awt.Frame parent, boolean modal, int repName, java.sql.Connection connectDb) {
...
this.dispose();        // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
           case 5215:
            ...
            {
                com.afrisoftech.sacco.EarningBySourcePdf policy = new com.afrisoftech.sacco.EarningBySourcePdf();
   ...
   policy.EarningBySourcePdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(), this.jComboBox1.getSelectedItem().toString());
          ...
          */  
          ...
          /*   case 5210:
            ...
            {
                com.afrisoftech.sacco.ResignedMemberPdf policy = new com.afrisoftech.sacco.ResignedMemberPdf();
                
                policy.ResignedMemberPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField36.getText(),this.jTextField2.getText());
