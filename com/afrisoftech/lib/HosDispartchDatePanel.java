 ...
 * @author  root
 */
public class HosDispartchDatePanel extends javax.swing.JDialog {
    ...
    public HosDispartchDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder(null, "Select Dispatch No. here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(0, 0, 255)));
        jLabel4.setText("Dispatch No.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
 ...
 try {
                    searchRowSet1.execute("select distinct(dispatch_no) as scheme,account_no,payee from ac_debtors where dispatch_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY dispatch_no");
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
                ...
                
            {
                ...
                policy.DispatchSchPdf(connectDB, jTextField36.getText(),this.jTextField2.getText());
            ...
            {
                com.afrisoftech.reports.NHIFDispPdf policy = new com.afrisoftech.reports.NHIFDispPdf();
                
                policy.NHIFDispPdf(connectDB, jTextField36.getText(),this.jTextField2.getText());
