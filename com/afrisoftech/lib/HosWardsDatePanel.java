 ...
 * @author  root
 */
public class HosWardsDatePanel extends javax.swing.JDialog {
    ...
    public HosWardsDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset1.setCommand("select DISTINCT ward_name from hp_wards order by ward_name ");
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder("Select Ward here"));
        jLabel41.setText("Ward Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        ...
        jComboBox11.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset1, "ward_name", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
...
this.dispose();            // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.reports.AdmittedByWardPdf policy = new com.afrisoftech.reports.AdmittedByWardPdf();
                
                policy.AdmittedByWardPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jComboBox11.getSelectedItem().toString());
