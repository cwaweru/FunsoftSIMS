 ...
 * @author  root
 */
public class MemberEarningDatePanel extends javax.swing.JDialog {
    ...
    public MemberEarningDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder(null, "Select Withdrawal Reason here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(153, 0, 153)));
        ...
        jCheckBox1.setText("Search By Acc/No");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Interest", "Commission", "Sinking Fund" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.gridwidth = 2;
        ...
        setSize(new java.awt.Dimension(400, 241));
        setLocation((screenSize.width-400)/2,(screenSize.height-241)/2);
...
if(this.jTextField1111.getCaretPosition() < 3){
        ...
        if(this.jCheckBox1.isSelected()){
        try {
                    searchRowSet1.execute("select payroll_no, member_name as name from sacco_earnings where payroll_no ILIKE '"+jTextField1111.getText().toString()+"%' and trans_type ilike '"+jComboBox1.getSelectedItem().toString()+"' ORDER BY payroll_no");
            ...
            try {
                     searchRowSet1.execute("select payroll_no, member_name as name from sacco_earnings where member_name ILIKE '"+jTextField1111.getText().toString()+"%' and trans_type ilike '"+jComboBox1.getSelectedItem().toString()+"' ORDER BY payroll_no");
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
          ...
          */  
            ...
            {
                com.afrisoftech.sacco.MbrEarningByReasonPdf policy = new com.afrisoftech.sacco.MbrEarningByReasonPdf();
                
                policy.MbrEarningByReasonPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField36.getText(),this.jTextField2.getText(), this.jComboBox1.getSelectedItem().toString());
        ...
        /*
            ...
            {
                com.afrisoftech.reports.AttPerScmDetailedPdf policy = new com.afrisoftech.reports.AttPerScmDetailedPdf();
                
                policy.AttPerScmDetailedPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField36.getText(),this.jTextField2.getText());
