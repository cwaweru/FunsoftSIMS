 ...
 * @author  root
 */
public class HosTBApprDatePanel extends javax.swing.JDialog {
    ...
    public HosTBApprDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset1.setCommand("select DISTINCT company_name from payroll_comsetup order by company_name");
        ...
        jLabel3.setText("Approve Trial Balance");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        setSize(new java.awt.Dimension(350, 238));
        setLocation((screenSize.width-350)/2,(screenSize.height-238)/2);
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.reports.ApproveTBPdf policy = new com.afrisoftech.reports.ApproveTBPdf();
                
                policy.ApproveTBPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jPasswordField1.getText());
          ...
          /*   case 23:
            ...
            {
                com.afrisoftech.hospayroll.ApprovingPayroll approvingPayroll = new com.afrisoftech.hospayroll.ApprovingPayroll(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jPasswordField1.getText(),jComboBox1.getSelectedItem().toString());
