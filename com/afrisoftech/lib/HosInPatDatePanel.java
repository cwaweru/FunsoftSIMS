...
public class HosInPatDatePanel extends javax.swing.JDialog {
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        try {
            searchRowSet1.execute("select trim(patient_no) as scheme,second_name||' '||first_name as name from hp_inpatient_register where patient_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY name");
