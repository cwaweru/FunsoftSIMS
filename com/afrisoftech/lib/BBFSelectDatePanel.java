 ...
 * @author  root
 */
public class BBFSelectDatePanel extends javax.swing.JDialog {
    ...
    public BBFSelectDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
...
if(this.jTextField1111.getCaretPosition() < 2){
        ...
        if(this.jCheckBox1.isSelected()){
        try {
                    searchRowSet1.execute("select sacco_no, staff_name as name, sum(credit-debit) as balance from bbf_satement_detailed where sacco_no ILIKE '"+jTextField1111.getText().toString()+"%' group by sacco_no, staff_name ORDER BY sacco_no");
            ...
            try {
                   searchRowSet1.execute("select sacco_no, staff_name as name, sum(credit-debit) as balance from bbf_satement_detailed where staff_name ILIKE '"+jTextField1111.getText().toString()+"%' group by sacco_no, staff_name ORDER BY sacco_no");
...
this.dispose();        // Add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        System.out.println("Selected the report");
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.sacco.BBFMemberSharesPdf policy = new com.afrisoftech.sacco.BBFMemberSharesPdf();
                
                policy.BBFMemberSharesPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),this.jTextField2.getText());
         ...
         System.out.println("Passed the first  hurdle");
