 ...
 * @author  root
 */
public class SchemesDatePanel extends javax.swing.JDialog {
    ...
    public SchemesDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset1.setCommand("select DISTINCT description from deductions_allowances where taxable = false and benefit = true order by description");
