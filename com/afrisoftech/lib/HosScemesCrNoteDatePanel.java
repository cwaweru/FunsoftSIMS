 ...
 * @author  root
 */
public class HosScemesCrNoteDatePanel extends javax.swing.JDialog {
    ...
    public HosScemesCrNoteDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setSize(new java.awt.Dimension(418, 245));
        setLocation((screenSize.width-418)/2,(screenSize.height-245)/2);
...
if(this.jTextField1111.getCaretPosition() < 2){
        ...
        if(this.jCheckBox1.isSelected()){
        try {
                    searchRowSet1.execute("select trim(scheme_name) as scheme,(payer_name) as name,account_no from ac_schemes where account_no ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY scheme_name");
...
this.dispose();        // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.reports.DebtorsCrNotePdf policy = new com.afrisoftech.reports.DebtorsCrNotePdf();
                
                policy.DebtorsCrNotePdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField3.getText(),this.jTextField2.getText());
