...
public class OpAttSheetSummPdf implements java.lang.Runnable {
    ...
    public void OpAttSheetSummPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("OutPatient Att. List Summary:     Period : "  +dateFormat.format(endDate11)+" ------ "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            int cash =0;
                            int scheme = 0;
                            java.sql.ResultSet rset11 = st111.executeQuery("select count(distinct(patient_no)) from hp_patient_visit WHERE date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and transaction_type ilike 'regis%' and payment ilike 'scheme'");
                            
                            java.sql.Statement st11 = connectDB.createStatement();
                            
                            
                            java.sql.ResultSet rset1 = st11.executeQuery("select count(distinct(patient_no)) from hp_patient_visit WHERE date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and transaction_type ilike 'regis%' and payment not ilike 'scheme'");
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                int cash1 = 0;
                                int scheme1 = 0;
                                java.sql.PreparedStatement pset = connectDB.prepareStatement("select count(distinct(patient_no)) from hp_patient_visit  WHERE date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and transaction_type ilike 'regi%' and payment not ilike 'scheme' and date = ?");
                                pset.setString(1,listofAct[i].toString());
                                java.sql.ResultSet rset = pset.executeQuery();
                                java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select count(distinct(patient_no)) from hp_patient_visit  WHERE date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and transaction_type ilike 'regi%' and payment ilike 'scheme' and date = ?");
