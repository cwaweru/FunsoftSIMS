 ...
 * @author  root
 */
public class LPODatePanel extends javax.swing.JDialog {
    ...
    public LPODatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset1.setCommand("SELECT DISTINCT order_no from st_orders order by order_no");
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder("Select Revenue Acc. here"));
        jLabel4.setText("LPO No.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        setSize(new java.awt.Dimension(388, 151));
        setLocation((screenSize.width-388)/2,(screenSize.height-151)/2);
...
this.dispose();            // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.hospinventory.UnpricedRepPdf policy = new com.afrisoftech.hospinventory.UnpricedRepPdf();
                
                policy.UnpricedRepPdf(connectDB,jComboBox1.getSelectedItem().toString());
