 ...
 * @author  root
 */
public class HosInsDatePanel extends javax.swing.JDialog {
    ...
    public HosInsDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset1.setCommand("select DISTINCT sacco_name from sacco_deductions order by sacco_name");
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder("Select Institution here"));
        ...
        jComboBox1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset1, "sacco_name", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
...
this.dispose();            // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.hospayroll.SaccoListPdf policy = new com.afrisoftech.hospayroll.SaccoListPdf();
                
                policy.SaccoListPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jComboBox1.getSelectedItem().toString());
