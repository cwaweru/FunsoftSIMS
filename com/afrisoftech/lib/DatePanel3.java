 ...
 * @author  root
 */
public class DatePanel3 extends javax.swing.JDialog {
    ...
    public DatePanel3(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
 ...
 //       return dateStartEnd; 
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset21.setCommand("select member_no from approved_loans order by member_no");
        ...
        jComboBox1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset21, "member_no", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
  ...
  //    new DatePanel(new javax.swing.JFrame(), true).show();
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.sacco.AllAccountBalPdf policy = new com.afrisoftech.sacco.AllAccountBalPdf();
                            
                policy.AllAccountBalPdf(connectDB, this.datePicker1.getDate().toString(), this.datePicker2.getDate().toString(),jComboBox1.getSelectedItem().toString());
            ...
            {
                com.afrisoftech.sacco.LoanStatementPdf policy = new com.afrisoftech.sacco.LoanStatementPdf();
                            
                policy.LoanStatementPdf(connectDB, this.datePicker1.getDate().toString(), this.datePicker2.getDate().toString(),jComboBox1.getSelectedItem().toString());
                            ...
                            
            {
                ...
                policy.MemberStatementPdf(connectDB, this.datePicker1.getDate().toString(), this.datePicker2.getDate().toString(),this.jComboBox1.getSelectedItem().toString());
