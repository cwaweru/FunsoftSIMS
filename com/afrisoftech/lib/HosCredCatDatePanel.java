 ...
 * @author  root
 */
public class HosCredCatDatePanel extends javax.swing.JDialog {
    ...
    public HosCredCatDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset1.setCommand("select distinct category as activity from st_suppliers where category !='' order by category");
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder("Select Gl Acc. here"));
 ...
 try {
                ...
                java.sql.ResultSet rs = pstmt.executeQuery("select category from st_suppliers where category ilike '"+jComboBox1.getSelectedItem().toString()+"'");
                while (rs.next()){
...
this.dispose();            // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.reports.CreditorsAgeingByCatPdf policy = new com.afrisoftech.reports.CreditorsAgeingByCatPdf();
                
                policy.CreditorsAgeingByCatPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jComboBox1.getSelectedItem().toString(),this.jTextField1.getText());
