 ...
 * @author  root
 */
public class DatePanel1 extends javax.swing.JDialog {
    ...
    public DatePanel1(java.awt.Frame parent,  org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName,java.sql.Connection connectDb) {
 ...
 //       return dateStartEnd; 
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jComboBox1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset21, "bank_acc_no", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
  ...
  //    new DatePanel(new javax.swing.JFrame(), true).show();
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.sacco.CashBookListPdf policy = new com.afrisoftech.sacco.CashBookListPdf();
                            
                policy.CashBookListPdf(connectDB, this.datePicker1.getDate().toString(), this.datePicker2.getDate().toString(),jComboBox1.getSelectedItem().toString());
                            ...
                            
            {
                ...
                policy.BankingPdf(connectDB, this.datePicker1.getDate().toString(), this.datePicker2.getDate().toString(),this.jComboBox1.getSelectedItem().toString());
