 ...
 * @author  root
 */
public class HosPayrollStaffDatePanel extends javax.swing.JDialog {
    ...
    public HosPayrollStaffDatePanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jPanel4.setBorder(new javax.swing.border.TitledBorder(null, "Select staff name  here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(0, 0, 255)));
 ...
 try {
                    searchRowSet1.execute("select trim(employee_no) as scheme,first_name||' '||middle_name||' '||last_name as name from master_file where first_name||' '||middle_name||' '||last_name ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY name");
                    ...
                    jSearchTable1.setModel(new org.netbeans.lib.sql.models.TableModel(searchRowSet1, new org.netbeans.lib.sql.models.TableModel.Column[] {
                        new org.netbeans.lib.sql.models.TableModel.Column("scheme", "Staff No", false),
...
this.dispose();        // Add your handling code here:
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
            ...
            {
                com.afrisoftech.hospayroll.PayslipPerStaffPdf policy = new com.afrisoftech.hospayroll.PayslipPerStaffPdf();
                
                policy.PayslipPerStaffPdf(connectDB,datePicker1.getDate(),datePicker2.getDate(),jTextField36.getText());
            ...
            {
                com.afrisoftech.hospayroll.IndPayslipAnalisysPdf policy = new com.afrisoftech.hospayroll.IndPayslipAnalisysPdf();
                
                policy.IndPayslipAnalisysPdf(connectDB,datePicker1.getDate(),datePicker2.getDate(),jTextField36.getText());
