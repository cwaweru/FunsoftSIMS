 ...
 * @author  root
 */
public class AccountHosDatePanel1 extends javax.swing.JDialog {
    ...
    public AccountHosDatePanel1(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset1.setCommand("select distinct activity as activity from pb_activity order by activity");
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
                ...
                
            {
                ...
                policy.TransPerAccountPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField1.getText());
                ...
                
            {
                ...
                policy.TransByAccountPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField1.getText());
                ...
                
            {
                ...
                policy.TransByAccountSummPdf(connectDB, this.datePicker1.getDate(), this.datePicker2.getDate(),jTextField1.getText());
