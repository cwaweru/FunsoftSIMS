 ...
 * @author  root
 */
public class SecureLogin2HospInventory extends javax.swing.JDialog {
    ...
    com.afrisoftech.hospinventory.StockMain hospitalStockInst;
    ...
    public SecureLogin2HospInventory(java.awt.Frame parent, boolean modal, java.sql.Connection connectDB, org.netbeans.lib.sql.pool.PooledConnectionSource pconnectDB, java.lang.String logonName) {
...
//    }
    ...
    public com.afrisoftech.hospinventory.StockMain logOn2System() {
        
        com.afrisoftech.hospinventory.StockMain secureStockMain = null;
...
//                pconnDB = this.getPooledConnectionSource();
                ...
                while (reSet.next()) {
                    ...
                    try {
                        ...
                        java.lang.Class cl = Class.forName("com.afrisoftech.hospinventory.StockMain");
                    ...
                    hospitalStockInst = new com.afrisoftech.hospinventory.StockMain(connDB, pconnDB, path2Acrobat, passwd);//, this.path2Acrobat, this.pwdInfo.getPassword());
                    ...
                    hospitalStockInst.menuItemsDisabler(menuList2enable);
                    
                    secureStockMain = hospitalStockInst;
    ...
    public java.lang.String[] getMenuItems2Enable(java.lang.String logiName) {
        ...
        try {
            ...
            java.sql.PreparedStatement stmtDB = connDB.prepareStatement("SELECT menu_list FROM secure_menu_access WHERE login_name = ? AND sys_name = ?");
            
            stmtDB.setString(1, logiName.toString());
            
            stmtDB.setString(2, "hospital_inventory");
            
            java.sql.ResultSet rSet = stmtDB.executeQuery();
          //  java.sql.ResultSet rSet = stmtDB.executeQuery("SELECT menu_list FROM secure_menu_access WHERE login_name ='"+logiName+"' AND sys_name = 'hospital_inventory'");
    ...
    public java.lang.Object[] getSystemMenuItems2Enable(java.lang.String[] menus2enable) {
        ...
        for (int i = 0; i < menus2enable.length; i++) {
            ...
            try {
                ...
                java.sql.ResultSet rSet = stmtDB.executeQuery("SELECT menu_item FROM menu_item_list WHERE item_desc='"+menus2enable[i]+"' AND app_name = 'hospital_inventory'");
