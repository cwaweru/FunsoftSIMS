 ...
 * @author  root
 */
public class SecureLogin2HospPayroll extends javax.swing.JDialog {
    ...
    com.afrisoftech.hospayroll.PayrollMain hospitalPayrollInst;
    ...
    public SecureLogin2HospPayroll(java.awt.Frame parent, boolean modal, java.sql.Connection connectDB, org.netbeans.lib.sql.pool.PooledConnectionSource pconnectDB, java.lang.String logonName) {
...
//    }
    ...
    public com.afrisoftech.hospayroll.PayrollMain logOn2System() {
...
//                pconnDB = this.getPooledConnectionSource();
                ...
                while (reSet.next()) {
                    ...
                    try {
                        ...
                        java.lang.Class cl = Class.forName("com.afrisoftech.hospayroll.PayrollMain");
                    ...
                    hospitalPayrollInst = new com.afrisoftech.hospayroll.PayrollMain(connDB, pconnDB);//, this.path2Acrobat, this.pwdInfo.getPassword());
                    ...
                    hospitalPayrollInst.menuItemsDisabler(menuList2enable);
                    
                    securePayrollMain = hospitalPayrollInst;
    ...
    public java.lang.String[] getMenuItems2Enable(java.lang.String logiName) {
        ...
        try {
            ...
            stmtDB.setString(2, "hospital_payroll");
            
            java.sql.ResultSet rSet = stmtDB.executeQuery();
         /*   
            java.sql.Statement stmtDB = connDB.createStatement();
            
            java.sql.ResultSet rSet = stmtDB.executeQuery("SELECT menu_list FROM secure_menu_access WHERE login_name ='"+logiName+"' AND sys_name = 'hospital_payroll'");
            */
            while (rSet.next()) {
    ...
    public java.lang.Object[] getSystemMenuItems2Enable(java.lang.String[] menus2enable) {
        ...
        for (int i = 0; i < menus2enable.length; i++) {
            ...
            try {
                ...
                java.sql.ResultSet rSet = stmtDB.executeQuery("SELECT menu_item FROM menu_item_list WHERE item_desc='"+menus2enable[i]+"' AND app_name = 'hospital_payroll'");
                */
                while (rSet.next()) {
