 ...
 * @author  root
 */
public class Login2HRM extends javax.swing.JDialog {
    ...
    com.afrisoftech.hr.HRMain hospitalHRMInst;
    ...
    public Login2HRM(java.awt.Frame parent, boolean modal) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setTitle("Login Dialog Box - Human Resources Management\n");
    ...
    public static void main(String args[]) {
        ...
        new Login2HRM(new javax.swing.JFrame(), true).setVisible(true);
        ...
        if (!userName.equals("") && !passWord.equals("")) {
            ...
            try {
                ...
                while (reSet.next()) {
                    ...
                    hospitalHRMInst = new com.afrisoftech.hr.HRMain(connDB, pconnDB,null,null);//, this.path2Acrobat, this.pwdInfo.getPassword());
                   ...
                   // sysProp.put("hospmain", hospitalInst);
                    ...
                    hospitalHRMInst.menuItemsDisabler(menuList2enable);
                    
                    //   hospitalInst.setSize(java.awt.Toolkit.getDefaultToolkit().getScreenSize());
                    
                    hospitalHRMInst.setExtendedState(javax.swing.JFrame.MAXIMIZED_BOTH);
                    //                     inventoryInst.setVisible(true);
                    hospitalHRMInst.getPath2Acrobat();
               ...
               // if (mainApp) {
                ...
                hospitalHRMInst.setVisible(true);
