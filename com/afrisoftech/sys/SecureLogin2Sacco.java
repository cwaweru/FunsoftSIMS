 ...
 * @author  root
 */
public class SecureLogin2Sacco extends javax.swing.JDialog {
    ...
    com.afrisoftech.sacco.SaccoMain saccoInst;
    ...
    public SecureLogin2Sacco(java.awt.Frame parent, boolean modal, java.sql.Connection connectDB, org.netbeans.lib.sql.pool.PooledConnectionSource pconnectDB, java.lang.String logonName) {
...
//    }
    ...
    public com.afrisoftech.sacco.SaccoMain logOn2System() {
...
//                pconnDB = this.getPooledConnectionSource();
                ...
                while (reSet.next()) {
                    ...
                    saccoInst = new com.afrisoftech.sacco.SaccoMain(connDB, pconnDB, path2Acrobat, passwd);//, this.path2Acrobat, this.pwdInfo.getPassword());
                    ...
                    saccoInst.menuItemsDisabler(menuList2enable);
                    
                    secureSaccoMain = saccoInst;
    ...
    public java.lang.String[] getMenuItems2Enable(java.lang.String logiName) {
        ...
        try {
            ...
            java.sql.ResultSet rSet = stmtDB.executeQuery("SELECT menu_list FROM secure_menu_access WHERE login_name ='"+logiName+"' AND sys_name = 'sacco_main'");
    ...
    public java.lang.Object[] getSystemMenuItems2Enable(java.lang.String[] menus2enable) {
        ...
        for (int i = 0; i < menus2enable.length; i++) {
            ...
            try {
                ...
                java.sql.ResultSet rSet = stmtDB.executeQuery("SELECT menu_item FROM menu_item_list WHERE item_desc='"+menus2enable[i]+"' AND app_name = 'sacco_main'");
