 ...
 * @author  postgres
 */
public class InventoryLimIntfr extends javax.swing.JInternalFrame {
    ...
    public InventoryLimIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Inventory Limits SetUp ");
        setVisible(true);
        ...
        jLabel1.setText("Set Preffered Operational Limits here");
