 ...
 * @author  postgres
 */
public class ExceptionalItemsIntfr extends javax.swing.JInternalFrame {
    ...
    public ExceptionalItemsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Exceptional Items Setup");
        setVisible(true);
        ...
        jTextArea1.setText("Please set below the exceptional items you would like to be reported\n,e.g large Payments of over Kshs 500,000, Large Sales,New bank AcountNs\n,New Diseases.\n\n");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 10.0;
        buttonPanel.add(jTextArea1, gridBagConstraints);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Description", "GL Code", "Department", "Responsible Person", "Amount", "%"
            }
        ) {
