...
package com.afrisoftech.management ;

/**
 *
 * @author  postgres
 */
public class CurrencyIntfr extends javax.swing.JInternalFrame {
    ...
    public CurrencyIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        branchnameLbl1 = new javax.swing.JLabel();
        branchnameTxt1 = new javax.swing.JTextField();
        branchnameTxt2 = new javax.swing.JTextField();
        branchnameLbl2 = new javax.swing.JLabel();
        branchnameLbl3 = new javax.swing.JLabel();
        branchnameTxt3 = new javax.swing.JTextField();
        branchnameTxt4 = new javax.swing.JTextField();
        branchnameLbl4 = new javax.swing.JLabel();
        branchnameTxt5 = new javax.swing.JTextField();
        ...
        jLabel1.setText("Set Currencies here");
        ...
        branchnameLbl.setText("Currency Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        branchnameLbl1.setText("Conversion Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(branchnameLbl1, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 16, 0, 16);
        fieldsPanel.add(branchnameTxt1, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 16, 0, 16);
        fieldsPanel.add(branchnameTxt2, gridBagConstraints);

        branchnameLbl2.setText("Multiply or Divide");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(branchnameLbl2, gridBagConstraints);

        branchnameLbl3.setText("Symbol ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(branchnameLbl3, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 16, 0, 16);
        fieldsPanel.add(branchnameTxt3, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 16, 0, 16);
        fieldsPanel.add(branchnameTxt4, gridBagConstraints);

        branchnameLbl4.setText("Short Names");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(branchnameLbl4, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 16, 0, 16);
        fieldsPanel.add(branchnameTxt5, gridBagConstraints);
    ...
    private void clearActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearActionActionPerformed
        branchnameTxt1.setText("");
        branchnameTxt3.setText("");
        branchnameTxt5.setText("");
        branchnameTxt.setText("");
        branchidTxt.setText("");
        branchnameTxt2.setText("");        
        // TODO add your handling code here:
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into currency values(?, ?, ?, ?, ?, ?)");
            pstmt.setString(1,branchnameTxt1.getText());
            pstmt.setString(2,branchnameTxt3.getText());
            pstmt.setString(3,branchnameTxt5.getText());
            pstmt.setString(4,branchnameTxt.getText());
            pstmt.setString(5,branchidTxt.getText());
            pstmt.setString(6,branchnameTxt2.getText());
    ...
    private javax.swing.JTextField branchnameTxt5;
    private javax.swing.JButton jButton14;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel branchnameLbl1;
    private javax.swing.JLabel branchnameLbl2;
    private javax.swing.JButton clearAction;
    private javax.swing.JPanel actionsPanel;
    private javax.swing.JLabel jLabel2;
    private javax.swing.JPanel spacerPanel;
    private javax.swing.JPanel dataPanel;
    private javax.swing.JLabel branchnameLbl4;
    ...
    private javax.swing.JTextField branchnameTxt2;
    private javax.swing.JLabel branchidLbl;
    private javax.swing.JTextField branchnameTxt4;
    private javax.swing.JTextField branchnameTxt3;
