 ...
 * @author  postgres
 */
public class AmmendExRateIntfr extends javax.swing.JInternalFrame {
    ...
    public AmmendExRateIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Ammend Exchange Rate Setup");
        setVisible(true);
        ...
        jLabel1.setText("Ammend Exchange Rate  here");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Code", "Local Currency", "International Currency"
            }
        ));
        ...
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weighty = 1.0;
        dataPanel.add(jButton14, gridBagConstraints);
