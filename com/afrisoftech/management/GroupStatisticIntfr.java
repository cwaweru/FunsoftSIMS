 ...
 * @author  postgres
 */
public class GroupStatisticIntfr extends javax.swing.JInternalFrame {
    ...
    public GroupStatisticIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Please Register Groups  here");
        ...
        branchidLbl.setText("Group Statistic Id");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        ...
        branchnameLbl.setText("Group Statistic Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into group_statistics values(?, ?)");
            pstmt.setString(1,branchidTxt.getText());
            pstmt.setString(2,branchnameTxt.getText());
