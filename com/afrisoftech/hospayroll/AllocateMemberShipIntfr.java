 ...
 * @author  root
 */
public class AllocateMemberShipIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    public AllocateMemberShipIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Membership Number Entry");
        ...
        */
        ...
        try {
            ...
            crset2.setConnectionSource(pConnDB);
            crset2.execute("select description from deductions_allowances where allowance_deduction = 'Deduction' order by description");
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        if(jTextField113.getCaretPosition() < 2){
            ...
            try {
                ...
                searchRowSet2.execute("select employee_no,first_name||' '||middle_name||' '||last_name AS name,id_no from master_file where first_name||' '||middle_name||' '||last_name ILIKE '"+jTextField113.getText()+"%'");//||' '||second_name||' '||last_name");
                ...
                jSearchTable2.setModel(new org.netbeans.lib.sql.models.TableModel(searchRowSet2, new org.netbeans.lib.sql.models.TableModel.Column[] {
                    ...
                    new org.netbeans.lib.sql.models.TableModel.Column("id_no", "ID/Passport No.", false)
    ...
    private void jButton301ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton301ActionPerformed
        ...
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into statutory_nos values(?,?,upper(?),?,?,?)");
            ...
            connectDB.setAutoCommit(true);
               javax.swing.JOptionPane.showMessageDialog(this,"Data Successfully Saved..","Information Message",javax.swing.JOptionPane.INFORMATION_MESSAGE);
