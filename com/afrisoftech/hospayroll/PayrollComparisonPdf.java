...
public class PayrollComparisonPdf implements java.lang.Runnable {
    ...
    public void PayrollComparisonPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            for (int t = 0; t < rangeDates.length; t++) {
                                java.sql.ResultSet rset18 = st18.executeQuery("select sum(dv.amount) from deduction_summary dv where dv.date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"' and company_name ilike '"+bank+"'");
                                while (rset18.next()) {
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
