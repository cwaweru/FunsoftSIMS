...
public class PayrollDiffPdf implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
   ...
   java.lang.String bank = null;
    ...
    public void PayrollDiffPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                   ...
                   */
                        int headerwidths[] = {35,13,13,13,13};//,13,13};
                     ...
                     */
                        ...
                        try {
                            ...
                            phrase = new Phrase("Payroll Comparison as at " +dateFormat.format(endDate2), pFontHeader);
                      ...
                      //  table.addCell(phrase);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.PreparedStatement pSeta1 = connectDB.prepareStatement("SELECT count(description) FROM posting where  description = '"+listofAct[i]+"' and amount > 0 and company_name ilike '"+bank+"'");
                                java.sql.PreparedStatement pset22 = connectDB.prepareStatement("select description from posting WHERE description = ? and company_name ilike '"+bank+"' GROUP BY description");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                            ...
                            */
                                    ...
                                    java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(amount) from posting WHERE description = ?  AND date < '"+rangeDates[rangeDates.length - 1][0]+"' and company_name ilike '"+bank+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    pset1.setString(1,listofAct[i].toString());
                                    java.sql.ResultSet rset1 = pset1.executeQuery();
                                    
                                    java.sql.PreparedStatement pset111 = connectDB.prepareStatement("select sum(amount) from posting WHERE description = ?  AND date < '"+endDate+"' and company_name ilike '"+bank+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                ...
                                */
                                    java.sql.PreparedStatement pset112 = connectDB.prepareStatement("select sum(amount) from posting WHERE description = ? AND date < '"+endDate+"' and company_name ilike '"+bank+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    ...
                                    */
                                        java.sql.PreparedStatement pset = connectDB.prepareStatement("select sum(amount) from posting WHERE description = ?  AND date between '"+rangeDates[t][1]+"' AND '"+rangeDates[t][0]+"' and company_name ilike '"+bank+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                   ...
                                   //     table.addCell(phrase);
                                    ...
                                    for (int t = 0; t < ageingDates.length; t++) {
                                        ...
                                        while (rset112.next()){
                                            ...
                                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset112.getString(1)),pFontHeader1);
                                            table.addCell(phrase);
                                            columnTotals[t] = columnTotals[t] + rset112.getDouble(1);
                                            
                                            
                                        }
                                        TotalCount = TotalCount + rset112.getDouble(1);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT description FROM posting where description NOT ILIKE 'Monthly Per%' and company_name ilike '"+bank+"' order by description");
