 ...
 * @author  root
 */
public class MarketIntrRatesintfr extends javax.swing.JInternalFrame {
    ...
    public MarketIntrRatesintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Market Interest Rates");
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder("Enter Market Interest Rates here"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
              java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into prmarket_interest_rates values(?, ?)");
