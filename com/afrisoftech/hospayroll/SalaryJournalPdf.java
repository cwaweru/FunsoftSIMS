...
public class SalaryJournalPdf implements java.lang.Runnable {
    ...
    public void SalaryJournalPdf(java.sql.Connection connDb,java.lang.String begindate,java.lang.String endate,java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Salary Journal - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                       ...
                       table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                        ...
                        phrase = new Phrase("Earnings", pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select description,sum(amount) from earning_summary where description = '"+listofAct[i]+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' and company_name ilike '"+bank+"' GROUP BY description");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                ...
                                while (rset1.next()){
                                    ...
                                    table.addCell(phrase);
                                    Earning = Earning + rset1.getDouble(2);
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase("    ", pFontHeader);
                            ...
                            System.out.println(listofAct1.length);
                            ...
                            for (int i = 0; i < listofAct1.length; i++) {
                                ...
                                java.sql.Statement st3 = connectDB.createStatement();
                                  ...
                                  java.sql.ResultSet rset1 = st1.executeQuery("select description,sum(amount) from deduction_summary where description = '"+listofAct1[i]+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' and company_name ilike '"+bank+"' GROUP BY description");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                ...
                                while (rset1.next()){
                                    ...
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset1.getString(2)),pFontNum);
                                    table.addCell(phrase);
                                    Deduction = Deduction + rset1.getDouble(2);
                                    
                                }
                                
                            }
                            
                            NetPay = Earning - Deduction;
                            
                            System.out.println(NetPay);
                            DeductionTotal = Deduction + NetPay;
                            table.getDefaultCell().setColspan(1);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(Earning)),pFontHeader);
                            table.addCell(phrase);
                            
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(DeductionTotal)),pFontHeader);
                            table.addCell(phrase);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT description FROM earning_summary where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and company_name ilike '"+bank+"' order by description");
