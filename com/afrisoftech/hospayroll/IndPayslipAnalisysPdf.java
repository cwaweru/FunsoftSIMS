...
public class IndPayslipAnalisysPdf implements java.lang.Runnable {
    ...
    public void IndPayslipAnalisysPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String staffno) {
                            ...
                            try {
                                ...
                                for (int m = 0; m < listofAct4.length; m++) {
                                    ...
                                    for (int t = 0; t < rangeDates.length; t++) {
                                        java.sql.ResultSet rset1 = st31.executeQuery("select sum(amount) from posting where staff_no = '"+listofStaffNos[j]+"' AND description =  '"+listofAct4[m]+"' AND date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"' AND allowance_deduction ILIKE 'Earning%'");
                                ...
                                for (int t = 0; t < rangeDates.length; t++) {
                                    java.sql.ResultSet rset1 = st31.executeQuery("select sum(amount) from posting where staff_no = '"+listofStaffNos[j]+"' AND date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"' AND allowance_deduction ILIKE 'Earning%'");
                                ...
                                for (int n = 0; n < listofAct5.length; n++) {
                                    ...
                                    for (int s = 0; s < rangeDates.length; s++) {
                                        java.sql.ResultSet rset11 = st31.executeQuery("select sum(amount) from posting where staff_no = '"+listofStaffNos[j]+"' AND description =  '"+listofAct5[n]+"' AND date BETWEEN '"+rangeDates[s][0]+"' AND '"+rangeDates[s][1]+"'");
                                ...
                                for (int t = 0; t < rangeDates.length; t++) {
                                    java.sql.ResultSet rset1A = st3A.executeQuery("select sum(amount) from posting where date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"' and staff_no = '"+listofStaffNos[j]+"' AND allowance_deduction ILIKE 'NON CASH%'");
                                ...
                                for (int t = 0; t < rangeDates.length; t++) {
                                    rsetTotals1 = st4.executeQuery("SELECT sum(pt.amount) from posting pt WHERE pt.staff_no = '"+listofStaffNos[j]+"' AND pt.date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"' AND (pt.allowance_deduction ILIKE 'Earning%' OR pt.allowance_deduction ILIKE 'non%')");
                                ...
                                for (int n = 0; n < listofAct6.length; n++) {
                                    ...
                                    for (int s = 0; s < rangeDates.length; s++) {
                                        java.sql.ResultSet rset11 = st31.executeQuery("select sum(amount) from posting where staff_no = '"+listofStaffNos[j]+"' AND description ilike  '"+listofAct6[n]+"' AND date BETWEEN '"+rangeDates[s][0]+"' AND '"+rangeDates[s][1]+"'");
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                for (int s = 0; s < rangeDates.length; s++) {
                                    java.sql.ResultSet rset11 = st31.executeQuery("select sum(amount) from posting where staff_no = '"+listofStaffNos[j]+"' AND date BETWEEN '"+rangeDates[s][0]+"' AND '"+rangeDates[s][1]+"' AND allowance_deduction ILIKE 'Less Re%'");
                                ...
                                for (int t = 0; t < rangeDates.length; t++) {
                                    ...
                                    java.sql.ResultSet rset11 = st31.executeQuery("select sum(amount) from posting where staff_no = '"+listofStaffNos[j]+"' AND date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"' AND allowance_deduction ILIKE 'Less Re%'");
                                ...
                                for (int t = 0; t < rangeDates.length; t++) {
                                    java.sql.ResultSet rset14 = st14.executeQuery("select sum(tx.amount) from posting tx where tx.staff_no = '"+listofStaffNos[j]+"' AND tx.date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"' AND (tx.description ILIKE 'PAYE%' OR tx.description ILIKE 'Monthly Personal Relief%' OR tx.description ILIKE 'P.A.Y.E%')");
                                    while (rset14.next()) {
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                ...
                                for (int t = 0; t < rangeDates.length; t++) {
                                    java.sql.ResultSet rset14 = st14.executeQuery("select sum(tx.amount) from posting tx where tx.staff_no = '"+listofStaffNos[j]+"' AND tx.date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"' AND tx.description ILIKE 'Monthly Personal Relief%'");
                                    while (rset14.next()) {
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                        phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset14.getString(1)),pFontNum);
                                        table.addCell(phrase);
                                ...
                                for (int t = 0; t < rangeDates.length; t++) {
                                    java.sql.ResultSet rset14 = st14.executeQuery("select sum(tx.amount) from posting tx where tx.staff_no = '"+listofStaffNos[j]+"' AND tx.date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"' AND (tx.description ILIKE 'PAYE%' OR tx.description ILIKE 'P.A.Y.E%')");
                                    while (rset14.next()) {
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                        phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset14.getString(1)),pFontNum);
                                        table.addCell(phrase);
                                ...
                                for (int k = 0; k < listofAct.length; k++) {
                                    ...
                                    for (int t = 0; t < rangeDates.length; t++) {
                                        ...
                                        java.sql.ResultSet rset17 = st17.executeQuery("select sum(av.amount) as amount from posting av where av.staff_no = '"+listofStaffNos[j]+"' AND av.date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"' and av.description ilike '"+listofAct[k]+"'");
                                ...
                                for (int t = 0; t < rangeDates.length; t++) {
                                    java.sql.ResultSet rset18 = st18.executeQuery("select sum(dv.amount) from deduction_summary dv where dv.staff_no = '"+listofStaffNos[j]+"' AND dv.date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"'");
                                    while (rset18.next()) {
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                ...
                                for (int t = 0; t < rangeDates.length; t++) {
                                    java.sql.ResultSet rset19 = st19.executeQuery("select sum(amount) from net_pay_view dv where dv.staff_no = '"+listofStaffNos[j]+"' AND dv.date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"'");
                                    while (rset19.next()) {
                                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT staff_no FROM posting WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and staff_no = '"+patNo+"'");
