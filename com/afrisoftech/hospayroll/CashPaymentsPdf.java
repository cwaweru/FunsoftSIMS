...
public class CashPaymentsPdf implements java.lang.Runnable {
    ...
    public void CashPaymentsPdf(java.sql.Connection connDb,java.lang.String begindate,java.lang.String endate,java.lang.String combox) {
    ...
    public void generatePdf() {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Cash Payments  " +dateFormat.format(formattedDate)+ " --  " +dateFormat.format(formattedDate), pFontHeader);
                      ...
                      //  Phrase phrase = new Phrase("Cash Payments Period From: " +beginDate +"  To: "+ endDate, pFontHeader);
                       ...
                       // table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select ep.staff_no,initcap(mf.first_name||' '||mf.middle_name||' '||last_name) as name,mf.id_no,initcap(mf.bank),mf.bank_account_no,sum(ep.amount) from master_file mf, net_pay_view ep where ep.staff_no = mf.employee_no and ep.staff_no = '"+listofStaffNos[j]+"' and mf.payment_mode ='Cash' and ep.date BETWEEN '"+beginDate+"' AND '"+endDate+"' and mf.company_name ilike '"+bank+"' group by name,ep.staff_no, mf.bank,mf.id_no,mf.bank_account_no");
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT employee_no FROM master_file where payment_mode = 'Cash' and company_name ilike '"+bank+"' order by employee_no");
