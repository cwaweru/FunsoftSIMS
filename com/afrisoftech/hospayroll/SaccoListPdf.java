...
public class SaccoListPdf implements java.lang.Runnable {
    ...
    public void SaccoListPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Checked by :_______________________________       Signature ___________________________ \n Designation____________________________ "+
                    "Date ____________________________     Sacco List - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.util.Date formattedDate = dateFormat.parse(endDate.toLocaleString());//dateInstance.toLocaleString());
                        ...
                        try {
                            java.sql.Statement st3 = connectDB.createStatement();
                           // java.sql.ResultSet rsetTotals = st3.executeQuery("SELECT SUM(paye_tax) from tax_card WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            ...
                            java.lang.Object listofStaffNos[] = this.getListofStaffNos();
                                ...
                                java.sql.Statement st2 = connectDB.createStatement();
                                 java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT sum(sc.amount),sum(pt.amount) from sacco_deductions sc,posting pt WHERE pt.date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND sc.sacco_name = '"+bank+"' and sc.sacco_name = pt.description group by pt.staff_no");
                              for (int j = 0; j < listofStaffNos.length; j++) {
                            
                                
                                java.sql.ResultSet rset = st.executeQuery("select pt.staff_no,sc.staff_name,sc.sacco_no,sc.amount,pt.amount from sacco_deductions sc,posting pt where pt.staff_no = '"+listofStaffNos[j]+"' and pt.staff_no = sc.staff_no and sc.sacco_name = '"+bank+"' and sc.sacco_name = pt.description AND pt.date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by sc.staff_no");
