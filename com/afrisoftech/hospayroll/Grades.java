 ...
 * Grades.java
 *
 * Created on Aug 24, 2003, 03:02 PM
*/
...
java.sql.Connection connectDB = null;
    ...
    public Grades(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select * from grade_setup order by code");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        try {
            nBCachedRowSet1.setTableName("grade_setup");
        } catch (java.sql.SQLException e1) {
            e1.printStackTrace();
        }
