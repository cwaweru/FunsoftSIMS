...
public class StaffEarningsPdf implements java.lang.Runnable {
    ...
    public void StaffEarningsPdf(java.sql.Connection connDb,java.lang.String begindate,java.lang.String endate,java.lang.String combox) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Salary Summary As At :  " +dateFormat.format(formattedDate), pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select employee_no,upper(first_name||' '||middle_name||' '||last_name) from master_file where employee_no = '"+listofAct[i]+"' and company_name ilike '"+bank+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                
                                java.sql.ResultSet rset = st2.executeQuery("select EXTRACT (month from date)||' '||EXTRACT (year from date) as date,description,amount from posting where staff_no = '"+listofAct[i]+"' AND description IS NOT NULL AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' and company_name ilike '"+bank+"' order by date");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                ...
                                rsetTotals1 = st3.executeQuery("SELECT SUM(amount) from posting WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and company_name ilike '"+bank+"'");
