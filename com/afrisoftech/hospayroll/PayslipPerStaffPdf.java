        ...
        try {
            ...
            try {
              ...
              /*      java.util.Calendar calendar = java.util.Calendar.getInstance();
                    ...
                    java.util.Date dateFirst = calendar.getTime();
               
                    System.out.println("First day of year "+dateFirst.toString());
               */
                  /*  try {
                        ...
                        for (int j = 0; j < listofStaffNos.length; j++) {
                            ...
                            //                               java.util.Date formattedDate1 = dateFormat.parse(beginDate);//dateInstance.toLocaleString());
                            
                            
                            //         phrase = new Phrase("Pay Period: " +dateFormat.format(formattedDate1)+" --"+dateFormat.format(formattedDate) , pFontHeader);
                            ...
                            try {
                                ...
                                phrase = new Phrase("Department       :  "+rset.getObject(3).toString().toUpperCase(),pFontHeader);
                                ...
                                while (rsetTotals1.next()) {
                                    ...
                                    phrase1 = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rsetTotals1.getObject(1).toString()), pFontHeader);
                                ...
                                while (rset1.next()) {
                                    ...
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset1.getString(3)),pFontNum);
                                ...
                                while (rset1A.next()) {
                                    ...
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset1A.getObject(2).toString()),pFontNum);
                                    table.addCell(phrase);
                                ...
                                while (rsetTotals1A.next()) {
                                    ...
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rsetTotals1A.getObject(1).toString()), pFontHeader);
                                ...
                                while (rsetss.next()) {
                                    ...
                                    table.getDefaultCell().setColspan(3);
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase("Payment By    :   "+rsetss.getObject(3).toString(),pFontHeader);
                                    table.addCell(phrase);
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase("Bank Name     :   "+rsetss.getObject(1).toString(),pFontHeader);
                                    table.addCell(phrase);
                                    
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase("Account No    :  "+rsetss.getObject(2).toString(),pFontHeader);
                                    table.addCell(phrase);
