...
public class DeductionsPdf implements java.lang.Runnable {
    ...
    public void DeductionsPdf(java.sql.Connection connDb,java.lang.String begindate,java.lang.String endate,java.lang.String combox) {
                 ...
                 //   docPdf.setFooter(footer);
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Deductions: " +dateFormat.format(formattedDate), pFontHeader);
                        ...
                        table.addCell(phrase);
                         phrase = new Phrase("Staff_name",pFontHeader);
                        table.addCell(phrase);
                        
                        phrase = new Phrase("Descrption",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select np.staff_no,upper(np.staff_name),upper(np.description),sum(np.amount) from posting np WHERE np.date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND (allowance_deduction ='Deduction' OR allowance_deduction = 'Less Relief' OR allowance_deduction = 'Monthly Personal Relief') and company_name ilike '"+bank+"' group by np.staff_no,np.staff_name,np.description ORDER BY np.staff_no");
                            
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(amount) from posting WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND (allowance_deduction ='Deduction' OR allowance_deduction = 'Less Relief' OR allowance_deduction = 'Monthly Personal Relief') and company_name ilike '"+bank+"'");
