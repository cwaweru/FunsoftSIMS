...
public class NetSalaryPdf implements java.lang.Runnable {
    ...
    public void NetSalaryPdf(java.sql.Connection connDb,java.lang.String begindate,java.lang.String endate,java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Net Salary - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Net Salarly: " +dateFormat.format(formattedDate), pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select np.staff_no,np.staff_name,sum(np.amount) from net_salary_view np WHERE np.date BETWEEN '"+beginDate+"' AND '"+endDate+"' and company_name ilike '"+bank+"' group by np.staff_no,np.staff_name");
                            
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(amount) from net_salary_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and company_name ilike '"+bank+"' ");
