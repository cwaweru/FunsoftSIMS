            ...
            if (dess.equalsIgnoreCase(Password)){
               ...
               java.lang.Object items[] = getListofActivitiesq(); 
                ...
                for (int j = 0; j < items.length; j++) {
                    ...
                    java.sql.ResultSet rstg1 = pstmtg1.executeQuery("SELECT st.code,st.activity from pb_activity st where st.code ilike '"+items1[i]+"%'");
 ...
 */
    ...
    public java.lang.Object[] getListofActivitiesq1(java.lang.Object descDeductions) {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT gl_code FROM deductions_allowances where description ilike '"+descDeductions+"'");
