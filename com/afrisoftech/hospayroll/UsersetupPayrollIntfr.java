 ...
 * @author  root
 */
public class UsersetupPayrollIntfr extends javax.swing.JInternalFrame {
    ...
    public UsersetupPayrollIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset3.setCommand("select DISTINCT item_desc from menu_item_list WHERE app_name = 'hospital_payroll' order by item_desc");
...
/*       
   ...
   //         for (int i = 0; i  < selectedValues.length; i++){
            java.sql.Statement pstmt = connectDB.createStatement();
                           java.sql.PreparedStatement pmstmt = connectDB.prepareStatement("UPDATE secure_menu_access SET menu_list = '{"+str+"}' WHERE login_name = '"+jComboBox1.getSelectedItem()+"' AND sys_name = 'hospital_payroll'");
