...
public class PayslipAnalisysPdf implements java.lang.Runnable {
    ...
    public void PayslipAnalisysPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
                            ...
                            try {
                                ...
                                for (int m = 0; m < listofAct4.length; m++) {
                                    ...
                                    for (int t = 0; t < rangeDates.length; t++) {
                                        java.sql.ResultSet rset1 = st31.executeQuery("select sum(amount) from posting where staff_no = '"+listofStaffNos[j]+"' AND description =  '"+listofAct4[m]+"' AND date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"' AND allowance_deduction ILIKE 'Earning%' and company_name ilike '"+bank+"'");
                                ...
                                for (int t = 0; t < rangeDates.length; t++) {
                                    java.sql.ResultSet rset1 = st31.executeQuery("select sum(amount) from posting where staff_no = '"+listofStaffNos[j]+"' AND date BETWEEN '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"' AND allowance_deduction ILIKE 'Earning%' and company_name ilike '"+bank+"'");
