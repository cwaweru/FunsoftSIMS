 ...
 * @author  root
 */
public class ProvisionsPerDebtorIntfr extends javax.swing.JInternalFrame {
    ...
    public ProvisionsPerDebtorIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Inv. No.", "Patient No.", "Inv Amount", "Amt To Provision", "Balance", "Select"
            }
        ) {
        ...
        jLabel4.setText("Provisionable Balance");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 11;
        ...
        try {
          ...
          //  while (rsts.next())
            ...
            Object newdate = datenowSql;
                       ...
                       */
                        java.sql.PreparedStatement pstmt3 = connectDB.prepareStatement("UPDATE ac_debtors set provision = true,prov_amt = balance,prov_date = current_date,prov_user = current_user WHERE dealer = '"+this.jTextField36.getText()+"' and date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"' and balance >0");
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        this.populateTable1(this.jTextField36.getText()); 
         ...
         try {
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.Statement stmt1 = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select sum(balance) from ac_debtors where dealer = '"+jTextField36.getText()+"' AND date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"'");
            //  java.sql.ResultSet rset1 = stmt1.executeQuery("select count(debit) from ac_cash_collection where cash_point ='"+jComboBox2.getSelectedItem()+"' and shift_no = '"+jTextField9.getText()+"'");
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(jTextField111.getCaretPosition() < 3){
            ...
            try {
                ...
                searchRowSet.execute("select trim(scheme_manager) as scheme ,account_no from ac_scheme_providers where scheme_manager ILIKE '"+jTextField111.getText().toString()+"%'");
                //   searchRowSet.execute();
                //     searchRowSet.execute("SELECT patient_no, (upper(first_name||' '||second_name||' '||last_name)) as name, year_of_birth, residence from hp_patient_register where first_name '~ '~"+jTextField11.getText()+"' order by name");
  ...
  */
    ...
    private void populateTable1(java.lang.String patient_no) {
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("SELECT count(dealer) FROM ac_debtors WHERE dealer = '"+patient_no+"' and balance > 0 and date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"'");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
            ...
            if (j > 0){
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT date, invoice_no, admission_no,balance::numeric ,'false' FROM ac_debtors WHERE dealer = '"+patient_no+"' AND balance > 0 and provision = false and date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"' order by date");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
