 ...
 * CashPoints.java
 *
 * Created on Sep 10, 2003, 11:25 AM
*/
...
public class CashPoints extends javax.swing.JFrame
{
    ...
    public CashPoints(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select * from ac_cash_points_setup order by description");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        try {
            nBCachedRowSet1.setTableName("ac_cash_points_setup");
        } catch (java.sql.SQLException e1) {
            e1.printStackTrace();
        }
