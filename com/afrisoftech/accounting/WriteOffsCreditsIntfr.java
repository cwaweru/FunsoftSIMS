 ...
 * @author  root
 */
public class WriteOffsCreditsIntfr extends javax.swing.JInternalFrame {
    ...
    public WriteOffsCreditsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Rct. No.", "Doc No.", "Org Amount", "Amt To Write Off", "Balance", "Write Off"
            }
        ) {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,4) != null){
                    ...
                    if(java.lang.Double.parseDouble(jTable1.getValueAt(i,4).toString()) > 0){
                        ...
                        pstmt3.setObject(3,"WriteOffCredits");
                        ...
                        if(jTable1.getValueAt(i,2).toString()== null){
                             pstmt3.setObject(11,jTable1.getValueAt(i,1).toString());
                        }else{
                        ...
                        java.sql.PreparedStatement pstmt4 = connectDB.prepareStatement("UPDATE ac_debtors set credit_bal = 0,write_off = true,wrt_amt = '"+jTable1.getModel().getValueAt(i,4).toString()+"',wrt_date = 'now',wrt_user = '"+User+"' WHERE receipt_no = '"+jTable1.getModel().getValueAt(i,1).toString()+"' and account_no = '"+jTextField4.getText()+"'");
  ...
  */
    ...
    private void populateTable1(java.lang.String patient_no) {
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("SELECT count(dealer) FROM ac_debtors WHERE account_no = '"+patient_no+"' and credit_bal != 0 and date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"'");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
            ...
            if (j > 0){
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT date, receipt_no, '0',credit_bal::numeric ,'false' FROM ac_debtors WHERE account_no = '"+patient_no+"' AND credit_bal != 0 and date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"' order by date");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
                ...
                while (rsetTable1.next()) {
                  ...
                  //  jTable1.setValueAt(dbObject.getDBObject(rsetTable1.getString(3).toString(), i, 2).toString(), "0");
