 ...
 * @author  root
 */
public class BankRecSchdIntfr extends javax.swing.JInternalFrame {
    ...
    public BankRecSchdIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Reconciliation Schedule");
 ...
 try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("select account_name from ac_cash_book where account_no ='"+jComboBox2.getSelectedItem()+"'");
             while (rset.next()){
...
//          javax.swing.JFrame off = new Department(connectDB, pConnDB);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into ac_bank_rec values(?,?,?,?,?,?)");
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    ...
                    if (jTable1.getModel().getValueAt(i,1) == null){
                        ...
                        javax.swing.JOptionPane.showMessageDialog(this,"Enter Narration.","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
                    }else{
                        pstmt.setObject(4,jTable1.getValueAt(i,1).toString());
                    }
                    if (jTable1.getModel().getValueAt(i,2) == null){
                        
                        javax.swing.JOptionPane.showMessageDialog(this,"Amount","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
                    }else{
                   ...
                   //  if (jTable1.getModel().getValueAt(i,3) == null){
                    ...
                    pstmt.setObject(2,jTextField71.getText().toString());
