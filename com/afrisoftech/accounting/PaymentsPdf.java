...
public class PaymentsPdf implements java.lang.Runnable {
    ...
    public void PaymentsPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Payments - Page: ", pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("SELECT date,voucher_no,initcap(dealer),initcap(description),cheque_no,credit from ac_cash_book WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND transaction_type = 'Payment' order by date");
                            
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(credit) from ac_cash_book WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'  AND transaction_type = 'Payment'");
