 ...
 * @author  root
 */
public class SickLeaveIntfr extends javax.swing.JInternalFrame {
    ...
    public SickLeaveIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jComboBox1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset11, "patient_name", null, null, null));
        ...
        jPanel7.setBorder(new javax.swing.border.TitledBorder("Recommedations"));
        ...
        jPanel7.add(jRadioButton4, new java.awt.GridBagConstraints());
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        getContentPane().add(datePicker11, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        getContentPane().add(datePicker12, gridBagConstraints);

        jLabel62.setText("Resumption Date");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 8;
        gridBagConstraints.weightx = 1.0;
        ...
        jLabel5.setText("No. of sick Days");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 7;
        ...
        try {
           ...
           String Recom = null;
            ...
            if (jCheckBox5.isSelected()){
                Excemt = this.jCheckBox5.getText();
            }else{
                if (jCheckBox6.isSelected()){
                   Excemt = jCheckBox6.getText();
                }else{
           ...
           if (this.jRadioButton1.isSelected()){
            ...
            user = rst11.getObject(2).toString();
                        ...
                        pstmt2.setString(5,jTextField4.getText());
                        pstmt2.setString(7,Recom);
                        pstmt2.setString(6,Excemt);
                        pstmt2.setObject(8,jTextField3.getText());
                        pstmt2.setString(9,datePicker11.getDate().toString());
                         pstmt2.setString(10,datePicker12.getDate().toString());
                       
                        pstmt2.setString(11,jTextField10.getText());
                        pstmt2.setString(14,user);
                       pstmt2.setString(13,datePicker1.getDate().toString());
                       
                         pstmt2.setString(12,prescNo);
                        pstmt2.setObject(15,jTextField9.getText());
                        pstmt2.setObject(16,jTextField8.getText());
