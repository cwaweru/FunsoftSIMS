...
public class RefferalsIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder("Patient Details"));
        ...
        jPanel8.setBorder(new javax.swing.border.TitledBorder(null, "Doctor/Service Provider Reffered to", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(153, 0, 153)));
 ...
 this.jSearchDialog2.dispose();          // Add your handling code here:
  ...
  if(jTextField113.getCaretPosition() < 2){
            ...
            try {
                ...
                searchRowSet2.execute(" SELECT patient_no, (second_name||' '||first_name) as patient_name from hp_patient_register where (second_name||' '||first_name) ILIKE '"+jTextField113.getText()+"%'  order by second_name");//||' '||second_name||' '||last_name");
             ...
             try {
                ...
                searchRowSet2.execute("SELECT patient_no, (second_name||' '||first_name) as patient_name from hp_patient_register where patient_no ILIKE '"+jTextField113.getText()+"%'  order by second_name");//||' '||second_name||' '||last_name");
