 ...
 * @author  root
 */
public class ApproveDepreciationClass {
    ...
    public ApproveDepreciationClass(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    public void DepreciationClass(){
            ...
            int exitOption = javax.swing.JOptionPane.showConfirmDialog(new java.awt.Frame(), "Are you sure that depreciation is okey?", "Caution before approving!", javax.swing.JOptionPane.YES_NO_CANCEL_OPTION);
        
          if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
        java.lang.Object listofStaffNos[] = this.getListofStaffNos();
        java.lang.Object[] listofAct = getListofActivities();
        int confOption = javax.swing.JOptionPane.showConfirmDialog(new java.awt.Frame(), "Are you sure you want to continue with updating depreciation", "Caution before Approving!", javax.swing.JOptionPane.YES_NO_CANCEL_OPTION);
            ...
            try {
             ...
             //   pstm.executeUpdate();
                ...
                if(depreciationmethod.equals("Straight Line Method")){
                    ...
                    java.sql.ResultSet rs22 = stm22.executeQuery("select sum(amount_depreciated) from ac_asset_allocation dr WHERE dr.cost > dr.depreciation");
                    while (rs22.next())
                    ...
                    java.sql.ResultSet rs1 = pst1.executeQuery("select dr.depreciation_code,dr.asset_category,dr.asset_type,sum(amount_depreciated) from ac_asset_allocation dr WHERE dr.cost > dr.depreciation group by dr.asset_type,dr.depreciation_code,dr.asset_category");
                    ...
                    while (rs1.next()){
                        ...
                        pstmt25.setString(17,rate);
                        pstmt25.setObject(16,"00");
                        ...
                        java.sql.PreparedStatement pstmt = connectDB.prepareStatement("begin work; update ac_asset_allocation set depreciation = depreciation + amount_depreciated,approved = true WHERE asset_category = '"+glType+"';commit work");
                        pstmt.executeUpdate();
                        
                        java.sql.PreparedStatement pstmt281 = connectDB.prepareStatement("begin work; update pb_activity set ytd_credit =  ytd_credit + '"+rate+"' WHERE code = '"+accountCode+"';commit work");
                    ...
                    pstmt21.setFloat(16,Amount);
                    pstmt21.setObject(17,"00");
                    ...
                    pstmt21.executeUpdate();
                     ...
                     java.sql.PreparedStatement pstmt281 = connectDB.prepareStatement("begin work; update pb_activity set ytd_debit =  ytd_debit + '"+Amount+"' WHERE code = '"+rCode+"';commit work");
                        pstmt281.executeUpdate();
                    ...
                    if(depreciationmethod.equals("Reducing Instalments Method")){
                        ...
                        while (rs1.next()){
                            ...
                            pstmt27.setString(17,rate);
                            pstmt27.setObject(16,"00");
                            ...
                            java.sql.PreparedStatement pstmt28 = connectDB.prepareStatement("begin work; update ac_asset_allocation set depreciation = depreciation + amount_depreciated,approved = true WHERE asset_category = '"+glType+"';commit work");
                        ...
                        java.sql.PreparedStatement pstmt21 = connectDB.prepareStatement("insert into ac_ledger values(?, ?, ?, ?, initcap(?), ?, initcap(?), ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?)");
                        pstmt21.setObject(1,rCode);
                        pstmt21.setObject(2,"Assets Depreciation");
                        pstmt21.setString(3,"");
                        pstmt21.setObject(4,"");
                        pstmt21.setObject(5,"");
                        pstmt21.setString(6,"");
                ...
                //javax.swing.JOptionPane.showConfirmDialog(this, "Insert Done Successfully","Comfirmation",javax.swing.JOptionPane.INFORMATION_MESSAGE);
