 ...
 * @author  root
 */
public class PaymodeAdjIntfr extends javax.swing.JInternalFrame {
    ...
    public PaymodeAdjIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Change Receipt Paymode");
        ...
        */
        ...
        jComboBox2.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset31, "description", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jLabel5.setText("Current Pay Mode");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.insets = new java.awt.Insets(0, 30, 0, 0);
...
//        jComboBox131.setSelectedItem(null);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            //java.sql.ResultSet rse1 = stm1.executeQuery("UPDATE ac_cash_collection set payment_mode = '"+jComboBox2.getSelectedItem().toString()+"' where receipt_no ='"+jTextField91.getText()+"'");
            java.sql.PreparedStatement pstmt5 = connectDB.prepareStatement("UPDATE ac_cash_collection set payment_mode = '"+jComboBox2.getSelectedItem().toString()+"' where receipt_no ='"+jTextField91.getText()+"'");
        ...
        /*    java.sql.Statement stm1 = connectDB.createStatement();
           ...
           while (rse1.next())
            ...
            connectDB.setAutoCommit(true);
               ...
               javax.swing.JOptionPane.showMessageDialog(this,"Payment Mode adjusted to '"+jComboBox2.getSelectedItem().toString()+"' ","Confirmation Message!",javax.swing.JOptionPane.INFORMATION_MESSAGE);
