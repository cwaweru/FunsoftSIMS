 ...
 * @author  postgres
 */
public class RevenuleIntfr extends javax.swing.JInternalFrame {
    ...
    public RevenuleIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Please Revenue Collection  here");
        ...
        try {
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null && jTable1.getModel().getValueAt(i,2) != null){
                    ...
                    stmt11.execute("insert into ac_revenue(province,hospital,date,amount) values('"+jTable1.getValueAt(i,0).toString()+"','"+jTable1.getValueAt(i,1).toString()+"','"+datePicker1.getDate()+"','"+jTable1.getValueAt(i,2).toString()+"')");
                }
            }
