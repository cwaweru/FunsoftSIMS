...
public class CopayReceiptsIntfr extends javax.swing.JInternalFrame {
    ...
    public CopayReceiptsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        if(jTextField11.getCaretPosition() < 3){
            ...
            if(this.jCheckBox2.isSelected()){
                ...
                try {
                    ...
                    searchRowSet.execute("SELECT (second_name||' '|| first_name||' '||last_name) as name,patient_no from hp_patient_register where second_name||' '|| first_name||' '||last_name ILIKE '"+jTextField11.getText()+"%' and pay_mode ilike 'scheme' and last_visit between (current_date - 4) and current_date order by second_name");
                ...
                if(this.jCheckBox1.isSelected()){
                    ...
                    try {
                        ...
                        searchRowSet.execute("SELECT (second_name||' '|| first_name||' '||last_name) as name,patient_no from hp_patient_register where patient_no ILIKE '"+jTextField11.getText()+"%' and pay_mode ilike 'scheme' and  last_visit between (current_date - 4) and current_date order by patient_no");
    ...
    private void jButton1111ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1111ActionPerformed
        ...
        try {
            ...
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select service_type,gl_account,main_service from pb_operating_parameters where service_type ILIKE 'CONSULTATION FEE'");
            while (rset.next())
                activity = rset.getObject(1).toString();
            actNo = rset.getObject(2).toString();
            mainAcc = rset.getObject(3).toString();
            // user = rset.getObject(4).toString();
            
            
            
            System.out.println(actNames1);
            java.sql.PreparedStatement pstmt23 = connectDB.prepareStatement("insert into ac_ledger values(?,?,?,initcap(?),?,?, ?, initcap(?), initcap(?), ?, ?, ?,  ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?)");
            pstmt23.setObject(1,patientAcc);
            pstmt23.setObject(5,jTextField11.getText());
            pstmt23.setString(2,AccDesc);
            pstmt23.setString(3,"");
            pstmt23.setString(4,jTextField20.getText());
            pstmt23.setString(6,"");
            pstmt23.setString(8,jTextField1.getText());
            pstmt23.setString(9,jTextField9.getText());
            pstmt23.setString(10,"");
            pstmt23.setString(11,jTextField221.getText());
            pstmt23.setString(12,receiptNo1);
            pstmt23.setString(7,"");
            pstmt23.setString(13,"");
            pstmt23.setString(14,"Copay");
            // pstmt2.setString(15,jTextField7.getText());
            //  pstmt2.setString(16,jTextField5.getText());
            pstmt23.setObject(15,"Receipts");
            pstmt23.setObject(17,jTextField17.getText());
            pstmt23.setString(16,"00");
            pstmt23.setString(18,datePicker2.getDate().toString());
            pstmt23.setString(19,transNo1);
            pstmt23.setBoolean(22,false);
            pstmt23.setBoolean(20,false);
            pstmt23.setBoolean(21,false);
            pstmt23.setString(23,user);
            pstmt23.setString(24,jTextField81.getText());
            pstmt23.setString(25,jTextField14.getText());
            pstmt23.executeUpdate();
            
            java.sql.PreparedStatement pstmt212 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_credit = ytd_credit + '"+jTextField17.getText()+"' where code = '"+patientAcc+"'");
            pstmt212.executeUpdate();
            ...
            pstmt2.executeUpdate();
             ...
             java.sql.PreparedStatement pstmt2126 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_debit = ytd_debit + '"+jTextField17.getText()+"' where code = '"+rcode+"'");
            ...
            pstmt2b.setString(6,"1");
            pstmt2b.setDouble(7,-Double.parseDouble(jTextField17.getText()));
            pstmt2b.setString(8,actNo);
            pstmt2b.setString(9,datePicker2.getDate().toString());
            pstmt2b.setString(10,"");
            pstmt2b.setString(12,"false");
