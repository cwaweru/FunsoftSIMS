 ...
 * @author  root
 */
public class DispatchPerPayerInvoicesIntfr extends javax.swing.JInternalFrame {
    ...
    public DispatchPerPayerInvoicesIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        //try {
            ...
            setMaximizable(true);
            setResizable(true);
            setTitle("Dispatch Invoices Per Scheme Manager");
            ...
            jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                    "Date", "Inv No.", "Patient No.", "Patient Name", "Inv. Amt", "Dispatch"
                }
            ) {
            ...
            jPanel1.setBorder(new javax.swing.border.TitledBorder(null, "Select Scheme Manager Here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(255, 0, 255)));
            jLabel11.setText("Scheme Manager");
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 0;
            gridBagConstraints.gridy = 1;
            gridBagConstraints.weightx = 1.0;
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(jTextField1111.getCaretPosition() < 3){
            ...
            try {
                ...
                searchRowSet11.execute("SELECT account_no,scheme_manager from ac_scheme_providers where scheme_manager ILIKE '"+jTextField1111.getText()+"%' order by scheme_manager");
                ...
                jSearchTable11.setModel(new org.netbeans.lib.sql.models.TableModel(searchRowSet11, new org.netbeans.lib.sql.models.TableModel.Column[] {
                    ...
                    new org.netbeans.lib.sql.models.TableModel.Column("scheme_manager", "Name", false)
            ...
            try {
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++){
                    ...
                    if (jTable1.getModel().getValueAt(i,5) != null){
                        ...
                        java.sql.PreparedStatement pstmt = connectDB.prepareStatement("UPDATE ac_debtors set sent = '"+jTable1.getModel().getValueAt(i,5).toString()+"',dispatch_no = '"+DispNo+"',dispatch_date = 'now' WHERE invoice_no = '"+jTable1.getModel().getValueAt(i,1).toString()+"'");
                        pstmt.executeUpdate();
                        // }
                    }
                }
  ...
  */
    ...
    private void populateTable1(java.lang.String patient_no) {
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("SELECT count(dealer) FROM ac_debtors WHERE dealer = '"+patient_no+"' and balance > 0 and sent = false");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
            ...
            if (j > 0){
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT date::date, invoice_no, admission_no,initcap(item),debit::numeric,null as boolean FROM ac_debtors WHERE dealer = '"+patient_no+"' AND balance > 0 and sent = false order by date");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
