 ...
 * @author  root
 */
public class AllocateWithoutCreditsIntfr extends javax.swing.JInternalFrame {
    ...
    public AllocateWithoutCreditsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Allocate Invoices W/O Credits");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Inv. No.", "Patient No.", "Inv Amount", "Amt To All.", "Balance", "Allocate"
            }
        ) {
...
this.jButton1.setEnabled(true);
 ...
 /*   public void tableModelTableChanged() {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        this.jTextField36.setText("100000");
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,4) != null){
                    ...
                    if(java.lang.Double.parseDouble(jTable1.getValueAt(i,4).toString()) > 0){
                        ...
                        java.sql.PreparedStatement pstmt11 = connectDB.prepareStatement("UPDATE ac_doctors_ledger SET paid = true,credit_bal = 0 where pat_inv = '"+jTable1.getValueAt(i,1).toString()+"'");
