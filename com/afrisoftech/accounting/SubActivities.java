 ...
 * SubActivities.java
 *
 * Created on Jun 14, 2003, 04:37 PM
*/
...
public class SubActivities extends javax.swing.JFrame
{
    ...
    public SubActivities(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, java.lang.String cmbox) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select * from pb_sub_activities WHERE main_code = '"+comboBox+"' order by sub_code");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        try {
            nBCachedRowSet1.setTableName("pb_sub_activities");
        } catch (java.sql.SQLException e1) {
            e1.printStackTrace();
        }
        ...
        jTable1.setModel(new org.netbeans.lib.sql.models.TableModel(nBCachedRowSet1, new org.netbeans.lib.sql.models.TableModel.Column[] {
            ...
            new org.netbeans.lib.sql.models.TableModel.Column("identifier", "Identifier", true),
            new org.netbeans.lib.sql.models.TableModel.Column("member_account", "Member account", true)
        }));
        ...
        setBounds(0, 0, 533, 300);
    }//GEN-END:initComponents

    public static void main(String[] args)
    {
       // new SubActivities().show();    
    }
