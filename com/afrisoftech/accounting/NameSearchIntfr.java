...
public class NameSearchIntfr extends javax.swing.JInternalFrame {
   ...
   int i = 0;
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("SELECT count(second_name||first_name||''||''||last_name) from hp_patient_register where second_name||first_name||last_name ilike '%"+this.jTextField1.getText()+"%' ");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
            ...
            if (j > 0){
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT   last_visit,patient_no,initcap(second_name||first_name||''||''||last_name),pay_mode, initcap(description),initcap(payer) from hp_patient_register where second_name||first_name||last_name ilike '%"+this.jTextField1.getText()+"%' order by last_visit desc");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
                ...
                while (rsetTable1.next()) {
                    ...
                    javax.swing.JOptionPane.showMessageDialog(this,"Name Not Found","Comfirmation Message!",javax.swing.JOptionPane.INFORMATION_MESSAGE);
            ...
            if (j > 0){
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT   last_visit,patient_no,initcap(second_name||first_name||''||''||last_name),pay_mode, initcap(description),initcap(payer) from hp_inpatient_register where second_name||first_name||last_name ilike '%"+this.jTextField1.getText()+"%' order by last_visit desc");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
