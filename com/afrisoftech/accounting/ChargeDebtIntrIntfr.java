 ...
 * @author  root
 */
public class ChargeDebtIntrIntfr extends javax.swing.JInternalFrame {
    ...
    public ChargeDebtIntrIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Charge Debtors Interest");
        ...
        jCheckBox3.setText("Calculate Interest");
    ...
    private void jCheckBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox3ActionPerformed
      double Intr = 0;
       ...
       Intr = java.lang.Double.parseDouble(this.jTextField1.getText());
       Debt = java.lang.Double.parseDouble(this.jTextField2.getText());
       
       this.jTextField3.setText(""+Intr*Debt);
    ...
    try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("select sum(balance-credit_bal) from ac_debtors where account_no ='"+jTextField8.getText()+"' and date <= '"+datePicker1.getDate().toString()+"'");
            while (rset.next()){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            while (rst.next())
                ...
                java.sql.ResultSet rsts = pss.executeQuery("select 'INT'||nextval('mcredit_no_seq')");
                while (rsts.next())
