...
public class OpeningBalintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        crset2.setCommand("select ac.activity as activity from pb_activity ac where (ac.activity_category = 'I' OR ac.activity_category = 'CA'  OR ac.activity_category = 'CF'  )");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Description", "Gl Code", "Debit", "Credit"
            }
        ) {
    ...
    private void jScrollPane1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jScrollPane1MouseClicked
     if (jScrollPane1.isRequestFocusEnabled()) {
 ...
 if(jTextField111.getCaretPosition() > 2){
           ...
           try {
            searchRowSet.execute("SELECT activity,code from pb_activity where  activity ILIKE '"+jTextField111.getText()+"%' order by activity");
        ...
        try {
          ...
          //  java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into st_stock_prices values( ?,?,?,?,?,?,?,?,?,?,?)");
            for (int i = 0; i< jTable1.getRowCount(); i++) {
             ...
             java.sql.PreparedStatement pstmt812 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_debit = '"+jTable1.getModel().getValueAt(i,2).toString()+"',mtd_debit = '"+jTable1.getModel().getValueAt(i,2).toString()+"',ytd_credit = '"+jTable1.getModel().getValueAt(i,3).toString()+"',mtd_credit = '"+jTable1.getModel().getValueAt(i,3).toString()+"' where code = '"+jTable1.getValueAt(i,1).toString()+"'");
