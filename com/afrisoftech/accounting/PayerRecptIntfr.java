 ...
 * @author  root
 */
public class PayerRecptIntfr extends javax.swing.JInternalFrame {
    ...
    public PayerRecptIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsts = pss.executeQuery("select nextval('glreceipt_no_seq')");
            while (rsts.next())
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    ...
                    pstmt.setObject(24,jTable1.getValueAt(i,2).toString());
                    pstmt.setString(25,"");
                    pstmt.setString(26,null);
                    pstmt.setString(27,"false");
                    pstmt.setString(28,"00");
                    pstmt.setString(29,null);
                    pstmt.setString(30,"");
                    pstmt.setString(31,"false");
                    pstmt.setString(32,"00");
                    ...
                    java.sql.PreparedStatement pstmt4 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_credit = ytd_credit + '"+jTable1.getModel().getValueAt(i,2).toString()+"', mtd_credit = mtd_credit + '"+jTable1.getModel().getValueAt(i,2).toString()+"' where code = '"+bankAcc+"'");
                    ...
                    pstmt2.setString(5,jComboBox11.getSelectedItem().toString());
                    pstmt2.setObject(2,jTable1.getValueAt(i,0).toString());
                    //  pstmt2.setString(2,jTextField361.getText());
                    pstmt2.setString(3,"");
                    ...
                    java.sql.PreparedStatement pstmt41 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_debit = ytd_debit + '"+jTable1.getModel().getValueAt(i,2).toString()+"', mtd_debit = mtd_debit + '"+jTable1.getModel().getValueAt(i,2).toString()+"' where code = '"+rcode+"'");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            ...
            com.afrisoftech.accounting.OtherReceiptsPdf policy = new com.afrisoftech.accounting.OtherReceiptsPdf();
             policy.OtherReceiptsPdf(connectDB,jTextField36.getText(), jTextField4.getText(),jTextField3.getText(),receiptNo,jComboBox11.getSelectedItem().toString(),jTextField2.getText());
   ...
   */
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        javax.swing.JFrame other = new com.afrisoftech.accounting.OtherReceipts(connectDB, pConnDB);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       jButton11ActionPerformed(evt);
            java.sql.Statement pss = connectDB.createStatement();
            java.sql.ResultSet rsts = pss.executeQuery("select currval('glreceipt_no_seq')");
            while (rsts.next())
                rsts.getObject(1).toString();
