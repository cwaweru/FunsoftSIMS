 ...
 * @author  root
 */
public class AllocateInvoicesByPayerIntfr extends javax.swing.JInternalFrame {
    ...
    public AllocateInvoicesByPayerIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Allocate Invoices By Payer");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Inv. No.", "Patient No.", "Inv Amount", "Amt To All.", "Balance", "Allocate", "Acc/No"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Boolean.class, java.lang.Object.class
            };
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("select rc.cheque_no from ac_debtors db,ac_cash_collection rc where db.dealer = '"+jTextField4.getText()+"' AND db.receipt_no = '"+this.jTextField361.getText()+"' and db.receipt_no = rc.receipt_no");
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        try {
            ...
            searchRowSet1.execute("select receipt_no,credit_bal from ac_debtors where dealer ilike'"+jTextField36.getText()+"' and credit_bal > 0 and receipt_no ILIKE '"+jTextField1111.getText().toString()+"%'");
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,4) != null){
                    ...
                    if(java.lang.Double.parseDouble(jTable1.getValueAt(i,4).toString()) > 0){
                        ...
                        pstmt.setObject(1,jTable1.getValueAt(i,7).toString());
    ...
    private void populateTable1(java.lang.String patient_no) {
        ...
        try {
            ...
            if (j > 0){
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT date, invoice_no, admission_no,balance::numeric ,'false',account_no FROM ac_debtors WHERE dealer = '"+patient_no+"' AND balance > 0 and date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"' order by date");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
