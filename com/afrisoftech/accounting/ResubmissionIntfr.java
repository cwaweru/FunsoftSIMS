...
/*        try {
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        ...
        if(this.jTextField113.getCaretPosition() < 2){
            ...
            try {
                // searchRowSet2.execute("select distinct pr.patient_no as pat_no,pr.first_name||' '||pr.second_name||' '||last_name as name,pr.account_no AS staff_no,description from hp_patient_register pr where pr.description ='"+jComboBox1.getSelectedItem()+"' AND pr.first_name||' '||pr.second_name||' '||last_name ILIKE '"+jTextField113.getText()+"%' AND pr.pay_mode = 'Scheme' order by name");
                searchRowSet2.execute("select invoice_no,admission_no as pat_no,item as name,date from ac_debtors  where invoice_no ILIKE '"+jTextField113.getText()+"%' and sent='f' and balance >0 order by invoice_no");
 ...
 */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String ClaimNo = rsts.getObject(1).toString();
           ...
           */
           ...
           /* if(this.jTextField12.getText().equals(null) ||this.jTextField12.getText().equals("")){
                javax.swing.JOptionPane.showMessageDialog(this,"Please Indicate Reason !!!","Confirmation Message!",javax.swing.JOptionPane.INFORMATION_MESSAGE);
            }else{
            ...
            */
         //  java.sql.PreparedStatement pstmt22 = connectDB.prepareStatement("UPDATE ac_debtors set dispatch_no = '"+this.jTextField12.getText()+"'R,sent = 'f' WHERE invoice_no = '"+jTextField9.getText()+"'");
