 ...
 * @author  root
 */
public class CashbookAmmendIntfr extends javax.swing.JInternalFrame {
    ...
    public CashbookAmmendIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        */
        ...
        //try {
            ...
            */
            ...
            setMaximizable(true);
            setResizable(true);
            setTitle("Amending Cashbook Transactions");
            ...
            jPanel3.setBorder(new javax.swing.border.TitledBorder("Cashbook Details"));
            ...
            jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                    "Date", "Description", "Cheque No", "Reference", "Debit", "Credit", "Gl Code"
                }
            ) {
...
/*        try {
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        if(this.jTextField113.getCaretPosition() < 2){
            ...
            try {
                searchRowSet2.execute("select DISTINCT account_no as pat_no,bank_name as name from ac_cash_book where account_no ILIKE '"+jTextField113.getText()+"%' order by account_no");
                ...
                jSearchTable2.setModel(new org.netbeans.lib.sql.models.TableModel(searchRowSet2, new org.netbeans.lib.sql.models.TableModel.Column[] {
                    // new org.netbeans.lib.sql.models.TableModel.Column("invoice_no", "Invoice No", false),
                    new org.netbeans.lib.sql.models.TableModel.Column("pat_no", "Account No.", false),
                    new org.netbeans.lib.sql.models.TableModel.Column("name", "Bank Name", false)
                    // new org.netbeans.lib.sql.models.TableModel.Column("date", "Date", false)
                }));
                jSearchScrollPane2.setViewportView(jSearchTable2);
                System.out.println("Cannot sort out");
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        try {
            ...
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select gl_code from ac_cash_book where account_no ='"+jTextField9.getText()+"' AND date BETWEEN '"+datePicker1.getDate()+"' and '"+datePicker2.getDate()+"'");
            while (rset.next()){
 ...
 */
    ...
    private void populateTable1(java.lang.String patient_no) {
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("SELECT count(account_no) FROM ac_cash_book WHERE account_no ILIKE '"+patient_no+"%' AND date BETWEEN '"+datePicker1.getDate()+"' and '"+datePicker2.getDate()+"'");
            ...
            if (j > 0){
                ...
                //  java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT description, quantity,(amount/quantity)::numeric(10,2),amount,gl_code  FROM hp_pharmacy WHERE patient_no = '"+patient_no+"' AND paid = false UNION SELECT service, quantity,(amount/quantity)::numeric(10,2),amount,gl_code  FROM hp_patient_billing WHERE patient_no = '"+patient_no+"' AND paid = false");
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select date::date,dealer,cheque_no,transaction_no,debit,credit from ac_cash_book where account_no ILIKE '"+patient_no+"%' AND date BETWEEN '"+datePicker1.getDate()+"' and '"+datePicker2.getDate()+"' order by date::date");
                ...
                while (rsetTable1.next()) {
                    ...
                    jTable1.setValueAt(rsetTable1.getObject(6), i, 5);
                     ...
                     java.sql.ResultSet rsetTable11 = stmtTable111.executeQuery(" select activity_code from ac_cash_book where transaction_no ILIKE '"+jTable1.getValueAt(i,3).toString()+"%'");
                    
                    while (rsetTable11.next()) {
                        
                          jTable1.setValueAt(rsetTable11.getObject(1), i, 6);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            java.sql.ResultSet rs = pssq.executeQuery("select voucher_no from ac_cash_book where transaction_no = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),3).toString()+"'");
            while (rs.next()){
                voucherNo = rs.getString(1);
               
            }
            java.sql.PreparedStatement pstmt3w = connectDB.prepareStatement("delete from ac_accounts_payable  WHERE reference_no = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),3).toString()+"'");
            pstmt3w.executeUpdate();
            
            java.sql.PreparedStatement pstmt3w1 = connectDB.prepareStatement("delete from ac_cash_book  WHERE transaction_no = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),3).toString()+"'");
            pstmt3w1.executeUpdate();
            
            java.sql.PreparedStatement pstmt3wa = connectDB.prepareStatement("delete from ac_debtors  WHERE reference_no = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),3).toString()+"'");
            pstmt3w.executeUpdate();
            
            java.sql.PreparedStatement pstmt3w1a = connectDB.prepareStatement("delete from ac_bills  WHERE voucher_no = '"+voucherNo+"'");
            pstmt3w1.executeUpdate();
            
            java.sql.PreparedStatement pstmt31a = connectDB.prepareStatement("delete from cr_allocation  WHERE cheque_no = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),2).toString()+"'");
            pstmt3w1.executeUpdate();
            
            
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("UPDATE pb_activity set ytd_debit = ytd_debit - '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),5)+"',mtd_debit = mtd_debit - '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),5)+"',ytd_credit= ytd_credit - '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),4)+"',mtd_credit = mtd_credit - '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),4)+"' WHERE code = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),6).toString()+"'");
            pstmt.execute();
            
            java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("UPDATE pb_activity set ytd_credit = ytd_credit - '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),5)+"',mtd_credit = mtd_credit - '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),5)+"',ytd_debit = ytd_debit - '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),4)+"',mtd_debit = mtd_debit - '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),4)+"' WHERE code = '"+jTextField1.getText()+"'");
            pstmt1.execute();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rs = pssq.executeQuery("select debit,credit from ac_cash_book where transaction_no = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),3).toString()+"'");
            while (rs.next()){
                debit = rs.getDouble(1);
                credit = rs.getDouble(2);
            }
            
            java.sql.PreparedStatement pstmt22 = connectDB.prepareStatement("UPDATE ac_accounts_payable set credit = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),4).toString()+"',debit = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),5).toString()+"' WHERE reference_no = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),3).toString()+"'");
            pstmt22.execute();
            
            java.sql.PreparedStatement pstmt221 = connectDB.prepareStatement("UPDATE ac_cash_book set debit = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),4).toString()+"',credit = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),5).toString()+"' WHERE transaction_no = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),3).toString()+"'");
            pstmt221.execute();
            
            java.sql.PreparedStatement pstmt222 = connectDB.prepareStatement("UPDATE ac_debtors set credit = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),4).toString()+"',debit = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),5).toString()+"' WHERE reference_no = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),3).toString()+"'");
            pstmt222.execute();
            
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("UPDATE pb_activity set ytd_debit = ytd_debit - '"+debit+"',mtd_debit = mtd_debit - '"+debit+"',ytd_credit= ytd_credit - '"+credit+"',mtd_credit = mtd_credit - '"+credit+"' WHERE code = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),7).toString()+"'");
            pstmt.execute();
            
            java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("UPDATE pb_activity set ytd_credit = ytd_credit - '"+credit+"',mtd_credit = mtd_credit - '"+credit+"',ytd_debit = ytd_debit - '"+debit+"',mtd_debit = mtd_debit - '"+debit+"' WHERE code = '"+jTextField1.getText()+"'");
            pstmt1.execute();
            
            java.sql.PreparedStatement pstmtq = connectDB.prepareStatement("UPDATE pb_activity set ytd_debit = ytd_debit + '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),5).toString()+"',mtd_debit = mtd_debit + '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),5).toString()+"',ytd_credit = ytd_credit + '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),4).toString()+"',mtd_credit = mtd_credit + '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),4).toString()+"' WHERE code = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),7).toString()+"'");
            pstmtq.execute();
            
            java.sql.PreparedStatement pstmt1q = connectDB.prepareStatement("UPDATE pb_activity set ytd_credit = ytd_credit + '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),5).toString()+"',mtd_credit = mtd_credit + '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),5).toString()+"',ytd_debit = ytd_debit + '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),4).toString()+"',mtd_debit = mtd_debit + '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),4).toString()+"' WHERE code = '"+jTextField1.getText()+"'");
            pstmt1q.execute();
