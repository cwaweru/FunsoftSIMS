 ...
 * @author  postgres
 */
public class BedOccupancyIntfr extends javax.swing.JInternalFrame {
    ...
    public BedOccupancyIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Please BedOccupancy Collection  here");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Province", "Hospital Name", "No of Patients"
            }
        ) {
        ...
        java.lang.Object[] strCmb = {"CENTRAL","COAST","EASTERN","NORTH EASTERN","NAIROBI","NYANZA","RIFT VALLEY",",WESTERN"};

        javax.swing.JComboBox cmBox = new javax.swing.JComboBox(strCmb);

        javax.swing.table.TableColumn teditor = this.jTable1.getColumn("Province");
        ...
        try {
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null && jTable1.getModel().getValueAt(i,2) != null){
                    ...
                    stmt11.execute("insert into bed_occupancy(province,hospital,date,amount) values('"+jTable1.getValueAt(i,0).toString()+"','"+jTable1.getValueAt(i,1).toString()+"','"+datePicker1.getDate().toString()+"','"+jTable1.getValueAt(i,2).toString()+"')");
                }
            }
