...
public class BankReconintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jCheckBox1.setText("Enter C/Book Discripancy");
        ...
        jCheckBox11.setText("Enter Bnk Stmt Discripancy");
...
//        javax.swing.JInternalFrame other = new BankStmtRecSchdIntfr(connectDB, pConnDB);
...
//        other.setVisible(true);       // Add your handling code here:
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        javax.swing.JInternalFrame other = new BankRecSchdIntfr(connectDB, pConnDB);
        this.getParent().add(other, javax.swing.JLayeredPane.DEFAULT_LAYER);
        try {
            other.setSelected(true);
        } catch(java.beans.PropertyVetoException pvt){}
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rset11 = stmt11.executeQuery("select Sum(debit - credit) from ac_cash_book where account_no ='"+jComboBox2.getSelectedItem().toString()+"'  AND date <= '"+datePicker2.getDate().toString()+"'  ");
            
            java.sql.ResultSet rset = stmt.executeQuery("select account_name,count(debit),sum(credit - debit) from ac_cash_book where account_no ='"+jComboBox2.getSelectedItem().toString()+"'  and reconciled = false AND date <= '"+datePicker2.getDate().toString()+"' group by account_name ");
            java.sql.ResultSet rset1 = stmt1.executeQuery("select count(debit) from ac_cash_book where account_no ='"+jComboBox2.getSelectedItem().toString()+"' and reconciled = false AND date <='"+datePicker2.getDate().toString()+"'");
            ...
            if (rowsNo < 1) {
                ...
                while (rset.next()){
                    ...
                    jTextField12.setText(rset.getObject(3).toString());
                ...
                double Unrec = Double.parseDouble(jTextField12.getText());
                double CbStmt = Double.parseDouble(jTextField1.getText());
            ...
            for (int i=0; i < jTable1.getRowCount(); i++) {
                if (!(jTable1.getModel().getValueAt(i,4).equals(null))){
                    if (Boolean.valueOf(jTable1.getModel().getValueAt(i, 4).toString()) == java.lang.Boolean.TRUE) {
                        ...
                        java.sql.PreparedStatement pstmt = connectDB.prepareStatement("UPDATE ac_cash_book SET reconciled = true ,date_reconcilled = date('now') WHERE date = '"+jTable1.getValueAt(i,0)+"' and account_no = '"+jComboBox2.getSelectedItem().toString()+"' and cheque_no = '"+jTable1.getValueAt(i,1)+"' and credit = '"+jTable1.getValueAt(i,3)+"' and debit = '"+jTable1.getValueAt(i,2)+"'");
                        pstmt.executeUpdate();
                    }
                }
            }
    ...
    public void tableModelTableChanged(javax.swing.event.TableModelEvent evt) {
        ...
        double Unrec = Double.parseDouble(jTextField12.getText());
        double CbStmt = Double.parseDouble(jTextField1.getText());
        double BStmt = Double.parseDouble(jTextField11.getText());
    //   double Net = Double.parseDouble(jTextField6.getText());
        ...
        if (Boolean.valueOf(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 4).toString()) == java.lang.Boolean.TRUE) {
            ...
            Unrec =Unrec + Double.parseDouble(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 2).toString()) - Double.parseDouble(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 3).toString());
    ...
    //    double Net =  Double.parseDouble(jTextField6.getText());
        jTextField12.setText(Double.toString(Unrec));
        double Total = Unrec+CbStmt;
        jTextField6.setText(Double.toString(Total));
        jTextField7.setText(Double.toString(Total-BStmt));
