 ...
 * @author  postgres
 */
public class TransactionTypeIntfr extends javax.swing.JInternalFrame {
    ...
    public TransactionTypeIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Set Transaction Types here");
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into pb_transaction_type values(?,initcap(?))");
