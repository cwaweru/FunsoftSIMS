 ...
 * @author  root
 */
public class CreditMiscsIntfr extends javax.swing.JInternalFrame {
    ...
    public CreditMiscsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder(null, "Enter payer details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(51, 51, 255)));
        ...
        jPanel41.setBorder(new javax.swing.border.BevelBorder(javax.swing.border.BevelBorder.RAISED, java.awt.Color.blue, null, java.awt.Color.magenta, java.awt.Color.blue));
        jCheckBox11.setText("Suppliers");
        buttonGroup2.add(jCheckBox11);
        jCheckBox11.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);
        jPanel41.add(jCheckBox11, new java.awt.GridBagConstraints());

        jCheckBox21.setText("Consultants");
        buttonGroup2.add(jCheckBox21);
        jCheckBox21.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);
        jPanel41.add(jCheckBox21, new java.awt.GridBagConstraints());
        ...
        if(jTextField11111.getCaretPosition() < 3){
            ...
            try {
                ...
                if(this.jCheckBox11.isSelected()){
                    ...
                    searchRowSet1.execute("select first_name as scheme,staff_no as code from pb_doctors_list where first_name ILIKE '"+jTextField11111.getText().toString()+"%'");
                }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if(this.jCheckBox1.isSelected()){
                ...
                java.sql.ResultSet rsts = pss.executeQuery("select 'MC'||nextval('mcredit_no_seq')");
                while (rsts.next())
                ...
                java.sql.Statement pss = connectDB.createStatement();
                java.sql.ResultSet rsts = pss.executeQuery("select 'MD'||nextval('mcredit_no_seq')");
                while (rsts.next())
                    rsts.getObject(1).toString();
                
                transNo1 = rsts.getObject(1).toString();
            }
            
            
            if(jCheckBox11.isSelected()){
                java.sql.Statement stm3 = connectDB.createStatement();
                java.sql.ResultSet rse3 = stm3.executeQuery("select activity,code from pb_activity where activity_category ilike 'CP'");
                while (rse3.next())
                ...
                if(this.jCheckBox1.isSelected()){
                    ...
                    java.sql.PreparedStatement pstmt8 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_credit = ytd_credit + '"+jTextField3.getText()+"',mtd_credit = mtd_credit + '"+jTextField3.getText()+"' where code = '"+bankAcc+"'");
                    pstmt8.executeUpdate();
                }else{
                    double Debit = -(java.lang.Double.parseDouble(jTextField3.getText().toString()));
                      pstmt.setString(16,transNo1);
                     pstmt.setString(4,transNo1);
              
                    pstmt.setString(12,"Debits");
                    pstmt.setString(14,"00");
                    pstmt.setString(13,jTextField3.getText());
                    pstmt.setString(11,transNo1);
                    pstmt.setDouble(25,Debit);
                    java.sql.PreparedStatement pstmt8 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_debit = ytd_debit + '"+jTextField3.getText()+"',mtd_debit = mtd_debit + '"+jTextField3.getText()+"' where code = '"+bankAcc+"'");
                    pstmt8.executeUpdate();
                }
                ...
                java.sql.Statement stm3 = connectDB.createStatement();
                java.sql.ResultSet rse3 = stm3.executeQuery("select activity,code from pb_activity where activity_category ilike 'DA'");
                while (rse3.next())
                    glCode = rse3.getObject(1).toString();
                bankAcc = rse3.getObject(2).toString();
                ...
                if(this.jCheckBox1.isSelected()){
                    ...
                    pstmt.setString(15,transNo1);
                    pstmt.setString(9,transNo1);
                    pstmt.setString(6,"Debits");
                ...
                pstmt.setString(16,jTextField111.getText());
               
                pstmt.setString(14,datePicker1.getDate().toString());
                pstmt.setObject(11,glCode);
            ...
            pstmt2.setString(6,"");
            pstmt2.setString(7,"");
            pstmt2.setString(5,jTextField111.getText());
            pstmt2.setString(9,"");
            pstmt2.setString(10,"");
            pstmt2.setString(12,"");
            ...
            if(this.jCheckBox1.isSelected()){
                pstmt2.setObject(15,"Credits");
                pstmt2.setString(16,jTextField3.getText());
                
                pstmt2.setString(17,"00");
                pstmt2.setString(19,transNo);
                java.sql.PreparedStatement pstmt81 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_debit = ytd_debit + '"+jTextField3.getText()+"',mtd_debit = mtd_debit + '"+jTextField3.getText()+"' where code = '"+jTextField4.getText()+"'");
                pstmt81.executeUpdate();
            }else{
                pstmt2.setObject(15,"Debits");
                pstmt2.setString(17,jTextField3.getText());
                pstmt2.setString(16,"00");
                pstmt2.setString(19,transNo1);
                java.sql.PreparedStatement pstmt81 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_credit = ytd_credit + '"+jTextField3.getText()+"',mtd_credit = mtd_credit + '"+jTextField3.getText()+"' where code = '"+jTextField4.getText()+"'");
                pstmt81.executeUpdate();
            }
