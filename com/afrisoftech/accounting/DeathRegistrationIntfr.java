...
public class DeathRegistrationIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jPanel8.setBorder(new javax.swing.border.TitledBorder("Cirtification"));
        ...
        jPanel7.setBorder(new javax.swing.border.TitledBorder("Cause of Death"));
        ...
        jComboBox1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset1, "disease_name", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
  ...
  if(jTextField113.getCaretPosition() < 2){
            ...
            try {
             ...
             try {
                ...
                searchRowSet2.execute("SELECT patient_no, (upper(patient_name)) as name from hp_admission where patient_no ILIKE '"+jTextField113.getText()+"%'  order by patient_name");//||' '||second_name||' '||last_name");
