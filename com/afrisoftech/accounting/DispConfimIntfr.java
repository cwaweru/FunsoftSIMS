 ...
 * @author  root
 */
public class DispConfimIntfr extends javax.swing.JInternalFrame {
    ...
    public DispConfimIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        //try {
            ...
            */
            ...
            setMaximizable(true);
            setResizable(true);
            setTitle("Dispatched Invoices Confirmation");
             ...
             // if (!(jTable1.getModel().getValueAt(i,4).equals(null))){
                ...
                // if (jTable1.getValueAt(i,4).equals("true")){
                 ...
                 System.out.println("Value 2 "+jTable1.getModel().getValueAt(i,1));
                     java.sql.PreparedStatement pstmt = connectDB.prepareStatement("UPDATE ac_debtors set approved = '"+jTable1.getModel().getValueAt(i,5).toString()+"' ,prov_date = '"+this.datePicker1.getDate().toString()+"',prov_user = current_user WHERE invoice_no = '"+jTable1.getModel().getValueAt(i,1).toString()+"' and dispatch_no = '"+this.jTextField71.getText().toString()+"'");
                pstmt.executeUpdate();
                // }
            }
            }
     ...
     //   jTextField2.setText(Integer.toString(i));
       ...
       */ 
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("SELECT count(dealer) FROM ac_debtors WHERE dispatch_no = '"+patient_no+"' and balance > 0 and approved = false");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
            ...
            if (j > 0){
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT date::date, invoice_no, admission_no,initcap(item),debit::numeric,null as boolean FROM ac_debtors WHERE dispatch_no = '"+patient_no+"' AND balance > 0 and approved = false order by date");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
