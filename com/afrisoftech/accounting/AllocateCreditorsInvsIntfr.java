 ...
 * @author  root
 */
public class AllocateCreditorsInvsIntfr extends javax.swing.JInternalFrame {
    ...
    public AllocateCreditorsInvsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Inv. No.", "Doc No.", "Inv Amount", "Amt To All.", "Balance", "Allocate"
            }
        ) {
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++){
                    if (jTable1.getModel().getValueAt(i,4) != null){
                        ...
                        if(java.lang.Double.parseDouble(jTable1.getValueAt(i,4).toString()) > 0){
                            ...
                            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into cr_allocation values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                            
                            
                            pstmt.setObject(1,jTextField4.getText());
                            pstmt.setObject(2,"'now'");
                            pstmt.setObject(3,Alloc);
                            ...
                            if(jTextField7.getText().equals(null) || jTextField7.getText().equals("")){
                                pstmt.setObject(7,"00");
                            }else{
                                pstmt.setObject(7,jTextField3.getText());
                            }
                            pstmt.setObject(6,"Chq");
                            pstmt.setObject(8,jTextField1.getText());
                            ...
                            pstmt.setObject(13,jTextField5.getText());
                            pstmt.setObject(14,jTextField7.getText());
                            pstmt.executeUpdate();
                            
                            double balance = Double.parseDouble(jTable1.getModel().getValueAt(i,5).toString());
                            double credit = Double.parseDouble(jTable1.getModel().getValueAt(i,3).toString());
                            
                            java.sql.PreparedStatement pstmt3 = connectDB.prepareStatement("UPDATE ac_accounts_payable set balance = '"+balance+"' WHERE invoice_no ILIKE '"+jTable1.getModel().getValueAt(i,1).toString()+"%' AND dealer ilike '"+jTextField36.getText().toString()+"%' and credit = '"+credit+"'");
                            pstmt3.executeUpdate();
                            
                        }
                    }
                }
                double quantity = Double.parseDouble(this.jTextField2.getText().toString());
                
                java.sql.PreparedStatement pstmt4 = connectDB.prepareStatement("UPDATE ac_accounts_payable set balance =  "+new java.lang.Double(-quantity)+" WHERE voucher_no = '"+this.jTextField361.getText()+"' AND dealer ilike '"+jTextField36.getText()+"%'");
  ...
  */
    ...
    private void populateTable1(java.lang.String patient_no) {
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("SELECT count(dealer) FROM ac_accounts_payable WHERE dealer ilike '"+patient_no+"' and balance > 0 and date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"'");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
            ...
            if (j > 0){
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT date, invoice_no, reference_no,balance::numeric ,'false',credit FROM ac_accounts_payable WHERE dealer ilike '"+patient_no+"' AND balance > 0 and date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker2.getDate().toString()+"' order by date");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
