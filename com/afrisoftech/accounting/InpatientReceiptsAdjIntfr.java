 ...
 * @author  root
 */
public class InpatientReceiptsAdjIntfr extends javax.swing.JInternalFrame {
    ...
    public InpatientReceiptsAdjIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("In Patient Receipts Adjustments");
        ...
        jPanel212.setBorder(new javax.swing.border.TitledBorder("Select receipt here"));
...
this.jButton1111.setEnabled(true);
    ...
    private void jTextField11CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11CaretUpdate
      if(jTextField11.getCaretPosition() < 3){
        ...
        try {
            ...
            searchRowSet.execute("SELECT DISTINCT receipt_no as name,patient_no,dealer from ac_cash_collection where receipt_no ILIKE '"+jTextField11.getText()+"%' order by receipt_no");
            
            jSearchTable.setModel(new org.netbeans.lib.sql.models.TableModel(searchRowSet, new org.netbeans.lib.sql.models.TableModel.Column[] {
                new org.netbeans.lib.sql.models.TableModel.Column("name", "Receipt No.", false),
                new org.netbeans.lib.sql.models.TableModel.Column("patient_no", "Patient no", false),
                  new org.netbeans.lib.sql.models.TableModel.Column("dealer", "Patient Name", false),
    ...
    private void jButton1111ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1111ActionPerformed
        ...
        try {
            ...
            System.out.println(actNames1);
            java.sql.PreparedStatement pstmtx = connectDB.prepareStatement("insert into hp_patient_card values(?,?,?,?,?,?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?,?)");
            pstmtx.setString(1,jTextField16.getText());
            pstmtx.setObject(2,"Receipt Adj");
            ...
            pstmtx.setString(14,jTextField2.getText());
            pstmtx.setObject(15,patientAcc);
            pstmtx.setString(16,"Receipt Adj");
            ...
            pstmtx.executeUpdate();
             ...
             java.sql.PreparedStatement pstmt8 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_debit = ytd_debit + '"+jTextField17.getText()+"' where code = '"+patientAcc+"'");
            ...
            pstmt2.setObject(5,jTextField1.getText());
            pstmt2.setString(2,"Receipt Adj");
            pstmt2.setString(3,jTextField16.getText());
            ...
            pstmt2.setObject(15,"Receipts Adj");
            pstmt2.setObject(17,jTextField17.getText());
            pstmt2.setString(16,"00");
            pstmt2.setString(18,jTextField2.getText());
            ...
            java.sql.PreparedStatement pstmt81 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_credit = ytd_credit + '"+jTextField17.getText()+"' where code = '"+rcode+"'");
