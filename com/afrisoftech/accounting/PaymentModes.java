 ...
 * PaymentModes.java
 *
 * Created on Sep 10, 2003, 11:17 AM
*/
...
public class PaymentModes extends javax.swing.JFrame
{
    ...
    public PaymentModes(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select * from pb_paymentmodes order by payment_mode");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        try {
            nBCachedRowSet1.setTableName("pb_paymentmodes");
        } catch (java.sql.SQLException e1) {
            e1.printStackTrace();
        }
        ...
        jTable1.setModel(new org.netbeans.lib.sql.models.TableModel(nBCachedRowSet1, new org.netbeans.lib.sql.models.TableModel.Column[] {
            ...
            new org.netbeans.lib.sql.models.TableModel.Column("payment_mode", "Payment mode", true),
