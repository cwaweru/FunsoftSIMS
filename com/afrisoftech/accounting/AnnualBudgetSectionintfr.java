 ...
 * @author  root
 */
public class AnnualBudgetSectionintfr extends javax.swing.JInternalFrame {
    ...
    public AnnualBudgetSectionintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset7.setCommand("Select section_name as workstation FROM section ORDER BY section_name");
    ...
    private void jCheckBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox2ActionPerformed
        ...
        try {
            ...
            crset1.setConnectionSource(pConnDB);
            crset1.execute("select activity from pb_activity WHERE payment_modes !='Receivable'");
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        try {
            ...
            crset6.execute("select activity from pb_activity WHERE payment_modes !='Payable'");// where "+table+" = '"+jComboBox1.getSelectedItem()+"'");
    ...
    private void cmbox1ActionPerformed(java.awt.event.ActionEvent evt){
        ...
        try {
            ...
            if (jCheckBox1.isSelected()){
                java.sql.Statement pstmt = connectDB.createStatement();
                java.sql.ResultSet rs = pstmt.executeQuery("select code from pb_activity where activity = '"+selectedGuaran1+"'");
                while (rs.next()){
                ...
                if (jCheckBox2.isSelected()){
                    ...
                    java.sql.ResultSet rs1 = pstmt1.executeQuery("select code from pb_activity where activity = '"+selectedGuaran1+"'");
                    while (rs1.next()){
                        //jTextField4.setText(rs.getObject(1).toString());
