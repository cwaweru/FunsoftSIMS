 ...
 * @author  root
 */
public class PartlyAllocateIntfr extends javax.swing.JInternalFrame {
    ...
    public PartlyAllocateIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Allocate Invoices (partly)");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Inv No.", "Patient No.", "Inv Amount", "Amt To Allocate", "Balance"
            }
        ) {
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        ...
        double resVal = 0.00;
        double floatTotal = new com.afrisoftech.sys.Format2Number().Format2Number(jTextField2.getText()).doubleValue();
        
//        double floatTotal = java.lang.Double.parseDouble(jTextField2.getText());
        double floatCol41 = java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString());
        
        if(floatCol41 > floatTotal){
            javax.swing.JOptionPane.showMessageDialog(this,"Amt to allocate Greater than Balance Amt","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
        }else if(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 4) != null) {
            double floatCol3 = java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString());
            
            double floatCol4 = java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString());
            if(floatCol4 > floatCol3){
                javax.swing.JOptionPane.showMessageDialog(this,"Amt to allocate Greater than Inv. Amt","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
            }else{
                resVal = floatCol3 - floatCol4;
       //     }
 ...
 /*           //    double floatCol3 = java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString());
            ...
            jTable1.setValueAt(new java.lang.Double(resFloat), jTable1.getSelectedRow(), 4);
        }
        for (int i = 0; i < jTable1.getRowCount(); i++) {
        ...
        //  jTable1.setSelectionModel(javax.swing.ListSelectionModel.SINGLE_SELECTION);
...
/*    double totals = 0.00;
    ...
    for (int j = 0; j < jTable1.getRowCount(); j++) {
        ...
        //if(!(this.jTable1.getModel().getValueAt(j,5).equals("false"))){
        //  if (jTable1.getModel().getValueAt(j, 5).toString().equalsIgnoreCase("TRUE")){// == java.lang.Boolean.TRUE) {
     //   if (Boolean.valueOf(jTable1.getValueAt(j, 5).toString()) == java.lang.Boolean.TRUE) {
                  if (jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 5) != null) {
            // if (jTable1.getSelectedColumn() == 5) {
        //       if (Boolean.valueOf(jTable1.getModel().getValueAt(j, 5).toString()) == java.lang.Boolean.TRUE) {
  
  
            //     System.out.println("No of rows in jtable = "+jTable1.getRowCount());
//            System.out.println("\n"+jTable1.getValueAt(j, 5).toString());
            amt = amt - Double.parseDouble(jTable1.getValueAt(j, 3).toString());
          ...
          jTable1.getModel().removeTableModelListener(new javax.swing.event.TableModelListener() {
            ...
            if(this.jTable1.getValueAt(j,5) != null){
                if(amt > floatCol2) {
                    //this.jTable1.setValueAt("0.00",j,4);
  
                    //  jTable1.getModel().setValueAt((Object)java.lang.String.valueOf(0.00), jTable1.getSelectedRow(), 4);
                    jTable1.setValueAt(new java.lang.Double(resFloat), jTable1.getSelectedRow(), 4);
                 /*   if (controlFlag) {
  
                        jTable1.setValueAt(java.lang.String.valueOf(0.00), jTable1.getSelectedRow(), 4);
...
/*                }else{
                    ...
                    if (controlFlag) {
                        jTable1.setValueAt(java.lang.String.valueOf(amt),jTable1.getSelectedRow(),4);
                        controlFlag = false;
                    }
                }
                if (amt < 0) {
        ...
        //     jTable1.getModel().setValueAt((Object)java.lang.Double.valueOf(0.00), jTable1.getSelectedRow(), 4);
 ...
 */
    ...
    public void tableModelTableChanged() {
        ...
        //        double resFloat = 0.00;
        double resFloat = 0.00;
        double Balance = new com.afrisoftech.sys.Format2Number().Format2Number(jTextField2.getText()).doubleValue();
        ...
        resFloat = Balance - Double.parseDouble(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 4).toString());
        
        //   }
        
        jTextField2.setText(java.lang.String.valueOf(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.Double.toString(resFloat))));
        
           /* }else{
             resFloat = Balance - Double.parseDouble(jTable1.getModel().getValueAt(i, 3).toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,4) != null){
                    ...
                    if(jTextField3.getText().equals(null) || jTextField3.getText().equals("")){
                       ...
                       // pstmt.setObject(6,java.lang.Double.toString(new com.afrisoftech.sys.Format2Number().Format2Number(jTextField2.getText()).doubleValue()));
                    }
                    ...
                    java.sql.PreparedStatement pstmt3 = connectDB.prepareStatement("UPDATE ac_debtors set balance = '"+jTable1.getModel().getValueAt(i,5).toString()+"' WHERE invoice_no = '"+jTable1.getModel().getValueAt(i,1).toString()+"'");
                    pstmt3.executeUpdate();
                    
                    java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("UPDATE ac_doctors_ledger set paid = 'true' WHERE invoice_no = '"+jTable1.getModel().getValueAt(i,1).toString()+"'");
                    pstmt31.executeUpdate();
                    // }
                }
            }
            java.sql.PreparedStatement pstmt4 = connectDB.prepareStatement("UPDATE ac_debtors set credeit_bal = '"+(new com.afrisoftech.sys.Format2Number().Format2Number(jTextField2.getText()).doubleValue())+"' WHERE receipt_no = '"+jTextField361.getText()+"'");
            ...
            javax.swing.JOptionPane.showMessageDialog(this,"Well Done !! Invoices Partly Allocated","Comfirmation Message!",javax.swing.JOptionPane.INFORMATION_MESSAGE);
            jButton1.setEnabled(false);
        ...
        if(amt > 0){
              for (int j = 0; j < jTable1.getRowCount(); j++) {
                if(this.jTable1.getModel().getValueAt(j,5) != null){
                    ...
                    if (Boolean.valueOf(jTable1.getModel().getValueAt(j, 5).toString()) == java.lang.Boolean.TRUE) {
                        ...
                        //     System.out.println("No of rows in jtable = "+jTable1.getRowCount());
                        System.out.println("\n"+jTable1.getModel().getValueAt(j, 5).toString());
             ...
             /*   if (controlFlag) {
                    ...
                    /*        }else{
                                ...
                                //    if (controlFlag) {
                                //                jTable1.setValueAt(java.lang.String.valueOf(floatCol2-amt),jTable1.getSelectedRow(),4);
                                //    controlFlag = false;
                                // }
                                ...
                                if (amt < floatCol2){
                                    ...
                                    jTable1.setValueAt(new java.lang.Double(java.lang.Math.round(floatCol2-amt)),jTable1.getSelectedRow(),4);
                        ...
                        // System.out.println("This table has changed");
                        //  if (Boolean.valueOf(jTable1.getModel().getValueAt(j, 5).toString()) == java.lang.Boolean.FALSE) {
                        //    jTable1.setValueAt(new java.lang.Double(floatCol2), jTable1.getSelectedRow(), 4);
                        //}
                    }
                }
            }
