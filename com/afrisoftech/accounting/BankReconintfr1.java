 ...
 * @author  root
 */
public class BankReconintfr1 extends javax.swing.JInternalFrame {
    ...
    public BankReconintfr1(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jCheckBox1.setText("Click To Enter Discripancy");
 ...
 private void cmboxMouseClicked1() {
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("select account_name,count(debit),sum(debit + credit) from ac_cash_book where account_no ='"+jComboBox2.getSelectedItem()+"'  and reconciled = false AND date BETWEEN '"+datePicker1.getDate().toString()+"' AND '"+datePicker2.getDate().toString()+"' group by account_name");
            java.sql.ResultSet rset1 = stmt1.executeQuery("select count(debit) from ac_cash_book where account_no ='"+jComboBox2.getSelectedItem()+"' and reconciled = false AND date BETWEEN '"+datePicker1.getDate().toString()+"' AND '"+datePicker2.getDate().toString()+"'");
      ...
      */
                ...
                crset4.setCommand("select date,cheque_no,debit as debit,credit as credit,reconciled from ac_cash_book where account_no ='"+jComboBox2.getSelectedItem()+"'  AND reconciled = false AND date BETWEEN '"+datePicker1.getDate().toString()+"' AND '"+datePicker2.getDate().toString()+"'  ORDER BY date ASC");
                crset4.setConnectionSource(pConnDB);
