 ...
 * @author  root
 */
public class TyreSetupintfr extends javax.swing.JInternalFrame {
    ...
    public TyreSetupintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        pconn1.setPassword("029ce33cae7e20955e3adea594937637e4ba612ef5895a1e3aadaca9efcd43467c", true);
        ...
        crset1.setPassword("02774f49c2a875f63f28c13ff18d591ad2603cdcc0e865b7d31f", true);
        try {
        ...
        crset4.setPassword("0277de4923fe68d8f1ea6dae4e1cca6b25f1afb3beb46486f3e0", true);
        crset5.setCommand("select distinct sub_service from service_rates");
        crset5.setConnectionSource(pconn1);
        crset5.setPassword("02ede32d9bf3da4727c0d12c333c5815507093795119feaa946c636307209aa046091df3e04bdd", true);
        crset7.setCommand("select name from doctors");
        crset7.setConnectionSource(pconn1);
        crset7.setPassword("02c98a80a4ec161037b146fdd1498892fa63e679e364ef784caf80644da2b57f94", true);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Vehicle Type", "Tyre Size", "Est. Lifespan"
            }
        ) {
