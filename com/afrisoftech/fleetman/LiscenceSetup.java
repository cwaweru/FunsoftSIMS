 ...
 * liscenceSetup.java
 *
 * Created on Jun 06, 2003, 03:14 PM
*/
...
public class LiscenceSetup extends javax.swing.JFrame
{
    ...
    public LiscenceSetup(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select * from lisence_setup");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        try {
            nBCachedRowSet1.setTableName("lisence_setup");
        } catch (java.sql.SQLException e1) {
            e1.printStackTrace();
        }

        setTitle("Liscence Setup");
        ...
        jTable1.setModel(new org.netbeans.lib.sql.models.TableModel(nBCachedRowSet1, new org.netbeans.lib.sql.models.TableModel.Column[] {
            ...
            new org.netbeans.lib.sql.models.TableModel.Column("licence_type", "Licence type", true),
        ...
        setBounds(0, 0, 507, 300);
    }//GEN-END:initComponents

    public static void main(String[] args)
    {
       // new liscenceSetup().show();    
    }
