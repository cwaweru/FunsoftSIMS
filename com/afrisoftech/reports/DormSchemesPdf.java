...
public class DormSchemesPdf implements java.lang.Runnable {
    ...
    public void DormSchemesPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Dormant Accounts Performance(Automated) - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Dormant Accounts Performance Report ", pFontHeader);
                        ...
                        try {
                           ...
                           // java.sql.ResultSet rset = st.executeQuery("select sc.account_no,initcap(sc.scheme_name),sc.allowed,sc.closed,sc.suspended,sum(ac.balance-ac.credit_bal) from ac_schemes sc,ac_debtors ac where   sc.account_no =ac.account_no group by sc.account_no,sc.scheme_name,sc.closed,sc.suspended,sc.allowed order by  sc.scheme_name");
                            java.sql.ResultSet rset = st.executeQuery("SELECT da.account_no, da.payee, da.payer_name, sum(ac.balance - ac.credit_bal) AS balance FROM ac_debtors ac, dormant_schm da WHERE  ac.account_no::text = da.account_no::text GROUP BY da.account_no, da.payee, da.payer_name ORDER BY da.payer_name,da.payee");
