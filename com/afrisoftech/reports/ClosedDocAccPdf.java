...
public class ClosedDocAccPdf implements java.lang.Runnable {
    ...
    public void ClosedDocAccPdf(java.sql.Connection connDb) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Closed/Suspended Accounts(Doctors)", pFontHeader);
                        ...
                        */
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select staff_no,first_name||' '||middle_name,status from pb_doctors_list where (status ilike 'closed%' or status ilike 'Suspended%') order by status, first_name||' '||middle_name");
