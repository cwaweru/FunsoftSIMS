                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select date::date,initcap(service) as service,transaction_type,sum(debit),sum(credit),sum(debit - credit + credit) as balance from hp_patient_card where patient_no = '"+memNo+"' AND date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by service,date,transaction_type order by date");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit),sum(credit),sum(debit - credit) from hp_patient_card where patient_no = '"+memNo+"' AND date::date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
