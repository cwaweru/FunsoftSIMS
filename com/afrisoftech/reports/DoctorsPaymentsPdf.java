...
public class DoctorsPaymentsPdf implements java.lang.Runnable {
    ...
    public void DoctorsPaymentsPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Doctors Payments - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,10,30,20,15,15};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Doctors Payments :     Period : "  +dateFormat.format(endDate11)+" ------ "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        phrase = new Phrase("Doctor Name",pFontHeader);
                        table.addCell(phrase);
                        phrase = new Phrase("Description",pFontHeader);
                        table.addCell(phrase);
                        
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                        phrase = new Phrase("Earning",pFontHeader);
                        table.addCell(phrase);
                        phrase = new Phrase("Deduction",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select input_date,account_no,doc_name,upper(description),debit,credit from ac_doctors_payments where input_date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by input_date");
                            ...
                            // java.sql.ResultSet rset2 = st2.executeQuery("select sum(debit) from ac_debtors WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and dealer = 'N.H.I.F'");
