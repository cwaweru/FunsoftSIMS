...
public class PatientLabResultsPdf implements java.lang.Runnable {
    ...
    public void PatientLabResultsPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date enddate, java.lang.String combox) {
        MNo = combox;
        endDate = enddate;
        beginDate = begindate;
                   ...
                   try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st.executeQuery("select specimen, test,parameter,result,time,status from hp_patient_visit where patient_no = '"+memNo+"' and date BETWEEN '"+beginDate+"' AND '"+endDate+"' and department ilike 'lab%' order by specimen");
                          ...
                          */
                            ...
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("Specimen",pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(1);
                            ...
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("Time",pFontHeader1);
                            table.addCell(phrase);
