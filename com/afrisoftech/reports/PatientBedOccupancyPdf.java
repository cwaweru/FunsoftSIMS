...
public class PatientBedOccupancyPdf implements java.lang.Runnable {
    ...
    public void PatientBedOccupancyPdf(java.sql.Connection connDb) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,15,12,30,10,10,30,10,30};
                        ...
                        table.addCell(phrase);
                        phrase = new Phrase("Admitting Doctor",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset33 = st33.executeQuery("select count(admission_no) from hp_admission where discharge = false");
                            
                            for (int i = 0; i < listofAct.length; i++) {
                                int lineNo = 0;
                                java.sql.Statement st3 = connectDB.createStatement();
                                
                                java.sql.ResultSet rset3 = st3.executeQuery("select DISTINCT ad.date_admitted,ad.admission_no,initcap(ad.patient_name),pr.year_of_birth,bed_no,initcap(ad.doctor),pr.pay_mode,pr.description from hp_admission ad,hp_inpatient_register pr where upper(ad.ward) = '"+listofAct[i]+"' and ad.discharge = false and pr.patient_no = ad.patient_no");
