            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Unfinalised Inv : ", com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,10));
                        ...
                        try {
                            ...
                            for (int k = 0; k < listofAct1.length; k++) {
                                java.sql.ResultSet rset1 = st2.executeQuery("SELECT trans_date,patient_no,patient_name,sum(amount) from op_unfinalised_inv where trans_date BETWEEN '"+beginDate+"' AND '"+endDate+"' and description ILIKE '"+listofAct1[k].toString()+"%' group by trans_date,patient_no,patient_name order by trans_date");
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
