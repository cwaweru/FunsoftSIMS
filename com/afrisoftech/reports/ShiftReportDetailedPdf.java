...
public class ShiftReportDetailedPdf implements java.lang.Runnable {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.Statement st5 = connectDB.createStatement();
                                  ...
                                  for (int k = 0; k < listofAct1.length; k++) {
                                    ...
                                    java.sql.ResultSet rset22 = st22.executeQuery("select receipt_no,dealer,date from ac_cash_collection where shift_no = '"+memNo+"' AND cash_point = '"+CashPoint+"' and payment_mode ILIKE '"+listofAct[i].toString()+"' and receipt_no = '"+listofAct1[k].toString()+"'");
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT payment_mode FROM ac_cash_collection where shift_no = '"+memNo+"'   AND cash_point = '"+CashPoint+"' order by payment_mode");
