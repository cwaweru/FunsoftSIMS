...
public class GlTransactDailyPdf implements java.lang.Runnable {
    ...
    public void GlTransactDailyPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,24,15,23,23};
                       ...
                       // Phrase phrase = new Phrase("Patients List As At:" +endDate, pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.PreparedStatement pset1 = connectDB.prepareStatement("SELECT SUM(tl.debit),SUM(tl.credit),ac.activity from ac_general_ledger_view tl,pb_activity ac where tl.gl_code = ? and ac.code = ? AND tl.date BETWEEN '"+beginDate+"' AND '"+endDate+"' GROUP BY ac.activity");
                               ...
                               // System.out.println("Select B done ...");
                                rsetTotals1 = st3.executeQuery("SELECT SUM(debit),SUM(credit) from ac_general_ledger_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT gl_code FROM ac_general_ledger_view where date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by gl_code");
