            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,12,10,10,35,10,10,10,12,25};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Deaths List :     Period From: "  +dateFormat.format(endDate11)+"' TO ' "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        phrase = new Phrase("Birth date",pFontHeader);
                        table.addCell(phrase);
                      ...
                      //  table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset3 = st.executeQuery("select age, sheet_no,deceased_no,diceased_name,gender,birth_date,age-birth_date,disease,officer from hp_death_register WHERE input_date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by input_date");
