...
public class UnReconcItemsPdf implements java.lang.Runnable {
    ...
    public void UnReconcItemsPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date enddate) {
                    ...
                    try {
                        ...
                        table.setHeaderRows(4);
                         table.getDefaultCell().setColspan(5);
                                             Phrase phrase = new Phrase("Un Reconcilled Items");
                       ...
                       table.getDefaultCell().setColspan(4);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select date,cheque_no,initcap(dealer),debit,credit from ac_cash_book WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and reconciled =false ORDER BY date");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                            
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(debit),SUM(credit) from ac_cash_book WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and reconciled = false");
