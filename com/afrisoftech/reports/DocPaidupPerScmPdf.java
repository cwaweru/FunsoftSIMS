...
public class DocPaidupPerScmPdf implements java.lang.Runnable {
    ...
    public void DocPaidupPerScmPdf(java.sql.Connection connDb,java.lang.String combox) {
                        ...
                        try {
                           ...
                           // java.sql.ResultSet rset41 = st41.executeQuery("select scheme from hp_patient_card where scheme = '"+listofStaffNos+"'");
                            ...
                            table.getDefaultCell().setBorderWidth(Rectangle.TOP | Rectangle.BOTTOM);
                                ...
                                phrase = new Phrase("Doctors Paidup Inv. Per Scheme", pFontHeader1);
                                table.addCell(phrase);
...
//                                while (rset41.next())
                             ...
                             for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select input_date, upper(name),pat_inv,credit_bal from doc_paidupscm_view where  scheme = '"+listofStaffNos[j]+"' AND acc_no = '"+memNo+"' order by input_date");
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT scheme FROM doc_paidupscm_view WHERE acc_no = '"+memNo+"' order by scheme");
