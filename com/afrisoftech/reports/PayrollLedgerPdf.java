...
public class PayrollLedgerPdf implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    public void PayrollLedgerPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
                   ...
                   */
                     ...
                     */
                        ...
                        try {
                            ...
                            phrase = new Phrase("Payroll Ageing as at " +dateFormat.format(endDate2), pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                               ...
                               // java.sql.PreparedStatement pset22 = connectDB.prepareStatement("select supplier_name from st_suppliers WHERE code = ? ");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                ...
                                java.sql.PreparedStatement pSeta1 = connectDB.prepareStatement("SELECT count(dealer) FROM ac_payroll_ledger where  dealer = ?");
                                java.sql.PreparedStatement pset22 = connectDB.prepareStatement("select distinct dealer from ac_payroll_ledger where  dealer = ? ");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                            ...
                            */
                                    ...
                                    java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(balance) from ac_payroll_ledger WHERE dealer = ?  AND date < '"+rangeDates[rangeDates.length - 1][0]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    pset1.setString(1,listofAct[i].toString());
                                    java.sql.ResultSet rset1 = pset1.executeQuery();
                                    
                                    java.sql.PreparedStatement pset111 = connectDB.prepareStatement("select sum(balance) from ac_payroll_ledger WHERE dealer = ?  AND date < '"+endDate+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                ...
                                */
                                    java.sql.PreparedStatement pset112 = connectDB.prepareStatement("select sum(balance) from ac_payroll_ledger WHERE dealer = ? AND date < '"+endDate+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    ...
                                    */
                                        java.sql.PreparedStatement pset = connectDB.prepareStatement("select sum(balance) from ac_payroll_ledger WHERE dealer = ?  AND date between '"+rangeDates[t][1]+"' AND '"+rangeDates[t][0]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT dealer FROM ac_payroll_ledger where dealer IS NOT NULL and balance != 0 order by dealer");
