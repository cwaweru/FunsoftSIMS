...
public class ShiftReportPdf1 implements java.lang.Runnable {
                    ...
                    try {
                      ...
                      //  java.lang.Object listofStaffNos[] = this.getListofStaffNos();
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetTotals1 = st2.executeQuery("SELECT SUM(debit),sum(credit),sum(debit-credit) from ac_cash_collection WHERE shift_no = '"+memNo+"'  AND cash_point = '"+CashPoint+"' and user_name = '"+UserName+"'");
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select sum(debit),sum(credit),sum(debit-credit) from ac_cash_collection where shift_no = '"+memNo+"'  AND cash_point = '"+CashPoint+"' and payment_mode ILIKE '"+listofAct[i].toString()+"' and user_name = '"+UserName+"' group by payment_mode ");
