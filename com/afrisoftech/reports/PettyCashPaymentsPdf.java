...
public class PettyCashPaymentsPdf implements java.lang.Runnable {
    ...
    public void PettyCashPaymentsPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,10,20,25,25,15,15};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Petty Cash Payments From : " +dateFormat.format(endDate11)+"  To : " +dateFormat.format(endDate1), pFontHeader);
                        ...
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                        phrase = new Phrase("Deposits KShs.",pFontHeader);
                        table.addCell(phrase);
                        
                        phrase = new Phrase("Withdrawals KShs.",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.Statement st3 = connectDB.createStatement();
                            java.sql.ResultSet rset = st.executeQuery("SELECT date,voucher_no,initcap(payee),initcap(status),department,debit,credit from ac_petty_cash WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND paid = 'true' order by date");
                            
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(debit),SUM(credit) from ac_petty_cash WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'  AND paid = 'true'");
                            
                            java.sql.ResultSet rsetTotals1 = st3.executeQuery("SELECT SUM(debit - credit) from ac_petty_cash WHERE date < '"+beginDate+"'");
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf((debit-credit)+totals)), pFontHeader);
