...
public class FinalisedInvListPdf implements java.lang.Runnable {
    ...
    public void FinalisedInvListPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,20,10,20,20,10,15};
                      ...
                      //  table.getDefaultCell().setColspan(4);
                                ...
                                phrase = new Phrase("Finalised Inv. List Period From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select admission_no,item,invoice_no,dealer,payee,account_no,debit from ac_debtors where (invoice_no ILIKE 'O%' OR invoice_no ILIKE 'I%') and date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by invoice_no");
