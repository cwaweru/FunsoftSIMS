...
public class InPatientsAttSheetPdf implements java.lang.Runnable {
    ...
    public void InPatientsAttSheetPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,15,20,25,10,20};
                        ...
                        try {
                            ...
                            phrase = new Phrase("InPatient Att. List :     Period : "  +dateFormat.format(endDate11)+" ------ "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        phrase = new Phrase("Date Adm.",pFontHeader);
                        table.addCell(phrase);
                        ...
                        phrase = new Phrase("Other Name(s)",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select adm_date,patient_no,upper(first_name),second_name,pay_mode,description from hp_inpatient_register WHERE adm_date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by adm_date");
