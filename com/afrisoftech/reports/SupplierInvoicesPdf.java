                    ...
                    try {
                      ...
                      //  table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select invoice_no,date,dealer,sum(credit),sum(debit) from ac_accounts_payable WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and (transaction_type ILIKE 'Stock Delivery' or transaction_type ilike 'inv%') and credit > 0 GROUP BY invoice_no,date,dealer ORDER BY date");
