...
public class ProvSummaryScmdocPdf implements java.lang.Runnable {
    ...
    public void ProvSummaryScmdocPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                */
                  ...
                  */
                     com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Provision Summary(Doctors) - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,20,7,20,15};
                       ...
                       table.getDefaultCell().setBorder(Rectangle.BOTTOM);
                        ...
                        try {
                            ...
                            java.sql.Statement st5 = connectDB.createStatement();
                             java.sql.ResultSet rset1 = st1.executeQuery("SELECT dt.account_no,dt.payee,sum(dt.debit) as balance,sum(dt.prov_amt),sum(dp.credit_bal) as doc from ac_doctors_ledger dp,ac_debtors dt where dp.pat_inv = dt.invoice_no and dt.provision = true and dp.credit_bal > 0 and dt.prov_date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by dt.payee,dt.account_no ORDER BY dt.payee ");
                            ...
                            phrase = new Phrase("Provision By Doctor Summary Report", pFontHeader11);
                            table.addCell(phrase);
                          ...
                          //  table.getDefaultCell().setBorderColor(java.awt.Color.BLACK);
                            ...
                            phrase = new Phrase("Prov Amt",pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("Doc Prov Amt. ",pFontHeader1);
                            table.addCell(phrase);
