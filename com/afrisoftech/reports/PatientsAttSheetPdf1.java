...
public class PatientsAttSheetPdf1 implements java.lang.Runnable {
    ...
    public void PatientsAttSheetPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {25,12,20,13,10,25};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Patient Att. List :     Period : "  +dateFormat.format(endDate11)+" ------ "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st11.executeQuery("select count(distinct(patient_no)) from hp_patient_visit WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and transaction_type ilike 'regis%'");
                            
                            for (int i = 0; i < listofAct.length; i++) {
                                System.out.println("item" +listofAct[i]);
                                java.sql.Statement st = connectDB.createStatement();
                                
                                java.sql.PreparedStatement st1 = connectDB.prepareStatement("select distinct pb.date::date,pb.patient_no,upper(pb.name),pb.payment,pr.description from hp_patient_register pr,hp_patient_visit pb WHERE pb.input_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pr.patient_no = ? and pb.patient_no = pr.patient_no and pb.transaction_type ilike 'registration%' order by pb.date::date,upper(pb.name)");
                                
                                //java.sql.ResultSet rset = st.executeQuery("select pb.input_date,pb.patient_no,upper(pb.name),pb.payment,pr.description from hp_patient_register pr,hp_patient_visit pb WHERE pb.input_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pr.patient_no = ? and pb.patient_no = pr.patient_no and pb.transaction_type ilike 'registration%' order by pb.input_date,pb.name");
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT patient_no FROM hp_patient_visit where transaction_type ilike 'registration%' and input_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"'  order by patient_no");
