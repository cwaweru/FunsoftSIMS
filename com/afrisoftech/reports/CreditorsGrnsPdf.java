...
public class CreditorsGrnsPdf implements java.lang.Runnable {
    ...
    public void CreditorsGrnsPdf(java.sql.Connection connDb,java.lang.String begindate,java.lang.String endate,java.lang.String supp,java.lang.String invno) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        phrase = new Phrase("Suplier  :"+suppName+"", pFontHeader);
                        ...
                        try {
                            ...
                            //   java.sql.ResultSet rset1 = st21.executeQuery("select received_by from st_stock_cardex WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND supplier = '"+suppName+"' ORDER BY item");
                            ...
                            // java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT sum(vat_amount),sum(debit) from st_stock_cardex WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND supplier = '"+suppName+"'");
  ...
  */
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select item,quantity_received,units,price_per_item,vat_amount,debit from st_stock_cardex WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND supplier = '"+suppName+"' and invoice_no = '"+invNo+"' ORDER BY item");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT sum(vat_amount),sum(debit) from st_stock_cardex WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND supplier = '"+suppName+"' and invoice_no = '"+invNo+"'");
