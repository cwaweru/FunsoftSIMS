        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Revenue List - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Income(Revenue) : ", com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,10));
                        ...
                        try {
                         ...
                         java.sql.ResultSet rset1 = st2.executeQuery("SELECT service_type,rate,gl_account from pb_operating_parameters where main_service = '"+listofAct1[k].toString()+"' order by service_type");
                               table.getDefaultCell().setColspan(1);
  ...
  /*  public java.lang.Object[] getListofActivities() {
     ...
     public java.lang.Object[] getListofActivities1() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT main_service FROM pb_operating_parameters order by main_service");
