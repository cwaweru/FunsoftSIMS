...
public class UnBankedItemsPdf implements java.lang.Runnable {
    ...
    public void UnBankedItemsPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date enddate) {
...
//        bank = combox;
    ...
    public void generatePdf() {
      ...
      */
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("UnBanked Items - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
