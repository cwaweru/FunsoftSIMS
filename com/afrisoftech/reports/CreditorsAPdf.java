...
public class CreditorsAPdf implements java.lang.Runnable {
    ...
    public void CreditorsAPdf(java.sql.Connection connDb) {
    ...
    public void generatePdf() {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Creditors Ledger: " +endDate, pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetTotals = st.executeQuery("SELECT SUM(credit - debit) from ac_accounts_payable WHERE description = 'Creditors Payable'");
                            
                   /*         java.sql.Statement std = connectDB.createStatement();
                            java.sql.ResultSet rsetTotals2 = std.executeQuery("SELECT SUM(credit - debit) from ac_accounts_payable WHERE description = 'Creditors Payable' AND date < 30 ");
                            
                            java.sql.Statement ste = connectDB.createStatement();
                            java.sql.ResultSet rsetTotals3 = ste.executeQuery("SELECT SUM(credit - debit) from ac_accounts_payable WHERE description = 'Creditors Payable' AND date < current_date - interval '30 days' and date > current_date - 60");
                            
                            java.sql.Statement stf = connectDB.createStatement();
                            java.sql.ResultSet rsetTotals4 = stf.executeQuery("SELECT SUM(credit - debit) from ac_accounts_payable WHERE description = 'Creditors Payable' AND date < current_date - interval '60 days' and date > current_date - 90");
                            
                            java.sql.Statement stg = connectDB.createStatement();
                            java.sql.ResultSet rsetTotals5 = stg.executeQuery("SELECT SUM(credit - debit) from ac_accounts_payable WHERE description = 'Creditors Payable' AND date < current_date - interval '90 days'");
                            
                            java.sql.Statement sth = connectDB.createStatement();
                            java.sql.ResultSet rsetTotals6 = sth.executeQuery("SELECT SUM(credit - debit) from ac_accounts_payable WHERE description = 'Creditors Payable'");
                           */ 
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset1 = st21.executeQuery("select CASE WHEN (dealer IS NULL) THEN '0.00' ELSE sum(credit-debit) END AS credit from ac_accounts_payable WHERE dealer = '"+listofAct[i]+"' AND date < current_date - interval '30 days' and date > current_date - 60 group by dealer");
                                java.sql.ResultSet rset2 = st22.executeQuery("select CASE WHEN (dealer IS NULL) THEN '0.00' ELSE sum(credit-debit) END AS credit from ac_accounts_payable WHERE dealer = '"+listofAct[i]+"' AND date < current_date - interval '60 days' and date > current_date - 90 group by dealer");
                                java.sql.ResultSet rset3 = st23.executeQuery("select CASE WHEN (dealer IS NULL) THEN '0.00' ELSE sum(credit-debit) END AS credit from ac_accounts_payable WHERE dealer = '"+listofAct[i]+"' AND date < current_date - interval '90 days' and date > current_date - 120 group by dealer");
                                java.sql.ResultSet rset1A = st2A.executeQuery("select CASE WHEN (dealer IS NULL) THEN '0.00' ELSE sum(credit-debit) END AS credit from ac_accounts_payable WHERE dealer = '"+listofAct[i]+"' group by dealer");
                                java.sql.ResultSet rset2B = st2B.executeQuery("select CASE WHEN (dealer IS NULL) THEN '0.00' ELSE sum(credit-debit) END AS credit from ac_accounts_payable WHERE dealer = '"+listofAct[i]+"' group by dealer");
                                ...
                                java.sql.ResultSet rset11 = st211.executeQuery("select COUNT(dealer) from ac_accounts_payable WHERE dealer = '"+listofAct[i]+"' AND date < current_date - interval '30 days' and date > current_date - 60 group by dealer");//WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and transaction_type = 'Payment' and description = 'Creditors Payable' OR description = 'Other Payables' AND debit >0");
                                java.sql.ResultSet rset21 = st221.executeQuery("select COUNT(dealer) from ac_accounts_payable WHERE dealer = '"+listofAct[i]+"' AND date < current_date - interval '60 days' and date > current_date - 90 group by dealer");//WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and transaction_type = 'Payment' and description = 'Creditors Payable' OR description = 'Other Payables' AND debit >0");
                                java.sql.ResultSet rset31 = st231.executeQuery("select COUNT(dealer) from ac_accounts_payable WHERE dealer = '"+listofAct[i]+"' AND date < current_date - interval '90 days' and date > current_date - 120 group by dealer");//WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and transaction_type = 'Payment' and description = 'Creditors Payable' OR description = 'Other Payables' AND debit >0");
        ...
        public java.lang.Object[] getListofActivities() {
            ...
            try {
                ...
                java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT dealer, sum(credit-debit) as amount FROM ac_accounts_payable where description = 'Creditors Payable' group by dealer order by dealer");
                
                while (rSet1.next()) {
                    if (rSet1.getFloat(2) > 0){
