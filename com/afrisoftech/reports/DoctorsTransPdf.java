...
public class DoctorsTransPdf implements java.lang.Runnable {
    ...
    public void DoctorsTransPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Doctors Ledger - Page: ", pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,15,30,25,15};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Doctors Ledger From : " +dateFormat.format(endDate11)+"  To : " +dateFormat.format(endDate1), pFontHeader);
                       ...
                       // table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("SELECT input_date,patient_no,initcap(doctor),initcap(description),credit from ac_doctors_ledger WHERE input_date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by input_date");
                            
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(credit) from ac_doctors_ledger WHERE input_date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
