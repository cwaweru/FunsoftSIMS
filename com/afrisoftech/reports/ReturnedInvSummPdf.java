...
public class ReturnedInvSummPdf implements java.lang.Runnable {
    int numberSeq = 0;
    ...
    public void ReturnedInvSummPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Returned Claims - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {7,12,12,9,20,10,30,10,13};
                        ...
                        Phrase phrase = new Phrase("Returned Invoices Report", pFontHeader);
                      ...
                      //  table.getDefaultCell().setColspan(3);
                        ...
                        table.addCell(phrase);
                          table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                        phrase = new Phrase("Date Rtd",pFontHeader);
                        table.addCell(phrase);
                        ...
                        table.addCell(phrase);
                         phrase = new Phrase("Action",pFontHeader);
                        table.addCell(phrase);
                         phrase = new Phrase("Type",pFontHeader);
                        table.addCell(phrase);
                       ...
                       double Count1 = 0.00;
                                ...
                                java.sql.ResultSet rset3 = st3.executeQuery(" select rc.input_date,rc.date_returned,rc.acc_no,initcap(sc.scheme_name),rc.inv_no,initcap(rc.action),initcap(rc.type),rc.inv_amount from pb_returned_claim rc,ac_schemes sc where sc.account_no =rc.acc_no and rc.reason ilike '"+listofAct[i]+"' and dispatched = false AND input_date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by acc_no,input_date");
                              ...
                              //  while (rset3.next()){
                                ...
                                table.addCell(phrase);
                                  ...
                                  // Count = Count + rset3.getDouble(5);
                                  // Count1 = Count1 +rset3.getDouble(5);
                                    table.addCell(phrase);
                                ...
                                Balance = Balance + rset3.getDouble(8);
                                 Balance1 = Balance1 + rset3.getDouble(8);
                                table.addCell(phrase);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT reason FROM pb_returned_claim where dispatched = false  AND input_date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by reason");
