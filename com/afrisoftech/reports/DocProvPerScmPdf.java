...
public class DocProvPerScmPdf implements java.lang.Runnable {
   ...
   //  public void FinalPatientInvoicePdf(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate, java.lang.String combox) {
    public void DocProvPerScmPdf(java.sql.Connection connDb,java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                  ...
                  */
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Provisioned Invoices Per Doctor Report - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                        ...
                        try {
                           ...
                           // java.sql.ResultSet rset41 = st41.executeQuery("select scheme from hp_patient_card where scheme = '"+listofStaffNos+"'");
                            ...
                            table.getDefaultCell().setBorderWidth(Rectangle.TOP | Rectangle.BOTTOM);
                                ...
                                phrase = new Phrase("Doctors Provisioned Inv. Per Scheme", pFontHeader1);
                                table.addCell(phrase);
...
//                                while (rset41.next())
                              ...
                              //  table.getDefaultCell().setColspan(3);
                                ...
                                table.addCell(phrase);
                               java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(credit_bal) from doc_prov where acc_no = '"+memNo+"'");
                               //double OsBalance = 0.00;
                             for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select input_date, upper(name),pat_inv,credit,credit_bal from doc_prov where  scheme = '"+listofStaffNos[j]+"' AND acc_no = '"+memNo+"' order by prov_date");
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT scheme FROM doc_prov WHERE acc_no = '"+memNo+"' order by scheme");
