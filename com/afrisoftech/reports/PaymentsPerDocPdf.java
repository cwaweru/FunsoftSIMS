...
public class PaymentsPerDocPdf implements java.lang.Runnable {
    ...
    public void PaymentsPerDocPdf(java.sql.Connection connDb, java.lang.String combox,java.util.Date begindate, java.util.Date endate) {
        MNo = combox;
        ...
        try {
            ...
            double osBalancebf = 0.00;
                    ...
                    try {
                        ...
                        int headerwidths[] = {13,10,10,34,15,15};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select input_date::date,cheque_no,voucher_no,upper(description),debit,credit from ac_doctors_payments where account_no = '"+memNo+"'and input_date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by input_date::date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                           // java.sql.ResultSet rsetTotals2 = st2.executeQuery("select sum(credit_bal - debit_bal) from ac_doctors_ledger where acc_no = '"+memNo+"' and input_date < '"+beginDate+"'");
                            ...
                            phrase = new Phrase("Payments (Per Doctor)", pFontHeader1);
                            table.addCell(phrase);
                               table.getDefaultCell().setBorderColor(java.awt.Color.white);
                            while (rset.next()) 
                           ...
                           // table.addCell(phrase);
                            ...
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("Earning",pFontHeader1);
                            table.addCell(phrase);
                            
                            phrase = new Phrase("Deduction",pFontHeader1);
                            table.addCell(phrase);
