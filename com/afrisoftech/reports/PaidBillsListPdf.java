...
public class PaidBillsListPdf implements java.lang.Runnable {
    ...
    public void PaidBillsListPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Bookings List - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,8,12,20,24,8};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Bills paidup List :     Period : "  +dateFormat.format(endDate11)+" ------ "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        phrase = new Phrase("Vouch.No.",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select voucher_date,final_voucher_no,voucher_no,initcap(dealer),initcap(description),debit from ac_bills WHERE voucher_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and final_voucher_no ilike 'VC%' order by voucher_date::date");
