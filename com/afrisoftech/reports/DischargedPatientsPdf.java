...
public class DischargedPatientsPdf implements java.lang.Runnable {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,12,10,25,25,10,20};
                     ...
                     //   table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select discharge_date,patient_no,patient_name,ward,bed_no,doctor from hp_patient_discharge WHERE discharge_date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by discharge_date");
