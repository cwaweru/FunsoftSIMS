...
public class ExpensesPdf implements java.lang.Runnable {
    ...
    public void ExpensesPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Expenses - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,15,15,25,20,10};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Expenses :     Period : "  +dateFormat.format(endDate11)+" ------ "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select ac.activity_code,pb.activity,sum(ac.debit) from ac_ledger ac,pb_activity pb where ac.debit > 0 and ac.date BETWEEN '"+beginDate+"' AND '"+endDate+"' and ac.activity_code = pb.code and pb.activity_category ilike 'E' group by ac.activity_code,pb.activity order by pb.activity");
