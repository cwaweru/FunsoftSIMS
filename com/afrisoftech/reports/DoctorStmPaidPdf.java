...
public class DoctorStmPaidPdf implements java.lang.Runnable {
    ...
    public void DoctorStmPaidPdf(java.sql.Connection connDb, java.lang.String combox) {
        MNo = combox;
        ...
        try {
            ...
            try {
                ...
                try {
                  ...
                  */
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Doctor's Paidup Bills Statement - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
            ...
            double osBalancebf = 0.00;
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select input_date::date,patient_no||' '||patient_name,description,reference,credit,pat_inv,credit_bal - debit_bal from ac_doctors_ledger where acc_no = '"+memNo+"' and paid = 'true' and (credit_bal > 0 or debit_bal > 0) order by input_date::date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(credit_bal - debit_bal) from ac_doctors_ledger where acc_no = '"+memNo+"' and paid = 'true'");
                            ...
                            phrase = new Phrase("Doctor's Paidup Bills Statement", pFontHeader1);
                            table.addCell(phrase);
                            while (rset.next()) 
