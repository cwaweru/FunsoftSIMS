...
public class InPatCashTrnoverPdf implements java.lang.Runnable {
    ...
    public void InPatCashTrnoverPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,25,12,20,12};
                        ...
                        Phrase phrase = new Phrase("", pFontHeader);
                            ...
                            try {
                                ...
                                phrase = new Phrase("In Patient List :     Period : "  +dateFormat.format(endDate11)+"' ------ '"+dateFormat.format(endDate1), pFontHeader);
                     ...
                     //   table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
                      ...
                      //  table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select pc.patient_no,pr.second_name,sum(pc.debit),sum(pc.credit),sum(pc.debit - pc.credit) from hp_patient_card pc,hp_inpatient_register pr where pc.BETWEEN '"+beginDate+"' AND '"+endDate+"' and invoice_no not ilike 'O%' and pr.pay_mode ilike 'cash' and pr.patient_no = pc.patient_no group by pc.patient_no,pr.second_name");
                            
                            java.sql.Statement st1 = connectDB.createStatement();
                            
                            
                           // java.sql.ResultSet rset1 = st1.executeQuery("select count(patient_no) from hp_patient_discharge WHERE discharge_date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                          ...
                          //osBalance =  rset.getDouble(3);
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset.getString(3)),pFontHeader1);
                                osBalance2 = osBalance2 + rset.getDouble(4);
                         // osBalance =  rset.getDouble(4);
                                table.addCell(phrase);
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset.getString(3)),pFontHeader1);
                                osBalance3 = osBalance3 + rset.getDouble(5);
                          //osBalance =  rset.getDouble(5);
                                table.addCell(phrase);
