...
public class TimeLogPdf implements java.lang.Runnable {
    ...
    public void TimeLogPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {20,15,30,15,10,15,15,5,15};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select input_date::timestamp(0),patient_no,upper(name),services,payment,department,transaction_type,quantity,amount from hp_patient_visit WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by input_date");
