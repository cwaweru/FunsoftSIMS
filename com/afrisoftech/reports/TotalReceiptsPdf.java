...
public class TotalReceiptsPdf implements java.lang.Runnable {
    ...
    public void TotalReceiptsPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Receipts(All) - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,10,25,8,10,10,15};
                        ...
                        Phrase phrase = new Phrase("", pFontHeader);
                            ...
                            try {
                                ...
                                phrase = new Phrase("Receipts List :     Period : From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), pFontHeader);
                       ...
                       // Phrase phrase = new Phrase("Patients List As At:" +endDate, pFontHeader);
                        ...
                        phrase = new Phrase("User",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select date,receipt_no,upper(dealer),user_name,payment_mode,cheque_no,sum(debit-credit) from ac_cash_collection WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND transaction_type = 'Receipts' GROUP BY date,receipt_no,dealer,account_no,payment_mode,user_name,cheque_no ORDER BY date");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(debit) from ac_cash_collection WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND transaction_type = 'Receipts'");
