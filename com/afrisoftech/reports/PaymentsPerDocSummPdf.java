...
public class PaymentsPerDocSummPdf implements java.lang.Runnable {
    ...
    public void PaymentsPerDocSummPdf(java.sql.Connection connDb, java.lang.String combox,java.util.Date begindate, java.util.Date endate) {
        MNo = combox;
        ...
        try {
            ...
            double osBalancebf = 0.00;
                    ...
                    try {
                        ...
                        int headerwidths[] = {13,10,34,15,15};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select input_date::date,voucher_no,upper(description),debit,debit_bal from ac_doctors_ledger where acc_no = '"+memNo+"' and input_date between '"+beginDate+"' and '"+endDate+"' and transaction_type  ilike 'payment%' order by input_date::date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
