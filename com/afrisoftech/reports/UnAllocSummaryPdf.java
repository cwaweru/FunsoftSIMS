...
public class UnAllocSummaryPdf implements java.lang.Runnable {
    ...
    java.lang.Process prThread;
      ...
      public void UnAllocSummaryPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
   // public void UnAllocSummaryPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                */
                  ...
                  */
                     com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("UnAllocated Cheques - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,25,30,13,15,15};
                       ...
                       table.getDefaultCell().setBorder(Rectangle.BOTTOM);
                        ...
                        try {
                           ...
                           // java.sql.ResultSet rset4 = st4.executeQuery("select scheme_name,account_no from ac_schemes where payer_name = '"+memNo+"'");
                           // java.sql.ResultSet rset41 = st41.executeQuery("select payer_name from ac_schemes where payer_name = '"+memNo+"'");
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select distinct db.date,db.dealer,db.payee,db.receipt_no,db.credit,db.credit_bal from ac_debtors db where credit_bal > 0 AND date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by db.date");// UNION select pd.date::date,initcap(pd.scheme_staff_no), (sh.first_name||' '||sh.second_name||' '||sh.last_name) as name,pd.reference,sum(pd.credit),pd.patient_no from hp_patient_card pd,hp_inpatient_register sh where pd.patient_no = sh.patient_no and pd.isurer = '"+memNo+"' AND pd.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pd.credit > 0 group by pd.date::date,pd.scheme_staff_no, name,pd.reference,pd.invoice_no,pd.patient_no order by pd.invoice_no");
                            ...
                            phrase = new Phrase("Unallocated Cheques Summary Report", pFontHeader11);
                            table.addCell(phrase);
                          ...
                          //  table.getDefaultCell().setBorderColor(java.awt.Color.BLACK);
                            ...
                            phrase = new Phrase("Receipt No. ",pFontHeader1);
                            table.addCell(phrase);
                            ...
                            table.addCell(phrase);
                             ...
                             phrase = new Phrase("Unalloc. Bal. ",pFontHeader1);
                            table.addCell(phrase);
                           table.getDefaultCell().setBorderColor(java.awt.Color.black);
                           ...
                           */
                            ...
                            while (rset1.next()){
                              ...
                              //  table.addCell(phrase);
                                ...
                                osBalancebf = osBalancebf + rset1.getDouble(5);
