...
public class ExpiredSchmAccPdf implements java.lang.Runnable {
    ...
    public void ExpiredSchmAccPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Expired Accounts - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,35,10,10,15,12};
                        ...
                        Phrase phrase = new Phrase("Expired Accounts(Schemes)", pFontHeader);
                        ...
                        table.addCell(phrase);
                        phrase = new Phrase("Exp Date",pFontHeader);
                        table.addCell(phrase);
                       /* table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
