...
public class DailyRevPdf1 implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    public void DailyRevPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
        ...
        ageingSeries = new com.afrisoftech.timeseries.DailyAgeing(7, endate);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Daily Comparison  Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Daily Revenue as at " +dateFormat.format(endDate2), pFontHeader);
                        ...
                        for (int x = 0; x < rangeDates.length; x++) {
                            ...
                            try {
                                ...
                                com.afrisoftech.lib.DateFormatter dateFormatter = new com.afrisoftech.lib.DateFormatter(dateFormat.parse(rangeDates[x][0].toString().trim()), "dd-MMM-yy");
                               ...
                               /* if (x < 1) {
                                    ...
                                    com.afrisoftech.lib.DateFormatter dateFormatterCurrent = new com.afrisoftech.lib.DateFormatter(endDate, "dd-MMM-yy");
