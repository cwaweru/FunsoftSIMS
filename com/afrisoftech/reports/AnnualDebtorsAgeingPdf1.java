...
public class AnnualDebtorsAgeingPdf1 implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    public void AnnualDebtorsAgeingPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
        ...
        ageingSeries = new com.afrisoftech.timeseries.YearlyAgeingSeries(4, endate);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT account_no,payee FROM ac_debtors where (account_no IS NOT NULL OR account_no !='') and balance > 0 order by account_no");
