...
public class DebtAllocSummPdf implements java.lang.Runnable {
    ...
    public void DebtAllocSummPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox) {
        //MNo = combox;
    ...
    public void generatePdf(java.lang.String memNo) {
              ...
              double rCount1 = 0.00;      
                    try {
                        ...
                        table.getDefaultCell().setBorderColor(java.awt.Color.BLACK);
                            ...
                            phrase = new Phrase(memNo+ " Allocation Summary", pFontHeader1);
                            table.addCell(phrase);
                           ...
                           */
                            ...
                            java.sql.ResultSet rset13 = st13.executeQuery("select count(receipt_no),sum(credit) from ac_debtors where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and dealer = '"+memNo+"'");
                             java.sql.ResultSet rset14 = st14.executeQuery("select count(receipt_no),sum(credit_bal) ,sum(credit_bal)*100/sum(credit) from ac_debtors where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and credit_bal >0 and dealer = '"+memNo+"'");
                          ...
                          java.sql.ResultSet rset12 = st12.executeQuery("select count(receipt_no),sum(credit) ,sum(credit-credit_bal),sum(credit_bal) ,sum(credit_bal)*100/sum(credit) from ac_debtors where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and account_no = '"+listofAct[i]+"' and credit_bal >0 and credit >0 and dealer = '"+memNo+"'");
        ...
        try {
           ...
           // java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT dealer FROM ac_debtors where date BETWEEN ? AND ? and dealer IS NOT NULL order by dealer");
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT account_no FROM ac_debtors where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and account_no !='' and credit_bal >0 and credit >0 and receipt_no is not null and receipt_no !='' and dealer ilike '"+memNo+"' order by account_no");
