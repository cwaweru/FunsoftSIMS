...
public class OpRevBrdwnPdf implements java.lang.Runnable {
    ...
    public void OpRevBrdwnPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate, java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Daily Rev.(OP) - Page: ", pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase(bank.toUpperCase() +" Daily Rev Breakdown(OP) : ".toUpperCase()  +dateFormat.format(endDate11)+ " - " +dateFormat.format(endDate1), pFontHeader11);
                        ...
                        try {
                            ...
                            for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                for (int k = 0; k < listofStaffNos1.length; k++) {
                                    java.sql.ResultSet rset7 = st7.executeQuery("select sum(credit-debit),count(service_type) from ac_ledger where date  between '"+beginDate+"' AND '"+endDate+"' and activity_code ilike '"+listofStaffNos[j]+"' and drawer ilike 'OP' and service_type ilike '"+listofStaffNos1[k]+"'");// tn,credit-debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                    System.out.println("Select A done ...");
                                    
                                    java.sql.ResultSet rset1 = st1.executeQuery("select sum(credit-debit),count(service_type) from ac_ledger where date  between '"+beginDate+"' AND '"+endDate+"' and  (gl_code ilike 'CASH' OR gl_code ilike 'CHEQUE' OR gl_code ilike 'CREDIT CARD') and activity_code ilike '"+listofStaffNos[j]+"' and drawer ilike 'OP' and service_type ilike '"+listofStaffNos1[k]+"'");// tn,credit-debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                    
                                    java.sql.ResultSet rset4 = st4.executeQuery("select sum(credit-debit),count(service_type) from ac_ledger where date  between '"+beginDate+"' AND '"+endDate+"' and gl_code ilike 'SCHEME' and activity_code ilike '"+listofStaffNos[j]+"' and  drawer ilike 'OP' and service_type ilike '"+listofStaffNos1[k]+"'");// tn,credit-debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                    
                                    java.sql.ResultSet rset41 = st2.executeQuery("select  upper(service_type) from ac_ledger where activity_code ilike '"+listofStaffNos[j]+"' and service_type ilike '"+listofStaffNos1[k]+"' AND date  between '"+beginDate+"' AND '"+endDate+"' AND drawer ilike 'OP' GROUP BY upper(service_type)");// tn,credit-debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
    ...
    public java.lang.Object[] getListofStaffNos1(java.lang.Object codes) {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT distinct service_type from ac_ledger  where activity_code = '"+codes+"' AND date  between '"+beginDate+"' AND '"+endDate+"' AND drawer = 'OP' order by service_type");
