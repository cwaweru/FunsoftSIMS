...
public class AnnualPayerAgeingPdf implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    public void AnnualPayerAgeingPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
                   ...
                   */
                     ...
                     */
                        ...
                        try {
                            ...
                            phrase = new Phrase(Debtor + ": Annual Debtors Ageing as at " +dateFormat.format(endDate2), pFontHeader);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT account_no,payee FROM ac_debtors where account_no IS NOT NULL and account_no !='' and balance > 0 and dealer ilike '"+Debtor+"' order by account_no");
