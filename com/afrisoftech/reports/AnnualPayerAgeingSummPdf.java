...
public class AnnualPayerAgeingSummPdf implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    public void AnnualPayerAgeingSummPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
                   ...
                   */
                     ...
                     */
                        ...
                        try {
                            ...
                            phrase = new Phrase("Annual Debtors Ageing Summary as at " +dateFormat.format(endDate2), pFontHeader);
                        ...
                        for (int i = 0; i < rangeDates.length; i++) {
                            ...
                            System.out.println("First Date : ["+rangeDates[i][0].toString()+"] and Second date : ["+rangeDates[i][1].toString()+"]");
   ...
   try {
                                ...
                                if (x < 1) {
                                    ...
                                    com.afrisoftech.lib.DateFormatter dateFormatterCurrent = new com.afrisoftech.lib.DateFormatter(endDate, "yyyy");
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                               ...
                               // java.sql.PreparedStatement pSeta1 = connectDB.prepareStatement("SELECT count(dealer) FROM ac_debtors where  dealer = '"+listofAct[i]+"' and balance > 0");
                               java.sql.PreparedStatement pset22 = connectDB.prepareStatement("select distinct initcap(scheme_manager) as dealer from ac_scheme_providers WHERE scheme_manager = ?");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                             
                               // java.sql.PreparedStatement pset22 = connectDB.prepareStatement("select distinct scheme_manager from ac_scheme_providers WHERE scheme_manager = ? ");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                              ...
                              //  while (rSeta1.next()) {
                               ...
                               // if (name > 0){
                                    ...
                                    java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(balance) from ac_debtors WHERE dealer = ?  AND date < '"+rangeDates[rangeDates.length - 1][0]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    pset1.setString(1,listofAct[i].toString());
                                    java.sql.ResultSet rset1 = pset1.executeQuery();
                                    
                                    java.sql.PreparedStatement pset111 = connectDB.prepareStatement("select sum(balance-credit_bal) from ac_debtors WHERE dealer = ?  AND date < '"+endDate+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    ...
                                    */
                                        java.sql.PreparedStatement pset = connectDB.prepareStatement("select sum(balance) from ac_debtors WHERE dealer = ?  AND date between '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                               ...
                               */
                                 ...
                                 /*   
                                    ...
                                    for (int t = 0; t < rangeDates.length; t++) {
                                        ...
                                        java.sql.PreparedStatement pset = connectDB.prepareStatement("select sum(balance) from ac_debtors WHERE dealer = ?  AND date between '"+rangeDates[t][1]+"' AND '"+rangeDates[t][0]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                        pset.setString(1,listofAct[i].toString().toUpperCase());
                                        java.sql.ResultSet rset = pset.executeQuery();
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
           ...
           // java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT dealer FROM ac_debtors where dealer IS NOT NULL and dealer !='' and balance > 0 order by dealer");
             java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT scheme_manager FROM ac_scheme_providers  where scheme_manager is not null and scheme_manager !='' order by scheme_manager");
