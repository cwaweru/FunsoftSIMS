...
public class DepartmentRevPdf implements java.lang.Runnable {
                    ...
                    try {
                       ...
                       // Phrase phrase = new Phrase("Patients List As At:" +endDate, pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select upper(service_type),COUNT(service_type),sum(credit-debit) from ac_ledger WHERE date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND activity_code ilike '"+Code+"' and credit > 0 group by service_type order by service_type");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
