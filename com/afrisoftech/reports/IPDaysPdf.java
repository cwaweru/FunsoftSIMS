...
public class IPDaysPdf implements java.lang.Runnable {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Ip Days List - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Ip Days :     Period From: "  +dateFormat.format(endDate11)+"' TO ' "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        phrase = new Phrase("Disc Date",pFontHeader);
                        table.addCell(phrase);
