...
public class LoanStatementPdf implements java.lang.Runnable {
    ...
    public void LoanStatementPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Loan Stock Statement - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
           ...
           // double current = 0.00;
            ///double osBalancebf = 0.00;
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,15,12,12,10,12,15,15,12,15};
                        ...
                        try {
                           double osBalance1 = 0.00;
                            ...
                            java.sql.Statement st5 = connectDB.createStatement();
                             java.sql.ResultSet rset4 = st4.executeQuery("select lender_name,loan_no,payment_terms,date,repayment,period,amount,total from pb_loan where lender_name = '"+memNo+"'");
                              java.sql.ResultSet rset1 = st1.executeQuery("select date,item,voucher_no, reason,invoice_no,debit,credit,journal_no,balance from ac_loans_ledger where dealer = '"+memNo+"' AND date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by date");// UNION select pd.date::date,initcap(pd.scheme_staff_no), (sh.first_name||' '||sh.second_name||' '||sh.last_name) as name,pd.reference,sum(pd.credit),pd.patient_no from hp_patient_card pd,hp_inpatient_register sh where pd.patient_no = sh.patient_no and pd.isurer = '"+memNo+"' AND pd.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pd.credit > 0 group by pd.date::date,pd.scheme_staff_no, name,pd.reference,pd.invoice_no,pd.patient_no order by pd.invoice_no");
                             java.sql.ResultSet rsetT = st41.executeQuery("select sum(balance) from ac_loans_ledger where dealer = '"+memNo+"' AND date::date < '"+beginDate+"'");
                            ...
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit),sum(credit) from ac_loans_ledger where dealer = '"+memNo+"'");
                          ...
                          //  table.getDefaultCell().setBorderWidth(Rectangle.TOP | Rectangle.BOTTOM);
                            ...
                            phrase = new Phrase("Loan / Advance Statement", pFontHeader11);
                            table.addCell(phrase);
                            ...
                            table.getDefaultCell().setColspan(6);
                              table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Principal Amt : " +new com.afrisoftech.sys.Format2Currency().Format2Currency(rset4.getString(7)),pFontHeader1);
                            table.addCell(phrase);
                           // table.getDefaultCell().setColspan(6);
                             table.getDefaultCell().setColspan(4);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Monthly Payment : " +new com.afrisoftech.sys.Format2Currency().Format2Currency(rset4.getString(5)),pFontHeader1);
                            table.addCell(phrase);
                              table.getDefaultCell().setColspan(6);
                           // table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                            phrase = new Phrase("Interest(%) : " +new com.afrisoftech.sys.Format2Currency().Format2Currency(rset4.getString(8)),pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(4);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Payment Terms : " +dbObject.getDBObject(rset4.getObject(3), "-"), pFontHeader1);
                            table.addCell(phrase);
                             table.getDefaultCell().setColspan(6);
                           // table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                            phrase = new Phrase("Period(Months) : " +new com.afrisoftech.sys.Format2Currency().Format2Currency(rset4.getString(6)),pFontHeader1);
                            table.addCell(phrase);
                             table.getDefaultCell().setColspan(4);
                          //  table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                            phrase = new Phrase("First Payment : " +dbObject.getDBObject(rset4.getObject(4), "-"), pFontHeader1);
                            table.addCell(phrase);
                           ...
                           /// table.addCell(phrase);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rsetT.getString(1)),pFontHeader1);
                                osBalanceOs = osBalanceOs + rsetT.getDouble(1);
                                table.addCell(phrase);
                            //table
                            while (rset1.next()){
                                table.getDefaultCell().setColspan(1);
                               ...
                               osBalance = osBalance + rset1.getDouble(7);
                                 //osBalancebf = osBalancebf + rset1.getDouble(6);
                                table.addCell(phrase);
                                 phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset1.getString(9)),pFontHeader);
                                osBalanceOs = osBalanceOs + rset1.getDouble(9);
                                 //osBalancebf = osBalancebf + rset1.getDouble(6);
                                table.addCell(phrase);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalanceOs)),pFontHeader);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalanceOs)),pFontHeader1);
                            ...
                            table.addCell(phrase);
                             ...
                             table.getDefaultCell().setColspan(10);
                              ...
                              phrase = new Phrase("Total Debit:   " + new com.afrisoftech.sys.Format2Currency().Format2Currency(rsetTotals.getString(1)),pFontHeader11);
                             
                            table.addCell(phrase);
                              
                             phrase = new Phrase("Total Credit:    "  +  new com.afrisoftech.sys.Format2Currency().Format2Currency(rsetTotals.getString(2)),pFontHeader11);
