...
public class InpatientDiagPdf implements java.lang.Runnable {
	...
	public void InpatientDiagPdf(java.sql.Connection connDb, java.lang.String combox) {
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Patient Diagnosis - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        int headerwidths[] = {8,8,8,6,5,5,5,5,20,30};
       ...
       // table.setWidths(headerwidths);
        ...
        table.setWidthPercentage((100));
         ...
         //  table.getDefaultCell().setBorder(Rectangle.BOTTOM);
           ...
           Phrase phrase = new Phrase("Patient Diagnosis", pFontHeader);
          ...
          //  table.getDefaultCell().setColspan(1);
            ...
            java.sql.ResultSet rset1 = st1.executeQuery("select patient_no,admission_no,patient_name from hp_admission where admission_no = '"+memNo+"'");
       ...
       table.getDefaultCell().setBorder(Rectangle.BOTTOM);
            ...
            phrase = new Phrase("Pulse",pFontHeader);
            table.addCell(phrase);
           phrase = new Phrase("Resp.",pFontHeader);
            table.addCell(phrase);
         //  table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);         
        
            phrase = new Phrase("Bp.",pFontHeader);
            table.addCell(phrase);
        phrase = new Phrase("Bmi.",pFontHeader);
            table.addCell(phrase);
         
            phrase = new Phrase("Sugar",pFontHeader);
            table.addCell(phrase);
         ...
         //  table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);         
          ...
          java.sql.Statement st = connectDB.createStatement();
            ...
            java.sql.ResultSet rset = st.executeQuery("select date,time,temperature,pulse,resp,bp,bmi,sugar,signature,remarks from hp_signs_record where patient_no = '"+memNo+"' order by date");
