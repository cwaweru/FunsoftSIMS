            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,10,10,10,10,10,10};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Ward Occupancy Statistics :     Period From: "  +dateFormat.format(endDate11)+" TO : "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        phrase = new Phrase("Design Cap.",pFontHeader);
                        table.addCell(phrase);
                        
                        phrase = new Phrase("Max Beds",pFontHeader);
                        table.addCell(phrase);
                        
                        phrase = new Phrase("Occ Capacity",pFontHeader);
                        table.addCell(phrase);
                        
                        phrase = new Phrase("Avg Daily Occ.",pFontHeader);
                        table.addCell(phrase);
                        phrase = new Phrase("Avg CS",pFontHeader);
                        table.addCell(phrase);
                        phrase = new Phrase("Occ.(%)",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            //java.sql.ResultSet rset = st.executeQuery("select date_admitted,patient_no,patient_name,ward,bed_no from hp_admission WHERE date_admitted BETWEEN '"+beginDate+"' AND '"+endDate+"' order by date_admitted");
                             java.sql.ResultSet rset = st.executeQuery("select distinct(ad.ward),wd.design_capacity,wd.max_beds,(select extract(days from timestamp '"+endDate+"' - '"+beginDate+"')+1)*wd.max_beds,count(ad.patient_no),(select extract(days from timestamp '"+endDate+"' - '"+beginDate+"')+1)*wd.max_beds/count(ad.patient_no),((select extract(days from timestamp '"+endDate+"' - '"+beginDate+"')+1)*wd.max_beds/wd.design_capacity) from hp_admission ad,hp_wards wd WHERE ad.date_admitted BETWEEN '"+beginDate+"' AND '"+endDate+"' and ad.ward = wd.ward_name  group by ad.ward,wd.max_beds,wd.design_capacity order by ad.ward");                 
