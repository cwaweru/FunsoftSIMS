...
public class DoctorsListPdf implements java.lang.Runnable {
   com.afrisoftech.lib.DBObject dbObject;
    ...
    public void DoctorsListPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Doctors List - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,20,15,10,10,10,10,15};
                        ...
                        Phrase phrase = new Phrase("Doctors List" , pFontHeader);
                      ...
                      //  table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
                        ...
                        phrase = new Phrase("Specialisation",pFontHeader);
                        table.addCell(phrase);
                        ...
                        table.addCell(phrase);
                         ...
                         phrase = new Phrase("Estate",pFontHeader);
                        table.addCell(phrase);
                        
                        phrase = new Phrase("House No.",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select staff_no,initcap(first_name||' '||middle_name||' '||last_name) as name,specialisation,profession_regno,id_no,estate,house_no,tel_no from pb_doctors_list order by staff_no");
