...
public class DiscCreditorsInvoicesPdf implements java.lang.Runnable {
    ...
    public void DiscCreditorsInvoicesPdf(java.sql.Connection connDb,java.lang.String begindate,java.lang.String endate, java.lang.String supp,java.lang.String invno) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {40,10,10,10,10,20};
                        ...
                        Phrase phrase = new Phrase("G.R.N", pFontHeader);
                        ...
                        try {
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("INVOICE NO::" +invNo, pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(2);
                            
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("STORE :" +rset.getObject(2).toString(), pFontHeader1);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("DATE " +rset.getObject(3).toString(), pFontHeader1);
                            table.addCell(phrase);
                        ...
                        phrase = new Phrase("DISC.",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select item,quantity_received,units,price_per_item,quantity_ordered,debit from st_stock_cardex WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND supplier = '"+suppName+"' and invoice_no = '"+invNo+"' and transaction_type ilike 'Receiving%' ORDER BY item");
                            ...
                            while (rset.next()) {
                                ...
                                table.addCell(phrase);
                                amountReceived  =  amountReceived + rset.getDouble(6);
                            ...
                            while (rset11.next()) {
                                ...
                                table.addCell(phrase);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(dbObject.getDBObject(rset11.getObject(2), "-"),pFontHeader1);
                                
                                table.addCell(phrase);
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(dbObject.getDBObject(rset11.getObject(3), "-"),pFontHeader1);
                                table.addCell(phrase);
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(dbObject.getDBObject(rset11.getObject(4), "-"),pFontHeader1);
                                table.addCell(phrase);
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset11.getString(5)),pFontHeader1);
                                table.addCell(phrase);
                                
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset11.getString(6)),pFontHeader1);
                                table.addCell(phrase);
                                amountReceived  =  amountReceived + rset11.getDouble(6);
                            ...
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(2);
                            phrase = new Phrase("____________________:", pFontHeader1);
                            table.addCell(phrase);
                            ...
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(2);
                            phrase = new Phrase("VERIFIED BY :", pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(2);
                            phrase = new Phrase("AUTHORISED BY :", pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(1);
