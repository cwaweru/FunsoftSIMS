...
public class AllocSummaryPdf implements java.lang.Runnable {
    ...
    public void AllocSummaryPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox1,java.lang.String combox) {
                ...
                */
                  ...
                  */
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,10,13,20,15};
                       ...
                       table.getDefaultCell().setBorder(Rectangle.BOTTOM);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select distinct db.date,db.receipt_no,al.cheque_no,db.credit,db.credit_bal from db_allocation al,ac_debtors db where al.acc_no = '"+memNo+"' and db.account_no = al.acc_no AND db.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and db.credit = al.amount order by db.date");// UNION select pd.date::date,initcap(pd.scheme_staff_no), (sh.first_name||' '||sh.second_name||' '||sh.last_name) as name,pd.reference,sum(pd.credit),pd.patient_no from hp_patient_card pd,hp_inpatient_register sh where pd.patient_no = sh.patient_no and pd.isurer = '"+memNo+"' AND pd.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pd.credit > 0 group by pd.date::date,pd.scheme_staff_no, name,pd.reference,pd.invoice_no,pd.patient_no order by pd.invoice_no");
                            ...
                            phrase = new Phrase("Scheme Payment Summary Report", pFontHeader11);
                            table.addCell(phrase);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Debtor : " +rset4.getObject(2).toString(), pFontHeader1);
                            table.addCell(phrase);
