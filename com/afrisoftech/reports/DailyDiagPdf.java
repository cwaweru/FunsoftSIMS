...
public class DailyDiagPdf implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    public void DailyDiagPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Monthly Diagnosis  Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {35,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8};//,13,13};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Daily Diagnosis as at ".toUpperCase() +dateFormat.format(endDate2), pFontHeader111);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.PreparedStatement pset22 = connectDB.prepareStatement("select disease from hp_patient_diagnosis WHERE disease = ? GROUP BY disease");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                ...
                                for (int t = 0; t < rangeDates.length; t++) {
                                    ...
                                    java.sql.PreparedStatement pset = connectDB.prepareStatement("SELECT count(disease) from hp_patient_diagnosis where disease = ?  AND date_recorded between '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT disease FROM hp_patient_diagnosis order by disease");
