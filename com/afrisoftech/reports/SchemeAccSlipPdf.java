...
public class SchemeAccSlipPdf implements java.lang.Runnable {
    ...
    public void SchemeAccSlipPdf(java.sql.Connection connDb,java.lang.String combox,java.lang.String scheme,java.lang.String patient,java.lang.String schpayer,java.lang.String membNo) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                            phrase = new Phrase("Service Provider Instructions", pFontHeader1);
                            ...
                            table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                            phrase = new Phrase("(Valid for only one visit)", pFontHeader1);
                            ...
                            phrase = new Phrase("Slip No : " +rset.getObject(1).toString(), pFontHeader);
                            table.addCell(phrase);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Valid till : "+rset.getObject(2).toString(), pFontHeader);
                            table.addCell(phrase);
                            
                            
                            table.getDefaultCell().setColspan(1);
                            
                            phrase = new Phrase("Please provide services on credit to : - " +Patient, pFontHeader);
                            ...
                            phrase = new Phrase("Scheme Name : "+Scheme, pFontHeader);
                            
                            table.addCell(phrase);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("Member No : " +MemNo, pFontHeader);
                            
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(2);
                            phrase = new Phrase("Scheme Payer : " +payer, pFontHeader);
                            ...
                            table.getDefaultCell().setColspan(2);
                            phrase = new Phrase("I have received the above services and have agreed to abide to the hospital credit terms ", pFontHeader);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase("Signature :_______________________________ ", pFontHeader);
                            table.addCell(phrase);
                            ...
                            while (rsetTotals22.next())
                                ...
                                table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("Issued By : " +rsetTotals22.getObject(1).toString(), pFontHeader);
                            table.addCell(phrase);
                            phrase = new Phrase("Time : " +rsetTotals22.getObject(2).toString(), pFontHeader);
                            table.addCell(phrase);
