...
public class AdmittedPatientsPdf implements java.lang.Runnable {
    ...
    public void AdmittedPatientsPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Admission List - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,12,10,35,25,10};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select DISTINCT date_admitted,patient_no,initcap(patient_name),ward,bed_no from hp_admission WHERE date_admitted BETWEEN '"+beginDate+"' AND '"+endDate+"' order by date_admitted,patient_no");
