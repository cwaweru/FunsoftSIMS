...
public class UncollectedShiftsPdf implements java.lang.Runnable {
    ...
    public void UncollectedShiftsPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
    ...
    public void generatePdf() {
      ...
      */
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,10,10,15,12,12,9,12,12,13,10};
                        ...
                        phrase = new Phrase("Uncollected Shifts" , pFontHeader);
                        ...
                        phrase = new Phrase("No. Of\nReceipts",pFontHeader);
                        table.addCell(phrase);
                        ...
                        phrase = new Phrase("Net",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select sum(debit - credit) from ac_cash_collection where shift_no ='"+listofAct[i]+"' and payment_mode ilike 'Cash%' and reconciled ='false'");// and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                java.sql.ResultSet rset11 = st11.executeQuery("select shift_no,user_name from ac_shifts where shift_no ='"+listofAct[i]+"'");// and start_date::date > '"+beginDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                ...
                                java.sql.ResultSet rset12 = st12.executeQuery("select sum(debit - credit) from ac_cash_collection where shift_no ='"+listofAct[i]+"' and payment_mode ilike 'Cheque%' and reconciled ='false'");//and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                java.sql.ResultSet rset13 = st13.executeQuery("select sum(debit - credit) from ac_cash_collection where shift_no ='"+listofAct[i]+"' and payment_mode ilike 'Credit Card%' and reconciled ='false'");// and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                ...
                                java.sql.ResultSet rset15 = st15.executeQuery("select sum(credit) from ac_cash_collection where shift_no ='"+listofAct[i]+"' and reconciled ='false'");//and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                java.sql.ResultSet rset16 = st16.executeQuery("select sum(debit - credit) from ac_cash_collection where shift_no ='"+listofAct[i]+"' and reconciled ='false'");// and date between '"+beginDate+"'::date and  '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT shift_no FROM ac_cash_collection WHERE reconciled ='false' and date between '"+beginDate+"'::date and  '"+endDate+"' and shift_no is not null and shift_no !=''");
