...
public class SchemesLimitPdf implements java.lang.Runnable {
    ...
    public void SchemesLimitPdf(java.sql.Connection connDb) {
    ...
    public void generatePdf() {
        ...
        try {
          ...
          // com.lowagie.text.Document docPdf = new com.lowagie.text.Document(PageSize.A4.rotate());
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Schemes (Expired) List - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {25,10,20,10,10,15,14};
                        ...
                        Phrase phrase = new Phrase("Expired Schemes : ", com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,10));
                        ...
                        phrase = new Phrase("Debt", pFontHeader);
