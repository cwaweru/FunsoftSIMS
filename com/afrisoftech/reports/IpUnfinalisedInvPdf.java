...
public class IpUnfinalisedInvPdf implements java.lang.Runnable {
    ...
    public void IpUnfinalisedInvPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
                        ...
                        try {
                          ...
                          //  java.sql.ResultSet rsetTotals = st21.executeQuery("SELECT sum(amount) from op_unfinalised_inv  where trans_date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            ...
                            for (int k = 0; k < listofAct1.length; k++) {
                                java.sql.ResultSet rset1 = st2.executeQuery("SELECT patient_no,sum(debit-credit) from hp_patient_card WHERE patient_no ILIKE '"+listofAct1[k].toString()+"%' and invoice_no NOT iLike 'O%' OR invoice_no NOT iLike 'I%' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by patient_no");
                                java.sql.ResultSet rset2 = st22.executeQuery("SELECT patient_name from hp_admission WHERE patient_no ILIKE '"+listofAct1[k].toString()+"%'");
   ...
   /*
    ...
    public java.lang.Object[] getListofActivities1() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT distinct patient_no from hp_patient_card where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and invoice_no NOT iLike 'O%' OR invoice_no NOT iLike 'I%'");
