...
public class NHIFDispPdf implements java.lang.Runnable {
    ...
    public void NHIFDispPdf(java.sql.Connection connDb,java.lang.String combox,java.lang.String combox1) {
               ...
               /// }
                    try {
                       ...
                       // table.endHeaders();
                        ...
                        int headerwidths[] = {15,15,30,10,15,15,15,8};
                      ...
                      //  }
                        ...
                        String Code = null;
                         ...
                         try {
                            java.sql.Statement st3 = connectDB.createStatement();
                            java.sql.ResultSet rset3 = st3.executeQuery("select code,rate from pb_nssf_rebeats");
                            while (rset3.next())
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset5 = st5.executeQuery("select account_no from ac_schemes where account_no = '"+memNo1+"'");
                        ...
                        //   java.sql.ResultSet rset1 = st1.executeQuery("select ac.date,pc.scheme_staff_no, ac.payee,ac.reference_no,sum(ac.debit),ac.admission_no from hp_patient_card pc,ac_debtors ac where pc.patient_no = ac.admission_no and ac.dealer = '"+memNo+"' and ac.dealer = pc.scheme AND ac.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and ac.debit > 0 group by ac.date,pc.scheme_staff_no, ac.payee,ac.reference_no,ac.admission_no");// UNION select pd.date::date,initcap(pd.scheme_staff_no), (sh.first_name||' '||sh.second_name||' '||sh.last_name) as name,pd.reference,sum(pd.credit),pd.patient_no from hp_patient_card pd,hp_inpatient_register sh where pd.patient_no = sh.patient_no and pd.isurer = '"+memNo+"' AND pd.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pd.credit > 0 group by pd.date::date,pd.scheme_staff_no, name,pd.reference,pd.invoice_no,pd.patient_no order by pd.invoice_no");
                           java.sql.ResultSet rset1 = st1.executeQuery("select date,journal_no, initcap(item),invoice_no ||' '||receipt_no,debit,balance-credit_bal,null as boolean from ac_debtors where dispatch_no = '"+memNo+"' and balance > 0  order by invoice_no");// UNION select pd.date::date,initcap(pd.scheme_staff_no), (sh.first_name||' '||sh.second_name||' '||sh.last_name) as name,pd.reference,sum(pd.credit),pd.patient_no from hp_patient_card pd,hp_inpatient_register sh where pd.patient_no = sh.patient_no and pd.isurer = '"+memNo+"' AND pd.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pd.credit > 0 group by pd.date::date,pd.scheme_staff_no, name,pd.reference,pd.invoice_no,pd.patient_no order by pd.invoice_no");
                          java.sql.ResultSet rsetTotals2 = st22.executeQuery("select sum(balance-credit_bal) from ac_debtors where dispatch_no = '"+memNo+"'");
                           java.sql.ResultSet rset412 = st412.executeQuery("select count(invoice_no) from ac_debtors where dispatch_no = '"+memNo+"' and balance > 0");// UNION select pd.date::date,initcap(pd.scheme_staff_no), (sh.first_name||' '||sh.second_name||' '||sh.last_name) as name,pd.reference,sum(pd.credit),pd.patient_no from hp_patient_card pd,hp_inpatient_register sh where pd.patient_no = sh.patient_no and pd.isurer = '"+memNo+"' AND pd.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pd.credit > 0 group by pd.date::date,pd.scheme_staff_no, name,pd.reference,pd.invoice_no,pd.patient_no order by pd.invoice_no");
      ...
      //                       if(docPdf.getPageNumber() == 1) {
                       ...
                       //     table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                         ...
                         */
                            ...
                            table.getDefaultCell().setColspan(8);
                              table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                            phrase = new Phrase("Invoice Dispatch Schedule", pFontHeader11);
                            table.addCell(phrase);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("PAYER REFERENCES", pFontHeader1);
                            table.addCell(phrase);
                            }
                            while (rset41.next()){
                                table.getDefaultCell().setColspan(4);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Payer Name : " +dbObject.getDBObject(rset41.getObject(1), "-"), pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Hospital Code : "+Code, pFontHeader1);
                            table.addCell(phrase);
                            }
                            while (rset5.next()){
                                table.getDefaultCell().setColspan(4);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Account No :"  +dbObject.getDBObject(rset5.getObject(1), "-"), pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Daily Rebate: "+Rate, pFontHeader1);
                            table.addCell(phrase);
                            }
                        ...
                        table.addCell(phrase);
                            ...
                            */
                            ...
                            //table.addCell(phrase);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Dispatch No. " +memNo, pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(3);
                            ...
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("Memb. No.",pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(1);
                            ...
                            //table
                             ...
                             phrase = new Phrase("Verify",pFontHeader1);
                            table.addCell(phrase);
                            ...
                            while (rset1.next()){
                                ...
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                phrase = new Phrase(dbObject.getDBObject(rset1.getObject(7), "[  ]"), pFontHeader1);
                          ...
                          //  while (rsetTotals.next()) {
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Inv. Count : " +dbObject.getDBObject(rset412.getObject(1), "-"), pFontHeader1);
                            table.addCell(phrase);
