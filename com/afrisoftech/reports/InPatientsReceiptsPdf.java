...
public class InPatientsReceiptsPdf implements java.lang.Runnable {
    ...
    public void InPatientsReceiptsPdf(java.sql.Connection connDb, java.lang.String combox,java.lang.String name, java.lang.String amount, java.lang.String receipt, java.lang.String paymode,java.lang.String cheque,java.lang.String payer) {
                ...
                try {
                    ...
                    */
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset5 = st5.executeQuery("select description,sum(debit) from ac_cash_collection where receipt_no = '"+Receipt+"' AND date::date = current_date and receipt_no = '"+Receipt+"' group by description");
                            java.sql.ResultSet rset6 = st6.executeQuery("select distinct user_name,cash_point from ac_cash_collection where receipt_no = '"+ Receipt+"' AND date = current_date");
                          ...
                          */
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Received From :  " + Payer, pFontHeader);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("In Respect Of :  "+ MNo +"   "+Name, pFontHeader);
                  ...
                  /*              table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                            ...
                            */
                            ...
                            //       table.getDefaultCell().setColspan(3);
                            //   phrase = new Phrase("Thank You. We wish you a quick recovary" , pFontHeader);
                            //  table.addCell(phrase);
                       ...
                       /* try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select cb.dealer from ac_cash_collection cb where cb.dealer = '"+MNo+"' AND cb.date::date = current_date AND cb.transaction_type = 'Receipts'");
                            ...
                            java.sql.ResultSet rs = st.executeQuery("select receipt_no,current_date from ac_cash_collection where dealer = '"+MNo+"' AND date::date = current_date");
                            java.sql.ResultSet rset5 = st5.executeQuery("select account_no,sum(debit) from ac_cash_collection where dealer = '"+MNo+"' AND transaction_type = 'Receipts' AND debit > 0  AND date::date = current_date group by account_no");
                            java.sql.ResultSet rset6 = st6.executeQuery("select payment_mode||' '||cheque_no, current_user,cash_point from ac_cash_collection where dealer = '"+MNo+"' AND transaction_type = 'Receipts' AND date::date = current_date");
                            System.out.println(MNo);
                        ...
                        */
                          /*  while (rset1.next())
                            ...
                            while (rset5.next()){
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("In Respect Of :" +rset5.getObject(1).toString(), pFontHeader);
