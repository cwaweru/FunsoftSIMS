...
public class DebtorsReceiptsPdf implements java.lang.Runnable {
    ...
    public void DebtorsReceiptsPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
                ...
                try {
                   ...
                   // double osBalance1 = 0.00;
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,10,30,10,15,10,15};
                        ...
                        Phrase phrase = new Phrase("", pFontHeader);
                            ...
                            try {
                                ...
                                phrase = new Phrase("Debtors Receipt :     Period : From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), pFontHeader);
                       ...
                       // Phrase phrase = new Phrase("Patients List As At:" +endDate, pFontHeader);
                        ...
                        phrase = new Phrase("Acc",pFontHeader);
                        table.addCell(phrase);
                      ...
                      //  table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select date,receipt_no,payee,account_no,reason,cheque_no,credit from ac_debtors WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND transaction_type ilike 'Receipts%' ORDER BY date");
