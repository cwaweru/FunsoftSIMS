...
public class StoresRevPdf implements java.lang.Runnable {
    ...
    public void StoresRevPdf(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate, java.lang.String combox) {
    ...
    public void generatePdf() {
      ...
      */
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Cash Book - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase(bank +"    Revenue Report"    +"  as at : "  +endDate, pFontHeader);
                        ...
                        phrase = new Phrase("Sales KShs.",pFontHeader);
                        table.addCell(phrase);
                       ...
                       // table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select item,units,issuing,sum(total) from st_sub_stores where total > 0 AND trans_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND store_name = '"+bank+"' group by item,units,issuing order by item");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                            
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(total) from st_sub_stores WHERE trans_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND store_name = '"+bank+"'");
