...
public class TransPerAccountPdf implements java.lang.Runnable {
    ...
    public void TransPerAccountPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String combox) {
    ...
    public void generatePdf() {
      ...
      */
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Transaction Per Acc. - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,8,20,15,10,9,13,13};
                       ...
                       phrase = new Phrase("Date",pFontHeader);
                        table.addCell(phrase);
                        phrase = new Phrase("Trans. Nno",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select date,transaction_no,initcap(payee),initcap(reason),voucher_no,cheque_no,debit,credit from ac_ledger WHERE date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND activity_code = '"+bank+"' order by date");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                            
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT sum(debit),SUM(credit) from ac_ledger WHERE date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND activity_code = '"+bank+"'");
