...
public class BookingsListPdf implements java.lang.Runnable {
    ...
    public void BookingsListPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,20,30,25,10};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Bookings List :     Period : "  +dateFormat.format(endDate11)+"' ------ '"+dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select booking_date::date,booking_no,initcap(name),service,quantity from pb_bookings WHERE booking_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by booking_date::date");
