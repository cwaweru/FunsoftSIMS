...
public class ProvPerDebtorPdf implements java.lang.Runnable {
    ...
    public void ProvPerDebtorPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                  ...
                  */
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Provisioned Invoices)  Form - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,10,20,10,13,13,13};
                        ...
                        try {
                           ...
                           // java.sql.ResultSet rset41 = st41.executeQuery("select scheme from hp_patient_card where scheme = '"+listofStaffNos+"'");
                            ...
                            table.getDefaultCell().setBorderWidth(Rectangle.TOP | Rectangle.BOTTOM);
                                ...
                                phrase = new Phrase("Submission (Provisioned Invoices) Form", pFontHeader1);
                                table.addCell(phrase);
...
//                                while (rset41.next())
                              ...
                              //  table.getDefaultCell().setColspan(3);
                               ...
                               // table.getDefaultCell().setColspan(2);
                                ...
                                table.addCell(phrase);
                                phrase = new Phrase("Provision",pFontHeader1);
                                table.addCell(phrase);
                                java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit),sum(balance),sum(prov_amt) from ac_debtors where dealer = '"+memNo+"' AND prov_date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND provision = true");
                               //double OsBalance = 0.00;
                             for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select db.date,journal_no, upper(db.item),db.invoice_no,debit,db.balance,prov_amt from ac_debtors db where  db.payee = '"+listofStaffNos[j]+"' AND db.dealer = '"+memNo+"' AND db.prov_date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND provision = true order by db.date");
                                ...
                                while (rset1.next()){
                                   ...
                                   // table.getDefaultCell().setColspan(2);
                                    ...
                                    OsBalance2 = OsBalance2 + rset1.getDouble(6);
                                    table.addCell(phrase);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT payee FROM ac_debtors WHERE prov_date BETWEEN '"+beginDate+"' AND '"+endDate+"' and dealer = '"+memNo+"' and provision = true order by payee");
