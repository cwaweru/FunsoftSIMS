...
public class PostdatedChqsPdf implements java.lang.Runnable {
    ...
    public void PostdatedChqsPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Cancelled Cheques - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,10,15,20,20,15};
                        ...
                        Phrase phrase = new Phrase("Postdated Cheques : ", com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,10));
                        ...
                        try {
                          ...
                          //  java.sql.ResultSet rsetTotals = st21.executeQuery("SELECT sum(amount) from patient_bill where date_prescribed BETWEEN '"+beginDate+"' AND '"+endDate+"' and amount < 0");
                            ...
                            for (int k = 0; k < listofAct1.length; k++) {
                                java.sql.ResultSet rset1 = st2.executeQuery("SELECT chq_date,voucher_no,cheque_no,dealer,description,credit from ac_cash_book where bank_name  ILIKE '"+listofAct1[k].toString()+"%' and chq_date > date order by chq_date");
                                table.getDefaultCell().setColspan(1);
    ...
    public java.lang.Object[] getListofActivities1() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT distinct upper(bank_name) from ac_cash_book where chq_date > date  order by upper(bank_name)");
