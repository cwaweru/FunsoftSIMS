...
public class DebtorsAnualSummaryPdf implements java.lang.Runnable {
    ...
    public void DebtorsAnualSummaryPdf(java.sql.Connection connDb) {
                    ...
                    try {
                       ...
                       table.getDefaultCell().setBorder(Rectangle.BOTTOM);
                        ...
                        try {
                           ...
                           java.sql.ResultSet rset1 = st1.executeQuery("select sum(debit),sum(balance-credit_bal) from ac_debtors where date between '2004-01-01' and '2004-06-30'");
                              java.sql.ResultSet rset2 = st2.executeQuery("select sum(debit),sum(balance-credit_bal) from ac_debtors where date between '2003-01-01' and '2003-12-31'");
                            java.sql.ResultSet rset3 = st3.executeQuery("select sum(debit),sum(balance-credit_bal) from ac_debtors where date between '2002-01-01' and '2002-12-31'");
                            java.sql.ResultSet rset4 = st4.executeQuery("select sum(debit),sum(balance-credit_bal) from ac_debtors where date between '2001-01-01' and '2001-12-31'");
                               java.sql.ResultSet rset5 = st5.executeQuery("select sum(debit),sum(balance-credit_bal) from ac_debtors where date between '2000-01-01' and '2000-12-31'");// UNION select pd.date::date,initcap(pd.scheme_staff_no), (sh.first_name||' '||sh.second_name||' '||sh.last_name) as name,pd.reference,sum(pd.credit),pd.patient_no from hp_patient_card pd,hp_inpatient_register sh where pd.patient_no = sh.patient_no and pd.isurer = '"+memNo+"' AND pd.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pd.credit > 0 group by pd.date::date,pd.scheme_staff_no, name,pd.reference,pd.invoice_no,pd.patient_no order by pd.invoice_no");
                            java.sql.ResultSet rset6 = st6.executeQuery("select sum(debit),sum(balance-credit_bal) from ac_debtors where date between '1999-01-01' and '1999-12-31'");// UNION select pd.date::date,initcap(pd.scheme_staff_no), (sh.first_name||' '||sh.second_name||' '||sh.last_name) as name,pd.reference,sum(pd.credit),pd.patient_no from hp_patient_card pd,hp_inpatient_register sh where pd.patient_no = sh.patient_no and pd.isurer = '"+memNo+"' AND pd.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pd.credit > 0 group by pd.date::date,pd.scheme_staff_no, name,pd.reference,pd.invoice_no,pd.patient_no order by pd.invoice_no");
                            java.sql.ResultSet rset7 = st7.executeQuery("select sum(debit),sum(balance-credit_bal) from ac_debtors where date between '1998-01-01' and '1998-12-31'");
                            ...
                            //java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(amount),sum(amount_alloc) from db_allocation where acc_no = '"+memNo+"' AND date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and acc_no = '"+memNo+"'");
                            ...
                            phrase = new Phrase("Annual Debtors Summary Report", pFontHeader11);
                            table.addCell(phrase);
                           ...
                           */
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase(" Date Printed " +date, pFontHeader1);
                            table.addCell(phrase);
                             table.getDefaultCell().setBorderColor(java.awt.Color.BLACK);
                          ...
                          //  table.getDefaultCell().setBorderColor(java.awt.Color.BLACK);
                            ...
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("Year",pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(1);
                            ...
                            table.addCell(phrase);
                             phrase = new Phrase("Accummulative Bal. ",pFontHeader1);
                            table.addCell(phrase);
                          ...
                          /*   while (rsetTotals2.next())
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                table.getDefaultCell().setColspan(4);
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rsetTotals2.getString(2)),pFontHeader1);
                                osBalancebf = osBalancebf + rsetTotals2.getDouble(2);
                                table.addCell(phrase);
                           ...
                           */
                            ...
                            while (rset1.next()){
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("2004(June)", pFontHeader);
                               ...
                               // osBalance1 = osBalance1 + rset1.getDouble(5);
                                ...
                                osBalanceb1 = osBalanceb1 + rset1.getDouble(2);
                              ...
                              phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalanceb1)),pFontHeader);
                               // osBalance1 = osBalance1 + rset1.getDouble(5);
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("2003", pFontHeader);
                               ...
                               // osBalance1 = osBalance1 + rset1.getDouble(5);
                                table.addCell(phrase);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset2.getString(2)),pFontHeader);
                                osBalanceb1 = osBalanceb1 + rset2.getDouble(2);
                               // osBalancebf = osBalance1;
                                table.addCell(phrase);
                              phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalanceb1)),pFontHeader);
                               // osBalance1 = osBalance1 + rset1.getDouble(5);
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("2002", pFontHeader);
                               ...
                               phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset3.getString(1)),pFontHeader);
                               // osBalance1 = osBalance1 + rset1.getDouble(5);
                                table.addCell(phrase);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset3.getString(2)),pFontHeader);
                                osBalanceb1 = osBalanceb1 + rset3.getDouble(2);
                               // osBalancebf = osBalance1;
                                table.addCell(phrase);
                              phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalanceb1)),pFontHeader);
                               // osBalance1 = osBalance1 + rset1.getDouble(5);
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("2001", pFontHeader);
                              ...
                              phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset4.getString(1)),pFontHeader);
                               // osBalance1 = osBalance1 + rset1.getDouble(5);
                                table.addCell(phrase); 
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset4.getString(2)),pFontHeader);
                                osBalanceb1 = osBalanceb1 + rset4.getDouble(2);
                               // osBalancebf = osBalance1;
                                table.addCell(phrase);
                              phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalanceb1)),pFontHeader);
                               // osBalance1 = osBalance1 + rset1.getDouble(5);
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("2000", pFontHeader);
                               ...
                               // osBalance1 = osBalance1 + rset1.getDouble(5);
                                table.addCell(phrase);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset5.getString(2)),pFontHeader);
                                osBalanceb1 = osBalanceb1 + rset5.getDouble(2);
                               // osBalancebf = osBalance1;
                                table.addCell(phrase);
                              phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalanceb1)),pFontHeader);
                               // osBalance1 = osBalance1 + rset1.getDouble(5);
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("1999", pFontHeader);
                               ...
                               // osBalance1 = osBalance1 + rset1.getDouble(5);
                                ...
                                osBalanceb1 = osBalanceb1 + rset6.getDouble(2);
                               // osBalancebf = osBalance1;
                                table.addCell(phrase);
                              phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalanceb1)),pFontHeader);
                               // osBalance1 = osBalance1 + rset1.getDouble(5);
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("1998", pFontHeader);
                               ...
                               // osBalance1 = osBalance1 + rset1.getDouble(5);
                                table.addCell(phrase);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset7.getString(2)),pFontHeader);
                                osBalanceb1 = osBalanceb1 + rset7.getDouble(2);
                               // osBalancebf = osBalance1;
                                table.addCell(phrase);
                              phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalanceb1)),pFontHeader);
                               // osBalance1 = osBalance1 + rset1.getDouble(5);
