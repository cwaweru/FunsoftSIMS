...
public class DocPaidupPerDebtorPdf implements java.lang.Runnable {
    ...
    public void DocPaidupPerDebtorPdf(java.sql.Connection connDb,java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                  ...
                  */
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("PaidUp Invoices Report - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                        ...
                        try {
                           ...
                           // java.sql.ResultSet rset41 = st41.executeQuery("select scheme from hp_patient_card where scheme = '"+listofStaffNos+"'");
                            ...
                            table.getDefaultCell().setBorderWidth(Rectangle.TOP | Rectangle.BOTTOM);
                                ...
                                phrase = new Phrase("Doctors Paidup Inv. Per Payer", pFontHeader1);
                                table.addCell(phrase);
...
//                                while (rset41.next())
                              ...
                              //  table.getDefaultCell().setColspan(3);
                                ...
                                java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(credit_bal) from doc_paidupscm_view where acc_no = '"+memNo+"'");
                               //double OsBalance = 0.00;
                             for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select input_date, upper(name),pat_inv,credit_bal from doc_paidupscm_view where  debtor = '"+listofStaffNos[j]+"' AND acc_no = '"+memNo+"' order by input_date");
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT debtor FROM doc_paidupscm_view WHERE acc_no = '"+memNo+"' order by debtor");
