...
public class QuarterlyRevPdf1 implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    public void QuarterlyRevPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
        ...
        ageingSeries = new com.afrisoftech.timeseries.QuarterAgeing(4, endate);
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {35,13,13,13,13,15};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Quarterly Revenue as at " +dateFormat.format(endDate2), pFontHeader2);
                        ...
                        for (int x = 0; x < rangeDates.length; x++) {
                            org.jfree.data.time.Quarter regularYears = new org.jfree.data.time.Quarter((java.util.Date)rangeDates[x][1]);
                            ...
                            //  } else {
                            phrase = new Phrase(regularYears.toString(),pFontHeader);
                            interval = x;
                            //}
