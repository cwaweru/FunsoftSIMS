...
public class AllocPerDebtPdf implements java.lang.Runnable {
    ...
    public void AllocPerDebtPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox) {
                ...
                */
                  ...
                  */
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,13,13,13,13,15,15,10};
                        ...
                        try {
                           ...
                           // java.sql.ResultSet rset3 = st3.executeQuery("select hospital_name,postal_code||' '||box_no||' '||town,main_telno||' '||other_telno,initcap(street),main_faxno,email,website,room_no from pb_hospitalprofile");
                            ...
                            //java.sql.ResultSet rset4 = st4.executeQuery("select scheme_manager,account_no from ac_scheme_providers where scheme_manager ilike '"+memNo+"'");
                            ...
                            // java.sql.ResultSet rsetTotals2 = st22.executeQuery("select sum(balance -credit_bal) from ac_debtors where dealer = '"+memNo+"' AND date::date < '"+beginDate+"'");
                            
                           // java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(balance -credit_bal) from ac_debtors where dealer ilike '"+memNo+"' AND date::date <= '"+endDate+"'");
                            
                            table.getDefaultCell().setColspan(8);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                            phrase = new Phrase(memNo+ " Allocation Detailed", pFontHeader1);
                           table.addCell(phrase);
                           ...
                           */
                            ...
                            for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select db.date,db.cheque_no,db.amount,db.inv_no,db.inv_date,ac.debit,db.amount_alloc,ac.debit-db.amount_alloc from db_allocation db,ac_debtors ac where acc_no = '"+listofStaffNos[j]+"'  AND db.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and db.inv_no = ac.invoice_no order by db.date");// UNION select pd.date::date,initcap(pd.scheme_staff_no), (sh.first_name||' '||sh.second_name||' '||sh.last_name) as name,pd.reference,sum(pd.credit),pd.patient_no from hp_patient_card pd,hp_inpatient_register sh where pd.patient_no = sh.patient_no and pd.isurer = '"+memNo+"' AND pd.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pd.credit > 0 group by pd.date::date,pd.scheme_staff_no, name,pd.reference,pd.invoice_no,pd.patient_no order by pd.invoice_no");
                                //java.sql.ResultSet rsetTotals2 = st22.executeQuery("select sum(balance -credit_bal) from ac_debtors where dealer = '"+memNo+"' AND date::date <= '"+beginDate+"' and payee = '"+listofStaffNos[j]+"'");
                                ...
                                // java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit),sum(credit) from ac_debtors where dealer = '"+memNo+"' AND date::date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                              ...
                              //  table.getDefaultCell().setBorder(Rectangle.BOTTOM);
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(Debit2)),pFontHeadert);
                                ...
                                table.addCell(phrase);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(Debit3)),pFontHeadert);
                           ...
                           table.getDefaultCell().setBorder(Rectangle.BOTTOM | Rectangle.TOP);
                            ...
                            //while (rsetTotals.next()) {
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                  phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(Debit21)),pFontHeadert);
                                
                                table.addCell(phrase);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(Debit1)),pFontHeadert);
                                
                                table.addCell(phrase);
                                  phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(Debit31)),pFontHeadert);
                                ...
                                table.addCell(phrase);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(CreditBal)),pFontHeadert);
                                
                                table.addCell(phrase);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(DebitBal)),pFontHeadert);
                                
                                table.addCell(phrase);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rsetTotals.getString(1)),pFontHeadert);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            // java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT patient_no FROM hp_patient_card WHERE date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND payment_mode = 'Scheme' AND isurer = '"+memNo+"' order by patient_no");
               java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT db.acc_no FROM db_allocation db, ac_schemes ac WHERE db.date BETWEEN '"+beginDate+"' AND '"+endDate+"' and ac.payer_name ilike '"+memNo+"' and db.acc_no=ac.account_no order by db.acc_no");
     ...
     /*       public java.lang.Object[] getListofActivities() {
        ...
        try {
           ...
           // java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT dealer FROM ac_debtors where date BETWEEN ? AND ? and dealer IS NOT NULL order by dealer");
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT db.acc_no FROM db_allocation db, ac_schemes ac WHERE db.date BETWEEN '"+beginDate+"' AND '"+endDate+"' and ac.payer_name ilike '"+memNo+"' and db.acc_no=ac.account_no order by db.acc_no");
