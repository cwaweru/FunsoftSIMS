                    ...
                    try {
                       ...
                       // table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select cb.dealer,cb.account_no from ac_cash_collection cb where cb.receipt_no = '"+MNo+"' AND cb.transaction_type = 'Receipts'");
