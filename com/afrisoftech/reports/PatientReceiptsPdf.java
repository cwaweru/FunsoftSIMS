...
public class PatientReceiptsPdf implements java.lang.Runnable {
   ...
   // java.lang.String beginDate = null;
    ...
    public void PatientReceiptsPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,10,10,30,13,15,13};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Patient Receipts List :     Period : "  +dateFormat.format(endDate11)+" ------ "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select * from receipts_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY date");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(amount) from receipts_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
