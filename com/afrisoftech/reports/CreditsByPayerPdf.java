...
public class CreditsByPayerPdf implements java.lang.Runnable {
    ...
    public void CreditsByPayerPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                  ...
                  */
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Submission (Undispatched Invoices) Form - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                       ...
                       // double OsBalance = 0.00;
                        ...
                        try {
                           ...
                           // java.sql.ResultSet rset41 = st41.executeQuery("select scheme from hp_patient_card where scheme = '"+listofStaffNos+"'");
                                ...
                                phrase = new Phrase("Submission (Undispatched Invoices)Form", pFontHeader1);
                                table.addCell(phrase);
...
//                                while (rset41.next())
                                ...
                                table.addCell(phrase);
                                java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(credit_bal) from ac_debtors where dealer = '"+memNo+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                               //double OsBalance = 0.00;
                             for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select db.date,db.receipt_no, upper(db.item),db.credit,credit_bal from ac_debtors db where db.account_no = '"+listofStaffNos[j]+"' AND db.dealer = '"+memNo+"' AND db.date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND db.credit_bal != 0  order by db.date");
                                  
                                 java.sql.ResultSet rset3 = st3.executeQuery("select scheme_name from ac_schemes where account_no = '"+listofStaffNos[j]+"'");
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
           ...
           // java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT payee FROM ac_debtors WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and dealer = '"+memNo+"' and credit_bal !=0 order by payee");
          //    java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT account_no FROM ac_schemes WHERE payer_name = '"+memNo+"'  order by account_no");
          java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT ac.account_no FROM ac_schemes ac,ac_debtors db WHERE ac.payer_name ilike  '"+memNo+"' and db.credit_bal !=0 and ac.account_no = db.account_no order by ac.account_no");
            while (rSet1.next()) {
