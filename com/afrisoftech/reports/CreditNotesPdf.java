...
public class CreditNotesPdf implements java.lang.Runnable {
    ...
    public void CreditNotesPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Credit Notes - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    
                    docPdf.setFooter(footer);
                    
                    
                    docPdf.open();
                    double osBalancebf = 0;
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,10,18,25,15};
                        ...
                        Phrase phrase = new Phrase("Credit Notes : ", com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,10));
                        ...
                        try {
                            ...
                            phrase = new Phrase("From :" +dateFormat.format(endDate1)+ "To : " +dateFormat.format(endDate2) , pFontHeader);
                        ...
                        phrase = new Phrase("Descr", pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetTotals = st21.executeQuery("SELECT sum(amount) from patient_bill where date_prescribed BETWEEN '"+beginDate+"' AND '"+endDate+"' and amount < 0");
                            ...
                            for (int k = 0; k < listofAct1.length; k++) {
                                java.sql.ResultSet rset1 = st2.executeQuery("SELECT date_prescribed,patient_no,initcap(patient_name),initcap(description),((amount)*-1) from patient_bill where date_prescribed BETWEEN '"+beginDate+"' AND '"+endDate+"' and main_service ILIKE '"+listofAct1[k].toString()+"%' and amount < 0 order by date_prescribed");
                                table.getDefaultCell().setColspan(1);
                                ...
                                while (rset1.next()) {
                                    ...
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    //phrase = new Phrase(rset1.getString(4),pFontNum);
   ...
   /*
    ...
    public java.lang.Object[] getListofActivities1() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT distinct upper(main_service) from patient_bill where main_service != '' and date_prescribed BETWEEN '"+beginDate+"' AND '"+endDate+"' and amount < 0 order by upper(main_service)");
