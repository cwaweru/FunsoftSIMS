...
public class ExcLimitActScmPdf implements java.lang.Runnable {
    ...
    public void ExcLimitActScmPdf(java.sql.Connection connDb) {
    ...
    public void generatePdf() {
        ...
        try {
          ...
          // com.lowagie.text.Document docPdf = new com.lowagie.text.Document(PageSize.A4.rotate());
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Active Schemes With Limits Exceeded List - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Active Schemes With Limits Exceeded : ", com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,10));
                            ...
                            //  System.out.println(listofAct.length);
                             java.sql.Statement st2 = connectDB.createStatement();
                                 ...
                                 //for (int k = 0; k < listofAct1.length; k++) {
                                     ...
                                     java.sql.ResultSet rset1 = st2.executeQuery("SELECT sl.scheme_name,sl.account_no,sl.payer_name,sl.expiry_date,ac.scheme_limit,sl.balance,(ac.scheme_limit-sl.balance)*-1 from scheme_limit_view sl,ac_schemes ac where balance > ac.scheme_limit and ac.closed = false and ac.suspended=false and sl.account_no= ac.account_no order by sl.scheme_name");
