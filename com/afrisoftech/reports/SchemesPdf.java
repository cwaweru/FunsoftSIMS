...
public class SchemesPdf implements java.lang.Runnable {
    ...
    public void SchemesPdf(java.sql.Connection connDb) {
        ...
        try {
          ...
          // com.lowagie.text.Document docPdf = new com.lowagie.text.Document(PageSize.A4.rotate());
                    ...
                    try {
                        ...
                        int headerwidths[] = {20,5,10,10,10,10,10,10,20};
                        ...
                        Phrase phrase = new Phrase("Schemes : ", com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,10));
