...
public class DoctorsLedgerPdf implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    public void DoctorsLedgerPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        com.lowagie.text.pdf.PdfPTable table = new com.lowagie.text.pdf.PdfPTable(ageingDates.length+4);
                        ...
                        try {
                            ...
                            phrase = new Phrase("Doctors Ledger as at " +dateFormat.format(endDate2), pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.PreparedStatement pSeta1 = connectDB.prepareStatement("SELECT count(acc_no) FROM ac_doctors_ledger where  acc_no = '"+listofAct[i]+"' and debit_bal > 0");
                                java.sql.PreparedStatement pset22 = connectDB.prepareStatement("select distinct staff_no||' '||first_name||' '||middle_name from pb_doctors_list WHERE staff_no = ? ");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                ...
                                if (name > 0){
                                    ...
                                    java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(credit_bal) from ac_doctors_ledger WHERE acc_no = ?  AND input_date < '"+ageingDates[0][0]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    pset1.setString(1,listofAct[i].toString());
                                    java.sql.ResultSet rset1 = pset1.executeQuery();
                                    
                                    java.sql.PreparedStatement pset111 = connectDB.prepareStatement("select sum(credit_bal-debit_bal) from ac_doctors_ledger WHERE acc_no = ?  AND input_date < '"+endDate+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    ...
                                    java.sql.PreparedStatement pset112 = connectDB.prepareStatement("select sum(debit_bal) from ac_doctors_ledger WHERE acc_no = ? AND input_date < '"+endDate+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    ...
                                    for (int t = ageingDates.length - 1; t >= 0; t--) {
                                        ...
                                        java.sql.PreparedStatement pset = connectDB.prepareStatement("select sum(credit_bal) from ac_doctors_ledger WHERE acc_no = ?  AND input_date between '"+ageingDates[t][0]+"' AND '"+ageingDates[t][1]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                   ...
                                   //  java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(debit_bal) from ac_doctors_ledger WHERE acc_no = ?  AND date < '"+ageingDates[ageingDates.length - 1][0]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    ...
                                    java.sql.PreparedStatement pset112 = connectDB.prepareStatement("select sum(debit_bal) from ac_doctors_ledger WHERE acc_no = ? AND input_date < '"+endDate+"'");
                                    pset112.setString(1,listofAct[i].toString());
                                    java.sql.ResultSet rset112 = pset112.executeQuery();
                                   ...
                                   // for (int t = 0; t < ageingDates.length; t++) {
                                        ...
                                        java.sql.PreparedStatement pset = connectDB.prepareStatement("select sum(credit_bal) from ac_doctors_ledger WHERE acc_no = ?  AND input_date between '"+ageingDates[t][0]+"' AND '"+ageingDates[t][1]+"'");
                                        pset.setString(1,listofAct[i].toString().toUpperCase());
                                        java.sql.ResultSet rset = pset.executeQuery();
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            // java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT dealer FROM ac_doctors_ledger where date BETWEEN ? AND ? and dealer IS NOT NULL order by dealer");
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT acc_no FROM ac_doctors_ledger where (acc_no IS NOT NULL OR acc_no !='') and debit_bal > 0 order by acc_no");
            
            // pSet1.setString(1,beginDate.toString());
            // pSet1.setString(2,endDate.toString());
            
            // java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT dealer FROM ac_doctors_ledger where date BETWEEN '1-2-2003' AND '11-12-2003' and dealer IS NOT NULL order by dealer");
