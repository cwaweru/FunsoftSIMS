...
public class YearlyRevPdf1 implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    public void YearlyRevPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Yearly Revenue as at " +dateFormat.format(endDate2), pFontHeader);
                        ...
                        phrase = new Phrase("+ "+((interval + 1) * 1)+" Year",pFontHeader);
