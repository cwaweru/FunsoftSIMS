...
public class SchmAccStatusPdf implements java.lang.Runnable {
    ...
    public void SchmAccStatusPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Accounts Status - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,40,10,10,10,15};
                        ...
                        Phrase phrase = new Phrase("Accounts(Schemes) Cover-Status", pFontHeader);
