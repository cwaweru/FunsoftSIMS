                    ...
                    try {
                        ...
                        for (int j = 0; j < listofStaffNos.length; j++) {
                            ...
                            try {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where invoice_no = '"+listofStaffNos[j]+"' AND paid = true and credit != 0.00 ");
                          ...
                          */
                                ...
                                table.addCell(phrase);
                               /* if(rset311.getBoolean(1) == false){
                                    table.getDefaultCell().setColspan(3);
                                    while (rset31.next())
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                               phrase = new Phrase("Payer Name: "+dbObject.getDBObject(rset31.getObject(1), "-"), pFontHeader1);
                                table.addCell(phrase);
                                */
                                // }else{
                                while (rset4.next())
