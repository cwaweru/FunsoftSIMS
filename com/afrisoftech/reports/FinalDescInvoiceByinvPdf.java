...
public class FinalDescInvoiceByinvPdf implements java.lang.Runnable {
                        ...
                        for (int j = 0; j < listofStaffNos.length; j++) {
                            ...
                            try {
                                ...
                                for (int k = 0; k < listofStaffNos1.length; k++) {
                                    ...
                                    java.sql.ResultSet rset1 = st1.executeQuery("select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where invoice_no = '"+listofStaffNos[j]+"' AND paid = true and credit != 0.00 AND main_service ilike '"+listofStaffNos1[k]+"' AND reference NOT ILIKE 'C%'");
    ...
    public java.lang.Object[] getListofStaffNos1(java.lang.Object InvoiceNo) {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT distinct upper(main_service) FROM hp_patient_card WHERE invoice_no = '"+InvoiceNo+"' and debit > 0 and main_service is not null order by upper(main_service)");
