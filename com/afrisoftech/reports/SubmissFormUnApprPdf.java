...
public class SubmissFormUnApprPdf implements java.lang.Runnable {
    ...
    public void SubmissFormUnApprPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox) {
...
//                                while (rset41.next())
                                ...
                                table.addCell(phrase);
                                java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit) from ac_debtors where dealer = '"+memNo+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND sent = false");
                               //double OsBalance = 0.00;
                             for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select db.date,db.journal_no, upper(db.item),db.invoice_no,db.debit from ac_debtors db where  db.payee = '"+listofStaffNos[j]+"' AND db.dealer = '"+memNo+"' AND db.date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND db.debit != 0  AND sent = false order by db.date");
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT payee FROM ac_debtors WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and dealer = '"+memNo+"' and sent = false and debit >0 order by payee");
