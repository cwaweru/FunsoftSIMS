...
public class FinalInvoiceCopyPdf implements java.lang.Runnable {
    ...
    public void FinalInvoiceCopyPdf(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate) {
                    ...
                    try {
                        ...
                        for (int j = 0; j < listofStaffNos.length; j++) {
                            ...
                            try {
                                ...
                                java.sql.ResultSet rset4 = st4.executeQuery("select scheme_manager,postal_code||' '||address,tel_main||' '||other_tel,main_fax from ac_scheme_providers");
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select date::date,initcap(service) as service,dosage,reference,debit-credit,invoice_no,date::date from hp_patient_card where patient_no = '"+listofStaffNos[j]+"' AND date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND transaction_no IS NOT NULL order by date::date");
                                java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(credit) from hp_patient_card where patient_no = '"+listofStaffNos[j]+"' AND date::date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                           //     java.sql.ResultSet rset11 = st11.executeQuery("select invoice_no,date::date from hp_patient_card where patient_no = '"+listofStaffNos[j]+"' AND date::date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT patient_no FROM hp_patient_card order by patient_no");
