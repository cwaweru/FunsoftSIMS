...
public class BookingsListAttPdf implements java.lang.Runnable {
    ...
    public void BookingsListAttPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                       ...
                       int headerwidths[] = {12,8,20,20,12,8};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Bookings List Confirmed:     Period : "  +dateFormat.format(endDate11)+" ------ "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        phrase = new Phrase("Booking No.",pFontHeader);
                        table.addCell(phrase);
                        ...
                        table.addCell(phrase);
                         phrase = new Phrase("Pat.Tel",pFontHeader);
                        table.addCell(phrase);
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select booking_date::date,booking_no,initcap(name),initcap(service),initcap(status),tel from pb_bookings WHERE att_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and confirmation = true order by booking_date::date");
