...
public class DebtorsAllocSummPdf implements java.lang.Runnable {
    ...
    public void DebtorsAllocSummPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
        //MNo = combox;
    ...
    public void generatePdf(java.lang.String memNo) {
        ...
        try {
            ...
            try {
                ...
                try {
                  ...
                  */
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Receipt Alloc Summary (Debtors)- Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
              ...
              double Gross = 0.00;      
                    try {
                        ...
                        table.getDefaultCell().setBorderColor(java.awt.Color.BLACK);
                            ...
                            phrase = new Phrase("Invoice Allocation Summary Per Debtor", pFontHeader1);
                            table.addCell(phrase);
                           ...
                           */
                           ...
                           phrase = new Phrase("Acc No.",pFontHeader1);
                            ...
                            phrase = new Phrase("Un Alloc.",pFontHeader1);
                            table.addCell(phrase);
                            
                            phrase = new Phrase("Allocated",pFontHeader1);
                            table.addCell(phrase);
                            phrase = new Phrase("Alloc%.",pFontHeader1);
                            table.addCell(phrase);
                           /*
                          ...
                          java.sql.ResultSet rset12 = st12.executeQuery("select count(receipt_no),sum(credit) ,sum(credit_bal),sum(credit-credit_bal) ,sum(credit-credit_bal)*100/sum(credit)from ac_debtors where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and dealer = '"+listofAct[i]+"'");
                           ...
                           */
                           ...
                           // while (rsetTotals2.next()) {
                               ...
                               table.getDefaultCell().setBorderColor(java.awt.Color.white);
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Un Allocated Percentage : " + new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance1*100/osBalance)),pFontHeader11);
                                
                                table.addCell(phrase);
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Allocated Percentage : " + new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance2*100/osBalance)),pFontHeader11);
        ...
        try {
           ...
           // java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT dealer FROM ac_debtors where date BETWEEN ? AND ? and dealer IS NOT NULL order by dealer");
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT dealer FROM ac_debtors where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and dealer !='' and credit >0 and receipt_no is not null and receipt_no !='' order by dealer");
