...
public class PayerAgeingAPdf implements java.lang.Runnable {
        ...
        try {
            ...
            try {
                ...
                try {
                   ...
                   */
                        int headerwidths[] = {22,13,13,13,13,13,13};//,13,13};
                     ...
                     */
                        ...
                        try {
                            ...
                            phrase = new Phrase(Debtor +" Ageing From : " +dateFormat.format(endDate1) +" To: " +dateFormat.format(endDate2), pFontHeader);
                       ...
                       // phrase = new Phrase("AccNo",pFontHeader);
                        //table.addCell(phrase);
                            ...
                            double TotalCount = 0.00;   
                             ...
                             //   table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                               ...
                               table.getDefaultCell().setColspan(1);
                                ...
                                table.addCell(phrase);
                                java.sql.PreparedStatement pset10 = connectDB.prepareStatement("select distinct payee from ac_debtors WHERE account_no = ?");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                               ...
                               while (rset10.next())
                                ...
                                java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(balance) from ac_debtors WHERE account_no = ? and dealer = '"+Debtor+"'  AND date < '"+beginDate+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                ...
                                for (int t = 0; t < rangeDates.length; t++) {
                                    ...
                                    java.sql.PreparedStatement pset = connectDB.prepareStatement("select sum(balance) from ac_debtors WHERE account_no = ? and dealer = '"+Debtor+"' AND date between '"+rangeDates[t][1]+"' AND '"+rangeDates[t][0]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
  ...
  */
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT account_no ,payee FROM ac_debtors where dealer = '"+Debtor+"' and account_no IS NOT NULL and account_no != '' and balance !=0 order by payee");
