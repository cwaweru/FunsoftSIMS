...
public class PatientStatementPdf implements java.lang.Runnable {
    ...
    public void PatientStatementPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String combox) {
        MNo = combox;
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select initcap(service) as service,sum(credit),sum(debit - credit) as balance from hp_patient_card where patient_no = '"+memNo+"' AND date:: BETWEEN '"+beginDate+"' AND '"+endDate+"' AND reference IS NOT NULL group by service");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(credit),sum(debit - credit) from hp_patient_card where patient_no = '"+memNo+"' AND date::date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
