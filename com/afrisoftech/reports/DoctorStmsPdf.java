...
public class DoctorStmsPdf implements java.lang.Runnable {
        ...
        try {
            ...
            double osBalancebf = 0.00;
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,30,10,20,8,10,10,15};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select input_date::date,patient_no||''||patient_name,description,debit,credit_bal,pat_inv,debit_bal from ac_doctors_ledger where acc_no = '"+memNo+"' order by input_date::date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(credit_bal) from ac_doctors_ledger where acc_no = '"+memNo+"'");
                            ...
                            while (rset3.next())
                                ...
                                phrase = new Phrase(dbObject.getDBObject(rset3.getObject(1), "-"), pFontHeader11);
                                table.addCell(phrase);
                            ...
                            while (rset.next()) 
                                ...
                                table.getDefaultCell().setColspan(4);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Acc. No.  "+memNo, pFontHeader);
                                table.addCell(phrase);
                                
                                
                                table.getDefaultCell().setColspan(4);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Doctor's Name : "+dbObject.getDBObject(rset.getObject(2), "-"), pFontHeader);
                                table.addCell(phrase);
                                ...
                                table.getDefaultCell().setColspan(3);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Residence: "+dbObject.getDBObject(rset.getObject(4), "-"), pFontHeader);
                                table.addCell(phrase);
                                table.getDefaultCell().setColspan(2);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                           ...
                           // table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                            ...
                            while (rset1.next()){
                                ...
                                table.addCell(phrase);
                                osBalancebf = osBalancebf + rset1.getDouble(7);
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
