...
public class DispatchPerPayerPdf implements java.lang.Runnable {
    ...
    public void DispatchPerPayerPdf(java.sql.Connection connDb,java.lang.String combox,java.lang.String combox1) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetTotals2 = st22.executeQuery("select sum(debit) from ac_debtors where dispatch_no = '"+memNo+"'");
                            ...
                            java.sql.ResultSet rset41 = st41.executeQuery("select distinct Dealer from ac_debtors where dispatch_no = '"+memNo+"'");
                            ...
                            for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                java.sql.ResultSet rset4 = st4.executeQuery("select distinct account_no||' '||payee from ac_debtors where account_no = '"+listofStaffNos[j]+"'");
                                java.sql.ResultSet rset1 = st1.executeQuery("select date,admission_no, initcap(item),invoice_no ||' '||receipt_no,debit,debit,null as boolean from ac_debtors where dispatch_no = '"+memNo+"' and debit > 0 AND account_no = '"+listofStaffNos[j]+"' order by date");
                                java.sql.ResultSet rset412 = st412.executeQuery("select count(invoice_no) from ac_debtors where dispatch_no = '"+memNo+"' and debit > 0 AND account_no = '"+listofStaffNos[j]+"'");
                                ...
                                while (rset1.next()){
                                    ...
                                    grandTotal = grandTotal + rset1.getDouble(6);
                                ...
                                while (rset412.next()){
                                    ...
                                    table.addCell(phrase);
                                    invoiceCount = invoiceCount + rset412.getInt(1);
                                }
                                table.getDefaultCell().setColspan(1);
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Invoices : " +invoiceCount, pFontHeader1);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(grandTotal)),pFontHeader1);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT account_no,payee FROM ac_debtors WHERE dispatch_no = '"+memNo+"' ORDER BY payee");
        ...
        System.out.println("Done list of Staff Nos ... [ "+listofStaffNos+" ]");
