...
public class CashBookListPdf implements java.lang.Runnable {
    ...
    public void CashBookListPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date enddate, java.lang.String combox) {
    ...
    public void generatePdf() {
      ...
      */
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Cash Book - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,15,20,23,10,10,13,13,13};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Cash Book Acc. No.:  " +bank    +"  as at : " +dateFormat.format(endDate1), pFontHeader);
                        ...
                        phrase = new Phrase("Accounts Desc.",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select date,activity_code,initcap(dealer),initcap(description),voucher_no,cheque_no,debit,credit from ac_cash_book WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND account_no = '"+bank+"' ORDER BY date");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                            
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(debit),SUM(credit) from ac_cash_book WHERE date < '"+beginDate+"'  AND account_no = '"+bank+"'");
                            ...
                            osBalance1 = osBalance1 + rsetTotals.getDouble(1);
                            table.addCell(phrase);
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rsetTotals.getString(2)),pFontHeader1);
                            osBalancebf = osBalancebf + rsetTotals.getDouble(2);
                            table.addCell(phrase);
                            
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance1-osBalancebf)),pFontHeader1);
                            table.addCell(phrase);
