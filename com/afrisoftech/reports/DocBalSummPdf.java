...
public class DocBalSummPdf implements java.lang.Runnable {
    ...
    public void DocBalSummPdf(java.sql.Connection connDb) {
      ...
      */
                    ...
                    try {
                        ...
                        table.getDefaultCell().setColspan(4);
                            ...
                            phrase = new Phrase("Unpaid Summary Report", pFontHeader);
                            table.addCell(phrase);
                        ...
                        try {
                           ...
                           for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset1 = st.executeQuery("select sum(credit_bal-debit_bal) from ac_doctors_ledger where acc_no ='"+listofAct[i]+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT staff_no,first_name||' '||middle_name FROM pb_doctors_list where status = 'Active' order by first_name||' '||middle_name");
