    ...
    public void generatePdf(java.lang.String memNo) {
        ...
        try {
            ...
            try {
                ...
                java.sql.ResultSet rse1 = stm1.executeQuery("select body_font,bodySize from report_pref");
                while (rse1.next()){
           ...
           // com.lowagie.text.Font pFontHeader = FontFactory.getFont(System.getProperty("bodyFont"),bodySize, Font.NORMAL);
           // com.lowagie.text.Font pFontHeader1 = FontFactory.getFont(System.getProperty("bodyFont"),bodySize, Font.BOLD);
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery(" select date::date,initcap(service) as service,dosage,reference,debit-credit from hp_patient_card where patient_no = '"+memNo+"' AND date::date >= '"+beginDate+"' and paid = 'false' AND (reference IS NULL OR reference != '') and service not ilike 'Receipt' AND service not ilike 'Receipt Adj'  AND service not ilike 'Discou%' and service != 'N.H.I.F' and paid = 'false' order by date::date,reference");
                           
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit - credit) from hp_patient_card where patient_no = '"+memNo+"' AND date::date >= '"+beginDate+"' and (service not ilike 'Receipt' OR service not ilike 'Receipt Adj' ) AND service not ilike 'Discou%' and paid = 'false' and service != 'N.H.I.F'");
                            
                            java.sql.ResultSet rset11 = st11.executeQuery(" select date::date,initcap(service) as service,dosage,reference,credit-debit from hp_patient_card where patient_no = '"+memNo+"' AND date::date >= '"+beginDate+"' AND (service = 'N.H.I.F' OR service ilike 'Receipt' OR service ilike 'Receipt Adj' OR service ilike 'Discou%') AND invoice_no NOT LIKE 'I%' order by date::date");
