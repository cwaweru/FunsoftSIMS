...
public class SubmissionFormPdf implements java.lang.Runnable {
    ...
    public void SubmissionFormPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox,java.lang.String invoiceType) {
        ...
        try {
            ...
            try {
                ...
                try {
                  ...
                  */
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Submission Form - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            table.getDefaultCell().setColspan(6);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                            phrase = new Phrase("Submission Form", pFontHeader1);
                            table.addCell(phrase);
                            ...
                            for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                if (InvoiceTypes.equalsIgnoreCase("BOTH")){
                                    ...
                                    if (InvoiceTypes.equalsIgnoreCase("OP")){
                                        java.sql.ResultSet rset1 = st1.executeQuery("select db.date,db.journal_no, upper(db.item),db.invoice_no,db.debit from ac_debtors db where  db.payee = '"+listofStaffNos[j]+"' AND db.dealer = '"+memNo+"' AND db.date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND db.debit != 0 AND db.invoice_no ILIKE 'O%' order by db.date");
                                        ...
                                        if (InvoiceTypes.equalsIgnoreCase("IP")){
                                            ...
                                            java.sql.ResultSet rset1 = st1.executeQuery("select db.date,db.journal_no, upper(db.item),db.invoice_no,db.debit from ac_debtors db where  db.payee = '"+listofStaffNos[j]+"' AND db.dealer = '"+memNo+"' AND db.date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND db.debit != 0 AND db.invoice_no ILIKE 'I%' order by db.date");
                                            table.getDefaultCell().setColspan(9);
                            ...
                            if (InvoiceTypes.equalsIgnoreCase("BOTH")){
                                ...
                                if (InvoiceTypes.equalsIgnoreCase("OP")){
                                    java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit) from ac_debtors where dealer = '"+memNo+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND invoice_no ilike 'O%'");
                                    while (rsetTotals.next()) {
                                    ...
                                    if (InvoiceTypes.equalsIgnoreCase("IP")){
                                        java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit) from ac_debtors where dealer = '"+memNo+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'  AND invoice_no ilike 'I%'");
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            if (InvoiceTypes.equalsIgnoreCase("BOTH")){
                ...
                java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT payee FROM ac_debtors WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and dealer = '"+memNo+"' and debit != 0 order by payee");
                ...
                if (InvoiceTypes.equalsIgnoreCase("OP")){
                    ...
                    java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT payee FROM ac_debtors WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and dealer = '"+memNo+"' and debit != 0 AND invoice_no ilike 'O%' order by payee");
                    ...
                    if (InvoiceTypes.equalsIgnoreCase("IP")){
                        ...
                        java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT payee FROM ac_debtors WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and dealer = '"+memNo+"' and debit != 0 AND invoice_no ilike 'I%' order by payee");
