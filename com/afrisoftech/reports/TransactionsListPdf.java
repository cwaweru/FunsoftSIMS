...
public class TransactionsListPdf implements java.lang.Runnable {
    ...
    public void TransactionsListPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,10,25,10,15,15,15};
                        ...
                        Phrase phrase = new Phrase("", pFontHeader);
                            ...
                            try {
                                ...
                                phrase = new Phrase("Transactions List :     Period : From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), pFontHeader);
