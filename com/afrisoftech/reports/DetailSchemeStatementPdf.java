...
public class DetailSchemeStatementPdf implements java.lang.Runnable {
    ...
    public void DetailSchemeStatementPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String combox, java.lang.String schemes) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            // java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit),sum(credit),sum(debit-credit) from ac_debtors where dealer = '"+memNo+"' AND date::date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            java.sql.ResultSet rsetTotals1 = st21.executeQuery("select sum(debit - credit) from ac_debtors where account_no = '"+schemeName+"' AND date::date < '"+beginDate+"'");
                            ...
                            phrase = new Phrase("Scheme Statement of Account", pFontHeader11);
                            table.addCell(phrase);
                            ...
                            try {
                                ...
                                phrase = new Phrase(memNo+  " Period : " +dateFormat.format(endDate11)+" - "+dateFormat.format(endDate1), pFontHeader1);
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select date,invoice_no,transaction_type||' '||receipt_no,debit,credit from ac_debtors where account_no = '"+schemeName+"' AND date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by date");// UNION select pd.date::date,initcap(pd.scheme_staff_no), (sh.first_name||' '||sh.second_name||' '||sh.last_name) as name,pd.reference,sum(pd.credit),pd.patient_no from hp_patient_card pd,hp_inpatient_register sh where pd.patient_no = sh.patient_no and pd.isurer = '"+memNo+"' AND pd.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pd.credit > 0 group by pd.date::date,pd.scheme_staff_no, name,pd.reference,pd.invoice_no,pd.patient_no order by pd.invoice_no");
                            
                            
                            while (rsetTotals1.next()){
                                table.getDefaultCell().setColspan(5);
                                
                                phrase = new Phrase("Balance BFWD - ",pFontHeader);
                                
                                table.addCell(phrase);
                                
                                table.getDefaultCell().setColspan(1);
                                
                                osBalance1 = rsetTotals1.getDouble(1);
                            ...
                            while (rset1.next()){
                                ...
                                osBalance1 = osBalance1 + rset1.getDouble(4);
                                bfwd = bfwd + rset1.getDouble(4);
                                ...
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance1-osBalance)),pFontHeader);
                                
                                table.addCell(phrase);
                                
                                // bfwd = (osBalance1 - osBalance)+bfwd;
                                // bfwd = (osBalance1 - osBalance);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(bfwd)),pFontHeader);
                            ...
                            // phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance1 - osBalance)+bfwd),pFontHeader);
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance1-osBalance)),pFontHeader);
                        ...
                        /*    try{
                                ...
                                try {
                                    ...
                                    java.sql.PreparedStatement pSeta1 = connectDB.prepareStatement("SELECT count(distinct(dealer)) FROM ac_debtors where dealer IS NOT NULL and dealer ='"+memNo+"'");
                                    java.sql.PreparedStatement pset22 = connectDB.prepareStatement("select distinct scheme_manager from ac_scheme_providers WHERE scheme_manager = '"+memNo+"' ");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    //   pset22.setString(1,""+memNo.toUpperCase());
                                   ...
                                   // java.sql.Statement st21 = connectDB.createStatement();
                                    ...
                                    System.out.println("Dealer Is : '"+memNo+"'");
                                    java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(balance) from ac_debtors WHERE dealer = '"+memNo+"' AND dealer IS NOT NULL AND date < '"+rangeDates[0][0]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    // pset1.setString(1,""+memNo);
                                    java.sql.ResultSet rset1A = pset1.executeQuery();
                                    
                                    java.sql.PreparedStatement pset112 = connectDB.prepareStatement("select sum(credit_bal) from ac_debtors WHERE dealer = ? AND date < '"+endDate+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    pset112.setString(1,memNo);
                                    ...
                                    for (int t = rangeDates.length - 1; t >= 0; t--) {
                                        ...
                                        java.sql.ResultSet rset01 = st01.executeQuery("select count(balance) from ac_debtors WHERE dealer = '"+memNo+"' AND dealer IS NOT NULL AND date between '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"'");
                                        
                                        java.sql.PreparedStatement pset = connectDB.prepareStatement("select sum(balance) from ac_debtors WHERE dealer = '"+memNo+"' AND dealer IS NOT NULL AND date between '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                        while (rset01.next()) {
                                            over = rset01.getInt(1);
                                        }
                                        if (over > 0){
                                            //  pset.setString(1,""+memNo.toString().toUpperCase());
                                    ...
                                    table12.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phraseA = new Phrase("Total", pFontHeader1);
                                    ...
                                    for (int x = rangeDates.length - 1; x >= 0; x--) {
                                        ...
                                        phraseA = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(columnTotals[x])), pFontHeader1);
                                        
                                        table12.addCell(phraseA);
                                        columnTo = columnTo + columnTotals[x];
                                    }
                                    
                                    phraseA = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(Over120Total)), pFontHeader1);
                                    
                                    table12.addCell(phraseA);
                                    
                                    phraseA = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(OS)), pFontHeader1);
                                    
                                    table12.addCell(phraseA);
                                    
                                    phraseA = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf((columnTo+Over120Total)-OS)), pFontHeader1);
