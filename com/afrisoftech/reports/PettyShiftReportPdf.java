...
public class PettyShiftReportPdf implements java.lang.Runnable {
    ...
    public void PettyShiftReportPdf(java.sql.Connection connDb, java.lang.String combox, java.lang.String cashPoint) {
        memNo = combox;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,10,25,20,10,10,10};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetTotals1 = st2.executeQuery("SELECT SUM(debit),sum(credit),sum(credit-debit) from ac_petty_cash WHERE shift_no = '"+memNo+"'  AND cash_point = '"+CashPoint+"'");
                           ...
                           // for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset = st.executeQuery("select voucher_no,date,payee,description,sum(debit),sum(credit),sum(credit-debit) from ac_petty_cash where shift_no = '"+memNo+"' AND cash_point = '"+CashPoint+"'  group by voucher_no,date,payee,description order by voucher_no");
                                
                                java.sql.ResultSet rset1 = st1.executeQuery("select sum(debit),sum(credit),sum(credit-debit) from ac_petty_cash where shift_no = '"+memNo+"' AND cash_point = '"+CashPoint+"'");
