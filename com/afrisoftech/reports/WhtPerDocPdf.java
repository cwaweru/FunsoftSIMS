...
public class WhtPerDocPdf implements java.lang.Runnable {
    ...
    public void WhtPerDocPdf(java.sql.Connection connDb, java.lang.String combox,java.util.Date begindate, java.util.Date endate) {
       memNo = combox;
    ...
    public void generatePdf() {
        ...
        try {
            ...
            try {
                ...
                try {
                  ...
                  */
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Payments Per Doctor - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
            ...
            double osBalancebf = 0.00;
                 double Gross = 0.00;    
                    try {
                        ...
                        int headerwidths[] = {8,10,10,10,10,10,10,9,9,9,10};
                        ...
                        table.getDefaultCell().setBorderColor(java.awt.Color.BLACK);
                            ...
                            phrase = new Phrase("Doctor's Earnings & Deductions", pFontHeader1);
                            table.addCell(phrase);
                               table.getDefaultCell().setBorderColor(java.awt.Color.white);
                            while (rset.next()) 
                            ...
                            phrase = new Phrase("WHT",pFontHeader1);
                            table.addCell(phrase);
                          
                            phrase = new Phrase("Debt Fee",pFontHeader1);
                            table.addCell(phrase);
                            
                            phrase = new Phrase("Medical",pFontHeader1);
                            table.addCell(phrase);
                            ...
                            //  java.sql.ResultSet rset = st.executeQuery("select DISTINCT member_code, member_name,date from shares_transactions order by member_code");
                              java.sql.ResultSet rset1 = st1.executeQuery("select input_date::date,cheque_no,voucher_no,sum(debit) from ac_doctors_payments where account_no = '"+memNo+"' and input_date BETWEEN '"+beginDate+"' AND '"+endDate+"' and voucher_no = '"+listofAct[i]+"' GROUP BY input_date::date,cheque_no,voucher_no order by input_date::date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                           java.sql.ResultSet rset11 = st11.executeQuery("select sum(credit) from ac_doctors_payments where account_no = '"+memNo+"'and input_date BETWEEN '"+beginDate+"' AND '"+endDate+"' and description ilike 'cons%' and voucher_no = '"+listofAct[i]+"'");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                          java.sql.ResultSet rset12 = st12.executeQuery("select sum(credit) from ac_doctors_payments where account_no = '"+memNo+"'and input_date BETWEEN '"+beginDate+"' AND '"+endDate+"'  and description ilike 'debt%' and voucher_no = '"+listofAct[i]+"'");
                          java.sql.ResultSet rset13 = st13.executeQuery("select sum(credit) from ac_doctors_payments where account_no = '"+memNo+"'and input_date BETWEEN '"+beginDate+"' AND '"+endDate+"'  and description ilike 'med%' and voucher_no = '"+listofAct[i]+"'");
                          java.sql.ResultSet rset14 = st14.executeQuery("select sum(credit) from ac_doctors_payments where account_no = '"+memNo+"'and input_date BETWEEN '"+beginDate+"' AND '"+endDate+"'  and description ilike 'rent%' and voucher_no = '"+listofAct[i]+"'");
                          java.sql.ResultSet rset15 = st15.executeQuery("select sum(credit) from ac_doctors_payments where account_no = '"+memNo+"'and input_date BETWEEN '"+beginDate+"' AND '"+endDate+"'  and description ilike 'serv%' and voucher_no = '"+listofAct[i]+"'");
                          java.sql.ResultSet rset16 = st16.executeQuery("select sum(credit) from ac_doctors_payments where account_no = '"+memNo+"'and input_date BETWEEN '"+beginDate+"' AND '"+endDate+"'  and description not ilike 'cons%' and description not ilike 'debt%' and description not ilike 'serv%' and description not ilike 'rent%' and description not ilike 'med%' and voucher_no = '"+listofAct[i]+"'");
                          java.sql.ResultSet rset17 = st17.executeQuery("select sum(debit - credit) from ac_doctors_payments where account_no = '"+memNo+"'and input_date BETWEEN '"+beginDate+"' AND '"+endDate+"' and voucher_no = '"+listofAct[i]+"'");
                           ...
                           */
                            while (rset1.next()){
                             ...
                             Gross = Gross + rset1.getDouble(4);
                               ...
                               // table.addCell(phrase);
                                ...
                                table.addCell(phrase);
                                osBalancebf = osBalancebf + rset11.getDouble(1);
                                }
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                ...
                                osBalance = osBalance + rset12.getDouble(1);
                                }
                                while (rset13.next()){ 
                               phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset13.getString(1)),pFontHeader);
                                osBalance1 = osBalance1 + rset13.getDouble(1);
                                table.addCell(phrase);
                                }
                                while (rset14.next()){ 
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset14.getString(1)),pFontHeader);
                                osBalance2 = osBalance + rset14.getDouble(1);
                                table.addCell(phrase);
                                }
                                while (rset15.next()){ 
                           ...
                           // while (rsetTotals2.next()) {
                                ...
                                table.addCell(phrase);
                                 ...
                                 table.getDefaultCell().setColspan(1);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(Gross)), pFontHeaderT);
                                ...
                                table.addCell(phrase);
                                 ...
                                 table.getDefaultCell().setColspan(1);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalancebf)), pFontHeaderT);
                                
                                table.addCell(phrase);
                                 
                                table.getDefaultCell().setColspan(1);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance)), pFontHeaderT);
                                
                                table.addCell(phrase);
                                
                               phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance1)), pFontHeaderT);
                                
                                table.addCell(phrase);
                                
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance2)), pFontHeaderT);
        ...
        try {
           ...
           // java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT dealer FROM ac_debtors where date BETWEEN ? AND ? and dealer IS NOT NULL order by dealer");
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT voucher_no FROM ac_doctors_payments where account_no = '"+memNo+"' order by voucher_no");
