...
public class WithholdingTaxPdf implements java.lang.Runnable {
    ...
    public void WithholdingTaxPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
                ...
                */
                  ...
                  */
                    ...
                    try {
                        ...
                        int headerwidths[] = {30,10,15,15,15};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset3 = st3.executeQuery("select pin_no from pb_hospitalprofile");
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("SELECT upper(doc_name) as doc_name, upper(pin_no) as pin,sum(debit), sum(credit),sum(debit-credit) FROM doc_view  where input_date  BETWEEN '"+beginDate+"' AND '"+endDate+"' group by voucher_no,doc_name ,pin_no order by doc_name asc");// UNION select pd.date::date,initcap(pd.scheme_staff_no), (sh.first_name||' '||sh.second_name||' '||sh.last_name) as name,pd.reference,sum(pd.credit),pd.patient_no from hp_patient_card pd,hp_inpatient_register sh where pd.patient_no = sh.patient_no and pd.isurer = '"+memNo+"' AND pd.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pd.credit > 0 group by pd.date::date,pd.scheme_staff_no, name,pd.reference,pd.invoice_no,pd.patient_no order by pd.invoice_no");
                            ...
                            java.sql.ResultSet rset412 = st412.executeQuery("select count(tax_code) from pb_statutory where description ilike 'cons%' ");// UNION select pd.date::date,initcap(pd.scheme_staff_no), (sh.first_name||' '||sh.second_name||' '||sh.last_name) as name,pd.reference,sum(pd.credit),pd.patient_no from hp_patient_card pd,hp_inpatient_register sh where pd.patient_no = sh.patient_no and pd.isurer = '"+memNo+"' AND pd.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pd.credit > 0 group by pd.date::date,pd.scheme_staff_no, name,pd.reference,pd.invoice_no,pd.patient_no order by pd.invoice_no");
                            
                            //  java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit),sum(balance-credit_bal) from ac_debtors where account_no = '"+memNo1+"' AND date::date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            //                       if(docPdf.getPageNumber() == 1) {
                       ...
                       //     table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                         ...
                         */
                            ...
                            table.getDefaultCell().setColspan(5);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                            phrase = new Phrase(" KENYA REVENUE AUTHORITY \n INCOME TAX DEPARTMENT", pFontHeader11);
                            table.addCell(phrase);
                            ...
                            while (rset412.next()){
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("TAX CODE : " +dbObject.getDBObject(rset412.getObject(1), "-"), pFontHeader11);
                            ...
                            while (rset3.next()){
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("PIN NO. : " +dbObject.getDBObject(rset3.getObject(1), "-"), pFontHeader11);
                            ...
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("PAYEE'S NAME",pFontHeader1);
                            table.addCell(phrase);
                            phrase = new Phrase("PIN No.",pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                            
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("GROSS Amt ",pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("WHT. Amt ",pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("NET Amt. ",pFontHeader1);
                            table.addCell(phrase);
                            //table
                            ...
                            while (rset1.next()){
                                ...
                                net = rset1.getDouble(5);
                                osBalance2 = osBalance2 + rset1.getDouble(5);
                            ...
                            if (witholding>0){
                                ...
                                phrase = new Phrase(pin, pFontHeader);
                                table.addCell(phrase);
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(gross)),pFontHeader);
                                
                                table.addCell(phrase);
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(witholding)),pFontHeader);
                          ...
                          /*   phrase = new Phrase(" \n"+"\n  ", pFontHeader1);
                            ...
                            phrase = new Phrase(" ");
                                     table.addCell(phrase);
                                      table.getDefaultCell().setColspan(7);
                                phrase = new Phrase("PREPARED BY:  _____________________________       CHEKED BY:______________________________", pFontHeader1);
                         table.addCell(phrase);
                          table.getDefaultCell().setColspan(28);
                          phrase = new Phrase(" ");
                                     table.addCell(phrase);
                               
                                 phrase = new Phrase("RECEIVED BY: ___________________  Sign:   __________________________ DateTime: _____________________", pFontHeader1);
                         table.addCell(phrase);
