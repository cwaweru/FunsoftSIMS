...
public class CashSalesBrdPdf implements java.lang.Runnable {
    ...
    public void CashSalesBrdPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String combox,java.lang.String code) {
   ...
   dbObject = new com.afrisoftech.lib.DBObject();
    ...
    public void generatePdf() {
      ...
      */
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Cash Sales Breakdown - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,15,8,30,15,15};
                        ...
                        table.getDefaultCell().setColspan(6);
                         Phrase phrase = new Phrase("", pFontHeader);
                            ...
                            try {
                                ...
                                phrase = new Phrase(bank +"  Cash Sales Report"    +"   Period : From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), pFontHeader);
                       ...
                       // Phrase phrase = new Phrase("Patients List As At:" +endDate, pFontHeader);
                        ...
                        phrase = new Phrase("Running Amt",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select date,initcap(description),receipt_no,initcap(dealer),debit from ac_cash_collection WHERE date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND  activity_code ilike '"+Code+"'  order by receipt_no");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
