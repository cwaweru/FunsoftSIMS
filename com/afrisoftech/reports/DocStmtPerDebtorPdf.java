...
public class DocStmtPerDebtorPdf implements java.lang.Runnable {
    ...
    public void DocStmtPerDebtorPdf(java.sql.Connection connDb,java.lang.String combox, java.util.Date begindate, java.util.Date endate) {
                ...
                try {
                  ...
                  */
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,20,10,13,13};
                       ...
                       // double OsBalance = 0.00;
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset4 = st4.executeQuery("select staff_no,first_name from pb_doctors_list where staff_no = '"+memNo+"'");
                           // java.sql.ResultSet rset41 = st41.executeQuery("select scheme from hp_patient_card where scheme = '"+listofStaffNos+"'");
                            ...
                            table.getDefaultCell().setBorderWidth(Rectangle.TOP | Rectangle.BOTTOM);
                                ...
                                phrase = new Phrase("Doctors Statement Per Payer", pFontHeader1);
                                table.addCell(phrase);
...
//                                while (rset41.next())
                              ...
                              //  table.getDefaultCell().setColspan(3);
                                ...
                                java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(credit_bal) from doc_scm_view where acc_no = '"+memNo+"' AND input_date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                               //double OsBalance = 0.00;
                             for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select input_date, upper(name),pat_inv,credit_bal from doc_scm_view where  debtor = '"+listofStaffNos[j]+"' AND acc_no = '"+memNo+"' AND input_date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by input_date");
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT debtor FROM doc_scm_view WHERE input_date BETWEEN '"+beginDate+"' AND '"+endDate+"' and acc_no = '"+memNo+"' order by debtor");
