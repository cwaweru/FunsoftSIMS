...
public class SchemesSalesPdf implements java.lang.Runnable {
    ...
    public void generatePdf() {
     ...
     public java.lang.Object[] getListofStaffNos1() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT payer_name FROM ac_schemes  WHERE  marketing_contact  ILIKE '"+Debtor+"' ");
  ...
  //  public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            // java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT patient_no FROM hp_patient_card WHERE date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND payment_mode = 'Scheme' AND isurer = '"+memNo+"' order by patient_no");
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT db.account_no FROM ac_debtors db ,ac_schemes ac WHERE db.date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND ac.marketing_contact  ILIKE '"+Debtor+"' and ac.account_no = db.account_no and ac.payer_name ilike '"+suppName+"' order by account_no");
