...
public class CashSaleRepPdf implements java.lang.Runnable {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Cash Sale Report - Page: ", pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("", pFontHeader);
                            ...
                            try {
                                ...
                                phrase = new Phrase("Cash Sale Breakdown:  Period : "  +dateFormat.format(endDate11)+" ------ "+dateFormat.format(endDate1), pFontHeader);
                       ...
                       // phrase = new Phrase("GL Code", pFontHeader);
                        ...
                        //  phrase = new Phrase("M.T.D Cases", pFontHeader);
                        ...
                        try {
                            ...
                            System.out.println(listofAct.length);
                                ...
                                rsetTotals1 = st3.executeQuery("SELECT SUM(debit - credit) from ac_cash_collection WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND transaction_type = 'Receipts' AND receipt_no NOT LIKE 'AC%'");
                                System.out.println("Select C done ...");
                               
                               //   for (int i = 0; i < listofAct.length; i++) {
                          
                                System.out.println("Statements Created ...");
                                java.sql.ResultSet rset = st.executeQuery("select description,SUM(debit-credit) from ac_cash_collection where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and transaction_type = 'Receipts' and receipt_no NOT LIKE 'AC%' GROUP BY description order by description ");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                                System.out.println("Select A done ...");
                              //  java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(credit)iption from ac_ledger where description ='"+listofAct[i].toString()+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' GROUP BY description");
    ...
    public java.lang.Object[] getListofActivities() {
      ...
      /*  try {
           ...
           // java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT main_service FROM revenue_breakdown_view where date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by main_service");
            java.sql.ResultSet rSet1 = stmt1.executeQuery("select DISTINCT description from ac_ledger where transaction_type = 'Revenue' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND description IS NOT NULL ORDER BY description");
