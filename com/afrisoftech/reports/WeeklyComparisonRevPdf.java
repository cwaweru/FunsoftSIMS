...
public class WeeklyComparisonRevPdf implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    public void WeeklyComparisonRevPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Weekly Sales Comparison " +dateFormat.format(endDate2), pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                if (name > 0){
                                    ...
                                    java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(credit-debit) from ac_ledger WHERE activity_code = ?  AND date = '"+rangeDates[rangeDates.length - 1][0]+"'");// AND '"+rangeDates[rangeDates.length - 1][1]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    ...
                                    while (rset1.next()){
                                        ...
                                        if (Over120 > 0){
                                            ...
                                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf((Over120/TurnOver)*100)), pFontHeader);
                                            table.addCell(phrase);
   ...
   /*                                     }else{
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT code,activity FROM pb_activity where activity_category ilike 'I%' order by code");
