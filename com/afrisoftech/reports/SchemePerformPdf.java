...
public class SchemePerformPdf implements java.lang.Runnable {
    ...
    public void SchemePerformPdf(java.sql.Connection connDb) {
    ...
    public void generatePdf() {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        java.sql.ResultSet rset21 = st41.executeQuery("SELECT avg_days from ac_limit_cons");
                        ...
                        com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+"   Printed On: "+date+" \n Period: "+Prd+" Days"),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Accounts Performance(Automated) - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,30,15,15,15};
                        ...
                        Phrase phrase = new Phrase("Accounts Performance Report ", pFontHeader);
                        ...
                        for (int j = 0; j < listofStaffNos.length; j++) {
                           ...
                           // java.sql.ResultSet rset = st.executeQuery("select sc.account_no,initcap(sc.scheme_name),sc.allowed,sc.closed,sc.suspended,sum(ac.balance-ac.credit_bal) from ac_schemes sc,ac_debtors ac where   sc.account_no =ac.account_no group by sc.account_no,sc.scheme_name,sc.closed,sc.suspended,sc.allowed order by  sc.scheme_name");
                            java.sql.ResultSet rset = st.executeQuery("select sc.account_no,sc.payee,sum(sc.debit) as limit,sum(sc.credit) from schm_limit sc where sc.account_no = '"+listofStaffNos[j]+"' group by sc.account_no,sc.payee");
                            java.sql.Statement st1 = connectDB.createStatement();
                             java.sql.ResultSet rset1 = st1.executeQuery("select sum(ac.balance-ac.credit_bal) as bal from ac_debtors ac where ac.account_no = '"+listofStaffNos[j]+"'");
                            ...
                            table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(Net3)),pFontHeader);
      ...
      public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt1.executeQuery("SELECT account_no,payee FROM schm_limit where account_no is not null order by payee");
          ...
          //  java.sql.ResultSet rSet1 = pSet1.executeQuery();
            ...
            while (rset.next()) {
                ...
                listStaffNoVector.addElement(rset.getObject(1).toString());
