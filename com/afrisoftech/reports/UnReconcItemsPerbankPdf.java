...
public class UnReconcItemsPerbankPdf implements java.lang.Runnable {
    ...
    public void UnReconcItemsPerbankPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date enddate,java.lang.String combox) {
    ...
    public void generatePdf() {
      ...
      */
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Un Reconcilled Items - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                       ...
                       //  table.addCell(phrase);
                        table.getDefaultCell().setColspan(5);
                         ...
                         table.addCell(phrase);
                           phrase = new Phrase("Bank Account :" +bankName);
                        
                         table.addCell(phrase);
                         phrase = new Phrase("Bank Name :" +acct);
                       ...
                       table.getDefaultCell().setColspan(4);
                        ...
                        phrase = new Phrase("Money In",pFontHeader);
                        table.addCell(phrase);
                        
                        
                        phrase = new Phrase("money Out",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select date,cheque_no,initcap(dealer),debit,credit from ac_cash_book WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and reconciled =false AND account_no = '"+bank+"' ORDER BY date");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                            
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(debit),SUM(credit) from ac_cash_book WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and reconciled = false AND account_no = '"+bank+"'");
