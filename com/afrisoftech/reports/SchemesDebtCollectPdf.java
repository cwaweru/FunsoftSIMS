...
public class SchemesDebtCollectPdf implements java.lang.Runnable {
    ...
    public void SchemesDebtCollectPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate, java.lang.String debtor) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Scheme Debt Collection Report - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase(Debtor.toUpperCase() + " : Debt Collection Report - Period : " +dateFormat.format(endDate11)+" - "+dateFormat.format(endDate1), pFontHeader1);
                        ...
                        try {
                            ...
                            for (int k = 0; k < listofAct1.length; k++) {
                                ...
                                for (int j = 0; j < listofStaffNos.length; j++) {
                                    ...
                                    java.sql.ResultSet rset22 = st22.executeQuery("select SUM(db.balance-db.credit_bal) from ac_debtors db WHERE  db.account_no = '"+listofStaffNos[j]+"'");// and (transaction_type = 'Raise Invoice' OR transaction_type = 'Stock Delivery' OR transaction_type = 'Stock Returns') and (description = 'Creditors Payable' OR description = 'Other Payables') GROUP BY invoice_no,date,dealer,item ORDER BY date");
                                    java.sql.ResultSet rset1a = st2a.executeQuery("select SUM(db.credit_bal) from ac_debtors db WHERE  db.account_no = '"+listofStaffNos[j]+"'");// and (transaction_type = 'Raise Invoice' OR transaction_type = 'Stock Delivery' OR transaction_type = 'Stock Returns') and (description = 'Creditors Payable' OR description = 'Other Payables') GROUP BY invoice_no,date,dealer,item ORDER BY date");
                                    
                                    java.sql.ResultSet rset1 = st2.executeQuery("select SUM(db.balance) from ac_debtors db WHERE  db.account_no = '"+listofStaffNos[j]+"' ");// and (transaction_type = 'Raise Invoice' OR transaction_type = 'Stock Delivery' OR transaction_type = 'Stock Returns') and (description = 'Creditors Payable' OR description = 'Other Payables') GROUP BY invoice_no,date,dealer,item ORDER BY date");
  ...
  */
                                    ...
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalanceb)),pFontHeader);
                                    ...
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance122a)),pFontHeader);
                                    
                                    table.addCell(phrase);
                                    table.getDefaultCell().setColspan(1);
                                    
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalance12a)),pFontHeader);
    ...
    public java.lang.Object[] getListofStaffNos(java.lang.Object suppName) {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT ac.account_no FROM ac_debtors db ,ac_schemes ac WHERE  ac.contact3  ILIKE '"+Debtor+"' and ac.account_no = db.account_no and ac.payer_name ilike '"+suppName+"' order by ac.account_no");
