...
public class RevenueRepPdf implements java.lang.Runnable {
    ...
    public void RevenueRepPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.ResultSet rset = st2.executeQuery("SELECT SUM(credit-debit) as amount,activity_code from ac_ledger where activity_code ILIKE '"+listofAct[i].toString()+"' AND date = '"+endDate+"' and (gl_code ilike 'CASH' OR gl_code ilike 'CHEQUE' OR gl_code ilike 'CREDIT CARD') GROUP BY activity_code ");
                                
                                java.sql.ResultSet rset1 = st21.executeQuery("SELECT SUM(credit-debit) as amount,activity_code  from ac_ledger where activity_code ILIKE '"+listofAct[i].toString()+"' AND date = '"+endDate+"' and gl_code ilike 'Scheme%' GROUP BY activity_code");
                                
                                java.sql.ResultSet rset3 = st3.executeQuery("SELECT SUM(credit-debit) as amount,activity_code  from ac_ledger where activity_code ILIKE '"+listofAct[i].toString()+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND (gl_code ilike 'CASH' OR gl_code ilike 'CHEQUE' OR gl_code ilike 'CREDIT CARD')  GROUP BY activity_code");
                                
                                java.sql.ResultSet rset31 = st31.executeQuery("SELECT SUM(credit-debit) as amount,activity_code  from ac_ledger where activity_code ILIKE '"+listofAct[i].toString()+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' and gl_code ilike 'Scheme%'  GROUP BY activity_code");
                                
                                java.sql.ResultSet rsetx = st2x.executeQuery("SELECT count(activity_code)  from ac_ledger where activity_code ILIKE '"+listofAct[i].toString()+"' AND date = '"+endDate+"' and (gl_code ilike 'CASH' OR gl_code ilike 'CHEQUE' OR gl_code ilike 'CREDIT CARD') GROUP BY activity_code");
                               ...
                               // java.sql.ResultSet rset1ww = st21to.executeQuery("SELECT SUM(credit-debit) as amount  from ac_ledger where date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND (gl_code ilike 'Scheme%' OR gl_code ilike 'Cash%')");
                                   java.sql.ResultSet rset1ww = st21to.executeQuery("SELECT SUM(credit-debit) as amount  from ac_ledger where date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND activity_code ILIKE '8%'");
                                ...
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf((monthCash/Days)+(monthScheme/Days))),pFontNum);
                                /// phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(0.00)),pFontNum);
                                
                                table.addCell(phrase);
                                Average = Average + (monthCash/Days)+(monthScheme/Days);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(dailyCashTotal+dailySchemeTotal)),pFontHeader);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(monthCashTotal+monthSchemeTotal)),pFontHeader);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(((cashAverage+schemeAverage)/Average)*100)),pFontHeader);
                            table.addCell(phrase);
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(((schemeAverage+cashAverage)/Average)*100))+"%",pFontHeader);
                            table.addCell(phrase);
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("select DISTINCT code,activity from pb_activity WHERE activity_category ilike 'I%' ORDER BY activity");
