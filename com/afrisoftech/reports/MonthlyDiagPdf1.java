...
public class MonthlyDiagPdf1 implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    public void MonthlyDiagPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {35,13,13,13,13,13,13,13,13,13,13,13,13};//,13,13};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Monthly Diagnosis as at " +dateFormat.format(endDate2), pFontHeader);
