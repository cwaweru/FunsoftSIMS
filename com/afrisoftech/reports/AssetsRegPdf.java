...
public class AssetsRegPdf implements java.lang.Runnable {
    ...
    public void AssetsRegPdf(java.sql.Connection connDb) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,20,10,10,13,10,10};
                        ...
                        Phrase phrase = new Phrase("Assets Register Report ", pFontHeader);
                        ...
                        phrase = new Phrase("Tag No",pFontHeader);
                        table.addCell(phrase);
                        
                        phrase = new Phrase("Make",pFontHeader);
                        table.addCell(phrase);
                        
                        phrase = new Phrase("Serial No",pFontHeader);
                        table.addCell(phrase);
                        
                        phrase = new Phrase("Manf",pFontHeader);
                        table.addCell(phrase);
                        phrase = new Phrase("Model",pFontHeader);
                        table.addCell(phrase);
                        phrase = new Phrase("Orig Country",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.Statement st33 = connectDB.createStatement();
                                ...
                                java.sql.ResultSet rset33 = st33.executeQuery("select count(tag_no) from asset_registration");
                                
                           // for (int i = 0; i < listofAct.length; i++) {
                                java.sql.Statement st3 = connectDB.createStatement();
                                
                                java.sql.ResultSet rset3 = st3.executeQuery("select tag_no,make,initcap(serial_registration_no),initcap(manufacturer),model,country_of_origin,supplier from asset_registration order by make");
