...
public class DocVoucherPdf implements java.lang.Runnable {
    ...
    public void DocVoucherPdf(java.sql.Connection connDb, java.lang.String voucno) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rs = st.executeQuery("select cb.voucher_no,current_date,cb.cheque_no,payment_mode from ac_cash_book cb where cb.voucher_no = '"+vouchNo+"'");
                            java.sql.ResultSet rset5 = st5.executeQuery("select sum(cb.credit) from ac_cash_book cb where cb.voucher_no = '"+vouchNo+"'");
                            java.sql.ResultSet rset6 = st6.executeQuery("select initcap(cb.payee),cb.credit from ac_cash_book cb where cb.voucher_no= '"+vouchNo+"'");
