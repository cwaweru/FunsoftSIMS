...
public class SchemeLimitStatusPdf implements java.lang.Runnable {
    ...
    public void SchemeLimitStatusPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Accounts With Exceeded Limits(Automated) - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,30,10,12,15};
                        ...
                        Phrase phrase = new Phrase("Accounts With Exceeded Limit ", pFontHeader);
                        ...
                        table.addCell(phrase);
                        phrase = new Phrase("Preset Limit",pFontHeader);
                        table.addCell(phrase);
                         phrase = new Phrase("Balance",pFontHeader);
                        
                        table.addCell(phrase);
                       // phrase = new Phrase("Suspended",pFontHeader);
                        ...
                        */
                        ...
                        try {
                           ...
                           // java.sql.ResultSet rset = st.executeQuery("select sc.account_no,initcap(sc.scheme_name),sc.allowed,sc.closed,sc.suspended,sum(ac.balance-ac.credit_bal) from ac_schemes sc,ac_debtors ac where   sc.account_no =ac.account_no group by sc.account_no,sc.scheme_name,sc.closed,sc.suspended,sc.allowed order by  sc.scheme_name");
                            java.sql.ResultSet rset = st.executeQuery("select account_no,payee,sum(balance-credit_bal) as bal,sum(schm_limit.debit) as limit,sum(ac_schemes.scheme_limit) from ac_debtors where balance > schm_limit.debit and account_no = schm_limit.account_no and schm_limit.account_no = ac_schemes.account_no group by account_no,payee order by payee");
                            java.sql.Statement st1 = connectDB.createStatement();
                            
                           // java.sql.ResultSet rset1 = st1.executeQuery("select count(account_no) from ac_schemes ");
                         ...
                         /*  // table.getDefaultCell().setColspan(12);
                             ...
                             while (rset1.next()) {
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Total count:" + dbObject.getDBObject(rset1.getObject(1), "-"), pFontHeader1);
                                table.addCell(phrase);
