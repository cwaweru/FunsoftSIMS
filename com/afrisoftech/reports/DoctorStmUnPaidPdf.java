...
public class DoctorStmUnPaidPdf implements java.lang.Runnable {
    ...
    public void DoctorStmUnPaidPdf(java.sql.Connection connDb, java.lang.String combox) {
        MNo = combox;
            ...
            double osBalancebf = 0.00;
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Doctor's UnPaid Invoices Statement", pFontHeader1);
                            table.addCell(phrase);
                            while (rset.next()) 
