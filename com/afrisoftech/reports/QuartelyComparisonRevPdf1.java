...
public class QuartelyComparisonRevPdf1 implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    com.afrisoftech.timeseries.QuarterAgeing ageingSeries= null;
    ...
    public void QuartelyComparisonRevPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
        ...
        ageingSeries = new com.afrisoftech.timeseries.QuarterAgeing(2, endate);
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Quarterly Revenue Differentials as at " +dateFormat.format(endDate2), pFontHeader2);
                       ...
                       for (int x = 0; x < rangeDates.length; x++) {
                        ...
                        table.addCell(phrase);
                        phrase = new Phrase("Change In Rate (+/-)",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                if (name > 0){
                                    ...
                                    java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select sum(credit-debit) from ac_ledger WHERE activity_code = ?  AND date = '"+rangeDates[rangeDates.length - 1][0]+"'");
                                    ...
                                    for (int t = 0; t < rangeDates.length; t++) {
                                        ...
                                        java.sql.PreparedStatement pset = connectDB.prepareStatement("select sum(credit-debit) from ac_ledger WHERE activity_code = ?  AND date between '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"'");
