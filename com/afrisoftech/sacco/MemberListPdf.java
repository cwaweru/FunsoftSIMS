...
public class MemberListPdf implements java.lang.Runnable {
	...
	public void MemberListPdf(java.sql.Connection connDb) {
...
//		new MemberListPdf().MemberListPdf();
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        int headerwidths[] = {15,15,15,15,25,15};
        ...
        table.setWidthPercentage((100));
         ...
         try {
          ...
          java.sql.Statement st = connectDB.createStatement();
            ...
            java.sql.ResultSet rset = st.executeQuery("select admission_date,m_number::int4,payroll_no,initcap(first_name),middle_name,last_name from member order by m_number");
