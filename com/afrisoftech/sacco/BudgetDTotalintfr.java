...
public class BudgetDTotalintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset1.setCommand("select distinct month from sectional_budget order by month");
    ...
    */
    ...
    jComboBox11.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset1, "month", null, null, null));
    ...
    private void jComboBox11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox11ActionPerformed
      //   try {
        ...
        try {
        crset5.setCommand("select activity,activity_code,sum(unit_cost) as unit_cost,sum(quantity) as quantity,sum(debit) as debit,sum(credit) as credit,comments,null as last_budget,null as actual,null as scaling,null as new_amount from sectional_budget WHERE month = '"+jComboBox11.getSelectedItem().toString()+"' GROUP BY activity,activity_code,comments");
        crset5.setConnectionSource(pConnDB);
    
            crset5.execute();
        
       // crset2.setExecuteOnLoad(true);
        jTable11.setModel(new org.netbeans.lib.sql.models.TableModel(crset5, new org.netbeans.lib.sql.models.TableModel.Column[] {
           new org.netbeans.lib.sql.models.TableModel.Column("activity", "Activity", false),
           new org.netbeans.lib.sql.models.TableModel.Column("activity_code", "Activity Code", false),
           new org.netbeans.lib.sql.models.TableModel.Column("unit_cost", "Unit Cost", false),
           new org.netbeans.lib.sql.models.TableModel.Column("quantity", "Quantity", false),
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
       ...
       jPanel1.grabFocus();
        ...
        try {
        crset4.setCommand("select activity,activity_code,sum(unit_cost) as unit_cost,sum(quantity) as quantity,sum(debit) as debit,sum(credit) as credit,null as comments,null as last_budget,null as actual,null as scaling,null as new_amount from sectional_budget GROUP BY activity,activity_code");
        crset4.setConnectionSource(pConnDB);
