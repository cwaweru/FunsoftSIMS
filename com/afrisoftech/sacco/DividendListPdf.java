...
public class DividendListPdf implements java.lang.Runnable {
	...
	public void DividendListPdf(java.sql.Connection connDb) {
...
//		new DividendListPdf().DividendListPdf();
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Dividend List - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        table.setWidthPercentage((100));
           ...
           Phrase phrase = new Phrase("Dividend List as at: "+date+"", pFontHeader);
         ...
         try {
            ...
            java.sql.ResultSet rset = st.executeQuery("select member_code,initcap(member_name),sum(credit - debit) * (select rate/100 from commissions where type = 'Dividend Payable') from shares_transactions where share_type = 'School Shares' OR share_type = 'Normal Shares' Group by member_code,member_name");
             java.sql.ResultSet rset1 = st1.executeQuery("select sum(credit - debit) * (select rate/100 from commissions where type = 'Dividend Payable') from shares_transactions where share_type = 'School Shares' OR share_type = 'Normal Shares'");
