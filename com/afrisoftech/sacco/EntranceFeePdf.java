...
public class EntranceFeePdf implements java.lang.Runnable {
	...
	public void EntranceFeePdf(java.sql.Connection connDb) {
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Entrance Fee - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        table.setWidthPercentage((100));
           ...
           Phrase phrase = new Phrase("Entrance Fee as at: "+date+"", pFontHeader);
         ...
         try {
            ...
            java.sql.ResultSet rset = st.executeQuery("select member_code,member_name,date,sum(credit) from shares_transactions WHERE share_type = 'Entrance Fee' GROUP BY member_code,member_name,date order by date");
             java.sql.ResultSet rset1 = st1.executeQuery("select sum(credit) from shares_transactions WHERE share_type = 'Entrance Fee'");
