...
public class LoanSecguarSamPdf implements java.lang.Runnable {
	...
	public void LoanSecguarSamPdf(java.sql.Connection connDb) {
...
//		new LoanSecguarSamPdf().LoanSecguarSamPdf();
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Loan Sec.& Guar.Summary - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        int headerwidths[] = {15,20,25,20,20};
        ...
        Phrase phrase = new Phrase("Loan Security & Guarantees Summary as at: " +date, pFontHeader);
       ...
       table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
            ...
            table.addCell(phrase);
             ...
             phrase = new Phrase("Net Security Value KShs.",pFontHeader);
            table.addCell(phrase);
         ...
         try {
            ...
            java.sql.ResultSet rset = st.executeQuery("select loan_acc_no,member_no,initcap(member_name),loan_approved,valid_loan_security from approved_loans ORDER BY loan_acc_no");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
            
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(loan_approved),sum(valid_loan_security) from approved_loans"); 
