 ...
 * @author  root
 */
public class Usersetupintfr extends javax.swing.JInternalFrame {
    ...
    public Usersetupintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset3.setCommand("select DISTINCT item_desc from menu_item_list WHERE app_name ilike 'sacco_main%' order by item_desc");
...
//                           java.sql.PreparedStatement pmstmt = connectDB.prepareStatement("begin work;UPDATE secure_menu_access SET menu_list = '{"+str+"}' WHERE login_name = '"+jComboBox1.getSelectedItem().toString()+"' AND sys_name = 'hospital_main' ;commit work");
                            java.sql.PreparedStatement pmstmt = connectDB.prepareStatement("begin work;UPDATE secure_menu_access SET menu_list = ? WHERE login_name = ? AND sys_name = 'sacco_main' ;commit work");
