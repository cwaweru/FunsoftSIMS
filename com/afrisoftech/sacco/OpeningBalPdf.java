...
public class OpeningBalPdf implements java.lang.Runnable {
	...
	public void OpeningBalPdf(java.sql.Connection connDb) {
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Opening balance List - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        int headerwidths[] = {13,10,10,24,17,13,13};
        ...
        table.setWidthPercentage((100));
           ...
           Phrase phrase = new Phrase("Opening balance List As At:" +date, pFontHeader);
         ...
         try {
          ...
          java.sql.Statement st = connectDB.createStatement();
            ...
            java.sql.ResultSet rset = st.executeQuery("select date,sacco_no,staff_no,staff_name,initcap(trans_type),month_deduction, balance from sacco_deductions order by  sacco_no");
