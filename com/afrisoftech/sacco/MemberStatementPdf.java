...
public class MemberStatementPdf implements java.lang.Runnable {
    ...
    public void MemberStatementPdf(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate, java.lang.String combox) {
        MNo = combox;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Detailed Member Statements - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,30,16,12,12,15};
                        ...
                        Phrase phrase = new Phrase("Member Statement as at : "   +endDate, pFontHeader1);
                      ...
                      double TotalCredit = 0.00;
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select date,initcap(description),loan_no,debit,credit,balance from member_statements_view where payroll_no ilike '"+memNo+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND description not ilike 'Loan Opening Balance' and description not ilike 'Loan Approval' ORDER BY description asc");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit),sum(credit),sum(balance) from member_statements_view where payroll_no ilike'"+memNo+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            ...
                            while (rset.next()) {
                                ...
                                phrase = new Phrase("Member Name:  "+rset.getObject(2).toString(), pFontHeader2);
                                table.addCell(phrase);
                                ...
                                table.getDefaultCell().setColspan(2);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("TSC No.  "+rset.getObject(6).toString(), pFontHeader2);
                                table.addCell(phrase);
                                ...
                                table.getDefaultCell().setColspan(2);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Member No:  "+rset.getObject(1).toString(), pFontHeader2);
                                table.addCell(phrase);
                            ...
                            while (rset1.next()){
                               ...
                               table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                ...
                                double Credit = 0.00;
                                double cumm = 0.00;
                                Debit = rset1.getDouble(4);
                                TotalDebit = TotalDebit+Debit;
                                
                                Credit = rset1.getDouble(5);
                                TotalCredit=TotalCredit+Credit;
                                cumm = Credit-Debit;
                                
                                cummTotal = cummTotal + cumm;
                            ...
                            while (rsetTotals.next()) {
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                 ...
                                 phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(TotalDebit)),pFontHeader2);
                                
                                table.addCell(phrase);
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                
                                 phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(TotalCredit)),pFontHeader2);
