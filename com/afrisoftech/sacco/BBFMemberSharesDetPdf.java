...
public class BBFMemberSharesDetPdf implements java.lang.Runnable {
  ...
  public void BBFMemberSharesPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox2) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Detailed BBF Member Transactions for the period between " +dateFormat.format(beginDate)+" and "+dateFormat.format(endDate), pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select distinct sacco_no, staff_name,bbf_contr_enddate,description, debit, credit from bbf_satement_detailed where sacco_no ilike '"+tscNo+"' and bbf_contr_enddate between '"+beginDate+"' and '"+endDate+"' order by bbf_contr_enddate");
                            
                            java.sql.ResultSet rset1 = st21.executeQuery("select sacco_no, staff_name,bbf_contr_enddate,description, debit, credit from bbf_satement_detailed where sacco_no ilike '"+tscNo+"' and bbf_contr_enddate between '"+beginDate+"' and '"+endDate+"'");
