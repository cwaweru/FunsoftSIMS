...
public class NextOfKinPdf implements java.lang.Runnable {
	...
	public void NextOfKinPdf(java.lang.String membNo, java.sql.Connection connDb) {
            connectDB = connDb;
...
//		new NextOfKinPdf().NextOfKinPdf(args[0]);
    ...
    public void generatePdf(java.lang.String memNo) {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Next Of Kin - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        table.setWidthPercentage((100));
           ...
           Phrase phrase = new Phrase("Next Of Kin", pFontHeader);
        ...
        //    table.addCell("Member No.");
         ...
         try {
            ...
            java.sql.ResultSet rset = st.executeQuery("select mb.m_number,mb.first_name||' '||mb.middle_name||' '||mb.last_name,nextof_kin,nok_address,nok_town,relation from member mb,shares_receiptb sr where mb.payroll_no ilike '"+memNo+"'");
          ...
          table.getDefaultCell().setColspan(1);
           ...
           table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("N.o.k. Address ", pFontHeader);
           table.addCell(phrase);
           table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           ...
           table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("N.o.k. Town", pFontHeader);
           table.addCell(phrase);
           table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           ...
           table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("Relation", pFontHeader);
           table.addCell(phrase);
           table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
