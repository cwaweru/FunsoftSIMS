 ...
 * @author  root
 */
public class RefundDispymtIntfr extends javax.swing.JInternalFrame {
    ...
    public RefundDispymtIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Refund Type", "Amount KShs.", "Rfd Amt.", "Balance", "TransDate"
            }
        ) {
        ...
        jLabel11.setText("Amt to refund");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.weightx = 1.0;
        ...
        jLabel111.setText("Total Overdeductions");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.weightx = 1.0;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel4.add(jTextField131, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
        jPanel4.add(jTextField112, gridBagConstraints);
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
       double resFloat = 0.00;
        double floatTotal = java.lang.Double.parseDouble(jTextField13.getText());
        ...
        /*
         double resFloat = 0.00;
         double floatTotal = java.lang.Double.parseDouble(jTextField131.getText());
        
        if (jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 2) != null) {
            double amtToalloc = java.lang.Double.parseDouble(jTextField13.getText());
            ...
            double balance = java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString());
            ...
            if (jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 2) == null) {
                jTable1.setValueAt(new java.lang.Double(jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString()), jTable1.getSelectedRow(), 3);
                this.tableModelTableChanged();
            }*/
        ...
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            ...
            if (jTable1.getValueAt(i, 0) != null) {
                ...
                if (jTable1.getSelectedColumn() == jTable1.getSelectedColumn()) {
                    ...
                    jTextField13.setText(java.lang.String.valueOf(resFloat));
                }else
                    resFloat = resFloat + Double.parseDouble(jTable1.getValueAt(i, 2).toString());
    ...
    /*
     public void tableModelTableChanged() {
        System.out.println("Calculating totals for table 11 and 2.");
        double zeros = 0.00;
        double resFloat = java.lang.Double.parseDouble(jTextField13.getText());;
        double resFloat1 = java.lang.Double.parseDouble(jTextField131.getText());;
        ...
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            ...
            if (jTable1.getModel().getValueAt(i, 2) != null) {
                ...
                resFloat = resFloat - Double.parseDouble(jTable1.getModel().getValueAt(i, 2).toString());
 ...
 /*   public void tableModelTableChanged2() {
        ...
        double resFloat = 0.00;
        double netPay = 0.00;
        double floatDeduct = java.lang.Double.parseDouble(jTextField13.getText());
        double floatTotal = java.lang.Double.parseDouble(jTextField131.getText());
        ...
        for (int i = 0; i < jTable2.getRowCount(); i++) {
            ...
            if (jTable2.getModel().getValueAt(i, 0) != null) {
                ...
                jTextField13.setText(java.lang.String.valueOf(resFloat+vat));
  ...
  **/
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,2) != null){
                    if(java.lang.Double.parseDouble(jTable1.getValueAt(i,2).toString()) > 0){
                        
                        
                        double dedAmt = java.lang.Double.parseDouble(jTable1.getValueAt(i, 2).toString());
                        double balDed = java.lang.Double.parseDouble(jTable1.getValueAt(i, 1).toString());
                        if (dedAmt > balDed){
                            java.awt.Toolkit.getDefaultToolkit().beep();
                            
                            
                            javax.swing.JOptionPane.showMessageDialog(this,"The amount to Deduct should not exceed the amount due","Error Message!",javax.swing.JOptionPane.INFORMATION_MESSAGE);
                            
                        }else{
                            java.sql.PreparedStatement pstmt1d = connectDB.prepareStatement("insert into ac_deposits2 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                            pstmt1d.setString(1,Code);
                            pstmt1d.setString(2,jTextField9.getText());
                            pstmt1d.setString(3,"NORMAL MEMBER");
                            pstmt1d.setString(4,jTextField111.getText());
                            pstmt1d.setString(5,jTextField9.getText());
                            pstmt1d.setObject(6,"Refunds");
                            pstmt1d.setString(7,jTextField31.getText());
                            pstmt1d.setString(8,vouchNo);
                            pstmt1d.setString(9,jTextField92.getText());
                            pstmt1d.setString(10,"");
                            pstmt1d.setString(11,transNo);
                            pstmt1d.setString(12,"Over-Deduction Payments");
                            pstmt1d.setString(13,jTextField13.getText());
                            pstmt1d.setString(14,"0.00");
                            pstmt1d.setString(15,datePicker1.getDate().toString());
                            pstmt1d.setObject(16,"");
                            pstmt1d.setString(17,jComboBox1.getSelectedItem().toString());
                            pstmt1d.setBoolean(18,true);
                            pstmt1d.setBoolean(19,true);
                            ...
                            java.sql.PreparedStatement pstmt812D = connectDB.prepareStatement("UPDATE deductions set amount_due = (amount_due + '"+dedAmt+"')::numeric where payroll_no ilike  '"+jTextField111.getText()+"' and date ilike '"+jTable1.getValueAt(i,4).toString()+"' and amount_due = (-1.00*'"+balDed+"')::numeric and share_type ilike '"+jTable1.getValueAt(i,0).toString()+"'and paid = false and amount_due < 0");
                            pstmt812D.executeUpdate();
                            
                            java.sql.Statement ps22X = connectDB.createStatement();
                            java.sql.ResultSet rs22X = ps22X.executeQuery("select amount_due from deductions where payroll_no ilike  '"+jTextField111.getText()+"' and date ilike '"+jTable1.getValueAt(i,4).toString()+"'  and share_type ilike '"+jTable1.getValueAt(i,0).toString()+"' and paid = false");
                            
                            while (rs22X.next()){
                                DueAmount = rs22X.getDouble(1);
                            }
                            
                            if(DueAmount >= 0.00){
                                
                                java.sql.PreparedStatement pstmt812DC = connectDB.prepareStatement("UPDATE deductions set paid=true where payroll_no ilike  '"+jTextField111.getText()+"' and date ilike '"+jTable1.getValueAt(i,4).toString()+"'and share_type ilike '"+jTable1.getValueAt(i,0).toString()+"'and paid = false");
                                pstmt812DC.executeUpdate();
                                
                                
                            }
                            
                            
                            java.sql.PreparedStatement pstmt812DB = connectDB.prepareStatement("UPDATE deductions set paid=true where payroll_no ilike  '"+jTextField111.getText()+"' and date ilike '"+jTable1.getValueAt(i,4).toString()+"' and amount_due = (-1.00*'"+balDed+"')::numeric and share_type ilike '"+jTable1.getValueAt(i,0).toString()+"'and paid = false and amount_due < 0");
                            pstmt812DB.executeUpdate();
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        try {
            ...
            java.sql.ResultSet rset3e = stmt3e.executeQuery("select m_number from member where payroll_no ilike '"+jTextField111.getText()+"%'");
            while (rset3e.next()){
                // jTextField31.setText(rset3.getObject(1).toString());
                jTextField31.setText(rset3e.getObject(1).toString());
            ...
            java.sql.ResultSet rset3 = stmt3.executeQuery("select -1*(sum(amount_due)) from deductions where payroll_no ilike '"+jTextField111.getText().toString()+"' and paid = false and amount_due < 0");
            while (rset3.next()){
                // jTextField31.setText(rset3.getObject(1).toString());
                jTextField131.setText(rset3.getObject(1).toString());
            ...
            java.sql.ResultSet rset = stmt.executeQuery("select share_type,-1*(amount_due), -1*(sum(amount_due)),date from deductions where payroll_no ilike '"+jTextField111.getText()+"%' and paid = false and amount_due < 0 group by share_type,amount_due,date");
            while (rset.next()){
