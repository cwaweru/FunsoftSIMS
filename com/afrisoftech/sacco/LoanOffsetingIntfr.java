 ...
 * @author  root
 */
public class LoanOffsetingIntfr extends javax.swing.JInternalFrame {
    ...
    public LoanOffsetingIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Loan Offset By Shares");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Loan no..", "Trans type", "Total Shares", "Loan Amt due", "Offset Amt", "Offset ?", "Interest", "Gl Code"
            }
        ) {
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getModel().getRowCount(); i++){
                ...
                if(jTable1.getValueAt(i,4) != null){
                    ...
                    pstmt.setString(4,"");
                    pstmt.setString(5,"LOAN OFFSETTING");
                    ...
                    pstmt.setObject(11,jTable1.getValueAt(i,4).toString());
                  //  pstmt.setObject(10,jTable1.getValueAt(i,4).toString());
                    pstmt.setString(12,"0.00");
                    pstmt.setString(13,actCode1);
                    pstmt.setString(14,actCode1);
                    ...
                    pstmt1e.setString(5,jTextField31.getText());
                    pstmt1e.setString(7,"KNUT Nairobi Branch");
                    pstmt1e.setString(6,"");
                    pstmt1e.setString(8,jTextField9.getText());
                    pstmt1e.setString(9,jComboBox2.getSelectedItem().toString());
                    pstmt1e.setString(10,jTextField4.getText());
                    pstmt1e.setString(11,jTextField5.getText());
                    pstmt1e.setString(12,"0.00");
                    pstmt1e.setString(13,"0.00");
                    pstmt1e.setString(14,"0.00");
                    pstmt1e.setString(15,"0.00");
                    pstmt1e.setString(16,"0.00");
                    pstmt1e.setString(17,"0.00");
                    pstmt1e.setObject(18,jTable1.getValueAt(i,4).toString());
                    pstmt1e.setString(19,transNo);
                    pstmt1e.setString(20,"Loan Offset By Shares");
                    pstmt1e.setObject(21,jTable1.getValueAt(i,7).toString());
                    pstmt1e.setString(22,actCode1);
                    ...
                    pstmt1e.setString(27,"'now'");
                    pstmt1e.setDouble(28,balance);
                    pstmt1e.setDouble(29,LoanAmt);
                    pstmt1e.executeUpdate();
                    
                    java.sql.PreparedStatement pstmtr3D = connectDB.prepareStatement("UPDATE ac_deposits SET balance = balance -'"+jTextField3.getText()+"' where invoice_no ilike'"+jTable1.getModel().getValueAt(i,0).toString()+"' and paid = false and sent= true");
                    pstmtr3D.executeUpdate();
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        jTextField13.setText(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 1).toString());
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        if(this.jTextField113.getCaretPosition() < 3){
            ...
            try {
                searchRowSet2.execute("select distinct staff_name as name,staff_no from loan_details_stmt_view WHERE BALANCE > 0 AND staff_no ILIKE '"+jTextField113.getText()+"%' order by staff_name");
                ...
                jSearchTable2.setModel(new org.netbeans.lib.sql.models.TableModel(searchRowSet2, new org.netbeans.lib.sql.models.TableModel.Column[] {
                    ...
                    new org.netbeans.lib.sql.models.TableModel.Column("staff_no", "TSC No.", false),
 ...
 /*       try {
    ...
    private void populateTable11(java.lang.String patient_name) {
        int j = 0;
        int i = 0;
        java.lang.Object shareAmt = null;
         java.lang.Object balance = null;
        ...
        try {
            ...
            if (j > 0) {
                ...
                java.sql.ResultSet rsetTable1x = stmtTable1x.executeQuery("select amount from member_shares_view2 ld where ld.payroll_no ilike '"+patient_name+"'");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
                while (rsetTable1x.next()) {
                    shareAmt = rsetTable1x.getObject(1);
                    
                }
                
               /* java.sql.Statement stmtTableB = connectDB.createStatement();
                java.sql.ResultSet rsetTableB = stmtTableB.executeQuery("SELECT sum(debit-credit) FROM loan_trans_view2 WHERE payroll_no = '"+patient_name+"'");
                while (rsetTableB.next()) {
                    balance = rsetTableB.getObject(1);
               ...
               */ 
                ...
                java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("SELECT loan_account_no, 'NORMAL LOAN', sum(debit-credit) as balance,0.00 FROM loan_trans_view2 WHERE payroll_no = '"+patient_name+"' group by loan_account_no");
                ...
                while (rsetTable11.next()) {
                    ...
                    jTable1.setValueAt(shareAmt, i, 2);
                    i++;
