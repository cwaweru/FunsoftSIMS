 ...
 * @author  root
 */
public class LoanRepaymentIntfr extends javax.swing.JInternalFrame {
    ...
    public LoanRepaymentIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Loan no..", "Reason", "Principal Due", "Total. Due", "Amt. Received", "Pay ?", "Interest due", "Gl Code"
            }
        ) {
        ...
        jTabbedPane1.addTab("Loan Repayment", jPanel3);
    ...
    private void cmbox221MouseClicked() {
        ...
        java.awt.Point point = jTextField9.getLocationOnScreen();
    ...
    private void jSearchTable22MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable22MouseClicked
        jTextField9.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 0).toString());
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        try {
            ...
            LoanAmt = java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString());
            AmtDed = java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString());
            
            balance = LoanAmt - AmtDed;
            
            java.sql.Statement ps = connectDB.createStatement();
            java.sql.ResultSet rst5 = ps.executeQuery("select nextval('transaction_no_seq')");
            while (rst5.next()){
                transNo = rst5.getObject(1).toString();
            }
            java.sql.Statement stm1M = connectDB.createStatement();
            java.sql.ResultSet rsetM = stm1M.executeQuery("select m_number from member where payroll_no ='"+jTextField13.getText().toString()+"'");
            while (rsetM.next()){
                // rsetM.getObject(1).toString();
                //rsetM.close();
            ...
            for (int i = 0; i < jTable1.getModel().getRowCount(); i++){
                if(jTable1.getValueAt(i,4) != null){
                    if (Boolean.valueOf(jTable1.getModel().getValueAt(i, 5).toString()) == java.lang.Boolean.TRUE) {
                        ...
                        pstmt1e.setString(1,jTable1.getValueAt(i,0).toString());
                        pstmt1e.setString(2,jTextField9.getText());
                        pstmt1e.setString(3,jTextField13.getText());
                        pstmt1e.setString(4,"NORMAL LOAN");
                        pstmt1e.setString(5,"");
                        pstmt1e.setString(6,receiptNo);
                        pstmt1e.setString(7,jTextField9.getText());
                        pstmt1e.setString(8,"Loan Repayment - Cash");
                        pstmt1e.setString(9,"");
                        ...
                        pstmt1e.setString(15,jTextField3.getText());
                        pstmt1e.setString(16,"0.00");
                        pstmt1e.setString(17,"0.00");
                        pstmt1e.setString(18,jTextField3.getText());
                        ...
                        pstmt1e.setDouble(28,balance);
                        pstmt1e.setDouble(29,LoanAmt);
                        
                        pstmt1e.executeUpdate();
                        System.out.println("Updated loan_transactions table");
                        
                        
                        java.sql.PreparedStatement pstmtED = connectDB.prepareStatement("insert into sacco_earnings values(?,?,?,?,?,?,?,?,?,?,?)");
                        
                        pstmtED.setString(1,jTextField13.getText());
                        pstmtED.setString(2,jTextField9.getText());
                        pstmtED.setString(3,"");
                        pstmtED.setString(4,"Interest");
                        pstmtED.setString(5,"Loan Repayment - Cash");
                        pstmtED.setString(6,datePicker1.getDate().toString());
                        pstmtED.setString(7,"0.00");
                        pstmtED.setString(8,jTable1.getValueAt(i,6).toString());
                        pstmtED.setString(9,transNo);
                        pstmtED.setBoolean(10,false);
                        pstmtED.setString(11,jTable1.getValueAt(i,0).toString());
                        ...
                        if(balance < 0.00){
                            ...
                            pstmtDD.setString(1,jTextField13.getText());
                            pstmtDD.setString(2,jTextField9.getText());
                            ...
                            pstmtDD.setDouble(5,balance);
                            pstmtDD.setBoolean(6,false);
                            pstmtDD.setString(7,datePicker1.getDate().toString());
                            pstmtDD.setObject(8,"0.00");
                            pstmtDD.setObject(9,"Loan Other receipts");
                        ...
                        java.sql.PreparedStatement pstmt812sd = connectDB.prepareStatement("UPDATE ac_deposits SET balance = balance - '"+jTextField3.getText()+"' where admission_no ILIKE '"+jTextField13.getText().toString()+"' and invoice_no ilike '"+jTable1.getModel().getValueAt(i,0).toString()+"'");
                        pstmt812sd.executeUpdate();
                        
                        java.sql.Statement stmP = connectDB.createStatement();
                        java.sql.ResultSet rsetP = stmP.executeQuery("select balance from ac_deposits where invoice_no ilike '"+jTable1.getModel().getValueAt(i,0).toString()+"' and admission_no = '"+jTextField13.getText()+"' and paid = false");
                        while (rsetP.next())
                            balanceL = rsetP.getDouble(1);
                        
                        
                        if(balanceL <= 0.00){
                            
                            java.sql.PreparedStatement pstmt31U = connectDB.prepareStatement("UPDATE ac_deposits SET paid = 'true'  where invoice_no ilike '"+jTable1.getModel().getValueAt(i,0).toString()+"' and admission_no = '"+jTextField13.getText()+"' and paid = false");
                            pstmt31U.executeUpdate();
                            
                        }
                        
                        
                        java.sql.PreparedStatement pstmt812s = connectDB.prepareStatement("UPDATE lrepayment_update SET balance = balance -'"+jTextField3.getText().toString()+"',ytd_interest = ytd_interest + '"+jTextField3.getText().toString()+"' where payroll_no = '"+jTextField13.getText().toString()+"'");
                        pstmt812s.executeUpdate();
                        
                        
                        java.sql.PreparedStatement pstmt3 = connectDB.prepareStatement("UPDATE ac_debtors set balance = '"+jTextField3.getText().toString()+"' WHERE account_no = '"+jTextField13.getText().toString()+"' ");
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        jTextField13.setText(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 0).toString());
        ...
        this.populateTable11(this.jTextField13.getText());
        this.jSearchDialog2.dispose();
        // Add your handling code here:
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        if(this.jTextField113.getCaretPosition() < 3){
            ...
            try {
                searchRowSet2.execute("select distinct admission_no, dealer as name from ac_deposits WHERE BALANCE > 0 AND paid = false AND approved = true and invoice_no is not null and invoice_no != '' and admission_no ILIKE '"+jTextField113.getText()+"%' order by admission_no");
  ...
  */
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        try {
            ...
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset1 = stmt.executeQuery("select bank_account_name,bank_account_code,bank_code from bank_branches where bank_acc_no ='"+jComboBox2.getSelectedItem().toString()+"'");
 ...
 /*       try {
    ...
    private void populateTable11(java.lang.String patient_name) {
        ...
        java.lang.Object interest = null;
        java.lang.Object principal= null;
        
        try {
            java.sql.Statement stmtTable1 = connectDB.createStatement();
            
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT count(dealer) FROM ac_deposits WHERE admission_no = '"+patient_name+"' AND approved = true and balance >0 ");
            ...
            if (j > 0) {
                ...
                java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("SELECT invoice_no, item, balance,0.00,activity_code FROM ac_deposits WHERE admission_no = '"+patient_name+"' AND approved = true and balance >0 and paid = false");
                
         /*
          
                java.sql.Statement stmtI = connectDB.createStatement();
          
            java.sql.ResultSet rsetI = stmtI.executeQuery("SELECT sum(debit) - sum(credit) from loan_interest_view where payroll_no = '"+patient_name+"' and debit is not null and debit !=''");
          
            while (rsetI.next()) {
               interest  = rsetI.getString(1).toString();
               // interest = new dbObject.getDBObject(rsetI.getObject(1));
          
                    //(dbObject.getDBObject(rset1.getObject(1), "-"), pFontHeader11)
            }
                java.sql.Statement stmtP = connectDB.createStatement();
          
            java.sql.ResultSet rsetP = stmtP.executeQuery("SELECT sum(debit) - sum(credit) from loan_interest_view where payroll_no = '"+patient_name+"' and debit is not null and debit !=''");
          
            while (rsetP.next()) {
              principal  = rsetP.getString(1).toString();
               //principal = new dbObject.getDBObject(rsetP.getObject(1));
          ...
          **/
                while (rsetTable11.next()) {
                    ...
                    jTable1.setValueAt(rsetTable11.getObject(4), i, 6);
                    jTable1.setValueAt(rsetTable11.getObject(4), i, 4);
                    jTable1.setValueAt(rsetTable11.getObject(3), i, 2);
                    jTable1.setValueAt(rsetTable11.getObject(5), i, 7);
                    
                    //  jTable1.setValueAt(principal, i, 2);
                    
                    // jTable1.setValueAt(interest, i, 6);
                    i++;
        ...
        if(Net < 0){
            ...
            try {
                ...
                if (jComboBox1.getSelectedItem().toString().equalsIgnoreCase("Cash")){
                    ...
                    pstmt1.setString(12,"");
                    pstmt1.setString(13,"");
                    pstmt1.setString(10,jTextField9.getText());
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++){
                    if (jTable1.getModel().getValueAt(i,4) != null){
                        ...
                        if(java.lang.Double.parseDouble(jTable1.getValueAt(i,3).toString()) > 0){
                            ...
                            pstmtq.setString(7,jTextField9.getText());
                ...
                for (int j = 0; j < jTable2.getRowCount(); j++){
                    if (jTable2.getModel().getValueAt(j,0) != null){
                        ...
                        pstmt11.setString(4,jTextField9.getText());
                        ...
                        if (jTable2.getModel().getValueAt(j,3) != null){
                            ...
                            pstmtw.setString(9,"");
                            pstmtw.setString(10,jTextField9.getText());
