...
public class ResignedMembPdf implements java.lang.Runnable {
	...
	public void ResignedMembPdf(java.sql.Connection connDb) {
                connectDB = connDb;
...
//		new ResignedMembPdf().ResignedMembPdf();
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Resigned Members - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        table.setWidthPercentage((100));
           ...
           Phrase phrase = new Phrase("Resigned Members", pFontHeader);
           ...
           phrase = new Phrase("Date Resigned", pFontHeader);
           table.addCell(phrase);
           table.getDefaultCell().setColspan(1);
         ...
         //     java.sql.Connection conDb1 = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
            ...
            java.sql.ResultSet rset = st.executeQuery("select date,member_no, member_name,reason from member_resignation where amount_paid <= 0 order by member_no");
            
             
              
              while (rset.next()) {
               // table.getDefaultCell().setBackgroundColor(java.awt.Color.black);
