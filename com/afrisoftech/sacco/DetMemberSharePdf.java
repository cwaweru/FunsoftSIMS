...
public class DetMemberSharePdf implements java.lang.Runnable {
    ...
    public void DetMemberSharePdf(java.lang.String membNo, java.sql.Connection connDb) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Detailed Member Share Transactions", pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st21.executeQuery("select sr.date, initcap(sr.description), sr.debit, sr.credit from member_statements_view sr where sr.description ilike 'Share%' and sr.payroll_no = '"+memNo+"' order by sr.date");
                            ...
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(TotalDebit - TotalCredit)),pFontHeader);
