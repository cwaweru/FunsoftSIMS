 ...
 * suffix.java
 *
 * Created on Mar 05, 2003, 09:34 AM
*/
...
public class Suffix extends javax.swing.JFrame
{
    ...
    public Suffix(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select * from suffix");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        try {
            nBCachedRowSet1.setTableName("suffix");
        } catch (java.sql.SQLException e1) {
            e1.printStackTrace();
        }
