...
public class Banksintfr extends javax.swing.JInternalFrame {
   ...
   public static java.sql.Connection connectDB = null;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder("Insert bank name here."));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       javax.swing.JFrame bank = new Bank(connectDB,pConnDB);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
           // java.sql.Connection con = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into bank values(?, ?)");
           ...
           // pstmt.setString(3,jComboBox1.getSelectedItem().toString());
            ...
            jLabel3.setText("Sorry. Another Branch Code already exists");
            }    // Add your handling code here:
