...
public class MemberBalPdf implements java.lang.Runnable {
    ...
    public void MemberBalPdf(java.lang.String membNo, java.sql.Connection connDb) {
        connectDB = connDb;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Member Share Transactions", pFontHeader3);
                      ...
                      double TotalDebit = 0.00;
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select distinct mb.payroll_no, mb.m_number,initcap(mb.first_name||' '||mb.middle_name||' '||mb.last_name) from member mb,shares_transactions sr where mb.payroll_no = '"+memNo+"' and sr.payroll_no = '"+memNo+"' and share_type ilike 'NORMAL SHARES'");
                            
                             java.sql.ResultSet rset1 = st21.executeQuery("select sr.date,sum(sr.credit-sr.debit), initcap(sr.share_type),initcap(transaction_type) from member mb,shares_transactions sr where mb.payroll_no = '"+memNo+"' and sr.payroll_no = '"+memNo+"' and share_type ilike 'NORMAL SHARES' group by sr.date, sr.share_type, sr.transaction_type order by sr.date");
                           
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(credit) from shares_transactions sr where sr.payroll_no = '"+memNo+"' and share_type ilike 'NORMAL SHARES'");
                            ...
                            while (rset.next()) {
                                ...
                                phrase = new Phrase("Member Name:   "+rset.getObject(3).toString(), pFontHeader1);
                                table.addCell(phrase);
                                ...
                                table.addCell(phrase);
                                 ...
                                 table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Member No:   "+rset.getObject(2).toString(), pFontHeader1);
                                table.addCell(phrase);
                            ...
                            while (rset1.next()) {
                                ...
                                table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(rset1.getObject(1).toString(), pFontHeader11);
                                
                                table.addCell(phrase);
                                
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(rset1.getObject(3).toString(), pFontHeader11);
                                
                                table.addCell(phrase);
                                
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(rset1.getObject(4).toString(), pFontHeader11);
                               ...
                               double Debit = 0.00;
                                ...
                                cummTotal = cummTotal + rset1.getDouble(2);
                                 ...
                                 TotalDebit = TotalDebit + rset1.getDouble(2);
