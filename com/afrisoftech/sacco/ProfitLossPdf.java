...
public class ProfitLossPdf implements java.lang.Runnable {
	...
	public void ProfitLossPdf(java.sql.Connection connDb,java.lang.String begindate,java.lang.String endate) {
...
//		new ProfitLossPdf().ProfitLossPdf();
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Profit & Loss - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        table.setHeaderRows(2);
           ...
           Phrase phrase = new Phrase("Profit & Loss AS At:"  +beginDate, com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,12));
        ...
        //    java.sql.Connection conDb1 = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
            ...
            java.sql.ResultSet rset4 = st4.executeQuery("select distinct sb.main_code,UPPER(sb.description) from accounts_setup sb,sub_activities sa where class LIKE 'pi%'");
           ...
           while (rset4.next()) {
            ...
            java.sql.ResultSet rset = st.executeQuery("select sb.sub_code,sb.description,sum(ev.amount) from plsub_activities_view sb,income_view ev,activity ac where sb.sub_code = '"+listofAct[i].toString()+"'and ac.sub_code = sb.sub_code and ev.gl_code = ac.code  AND ev.date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by sb.description,sb.sub_code");
         
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT ac.code,SUM(tl.amount),ac.activity from profit_loss_view tl,activity ac,sub_activities sb where tl.gl_code = ac.code and ac.sub_code ='"+listofAct[i].toString()+"' and ac.sub_code = sb.sub_code  AND tl.date BETWEEN '"+beginDate+"' AND '"+endDate+"' GROUP BY ac.activity,ac.code"); 
            
            rsetTotals1 = st3.executeQuery("SELECT SUM(amount) from income_view  WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'"); 
           table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
          ...
          table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);  
           ...
           table.addCell(phrase);
            ...
            java.sql.ResultSet rset5 = st5.executeQuery("select distinct sb.main_code,UPPER(sb.description) from accounts_setup sb,sub_activities sa where class LIKE 'pe%'");
           while (rset5.next()) {
                table.getDefaultCell().setColspan(1); 
            ...
            java.sql.Statement st3 = connectDB.createStatement();
             ...
             java.sql.ResultSet rset = st.executeQuery("select sb.sub_code,sb.description,sum(ev.amount) from plsub_activities_view sb,expense_view ev,activity ac where sb.sub_code = '"+listofAct1[i].toString()+"'and ac.sub_code = sb.sub_code and ev.gl_code = ac.code  AND ev.date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by sb.description,sb.sub_code");
          ...
          //  java.sql.ResultSet rset = st.executeQuery("select * from plsub_activities_view where sub_code = '"+listofAct1[i].toString()+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
            ...
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT ac.code,SUM(tl.amount),ac.activity from profit_loss_view tl,activity ac,sub_activities sb where tl.gl_code = ac.code and ac.sub_code ='"+listofAct1[i].toString()+"' and ac.sub_code = sb.sub_code  AND tl.date BETWEEN '"+beginDate+"' AND '"+endDate+"' GROUP BY ac.activity,ac.code"); 
            
            rsetTotals1 = st3.executeQuery("SELECT SUM(amount) from expense_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'"); 
           table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
