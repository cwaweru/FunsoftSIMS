...
public class JournalPdf implements java.lang.Runnable {
	...
	public void JournalPdf(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate) {
 ...
 */
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Journal - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        int headerwidths[] = {10,10,15,15,10,10,10,10,10};
        ...
        Phrase phrase = new Phrase("Journal AS At"  +endDate, pFontHeader);
        ...
        //    table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
          ...
          table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           ...
           table.addCell(phrase);  
            ...
            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("Jounal No.", pFontHeader);
           table.addCell(phrase);
           
             table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("Acc.Type", pFontHeader);
           table.addCell(phrase);  
           ...
           table.addCell(phrase);
            ...
            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("Mem. No.", pFontHeader);
           table.addCell(phrase);
       ...
       //     table.addCell("Reference No.");
           ...
           phrase = new Phrase("Vat Amt.", pFontHeader);
           table.addCell(phrase);
         ...
         try {
          ...
          //  java.sql.Connection conDb1 = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
            ...
            java.sql.Statement st2 = connectDB.createStatement();            
              ...
              java.sql.ResultSet rset = st.executeQuery("select date,journal_no,account_type,initcap(account),member_no,debit,credit,vat,vat_amount from journal WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY journal_no");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
            
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(debit),SUM(credit) from journal WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'"); 
