 ...
 * @author  root
 */
public class Distrintfr extends javax.swing.JInternalFrame {
    ...
    public Distrintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder("Enter District & it's Code here"));
        jLabel1.setText("District Code");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into district values(?, ?)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       javax.swing.JFrame dist = new Distr(connectDB,pConnDB);
