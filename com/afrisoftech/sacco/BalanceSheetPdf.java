...
public class BalanceSheetPdf implements java.lang.Runnable {
	...
	public void BalanceSheetPdf(java.sql.Connection connDb, java.lang.String begindate,java.lang.String endate) {
                connectDB = connDb;
                beginDate = begindate;
                endDate = endate;
 ...
 */
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        //    java.sql.Connection conDb1 = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
            ...
            java.sql.Statement st4 = connectDB.createStatement();
             java.sql.ResultSet rset4 = st4.executeQuery("SELECT SUM(amount) from assets_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'"); 
            ...
            java.sql.ResultSet rset = st.executeQuery("select bv.gl_code,initcap(bv.description),sum(bv.amount) from balance_sheet_view bv,activity ac,accounts_setup at,sub_activities sa where at.main_code = '"+listofAct[i].toString()+"' and sa.main_code = '"+listofAct[i].toString()+"' and ac.sub_code = sa.sub_code and bv.gl_code = ac.code and at.class = 'ba' AND bv.date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by bv.gl_code,bv.description order by bv.gl_code");
            
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(amount) from balance_sheet_view bv,activity ac,sub_activities sa,accounts_setup at where sa.main_code = '"+listofAct[i].toString()+"' and sa.main_code = at.main_code and sa.sub_code = ac.sub_code and bv.gl_code = ac.code and at.class = 'ba' AND bv.date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by sa.main_code"); 
          ...
          table.getDefaultCell().setBorder(Rectangle.BOTTOM);
           ...
           table.addCell(phrase);
             ...
             java.sql.ResultSet rset5 = st5.executeQuery("SELECT SUM(amount) from liabilities_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'"); 
            ...
            java.sql.ResultSet rset6 = st6.executeQuery("select bv.gl_code,bv.description,sum(bv.amount) from balance_sheet_view bv,activity ac,accounts_setup at,sub_activities sa where at.main_code = '"+listofAct1[i].toString()+"' and sa.main_code = '"+listofAct1[i].toString()+"' and ac.sub_code = sa.sub_code and bv.gl_code = ac.code and at.class = 'bl' AND bv.date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by bv.gl_code,bv.description order by bv.gl_code");
            
            java.sql.ResultSet rset7 = st7.executeQuery("SELECT SUM(amount) from balance_sheet_view bv,activity ac,sub_activities sa,accounts_setup at where sa.main_code = '"+listofAct1[i].toString()+"' and sa.main_code = at.main_code and sa.sub_code = ac.sub_code and bv.gl_code = ac.code and at.class = 'bl' AND bv.date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by sa.main_code"); 
       ...
       table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);     
        ...
        int j = 0;
             ...
             java.sql.ResultSet rset13 = st13.executeQuery(" SELECT description,sub_code,(select sum(amount) from pl_account_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"') from sub_activities where identifier Like 'pl%'");
             java.sql.Statement st9 = connectDB.createStatement();
             java.sql.ResultSet rset9 = st9.executeQuery("SELECT SUM(amount) from equity_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'"); 
         
            java.sql.Statement st14 = connectDB.createStatement();
             java.sql.ResultSet rset14= st14.executeQuery("select(select sum(amount) from pl_account_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"') + (select sum(amount) from equity_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"')"); 
             java.sql.Statement st16 = connectDB.createStatement();
             java.sql.ResultSet rset16= st16.executeQuery("select(select sum(amount) from pl_account_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"') + (select sum(amount) from equity_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"') + (select sum(amount) from liabilities_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"')"); 
          ...
          //   java.sql.ResultSet rset10 = st10.executeQuery("select * from equity_view");
            ...
            java.sql.ResultSet rset15 = st15.executeQuery("select bv.gl_code,bv.description,sum(bv.amount) from balance_sheet_view bv,activity ac,accounts_setup at,sub_activities sa where at.main_code = '"+listofAct2[i].toString()+"' and sa.main_code = '"+listofAct2[i].toString()+"' and ac.sub_code = sa.sub_code and bv.gl_code = ac.code and at.class = 'bli' AND bv.date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by bv.gl_code,bv.description order by bv.gl_code");
