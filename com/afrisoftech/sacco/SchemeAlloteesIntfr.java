 ...
 * @author  root
 */
public class SchemeAlloteesIntfr extends javax.swing.JInternalFrame {
    ...
    public SchemeAlloteesIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        //try {
            ...
            jPanel1.setBorder(new javax.swing.border.TitledBorder("Set staff & schemes here."));
            jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                    "Staff No.", "Staff Name", "Expiry Date", "Limit (KShs)"
                }
            ));
            ...
            */
            ...
            jLabel6.setText("Instruction Date");
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 0;
            gridBagConstraints.gridy = 1;
            gridBagConstraints.weightx = 1.0;
            ...
            jLabel8.setText("Signatory's Name");
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 3;
            gridBagConstraints.gridy = 1;
            gridBagConstraints.weightx = 1.0;
            ...
            jLabel9.setText("Instruction Ref.");
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 3;
            gridBagConstraints.gridy = 2;
            ...
            jPanel11.setBorder(new javax.swing.border.TitledBorder("Register Dependants Details :"));
            jTable11.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                    "Dependants  No.", "Dependants Name", "Relation", "Birth Date"
                }
            ));
            ...
            */
            ...
            jPanel61.setBorder(new javax.swing.border.TitledBorder(""));
            ...
            jPanel5.setBorder(new javax.swing.border.EtchedBorder(javax.swing.border.EtchedBorder.RAISED));
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        try {
            ...
            jComboBox1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel(crset21, "scheme_name", null, null, null));
            ...
            for (int i = 0; i < jTable11.getRowCount(); i++){
                if (jTable11.getModel().getValueAt(i,1) != null){
                    ...
                    pstmt.setObject(5,"'now'");
                     pstmt.setString(10,datePicker11.getDate().toString());
                    pstmt.setString(11,datePicker21.getDate().toString());
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    ...
                    pstmt.setString(13,datePicker2.getDate().toString());
