...
public class LoanInterestPaidPdf implements java.lang.Runnable {
  ...
  public java.lang.String dbUserName = null;
	...
	public void LoanInterestPaidPdf(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate) {
                connectDB = connDb;
                beginDate = begindate;
                endDate = endate;
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Loan Interest - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        int headerwidths[] = {15,10,10,30,20,15};
        ...
        Phrase phrase = new Phrase("Loan interest paid as at: " +endDate, pFontHeader);
        ...
        //    table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
           ...
           table.addCell(phrase);
            ...
            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("Loan Type", pFontHeader);
           table.addCell(phrase);
         ...
         try {
          ...
          //  java.sql.Connection conDb1 = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
            ...
            java.sql.ResultSet rset = st.executeQuery("select date,loan_account_no,member_no,initcap(member_name),initcap(loan_purpose),interest_paid from loan_transactions WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND interest_paid >0 ORDER BY date");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
            
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(interest_paid) from loan_transactions WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'"); 
