...
public class VouchersApprListPdf implements java.lang.Runnable {
	...
	public void VouchersApprListPdf(java.sql.Connection connDb,java.lang.String begindate,java.lang.String endate) {
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Approved Voucher List - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        int headerwidths[] = {15,15,25,25,20};
        ...
        //    table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
         ...
         try {
            ...
            java.sql.Statement st2 = connectDB.createStatement();            
              ...
              java.sql.ResultSet rset = st.executeQuery("select new_date,voucher_no,payee,description,amount from payments_approval WHERE approved = true AND paid = false and date BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY date");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
            
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(amount) from payments_approval WHERE approved = true AND paid = false AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'"); 
