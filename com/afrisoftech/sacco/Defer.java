 ...
 * defer.java
 *
 * Created on Feb 04, 2003, 05:21 PM
*/
...
public class Defer extends javax.swing.JFrame
{
    ...
    public Defer(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select * from defer_reason");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        try {
            nBCachedRowSet1.setTableName("defer_reason");
        } catch (java.sql.SQLException e1) {
            e1.printStackTrace();
        }

        setTitle("Defer Reasons");
        ...
        jTable1.setModel(new org.netbeans.lib.sql.models.TableModel(nBCachedRowSet1, new org.netbeans.lib.sql.models.TableModel.Column[] {
            new org.netbeans.lib.sql.models.TableModel.Column("defer_code", "Defer code", true),
