...
public class SuspendMembersPdf implements java.lang.Runnable {
	...
	public void SuspendMembersPdf(java.sql.Connection connDb) {
                connectDB = connDb;
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Suspended Members - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        table.setWidthPercentage((100));
           ...
           Phrase phrase = new Phrase("Suspended Members as at: "+date+"", pFontHeader);
           ...
           table.addCell(phrase);
            ...
            phrase = new Phrase("Date suspended",pFontHeader);
            table.addCell(phrase);
         ...
         try {
          ...
          java.sql.Statement st = connectDB.createStatement();
            ...
            java.sql.ResultSet rset = st.executeQuery("select member_no,reason,date from member_suspension WHERE status = 'Suspend' order by member_no");
