...
public class SubActivities extends javax.swing.JFrame
{
    ...
    public SubActivities(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select * from sub_activities");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        try {
            nBCachedRowSet1.setTableName("sub_activities");
        } catch (java.sql.SQLException e1) {
            e1.printStackTrace();
        }
