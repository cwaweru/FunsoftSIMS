                ...
                java.lang.String backup_date_stamp = this.getDateLable();
                  ...
                  try {
                     ...
                     System.out.println("Connecting to the database to run VaccumDB");
                      ...
                      vacuumingDB = rt_backup.exec("vacuumdb -U postgres -d sako");
                      ...
                      if (vacuumingDB_return == 0) {
                          ...
                          javax.swing.JOptionPane.showMessageDialog(new javax.swing.JFrame(), "VaccumDB of the SAKO database successfully completed on "+backup_date_stamp);
                          
                      } else {
                          
                          javax.swing.JOptionPane.showMessageDialog(new javax.swing.JFrame(), "VacuumDB of the SAKO database failed at "+backup_date_stamp);
