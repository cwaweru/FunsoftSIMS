...
public class PaymentsPdf implements java.lang.Runnable {
	...
	public void PaymentsPdf(java.sql.Connection connDb,java.lang.String begindate,java.lang.String endate) {
...
//		new TrialBalancePdf().TrialBalancePdf();
    ...
    public void generatePdf() {
       ...
       //   java.sql.Connection conDb = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
        ...
        int headerwidths[] = {15,10,15,20,20,20};
        ...
        table.setWidthPercentage((100));
           ...
           Phrase phrase = new Phrase("Payments As At:"  +endDate, pFontHeader);
           ...
           // table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
            ...
            table.addCell(phrase);
             ...
             phrase = new Phrase("Transaction No.",pFontHeader);
            table.addCell(phrase);
         ...
         try {
            ...
            java.sql.ResultSet rset = st.executeQuery("SELECT date,voucher_no,transaction_no,initcap(description),initcap(details),amount from payments_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by transaction_no");
            
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(amount) from payments_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'"); 
