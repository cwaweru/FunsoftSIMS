...
public class MemberDetailsPdf implements java.lang.Runnable {
	...
	public void MemberDetailsPdf(java.lang.String membNo, java.sql.Connection connDb) {
              connectDB = connDb;
...
//		new MemberDetailsPdf().MemberDetailsPdf(args[0]);
    ...
    public void generatePdf(java.lang.String memNo) {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Member Details - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        table.setWidthPercentage((100));
           ...
           Phrase phrase = new Phrase("Member Details", pFontHeader);
     ...
     */
         ...
         try {
          ...
          //  java.sql.ResultSet rset = st.executeQuery("select DISTINCT member_code, member_name,date from shares_transactions order by member_code");
             java.sql.ResultSet rset = st.executeQuery("select m_number,initcap(first_name||' '||middle_name||' '||last_name),present_address,tel_no,id_no,initcap(district),initcap(workstation),initcap(department),payroll_no from member where payroll_no = '"+memNo+"'");
           ...
           table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("District", pFontHeader);
           table.addCell(phrase);
           ...
           table.addCell(phrase);
             ...
             table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("Workstation", pFontHeader);
           table.addCell(phrase);
