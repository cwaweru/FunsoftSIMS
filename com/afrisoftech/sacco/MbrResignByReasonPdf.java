...
public class MbrResignByReasonPdf implements java.lang.Runnable {
   ...
   //   com.lowagie.text.ParagraphFont pgraph = Paragraph();
    ...
    public void MbrResignByReasonPdf(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate, java.lang.String comboBox) {
         reason = comboBox;
        connectDB = connDb;
        beginDate = begindate;
        endDate = endate;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,29,20,12,12,12};
                        ...
                        Phrase phrase = new Phrase("Members who have resigned due to "+reason+" reason " , pFontHeader2);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = stk.executeQuery("select payroll_no,initcap(member_name) as name, trans_no from member_resignation where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and reason ilike '"+reason+"' order by date");
                            java.sql.ResultSet rset1 = st1.executeQuery("select date, initcap(member_name), payroll_no, initcap(reason),amount_payable,commission, amount_paid from member_resignation where date BETWEEN '"+beginDate+"' AND '"+endDate+"' and reason ilike '"+reason+"' order by date");// UNION select pd.date::date,initcap(pd.scheme_staff_no), (sh.first_name||' '||sh.second_name||' '||sh.last_name) as name,pd.reference,sum(pd.credit),pd.patient_no from hp_patient_card pd,hp_inpatient_register sh where pd.patient_no = sh.patient_no and pd.isurer = '"+memNo+"' AND pd.date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and pd.credit > 0 group by pd.date::date,pd.scheme_staff_no, name,pd.reference,pd.invoice_no,pd.patient_no order by pd.invoice_no");
                        ...
                        //    table.getDefaultCell().setColspan(7);
                          ...
                          */  
                            ...
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("Shares ",pFontHeader1);
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("Comm. ",pFontHeader1);
                            table.addCell(phrase);
                            
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("Refund. ",pFontHeader1);
                            table.addCell(phrase);
                           ...
                           */   
                              ...
                              //   phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(runBal+osBalancebf)),pFontHeader);
                           ...
                           /*
                            ...
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(TotalDebit - TotalCredit+osBalancebf)),pFontHeader);
