...
public class TrialBalancePdf implements java.lang.Runnable {
	...
	public void TrialBalancePdf(java.sql.Connection connDb,java.lang.String begindate,java.lang.String endate) {
    ...
    public void generatePdf() {
       ...
       //   java.sql.Connection conDb = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
        ...
        table.setWidthPercentage((100));
           ...
           Phrase phrase = new Phrase("Trial Balance AS At:"  +endDate, pFontHeader);
         ...
         try {
            ...
            java.sql.ResultSet rset = st.executeQuery("SELECT gl_code,initcap(description),SUM(debit - credit) from trial_balance_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by gl_code,description order by gl_code");
            
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(debit - credit) from trial_balance_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'"); 
