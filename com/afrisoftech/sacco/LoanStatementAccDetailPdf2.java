...
public class LoanStatementAccDetailPdf2 implements java.lang.Runnable {
    ...
    public void LoanStatementAccDetailPdf2(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox,java.lang.String combox1,java.lang.String combox2) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            while (rset.next()) {
                                ...
                                table.getDefaultCell().setColspan(2);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Loan No.  "+rset.getObject(3).toString(), pFontHeader1);
                                table.addCell(phrase);
                            }
                            
                            while(rset22.next()){
                               principal = rset22.getDouble(2);
                              monthInt = rset22.getDouble(1);
                            }
                            
                            while(rset2.next()){
                               totalInt= rset2.getDouble(2);
                              monthInst = rset2.getDouble(1);
                            }
