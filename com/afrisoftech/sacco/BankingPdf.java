...
public class BankingPdf implements java.lang.Runnable {
	...
	public void BankingPdf(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate, java.lang.String combox) {
                bank = combox;    
               connectDB = connDb;
 ...
 */
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Banking- Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        int headerwidths[] = {15,15,20,20,15,15};
        ...
        Phrase phrase = new Phrase("Bank Acc:   "   +bank    +"   As At: "     +endDate, pFontHeader);
        ...
        //    table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
             ...
             phrase = new Phrase("Date Banked",pFontHeader);
            table.addCell(phrase);
          ...
          phrase = new Phrase("Account Desc.",pFontHeader);
            table.addCell(phrase);
             phrase = new Phrase("Slip No.",pFontHeader);
            table.addCell(phrase);
         ...
         try {
          ...
          //  java.sql.Connection conDb1 = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
            ...
            java.sql.Statement st2 = connectDB.createStatement();            
              ...
              java.sql.ResultSet rset = st.executeQuery("select date_banked,code,initcap(member_name),initcap(description),slip_no,amount_banked from cash_book WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND account_no = '"+bank+"' AND date_banked !='' ORDER BY gl_code");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
            
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(amount_banked) from cash_book WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND account_no = '"+bank+"' AND date_banked != ''"); 
