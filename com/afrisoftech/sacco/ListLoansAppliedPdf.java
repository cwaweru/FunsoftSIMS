...
public class ListLoansAppliedPdf implements java.lang.Runnable {
...
public void ListLoansAppliedPdf(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate) {
                connectDB = connDb;
                beginDate = begindate;
                endDate = endate;
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Loans Applied - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        Phrase phrase = new Phrase("List Of Loans Applied as at: " +endDate, pFontHeader);
        ...
        //    table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
            ...
            table.addCell("Applied Amount Kshs."); 
      ...
      //      java.sql.Connection conDb1 = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
            ...
            java.sql.ResultSet rset = st.executeQuery("select date_of_application,loan_account_no,member_no,initcap(member_name),initcap(loan_type),initcap(department),loan_amount from loan_application WHERE date_of_application BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY date_of_application");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
            
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(loan_amount) from loan_application WHERE date_of_application BETWEEN '"+beginDate+"' AND '"+endDate+"'"); 
