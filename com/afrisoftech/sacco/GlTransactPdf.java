...
public class GlTransactPdf implements java.lang.Runnable {
	...
	public void GlTransactPdf(java.sql.Connection connDb,java.lang.String begindate,java.lang.String endate) {
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        table.setHeaderRows(2);
           ...
           Phrase phrase = new Phrase("General Ledger As At : " +endDate, com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,12));
        ...
        //    java.sql.Connection conDb1 = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
            ...
            java.sql.ResultSet rset = st.executeQuery("select * from general_ledger_view where gl_code = '"+listofAct[i]+"' AND description IS NOT NULL AND transaction_no IS NOT NULL AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
            ...
            rsetTotals1 = st3.executeQuery("SELECT SUM(debit),SUM(credit) from general_ledger_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'"); 
           ...
           table.addCell(phrase);
            ...
            while (rset.next()) {
                ...
                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT); 
               phrase = new Phrase(rset.getObject(3).toString(),pFontNum);
 ...
 //               table.addCell(rset.getObject(4).toString());
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        //    java.sql.Connection connDB = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT gl_code FROM general_ledger_view where date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by gl_code");
