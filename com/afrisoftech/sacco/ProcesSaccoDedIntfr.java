 ...
 * @author  root
 */
public class ProcesSaccoDedIntfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    public ProcesSaccoDedIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mbr/Loan No.", "Mbr name", "TSC No.", "Ded. Due", "Interest.", "Total Due", "Trans"
            }
        ) {
...
this.jButton1.setEnabled(true);        // Add your handling code here:
  ...
  /*  public void tableModelTableChanged() {
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1M = stmt1M.executeQuery("SELECT distinct payroll_no  FROM member where membership_type != 'SACCO STAFF' and payroll_no != 'NA'");
            
            while (rSet1M.next()) {
                
                java.lang.Object mtype = rSet1M.getObject(1).toString();
                
             //   if(!mtype.toString().equalsIgnoreCase("sacco staff")){
                    
                    java.sql.Statement stmt1 = connectDB.createStatement();
                    
                    java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT distinct staff_no FROM sacco_deductions_view WHERE staff_no ilike '"+mtype+"' ORDER BY staff_no");
                    ...
                    if (Boolean.valueOf(jTable1.getModel().getValueAt(j, 9).toString()) == java.lang.Boolean.TRUE) {
                        ...
                        if (Boolean.valueOf(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 9).toString()) == java.lang.Boolean.FALSE) {
                            ...
                            if(this.jTable1.getModel().getValueAt(jTable1.getSelectedRow(),9) != null){
                                ...
                                //           jTable1.getModel().setValueAt((Object)java.lang.String.valueOf(0.00), jTable1.getSelectedRow(), 4);
                                jTable1.setValueAt(jTable1.getValueAt(jTable1.getSelectedRow(),5), jTable1.getSelectedRow(), 8);
                                jTable1.setValueAt(new java.lang.Double(0), jTable1.getSelectedRow(), 7);
   
                            }
                            if (amt1 > 0) {
                                jTextField2.setText(Double.toString(amt1+java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 5).toString())));
                            }else{
                                if (amt1 == 0) {
   
                                    jTextField2.setText(Double.toString(java.lang.Double.parseDouble(jTable1.getValueAt(jTable1.getSelectedRow(), 5).toString())-bal));
                                }
                            }
                        }
                    }
           ...
           pstmtA.executeUpdate();
            ...
            for (int i = 0; i < jTable1.getModel().getRowCount(); i++){
                    if(jTable1.getValueAt(i,1) != null){
                        ...
                        pstmt2.setObject(3,jTable1.getValueAt(i,6).toString());
                        ...
                        if (jTable1.getModel().getValueAt(i, 6).toString().equalsIgnoreCase("shares")){
                            pstmt2.setObject(6,"Share payments");
                        }else{
                            pstmt2.setObject(6,"Loan payments");
                        }
                        ...
                        pstmt2.setObject(13,jTable1.getValueAt(i,5).toString());
                        ...
                        pstmt2.setObject(22,jTable1.getValueAt(i,5).toString());
                        pstmt2.setObject(23,jTable1.getValueAt(i,3).toString());
                        pstmt2.setObject(24,jTable1.getValueAt(i,4).toString());
    ...
    private void populateTable1() {
        ...
        try {
            ...
            for (int j = 0; j < listofStaffNos.length; j++) {
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select ld.loan_no,  ld.staff_name, sum(ld.month_deduction), sum(ld.interest),sum(ld.month_deduction + ld.interest),trans_type,staff_no from sacco_deductions_view ld WHERE ld.staff_no ilike '"+listofStaffNos[j]+"' and commencement_date  <= '"+datePicker2.getDate().toString()+"' and balance > '0.00' and staff_no between '"+this.jTextField3.getText().toString()+"' and '"+this.jTextField4.getText().toString()+"' group by ld.staff_no,ld.staff_name,loan_no,trans_type order by staff_no desc");// '"+listofStaffNos[j]+"'order by ld.staff_no  ");// and revenue_code = '"+jTextField5.getText()+"' AND paid = false");
                ...
                while (rsetTable1.next()) {
                    ...
                    jTable1.setValueAt(rsetTable1.getObject(7), i, 2);
