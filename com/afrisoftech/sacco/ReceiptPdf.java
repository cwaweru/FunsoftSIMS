...
public class ReceiptPdf implements java.lang.Runnable {
	...
	public void ReceiptPdf(java.sql.Connection connDb) {
        ...
        */
        ...
        table.setWidthPercentage((100));
         ...
         try {
          ...
          //  java.sql.ResultSet rset = st.executeQuery("select DISTINCT member_code, member_name,date from shares_refund order by member_code");
             java.sql.ResultSet rset3 = st3.executeQuery("select company_name,short_name,address||' '||initcap(town),tel1||' '||tel2,initcap(street),initcap(avenue),fax_no,email,initcap(building_name),room_no from company_profile");
           //  java.sql.ResultSet rset1 = st1.executeQuery("select date,initcap(description),debit,credit,balance from member_statements_view where member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
           // java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit),sum(credit),sum(balance) from member_statements_view where member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
           ...
           table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("Street: "+rset3.getObject(5).toString(), pFontHeader);
           table.addCell(phrase);
           
           
           table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("Avenue: " +rset3.getObject(6).toString(), pFontHeader);
            
           table.addCell(phrase);
           
            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("Bulding: " +rset3.getObject(9).toString(), pFontHeader);
            
           table.addCell(phrase);
        
            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("Room No: "+rset3.getObject(10).toString(), pFontHeader);
          ...
          table.getDefaultCell().setBorder(Rectangle.BOTTOM);
            ...
            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("Address: " +rset3.getObject(3).toString(), pFontHeader);
           table.addCell(phrase);
           
                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("TEl: "+rset3.getObject(4).toString(), pFontHeader);
           ...
           table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("FAX: "+ rset3.getObject(7).toString(), pFontHeader);
            
           table.addCell(phrase);
           
               
               table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("E-MAIL: "+rset3.getObject(8).toString(), pFontHeader);
        ...
        /*
         ...
         //  table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
          ...
          //  java.sql.ResultSet rset = st.executeQuery("select DISTINCT member_code, member_name,date from shares_refund order by member_code");
             java.sql.ResultSet rset = st.executeQuery("select lpad(m_number,9,0),initcap(first_name||' '||middle_name||' '||last_name),present_address,present_town,tel_no from member where m_number = '"+memNo+"'");// AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
             java.sql.ResultSet rset1 = st1.executeQuery("select date,initcap(description),debit,credit,balance from member_statements_view where member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit),sum(credit),sum(balance) from member_statements_view where member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
           ...
           table.addCell(phrase);
             ...
             table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           phrase = new Phrase("Town", pFontHeader);
           table.addCell(phrase);
