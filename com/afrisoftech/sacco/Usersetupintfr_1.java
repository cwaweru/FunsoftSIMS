 ...
 * @author  root
 */
public class Usersetupintfr_1 extends javax.swing.JInternalFrame {
    ...
    public Usersetupintfr_1(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset3.setCommand("select DISTINCT item_desc from menu_item_list order by item_desc");
        crset3.setConnectionSource(pConnDB);
        crset1.setCommand("select usename from pg_user where usename !='postgres' ");
        crset1.setConnectionSource(pConnDB);
        crset2.setCommand("select usename from pg_user where usename !='postgres'");
        crset2.setConnectionSource(pConnDB);
        crset4.setCommand("select department from departments");
        crset4.setConnectionSource(pConnDB);
        crsetusertables.setCommand("select relname from user_tables");
        ...
        jComboBox3.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset4, "department", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 150);
        jPanel5.add(jScrollPane3, gridBagConstraints);

        jComboBox41.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crsetusertables, "relname", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jComboBox411.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crsetusertables, "relname", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
...
/*       
   ...
   //         for (int i = 0; i  < selectedValues.length; i++){
            java.sql.Statement pstmt = connectDB.createStatement();
                           java.sql.PreparedStatement pmstmt = connectDB.prepareStatement("UPDATE secure_menu_access SET menu_list = '{"+str+"}' WHERE login_name = '"+jComboBox1.getSelectedItem()+"'");
