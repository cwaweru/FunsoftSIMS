 ...
 * lpurpose.java
 *
 * Created on Aug 20, 2002, 02:09 PM
*/
...
public class Lpurpose extends javax.swing.JFrame
{
    ...
    public Lpurpose(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select * from l_purpose");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        nBCachedRowSet1.setReadOnly(true);
        try {
            nBCachedRowSet1.setTableName("l_purpose");
        } catch (java.sql.SQLException e1) {
            e1.printStackTrace();
        }

        setTitle("Loan Purpose Data");
