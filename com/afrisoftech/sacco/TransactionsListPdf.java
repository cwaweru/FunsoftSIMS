...
public class TransactionsListPdf implements java.lang.Runnable {
	...
	public void TransactionsListPdf(java.sql.Connection connDb,java.lang.String begindate,java.lang.String endate) {
...
//		new TransactionsListPdf().TransactionsListPdf();
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        int headerwidths[] = {15,10,25,10,20,20};
        ...
        table.getDefaultCell().setBorder(Rectangle.BOTTOM);
           ...
           Phrase phrase = new Phrase("Transactions List As At: " +endDate, pFontHeader);
        ...
        //    table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
            ...
            table.addCell(phrase);
              ...
              phrase = new Phrase("Ref No.",pFontHeader);
            table.addCell(phrase);
         ...
         try {
            ...
            java.sql.Statement st2 = connectDB.createStatement();            
              ...
              java.sql.ResultSet rset = st.executeQuery("select * from transactions_view WHERE transaction_no NOTNULL AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY transaction_no ASC");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
            
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(debit),SUM(credit) from transactions_view WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'"); 
