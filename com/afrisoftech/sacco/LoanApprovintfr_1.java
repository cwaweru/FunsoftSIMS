 ...
 * @author  root
 */
public class LoanApprovintfr_1 extends javax.swing.JInternalFrame {
    ...
    public LoanApprovintfr_1(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
   ...
   /*    
    ...
    private void jButton211ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton211ActionPerformed
        ...
        try {
            ...
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("SELECT COUNT(*) from loan_application WHERE approved_loans = false");
            while (rset.next()){
                LoanNo = rset.getInt(1);
            }
       ...
       /*if (jTextField48.getText() == "") {
        ...
        if (LoanNo < 1) {
            ...
            try {
                java.sql.Statement stmt = connectDB.createStatement();
                java.sql.ResultSet res = stmt.executeQuery("select member_name,department,workstation,position_in_sacco,service_terms,birth_date,loan_purpose,"+
                "repayment_period,(monthly_income* ((0.66)::NUMERIC)),lpad(member_no,9,0),loan_amount,loan_type,"+
                "commencement_date,loan_account_no,rate,monthly_repayment_amount,applicant_shares from loan_application WHERE loan_status ='Not Processed'  AND loan_account_no = '"+jTextField48.getText()+"' order by loan_account_no");
                
                while (res.next()){
              /*  float1 = res.getFloat(9);
                float2 = res.getFloat(13);
                float3 = res.getFloat(14);
                float4 = res.getFloat(15);
                float5 = res.getFloat(30);*/
                    jTextField21.setText(res.getObject(1).toString());
                    jTextField17.setText(res.getObject(2).toString());
                    jTextField20.setText(res.getObject(3).toString());
                    jTextField19.setText(res.getObject(4).toString());
                    ...
                    jTextField8.setText(res.getObject(16).toString());
                    jTextField4.setText(res.getObject(17).toString());
                    // jTextField48.setText(res.getObject(18).toString());
                    //  jTextField49.setText(res.getObject(19).toString());
                }
                res.close();
                stmt.close();
                // con.close();
            ...
            try {
                ...
                //  java.sql.ResultSet rs4 = st4.executeQuery("select COUNT(member_code) from shares_transactions where member_code ='"+jTextField15.getText()+"'");
                java.sql.ResultSet rs4 = st4.executeQuery("select COUNT(member_code) from member_shares where member_code ='"+jTextField15.getText()+"'");
                ...
                if (j > 0) {
                    ...
                    crset13.setCommand("SELECT share_type,amount from member_shares where member_code = '"+jTextField15.getText()+"'");
            ...
            try {
                java.sql.Statement stmt = connectDB.createStatement();
                java.sql.ResultSet rset = stmt.executeQuery("SELECT sum(credit)-sum(debit) from shares_transactions where share_type !='Entrance Fee' AND member_code ='"+jTextField15.getText()+"'");
                //where lacc ='"+jTextField48.getText()+"'");
                while (rset.next())
                    jTextField37.setText(rset.getObject(1).toString());
            } catch (java.sql.SQLException sq) {
            ...
            try {
                java.sql.Statement stmt = connectDB.createStatement();
                java.sql.ResultSet rset = stmt.executeQuery("select COUNT (lacc) from guarantors where lacc ='"+jTextField48.getText()+"'");
                //where lacc ='"+jTextField48.getText()+"'");
                while (rset.next())
                    jTextField28.setText(rset.getObject(1).toString());
            } catch (java.sql.SQLException sq) {
            ...
            try {
                java.sql.Statement stmt = connectDB.createStatement();
                java.sql.ResultSet rset = stmt.executeQuery("select amount from max_loan_allowable WHERE loan_type ='"+jTextField10.getText()+"'");
                //where lacc ='"+jTextField48.getText()+"'");
                while (rset.next())
                    jTextField38.setText(rset.getObject(1).toString());
            } catch (java.sql.SQLException sq) {
            ...
            try {
                java.sql.Statement stmt = connectDB.createStatement();
                java.sql.ResultSet rset = stmt.executeQuery("select COUNT (member_no) from loan_application where loan_account_no ='"+jTextField48.getText()+"'");
                //where lacc ='"+jTextField24.getText()+"'");
                while (rset.next())
                    jTextField24.setText(rset.getObject(1).toString());
            } catch (java.sql.SQLException sq) {
            ...
            try {
                java.sql.Statement st4 = connectDB.createStatement();
                java.sql.Statement stmt3 = connectDB.createStatement();
                java.sql.ResultSet rs4 = st4.executeQuery("select COUNT(lacc) from guarantors where lacc ='"+jTextField48.getText()+"'");
                java.sql.ResultSet rset = stmt3.executeQuery("select sum(amount) from guarantors where lacc ='"+jTextField48.getText()+"'");
                ...
                if (j > 0) {
                    ...
                    java.sql.Statement stmt4 = connectDB.createStatement();
                    java.sql.ResultSet rset1 = stmt4.executeQuery("select property_value from property_details where loan_acc_no ='"+jTextField48.getText()+"'");
            ...
            try {
                ...
                java.sql.ResultSet rs2 = stm2.executeQuery("select COUNT(member_no) from loan_transactions where member_no ='"+jTextField15.getText()+"'");
                while (rs2.next()) {
                    j = rs2.getInt(1);
                }
                if (j > 0) {
                    java.sql.ResultSet rset = stmt.executeQuery("select SUM(principal - principal_paid) from loan_transactions where member_no ='"+jTextField15.getText()+"'");
                    while (rset.next())
                        jTextField23.setText(rset.getObject(1).toString());
                } else {
                    jTextField23.setText("0.00");
                ...
                java.sql.Statement stm3 = connectDB.createStatement();
                java.sql.ResultSet rs21 = stm3.executeQuery("select COUNT(member_no) from approved_loans where member_no ='"+jTextField15.getText()+"'");
                while (rs21.next()) {
                    j = rs21.getInt(1);
                }
                if (j > 0) {
                    java.sql.ResultSet rs31 = stm1.executeQuery("select SUM(monthly_repayment) from approved_loans where member_no ='"+jTextField15.getText()+"'");
                    while (rs31.next())
                        jTextField53.setText(rs31.getObject(1).toString());
            ...
            try {
                ...
                if (j > 0) {
                    ...
                    crset12.setCommand("select gnumber,amount from guarantors where lacc ='"+jTextField48.getText()+"'");
                    crset12.setConnectionSource(pConnDB);
                    ...
                    // crset2.setExecuteOnLoad(true);
                    jTable2.setModel(new org.netbeans.lib.sql.models.TableModel(crset12, new org.netbeans.lib.sql.models.TableModel.Column[] {
                        new org.netbeans.lib.sql.models.TableModel.Column("gnumber", "Member No.", false),
                        new org.netbeans.lib.sql.models.TableModel.Column("amount", "Amount", false)
                    }));
                    jScrollPane3.setViewportView(jTable2);
            ...
            try {
                ...
                java.sql.Statement stmt4 = connectDB.createStatement();
                java.sql.ResultSet rs4 = st4.executeQuery("select COUNT(loan_account_no) from loans_security where loan_account_no ='"+jTextField48.getText()+"'");
                java.sql.ResultSet rset1 = stmt4.executeQuery("SELECT sum(security_rate * amount) from loans_security where loan_account_no ='"+jTextField48.getText()+"'");
                ...
                if (j > 0) {
                    ...
                    crset5.setCommand("SELECT security_type,registration_no,amount,(security_rate * amount) as scaled_value from loans_security where loan_account_no ='"+jTextField48.getText()+"' GROUP BY security_type,registration_no,amount,security_rate");
                    crset5.setConnectionSource(pConnDB);
            ...
            try {
                ...
                java.sql.ResultSet rs5 = st4.executeQuery("select COUNT(loan_acc_no) from property_details where loan_acc_no ='"+jTextField48.getText()+"'");
                ...
                if (j > 0) {
                    ...
                    crset7.setCommand("SELECT reg_no,property_no,property_desc,property_value from property_details where loan_acc_no ='"+jTextField48.getText()+"'");
                    crset7.setConnectionSource(pConnDB);
