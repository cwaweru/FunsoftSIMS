                ...
                java.lang.String backup_date_stamp = this.getDateLable();
                  ...
                  try {
                     ...
                     System.out.println("Connecting to the database to start optimization");
                      ...
                      CompactDB = rt_compactdb.exec("vacuumdb -U postgres --analyze --full -d sako");
                      ...
                      if (CompactDB_return == 0) {
                          ...
                          javax.swing.JOptionPane.showMessageDialog(new javax.swing.JFrame(), "Compacting of the SAKO database successfully completed on "+backup_date_stamp);
                          
                      } else {
                          
                          javax.swing.JOptionPane.showMessageDialog(new javax.swing.JFrame(), "Compacting of the SAKO database failed at "+backup_date_stamp);
