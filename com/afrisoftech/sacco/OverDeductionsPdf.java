...
public class OverDeductionsPdf implements java.lang.Runnable {
    ...
    public void OverDeductionsPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
        connectDB = connDb;
        beginDate = begindate;
        endDate = endate;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,10,25,15,12,12,14};
                        ...
                        phrase = new Phrase("Run bal.",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select date,payroll_no,member_name,share_type,amount_due from deductions where date between '"+beginDate+"' and '"+endDate+"' and paid = false and amount_due < 0 order by payroll_no");
