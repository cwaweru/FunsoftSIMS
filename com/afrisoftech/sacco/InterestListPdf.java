...
public class InterestListPdf implements java.lang.Runnable {
	...
	public void InterestListPdf(java.sql.Connection connDb) {
...
//		new InterestListPdf().InterestListPdf();
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Interest List - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        table.setWidthPercentage((100));
           ...
           Phrase phrase = new Phrase("Interest on Deposits", pFontHeader);
       ...
       phrase = new Phrase("Member No.", pFontHeader);
         ...
         try {
            ...
            java.sql.ResultSet rset = st.executeQuery("select member_code,initcap(member_name),sum(credit - debit) * (select rate/100 from commissions where type = 'Interest Payable') from shares_transactions where share_type = 'Deposits' AND member_name !='Opening Balance' Group by member_code,member_name");
             java.sql.ResultSet rset1 = st1.executeQuery("select sum(credit - debit) * (select rate/100 from commissions where type = 'Interest Payable') from shares_transactions where share_type = 'Deposits' AND member_name !='Opening Balance'");
