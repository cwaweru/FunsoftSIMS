...
public class MemberNotPayingPdf implements java.lang.Runnable {
    ...
    public void MemberNotPayingPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
        connectDB = connDb;
        beginDate = begindate;
        endDate = endate;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Members Not Being Deducted List - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {13,10,26,15,12,12,12};
                        ...
                        Phrase phrase = new Phrase("Deduction Balances List As At:" +date, pFontHeader);
                        ...
                        //  phrase = new Phrase("Last Name",pFontHeader);
                        //table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select date,payroll_no,member_name,description,total_due, refund,  -1*(sum(refund-total_due)) as deduction_paid from member_notpaying_view where date between '"+beginDate+"' and '"+endDate+"' group by date,payroll_no,member_name,description,total_due, refund order by payroll_no");
                            
                            java.sql.ResultSet rset1 = st1.executeQuery("select date,payroll_no,member_name,description,total_due, refund,  -1*(sum(refund-total_due)) as deduction_paid from member_notpaying_view where date between '"+beginDate+"' and '"+endDate+"' group by date,payroll_no,member_name,description,total_due, refund order by payroll_no");
