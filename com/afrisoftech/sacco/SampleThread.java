    ...
    public void backupImmediate(){
                ...
                java.lang.String backup_date_stamp = this.getDateLable();
                  ...
                  try {
                     ...
                     System.out.println(path2BackupFiles+"SAKO_"+backup_date_stamp+".sql");
                      
                      java.lang.Process backup_proc;
                      
                      backup_proc = rt_backup.exec("pg_dump -f "+path2BackupFiles+"SAKO_"+backup_date_stamp+".sql sako");
                      ...
                      if (backup_proc_return == 0) {
                          ...
                          javax.swing.JOptionPane.showMessageDialog(new javax.swing.JFrame(), "Backup of the SAKO database successfully completed on "+backup_date_stamp);
                          
                      } else {
                          
                          javax.swing.JOptionPane.showMessageDialog(new javax.swing.JFrame(), "Backup of the SAKO database failed at "+backup_date_stamp);
