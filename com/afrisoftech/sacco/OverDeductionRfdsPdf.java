...
public class OverDeductionRfdsPdf implements java.lang.Runnable {
    ...
    public void OverDeductionRfdsPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
        connectDB = connDb;
        beginDate = begindate;
        endDate = endate;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Members Overdeduction Refunds List - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,15,25,15,15,13};
                        ...
                        Phrase phrase = new Phrase("Over-Deductions Refunds List As At:" +date, pFontHeader);
                      ...
                      //  phrase = new Phrase("Amt due.",pFontHeader);
                       ...
                       // table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select date,admission_no,dealer,cheque_no,debit from ac_deposits2 where date between '"+beginDate+"' and '"+endDate+"' and transaction_type ilike 'Over-Deduction Payments' order by date");
                            
                            java.sql.ResultSet rset1 = st1.executeQuery("select date,admission_no,dealer,cheque_no,debit from ac_deposits2 where date between '"+beginDate+"' and '"+endDate+"' and transaction_type ilike 'Over-Deduction Payments' order by date");
