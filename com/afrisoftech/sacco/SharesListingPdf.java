...
public class SharesListingPdf implements java.lang.Runnable {
    ...
    public void SharesListingPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("All Member Shares List - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Member Shares Listing as at " +date, pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st21.executeQuery("select payroll_no, member_name, member_code,initcap(share_type),amount from shares_transactions_view where amount > 0.00");
                            
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(credit) from shares_transactions");
                            ...
                            while (rset1.next()) {
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(dbObject.getDBObject(rset1.getObject(3), "-"), pFontHeader11);
                                
                                table.addCell(phrase);
                                
                                
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(dbObject.getDBObject(rset1.getObject(4), "-"), pFontHeader11);
                                ...
                                cummTotal = cummTotal + rset1.getDouble(5);
