    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Account", "Loan Acc. No.", "Member No.", "Debit", "Credit", "Reference", "Member Name"
            }
        ) {
        ...
        */
        ...
        jTable11.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Account", "Member No.", "Debit", "Credit", "Reference", "Member Name"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        */
        ...
        jTable13.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bank Account", "Debit", "Credit", "Reference"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                true, true, true, false
     ...
     cmbox = new javax.swing.JComboBox();
      ...
      try {
           ...
           // crset2.setCommand("select item_description from order_details where order_no = '"+jComboBox1.getSelectedItem()+"'");
            crset9.setConnectionSource(pConnDB);
            //crset2.execute("select distinct drug_prescribed from general_patient_diagnosis where patient_no = '"+jComboBox1.getSelectedItem()+"'");
            crset9.execute("select distinct loan_account_no from loan_transactions");// where "+table+" = '"+jComboBox1.getSelectedItem()+"'");
     
            cmbox2.setModel(new org.netbeans.lib.sql.models.ComboBoxModel(crset9, "loan_account_no", null, null,null));
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        try {
           ...
           // crset2.setCommand("select item_description from order_details where order_no = '"+jComboBox1.getSelectedItem()+"'");
            crset9.setConnectionSource(pConnDB);
            //crset2.execute("select distinct drug_prescribed from general_patient_diagnosis where patient_no = '"+jComboBox1.getSelectedItem()+"'");
            crset9.execute("select loan_account_no from loan_transactions");// where "+table+" = '"+jComboBox1.getSelectedItem()+"'");
 ...
 */   
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        java.sql.Connection con;
         ...
         java.sql.Statement ps = connectDB.createStatement();            
            ...
            pstmt.setObject(3,jTable12.getValueAt(i,0));
            pstmt.setString(4,"");
   ...
   // } else{ 
       //   if (jComboBox1.getSelectedItem().equals("loan_transactions")) {
            ...
            pstm.setObject(1,jTable1.getValueAt(i,1));
            pstm.setObject(2,jTable1.getValueAt(i,6));
            pstm.setObject(3,jTable1.getValueAt(i,2));
           ...
           // pstm.setObject(14,"00");
            ...
            pstm.setObject(17,jTable1.getValueAt(i,3));
             }
             if(jTable1.getValueAt(i,4) == null){
                 pstm.setString(18,"00");
             } else{
            pstm.setObject(18,jTable1.getValueAt(i,4));
             }
            pstm.setObject(19,"");
            pstm.setObject(20,"Journal");
            pstm.setObject(21,"");
            pstm.setObject(22,jTable1.getValueAt(i,5));
         ...
         // if (table1 =="loan_transactions") {
            ...
            pst.setObject(2,jTable11.getValueAt(i,5));
            pst.setObject(3,"");
            pst.setString(4,"00");
            pst.setObject(5,"");
            pst.setObject(6,"");
