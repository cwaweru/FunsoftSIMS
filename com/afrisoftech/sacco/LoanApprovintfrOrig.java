 ...
 * @author  root
 */
public class LoanApprovintfrOrig extends javax.swing.JInternalFrame {
    ...
    public LoanApprovintfrOrig(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
            ...
            if (LoanNo < 1) {
                ...
                try {
                    ...
                    while (res.next()){
                        ...
                        jTextField37.setText(res.getObject(17).toString());
                        // jTextField1
                    }
                    res.close();
                    stmt.close();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (LoanNo < 1) {
            ...
            try {
                java.sql.Statement stmt = connectDB.createStatement();
                java.sql.ResultSet res = stmt.executeQuery("select member_name,department,workstation,position_in_sacco,service_terms,birth_date,loan_purpose,"+
                "repayment_period,(monthly_income* ((0.66)::NUMERIC)),member_no,loan_amount,loan_type,"+
