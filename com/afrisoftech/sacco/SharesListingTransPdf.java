...
public class SharesListingTransPdf implements java.lang.Runnable {
    ...
    public void SharesListingTransPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate) {
        connectDB = connDb;
        beginDate = begindate;
        endDate = endate;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Member Shares Listing between " +dateFormat.format(beginDate)+" and "+dateFormat.format(endDate), pFontHeader);
