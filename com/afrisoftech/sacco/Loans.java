 ...
 * loans.java
 *
 * Created on May 05, 2003, 06:33 PM
*/
...
public class Loans extends javax.swing.JFrame
{
    ...
    public Loans(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select * from loan");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        try {
            nBCachedRowSet1.setTableName("loan");
        } catch (java.sql.SQLException e1) {
            e1.printStackTrace();
        }
        ...
        jTable1.setModel(new org.netbeans.lib.sql.models.TableModel(nBCachedRowSet1, new org.netbeans.lib.sql.models.TableModel.Column[] {
            ...
            new org.netbeans.lib.sql.models.TableModel.Column("l_type", "L type", true)
        }));
