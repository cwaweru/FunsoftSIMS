 ...
 * @author  root
 */
public class BBFDeductionsintfr extends javax.swing.JInternalFrame implements java.lang.Runnable {
    ...
    public BBFDeductionsintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel21.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter details here"));
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "You can either search the member by TSC no. or by name. You click the top left hand corner cell in the table below for the search.", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10)));
    ...
    private void jTextField11CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11CaretUpdate
        ...
        if(this.jCheckBox2.isSelected()){
            ...
            if(jTextField11.getCaretPosition() < 3){
                ...
                if(jComboBox1.getSelectedItem().toString().equalsIgnoreCase("BBF")){
                    ...
                    */
                    ...
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select m_number,first_name||' '||middle_name||' '||last_name AS name,department from member where first_name||' '||middle_name||' '||last_name ILIKE '"+jTextField11.getText()+"%' ORDER BY first_name||' '||middle_name||' '||last_name"));
                    //to here
                    /*
                    try {
            ...
            //here
            if(jComboBox1.getSelectedItem().toString().equalsIgnoreCase("BBF")){
                   jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB, "select m_number,first_name||' '||middle_name||' '||last_name AS name,department from member where first_name||' '||middle_name||' '||last_name ILIKE '"+jTextField11.getText()+"%' ORDER BY first_name||' '||middle_name||' '||last_name"));//||' '||second_name||' '||last_name"));
                /*
                 try {
  ...
  /*  private void cmbox1ActionPerformed(java.awt.event.ActionEvent evt){
    ...
    private void jButton301ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton301ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsetX = stmtX.executeQuery("select count(sacco_no) from sacco_deductions where sacco_no ilike '"+jTable1.getValueAt(i,2).toString()+"' and trans_type ilike 'BBF'");
           ...
           */        
                    ...
                    if (jTable1.getModel().getValueAt(i,0) != null){
                       // if (item < 0){
                        ...
                        pstmt.setObject(13,jTable1.getValueAt(i,5).toString());
                            
                        
                        pstmt.executeUpdate();
                        
                       /* }else{
                          java.sql.PreparedStatement pstmt3W = connectDB.prepareStatement("UPDATE sacco_deductions SET amount= '"+jTable1.getValueAt(i,3).toString()+"', balance = '"+jTable1.getValueAt(i,3).toString()+"', month_deduction = '"+jTable1.getValueAt(i,4).toString()+"', bbf_join_date = '"+jTable1.getValueAt(i,5).toString()+"' where sacco_no = '"+jTable1.getValueAt(i,2).toString()+"' and trans_type ilike  'BBF%'");
                        ...
                        */
                        if(jComboBox1.getSelectedItem().toString().equalsIgnoreCase("NORMAL SHARES")){
                            ...
                            pstmt1.setObject(18,"");
                            pstmt1.setObject(19,"");
                            pstmt1.setObject(20,"BBF OPENING BALANCE");
                            ...
                            pstmt1x.setObject(11,"BBF Contribution");
                        ...
                        if(jComboBox1.getSelectedItem().toString().equalsIgnoreCase("BBF")){
                            ...
                            java.sql.PreparedStatement pstmtAB = connectDB.prepareStatement("update member set bbf_join_date = '"+jTable1.getValueAt(i,5).toString()+"' WHERE payroll_no = '"+jTable1.getModel().getValueAt(i,2).toString()+"' and payroll_no !='' and payroll_no notnull");
