...
public class LoanInArreasPdf implements java.lang.Runnable {
	...
	public void LoanInArreasPdf(java.sql.Connection connDb) {
                connectDB = connDb;
...
//		new LoanInArreasPdf().LoanInArreasPdf();
    ...
    public void generatePdf() {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Loan in arreas - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        int headerwidths[] = {10,10,20,15,15,15,15};
        ...
        Phrase phrase = new Phrase("Loan in Arreas as at: " +date, pFontHeader);
        ...
        //    table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
          // table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
           ...
           table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
             ...
             phrase = new Phrase("Loan Amount KShs.",pFontHeader);
            table.addCell(phrase);
            
             phrase = new Phrase("Amt Paid KShs.",pFontHeader);
            table.addCell(phrase);            
           phrase = new Phrase("Principal in Arreas KShs.",pFontHeader);
            table.addCell(phrase);
             phrase = new Phrase("Intr.in Arreas KShs.",pFontHeader);
            table.addCell(phrase);
         ...
         try {
            ...
            java.sql.ResultSet rset = st.executeQuery("select loan_account_no,member_no,initcap(member_name),sum(principal),sum(principal_paid),sum(principal - principal_paid),SUM(interest - interest_paid) from loan_transactions Group BY loan_account_no,member_no,member_name ORDER BY loan_account_no");
            
            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(principal),sum(principal_paid),sum(principal - principal_paid),sum(interest - interest_paid) from loan_transactions"); 
           ...
           table.addCell(phrase);
            ...
            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);         
           phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rsetTotals.getString(3)), pFontHeader1);
           table.addCell(phrase);
           
             table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);         
           phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rsetTotals.getString(4)), pFontHeader1);
            table.addCell(phrase);
