...
public class LoanStatementPdf implements java.lang.Runnable {
	...
	public void LoanStatementPdf(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate, java.lang.String combox) {
...
//		new LoanStatementPdf().LoanStatementPdf(args[0]);
    ...
    public void generatePdf(java.lang.String memNo) {
      ...
      //  com.lowagie.text.HeaderFooter headerFoter = new com.lowagie.text.HeaderFooter(new Phrase(""+compName+""),false);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 14, Font.BOLDITALIC,java.awt.Color.blue)));
        ...
        docPdf.setHeader(headerFoter);
            ...
            com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Loan Statement - Page: "), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
        ...
        int headerwidths[] = {10,10,15,10,10,15,15,15};
        ...
        table.setWidthPercentage((100));
           ...
           Phrase phrase = new Phrase("Loan Statement as at : " +endDate, pFontHeader);
         ...
         try {
          ...
          //  java.sql.ResultSet rset = st.executeQuery("select DISTINCT member_code, member_name,date from shares_transactions order by member_code");
             java.sql.ResultSet rset = st.executeQuery("select payroll_no,initcap(first_name||' '||middle_name||' '||last_name),present_address,present_town,tel_no from member where payroll_no = '"+memNo+"'");
             java.sql.ResultSet rset1 = st1.executeQuery("select date,member_no,member_name,principal,credit,monthly_repayment,principal_paid from loan_transactions where member_no = '"+memNo+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by date");
           java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(interest_paid),sum(principal),sum(principal_paid),sum(principal - principal_paid) from loan_transactions where member_no = '"+memNo+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' group byorder by date");
           ...
           table.addCell(phrase);
            ...
            phrase = new Phrase(rset1.getObject(4).toString(), pFontHeader1);
         ...
         //  table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);         
           ...
           phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rsetTotals.getString(4)),pFontHeader);
