 ...
 * @author  root
 */
public class ActivatePatNointfr extends javax.swing.JInternalFrame {
    ...
    public ActivatePatNointfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jLabel21.setText("-");
        jPanel21.add(jLabel21, new java.awt.GridBagConstraints());
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Search or Type Details"));
        ...
        jLabel14.setText("Patient Entry Point");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jRadioButton1.setText("Patient Name");
        ...
        jRadioButton2.setText("Patient No.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
...
// jPanel2.invalidate();
            ...
            System.out.print("Nothing");
                ...
                if(jRadioButton2.isSelected()){
                    if(jCheckBox2.isSelected()){
                        jSearchTable221.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select patient_no as pat_no,name,'Cash' from hp_patient_visit where name ILIKE '"+jTextField11321.getText()+"%' order by name"));
                        
                        
                        jSearchScrollPane221.setViewportView(jSearchTable221);
                    }else{
                        if(jCheckBox1.isSelected()){
                              jSearchTable221.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select patient_no as pat_no,name,'Cash' from hp_patient_visit where patient_no ILIKE '"+jTextField11321.getText()+"%' order by name"));
   ...
   */
        ...
        if(this.jTextField1132.getCaretPosition() < 0){
            ...
            if(jRadioButton1.isSelected()){
                if(jCheckBox2.isSelected()){
                    ...
                    if(jCheckBox1.isSelected()){
                        jSearchTable22.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select patient_no as pat_no,second_name||' '|| first_name as name,pay_mode from hp_patient_register where patient_no ILIKE '"+jTextField1132.getText()+"%' order by patient_no"));
                ...
                if(jRadioButton2.isSelected()){
                    if(jCheckBox2.isSelected()){
                        ...
                        if(jCheckBox1.isSelected()){
                            jSearchTable22.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select patient_no as pat_no,second_name||' '|| first_name as name,pay_mode from hp_patient_register where second_name||' '|| first_name ILIKE '"+jTextField1132.getText()+"%' order by name"));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        int exitOption = javax.swing.JOptionPane.showConfirmDialog(this, "Are you sure You would like to Activate Patient No. '"+jTextField911.getText()+"'?", "Caution before Activating Account!", javax.swing.JOptionPane.YES_NO_CANCEL_OPTION);
        ...
        if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
            ...
            try {
               ...
               /* if(jCheckBox2.isSelected()){
                         ...
                         java.sql.PreparedStatement pstmt221C = connectDB.prepareStatement("UPDATE hp_patient_card set CARD_no = PATIENT_NO WHERE patient_no = '"+jTextField911.getText()+"' OR patient_no = '"+jTextField91.getText()+"'");
                        pstmt221C.executeUpdate();
                    
                          java.sql.PreparedStatement pstmt221Cdd = connectDB.prepareStatement("UPDATE ac_debtors SET admission_no = '"+jTextField91.getText()+" WHERE admission_no = '"+jTextField911.getText()+"' ");
                        pstmt221Cdd.executeUpdate();
                    ...
                    java.sql.PreparedStatement pstmt2223 = connectDB.prepareStatement("UPDATE ac_cash_collection set patient_no = '"+jTextField91.getText()+"', dealer = '"+jTextField71.getText()+"' WHERE patient_no = '"+jTextField911.getText()+"'");
                    ...
                    java.sql.PreparedStatement pstmt2211 = connectDB.prepareStatement("UPDATE hp_admission set patient_no = '"+jTextField91.getText()+"', patient_name = '"+jTextField71.getText()+"' WHERE patient_no = '"+jTextField911.getText()+"'");
                    pstmt2211.executeUpdate();
                    
                    java.sql.PreparedStatement pstmt22111 = connectDB.prepareStatement("UPDATE hp_patient_discharge set patient_no = '"+jTextField91.getText()+"', patient_name = '"+jTextField71.getText()+"' WHERE patient_no = '"+jTextField911.getText()+"'");
                    ...
                    pstmt222.executeUpdate();
                     ...
                     java.sql.PreparedStatement pstmt221111C = connectDB.prepareStatement("UPDATE hp_pharmacy set DOCTOR = patient_no, patient_name = '"+jTextField71.getText()+"' WHERE patient_no = '"+jTextField911.getText()+"' OR patient_no = '"+jTextField91.getText()+"'");
                    pstmt221111C.executeUpdate();
                    ...
                    java.sql.PreparedStatement pstmtz = connectDB.prepareStatement("UPDATE hp_patient_card set visit_id = '"+jTextField2.getText()+"' WHERE visit_id = '"+jTextField1.getText()+"' and invoice_no not like 'I%'");
                    pstmtz.executeUpdate();
                    
                   // java.sql.PreparedStatement pstmt22a = connectDB.prepareStatement("delete from hp_inpatient_register WHERE patient_no = '"+jTextField911.getText()+"'");
                  //  pstmt22a.executeUpdate();
                }else{*/
                    
                    if(jCheckBox1.isSelected()){
                     java.sql.Statement stmtp = connectDB.createStatement();
                            java.sql.ResultSet rsetp = stmtp.executeQuery("select patient_no from hp_patient_register where patient_no ='"+this.jTextField911.getText()+"' AND patient_no != ''");
                            while (rsetp.next()){
                                patientNo = rsetp.getObject(1).toString();
                            }
                            
                            
                            if(this.jTextField911.getText().equalsIgnoreCase(patientNo)){
                                jLabel21.setForeground(java.awt.Color.red);
                                jLabel21.setText("Patient No. Already On File");
                                ...
                                java.sql.Statement stm1 = connectDB.createStatement();
                                                                                   ...
                                                                                   pstmt.setString(1,jTextField911.getText());
                                                                                       ...
                                                                                       pstmt.setString(3,jTextField71.getText());
                                                                                    pstmt.setString(4,"");
                                                                                        pstmt.setString(5,"");
                                                                                    ...
                                                                                    pstmt.setObject(8,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                                                                                    pstmt.setString(9,"");
                                                                                           pstmt.setString(10,"Male");
                                                                              
                                                                                    
                                                                                    pstmt.setDate(11,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate()));
                                                                                 pstmt.setString(12,jTextField41.getText());
                                                                                   pstmt.setString(13,jTextField41.getText());
                                                                                    pstmt.setString(14,"-");
                                                                                    pstmt.setString(15,"-");
                                                                                    ...
                                                                                    pstmt.setString(29,"-");
                                                                                    pstmt.setString(30,"-");
                                                                                    pstmt.setObject(31,"Single");
                                                                                    pstmt.executeUpdate();
                                
                                             // java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hp_patient_register values(first_name='"+jTextField1.getText()+"',  second_name='"+jTextField71.getText()+"',  nok='-',   residence='-',  address='-',  year_of_birth='"+com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate())+"',  tel_no='-',  sex='Male',  date='"+com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate())+"',  pay_mode='"+jTextField41.getText()+"',  payer='-',  account_no='-',  description='Cash',  category='"+jComboBox4.getSelectedItem()+"',"+
                                             //   "expiry_date='"+com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate())+"',  last_visit='"+com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate())+"',  department='"+jComboBox4.getSelectedItem()+"',  member_name='-',  card_no='-',  emails='-',  id_no='-',  nok_add='-', patient_no='-', pat_nationality='KENYAN', nok_telno='-',nok_relationship='-',nok_residence='-',nok_email='-',pat_marital_status='-')'");
                        ...
                        pstmt221.executeUpdate();
                           ...
                           java.sql.PreparedStatement pstmt221bC = connectDB.prepareStatement("UPDATE hp_patient_billing set DOCTOR=patient_no, patient_name = '"+jTextField71.getText()+"' WHERE patient_no = '"+jTextField911.getText()+"' OR patient_no = '"+jTextField91.getText()+"'");
                        pstmt221bC.executeUpdate();
                        
                         java.sql.PreparedStatement pstmt221b = connectDB.prepareStatement("UPDATE hp_patient_billing set patient_no = '"+jTextField91.getText()+"', patient_name = '"+jTextField71.getText()+"' WHERE patient_no = '"+jTextField911.getText()+"'");
                        pstmt221b.executeUpdate();
               ...
               // }
                ...
                javax.swing.JOptionPane.showMessageDialog(this,"Data Inserted Successfully\n Pls Select the number now for activation ","Confirmation Message!",javax.swing.JOptionPane.INFORMATION_MESSAGE);
