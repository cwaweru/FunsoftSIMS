                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(credit) from hp_patient_card where reference = '"+memNo+"'and paid = 'true' and service != 'Invoice'");
                            ...
                            java.sql.ResultSet rsetTotals1 = st21.executeQuery("select sum(credit) from hp_patient_card where reference = '"+memNo+"'");
