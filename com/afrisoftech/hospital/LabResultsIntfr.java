        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class, java.lang.Double.class, java.lang.Integer.class
            };
    ...
    private void jSearchTable21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable21MouseClicked
        ...
        if(this.jCheckBox1.isSelected()){
            ...
            try {
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT typeof_test,lower_limit,upper_limit,standard FROM pb_lab_standards where test = '"+this.jTextField91.getText()+"'");
            ...
            try {
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT typeof_test,status FROM pb_lab_standards where test = '"+this.jTextField91.getText()+"'");
