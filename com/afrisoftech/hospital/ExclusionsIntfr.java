 ...
 * @author  root
 */
public class ExclusionsIntfr extends javax.swing.JInternalFrame {
    ...
    public ExclusionsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Set Type of exclusions here."));
...
private void cmboxActionPerformed(java.awt.event.ActionEvent evt){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       javax.swing.JFrame off = new Exclusions(connectDB, pConnDB);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       // java.lang.Object name = "false"; 
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into pb_scheme_exclutions values(?)");
          ...
          //  pstmt.setObject(1,jComboBox1.getSelectedItem().toString());
           //  pstmt.setDate(4, datenowSql);
            if (jTable1.getModel().getValueAt(i,0) == null){
                        ...
                        javax.swing.JOptionPane.showMessageDialog(this,"Enter Type of exclusion","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
                    }else{
