 ...
 * Bank.java
 *
 * Created on Sep 04, 2003, 02:27 PM
*/
...
public class Bank extends javax.swing.JFrame
{
   ...
   java.sql.Connection connectDB = null;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select gl_code,bank_account_no,bank_name,bank_account_name,branch_name from ac_banks_setup");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        try {
            nBCachedRowSet1.setTableName("ac_banks_setup");
        } catch (java.sql.SQLException e1) {
            e1.printStackTrace();
        }
