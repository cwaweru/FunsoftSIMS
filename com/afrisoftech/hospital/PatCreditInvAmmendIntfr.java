 ...
 * @author  root
 */
public class PatCreditInvAmmendIntfr extends javax.swing.JInternalFrame {
    ...
    public PatCreditInvAmmendIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        */
        ...
        //try {
            ...
            */
            ...
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
            jPanel31.add(jTextField6, gridBagConstraints);
...
// TODO add your handling code here:
    ...
    private void jTextField112CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField112CaretUpdate
        if(jCheckBox1.isSelected()){
            ...
            javax.swing.JOptionPane.showMessageDialog(this,"You have to click services offered".toUpperCase(),"Caution Message",javax.swing.JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jSearchTable22MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable22MouseClicked
        ...
        jTextField91.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 0).toString());
         jTextField71.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 2).toString());
                    jTextField81.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 3).toString());
                    jTextField41.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 4).toString());
                    jTextField21.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 5).toString());
                    jTextField31.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 6).toString());
                    jTextField13.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 7).toString());
                     jTextField21.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 6).toString());
       jTextField6.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 8).toString());
        //jTextField7.setText(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 3).toString());
    ...
    private void jTextField1132CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1132CaretUpdate
        if(this.jTextField1132.getCaretPosition() < 5){
            ...
            jSearchTable22.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select DISTINCT invoice_no,PATIENT_no,scheme,account_no,payer,amount,amount,patient_name,reference from final_invoices  where invoice_no ILIKE '"+jTextField1132.getText()+"%' order by invoice_no"));
            ...
            try{
                ...
                try {
                    ...
                    if(jRadioButton2.isSelected() && jCheckBox1.isSelected() && jCheckBox5.isSelected()){
                        java.sql.PreparedStatement pstmt22 = connectDB.prepareStatement("UPDATE ac_debtors set balance = balance - '"+balance+"',debit = debit - '"+balance+"'  WHERE invoice_no = '"+jTextField91.getText()+"' and reference_no = '"+jTextField6.getText()+"'");
                        
                        pstmt22.executeUpdate();
                        java.sql.PreparedStatement pstmt223 = connectDB.prepareStatement("UPDATE HP_PATIENT_CARD set credit = credit - '"+balance+"'  WHERE invoice_no = '"+jTextField91.getText()+"' and service = 'Invoice' and reference = '"+jTextField6.getText()+"'");
                  ...
                  */
                    if(jRadioButton1.isSelected() && jCheckBox1.isSelected() && jCheckBox5.isSelected()){
                        java.sql.PreparedStatement pstmt224 = connectDB.prepareStatement("UPDATE ac_debtors set balance = balance + '"+balance+"',debit = debit + '"+balance+"'  WHERE invoice_no = '"+jTextField91.getText()+"' and reference_no = '"+jTextField6.getText()+"'");
                        
                        pstmt224.executeUpdate();
                        java.sql.PreparedStatement pstmt2234 = connectDB.prepareStatement("UPDATE HP_PATIENT_CARD set credit = credit + '"+balance+"'  WHERE invoice_no = '"+jTextField91.getText()+"' and service = 'Invoice' and reference = '"+jTextField6.getText()+"'");
