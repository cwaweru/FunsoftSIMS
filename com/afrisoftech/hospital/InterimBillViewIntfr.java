 ...
 * @author  root
 */
public class InterimBillViewIntfr extends javax.swing.JInternalFrame {
    ...
    public InterimBillViewIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void jCheckBox6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox6ActionPerformed
        ...
        try {
            ...
            if (j > 0){
                ...
                java.sql.ResultSet rsetTable1 = st1.executeQuery("select DISTINCT hp_patient_card.patient_no,patient_bill.description, hp_patient_card.dosage as quantity,round(hp_patient_card.debit/hp_patient_card.dosage::numeric,2)as price, hp_patient_card.debit,pb_activity.code as gl_code,hp_patient_card.main_service,hp_patient_card.date::date from hp_patient_card, pb_activity, patient_bill WHERE hp_patient_card.main_service ilike pb_activity.activity and hp_patient_card.reference = '"+jTextField10.getText()+"' and patient_bill.description = hp_patient_card.service AND hp_patient_card.transaction_type ilike 'billing' and hp_patient_card.credit = '0' and hp_patient_card.DOSAGE > 0 ");
    ...
    private void jTextField11CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11CaretUpdate
        if(jCheckBox21.isSelected()){
            if(jRadioButton1.isSelected()){
                jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select DISTINCT po.service_type,po.rate as price,po.gl_account as gl_code FROM pb_operating_parameters po,hp_patient_card pc WHERE po.service_type ILIKE '"+jTextField11.getText()+"%' AND po.main_service ilike '"+jComboBox1.getSelectedItem()+"%' and pc.patient_no = '"+jTextField9.getText()+"' AND pc.service = po.service_type and pc.main_service ilike '"+jComboBox1.getSelectedItem()+"%' UNION ALL select po.product,po.selling_price,po.gl_code as service_type FROM st_stock_prices po, hp_patient_card pc WHERE po.product ILIKE '"+jTextField11.getText()+"%' AND po.department ilike  '"+jComboBox1.getSelectedItem()+"'   AND pc.patient_no = '"+jTextField9.getText()+"' AND pc.service = po.product AND pc.main_service ilike '"+jComboBox1.getSelectedItem()+"%'"));
            }else{
                jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select DISTINCT po.service_type,po.anaesthetist_rate as price,po.gl_account as gl_code FROM pb_operating_parameters po,hp_patient_card pc WHERE po.service_type ILIKE '"+jTextField11.getText()+"%' AND po.main_service ilike '"+jComboBox1.getSelectedItem()+"%'  AND pc.patient_no = '"+jTextField9.getText()+"' AND pc.service = po.service_type AND pc.main_service ilike '"+jComboBox1.getSelectedItem()+"%'  UNION ALL select po.product,po.selling_price,po.gl_code as service_type FROM st_stock_prices po, hp_patient_card pc WHERE po.product ILIKE '"+jTextField11.getText()+"%' AND po.department ilike  '"+jComboBox1.getSelectedItem()+"'  AND pc.patient_no = '"+jTextField9.getText()+"' AND pc.service = po.product AND pc.main_service ilike '"+jComboBox1.getSelectedItem()+"%'"));
            ...
            if(jRadioButton1.isSelected()){
                jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select DISTINCT po.service_type,po.rate as price,po.gl_account as gl_code FROM pb_operating_parameters po,patient_bill pc WHERE po.service_type ILIKE '"+jTextField11.getText()+"%' AND po.main_service ilike '"+jComboBox1.getSelectedItem()+"%' and pc.patient_no = '"+jTextField9.getText()+"' AND pc.description = po.service_type and pc.main_service ilike '"+jComboBox1.getSelectedItem()+"%' UNION ALL select po.product,po.selling_price,po.gl_code as service_type FROM st_stock_prices po, patient_bill pc WHERE po.product ILIKE '"+jTextField11.getText()+"%' AND po.department ilike  '"+jComboBox1.getSelectedItem()+"'   AND pc.patient_no = '"+jTextField9.getText()+"' AND pc.description = po.product AND pc.main_service ilike '"+jComboBox1.getSelectedItem()+"%'"));
            }else{
                jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select DISTINCT po.service_type,po.anaesthetist_rate as price,po.gl_account as gl_code FROM pb_operating_parameters po,patient_bill pc WHERE po.service_type ILIKE '"+jTextField11.getText()+"%' AND po.main_service ilike '"+jComboBox1.getSelectedItem()+"%'  AND pc.patient_no = '"+jTextField9.getText()+"' AND pc.description = po.service_type AND pc.main_service ilike '"+jComboBox1.getSelectedItem()+"%'  UNION ALL select po.product,po.selling_price,po.gl_code as service_type FROM st_stock_prices po, patient_bill pc WHERE po.product ILIKE '"+jTextField11.getText()+"%' AND po.department ilike  '"+jComboBox1.getSelectedItem()+"'  AND pc.patient_no = '"+jTextField9.getText()+"' AND pc.description = po.product AND pc.main_service ilike '"+jComboBox1.getSelectedItem()+"%'"));
