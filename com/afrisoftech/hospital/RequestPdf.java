...
public class RequestPdf implements java.lang.Runnable {
    ...
    public void RequestPdf(java.sql.Connection connDb, java.lang.String combox, java.lang.String name, java.lang.String amount, java.lang.String receipt, java.lang.String paymode) {
    ...
    public void generatePdf(java.lang.String memNo) {
        ...
        try {
            ...
            try {
                ...
                java.sql.ResultSet rse1 = stm1.executeQuery("select header_font,body_font,width,height,margins from requisition_pref");
                while (rse1.next()){
            ...
            com.lowagie.text.Font pFontHeaderx = FontFactory.getFont(FontFactory.TIMES, bodyFont, Font.BOLD);
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset51 = st51.executeQuery("select distinct patient_no,patient_name from hp_patient_billing where requisition_no = '"+Receipt+"'");
                            
                            java.sql.ResultSet rset5 = st5.executeQuery("select INITCAP(service),quantity,amount,ROUND(sum(amount/quantity)) from hp_patient_billing where requisition_no = '"+Receipt+"' group by service,quantity,amount");
                            java.sql.ResultSet rset6 = st6.executeQuery("select distinct user_name from hp_patient_billing where requisition_no = '"+Receipt+"'");
                            java.sql.ResultSet rset61 = st61.executeQuery("select distinct revenue_code from hp_patient_billing where requisition_no = '"+Receipt+"'");
                            ...
                            while (rset3.next()){
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                table.getDefaultCell().setColspan(6);
                                phrase = new Phrase("     REQUISITION FORM", pFontHeader1);
                                
                                table.addCell(phrase);
                                while(rset61.next()){
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                                    table.getDefaultCell().setColspan(4);
                                    phrase = new Phrase("DEPARTMENT  "+ rset61.getObject(1).toString(), pFontHeader);
                                ...
                                phrase = new Phrase("Requisition No. "+ Receipt, pFontHeader);
                                ...
                                while (rset51.next()){
                                    MNo = rset51.getObject(1).toString();
                                    Name =  rset51.getObject(2).toString();
                                }
                                ...
                                while (rset1.next()){
                                    ...
                                    phrase = new Phrase("Description", pFontHeaderx);
                                    table.addCell(phrase);
                                    table.getDefaultCell().setColspan(1);
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                    
                                    phrase = new Phrase("Qty", pFontHeaderx);
                                    table.addCell(phrase);
                                    phrase = new Phrase("Unit Price", pFontHeaderx);
                                    table.addCell(phrase);
                                    //  table.addCell("Description");
                                    
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                    table.getDefaultCell().setColspan(1);
                                    phrase = new Phrase("Amount.", pFontHeaderx);
                                    table.addCell(phrase);
                                ...
                                while (rset5.next()){
                                    ...
                                    table.addCell(phrase);
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                    phrase = new Phrase(rset5.getObject(4).toString(), pFontHeader);
                                    ...
                                    table.addCell(phrase);
                                    Amount = Amount + rset5.getDouble(3);
                                ...
                                while (rset6.next()){
                                    ...
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase("Requested By : " +rset6.getString(1), pFontHeader);
                                    table.addCell(phrase);
                                    table.getDefaultCell().setColspan(6);
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase("Test Done By : _____________________________________" , pFontHeader);
                                    table.addCell(phrase);
