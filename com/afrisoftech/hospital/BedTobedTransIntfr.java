 ...
 * @author  root
 */
public class BedTobedTransIntfr extends javax.swing.JInternalFrame {
    ...
    public BedTobedTransIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Bed To Bed Transfer");
        setToolTipText("Bed to bed transfer");
        ...
        jButton41.setMnemonic('h');
        jButton41.setText("Help");
        ...
        jTextPane1.setBorder(new javax.swing.border.TitledBorder(null, "Transfer Reason", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP));
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("select patient_name,ward,bed_no from hp_admission where patient_no ='"+jTextField36.getText()+"'");
            while (rset.next()){
            ...
            jComboBox4.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB,"select bed_no from hp_bed_setup where ward  ILIKE '"+jTextField1.getText()+"%' and occupied = 'f' and available = 'Available' order by bed_no asc"));
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(this.jTextField1111.getCaretPosition() < 3){
            ...
            if(this.jCheckBox1.isSelected()){
                 jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select trim(patient_no) as Patient_no,patient_name as name from hp_admission where patient_no ILIKE '"+jTextField1111.getText().toString()+"%'  AND discharge = false ORDER BY patient_no"));
              ...
              */
                  ...
                  jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select trim(patient_no) as patient_no,patient_name as name from hp_admission where patient_name ILIKE '%"+jTextField1111.getText().toString()+"%' AND discharge = false ORDER BY patient_name"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hp_bed_to_bed_transfer values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            pstmt.setString(1,jTextField36.getText());
            pstmt.setString(2,jTextField2.getText());
            pstmt.setString(3,jTextField11.getText());
            pstmt.setString(4,jTextPane1.getText());
            ...
            java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("update hp_bed_setup set occupied = 'false' where bed_no ='"+jTextField3.getText()+"' and ward ilike '"+jTextField1.getText()+"%'");//,school ='"+jTable1.getColumn("School")+"',school_id ='"+jTable1.getColumn("School Id")+"'
            
            pstmt1.executeUpdate();
            
            
            java.sql.PreparedStatement pstmt2 = connectDB.prepareStatement("update hp_bed_setup set occupied = 'true' where bed_no ='"+jComboBox4.getSelectedItem()+"' and ward ilike '"+jTextField1.getText()+"%'");
            
            pstmt2.executeUpdate();
            
            java.sql.PreparedStatement pstmt22 = connectDB.prepareStatement("update hp_admission set bed_no  = '"+jComboBox4.getSelectedItem()+"' where patient_no ='"+jTextField36.getText()+"' and ward ilike '"+jTextField1.getText()+"%' AND discharge = false");
