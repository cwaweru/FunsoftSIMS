 ...
 * @author  root
 */
public class FinalisingInpatientBillIntfr2 extends javax.swing.JInternalFrame {
    ...
    public FinalisingInpatientBillIntfr2(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jLabel112.setText("Primary Patient No");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        ...
        jLabel8.setText("OutStanding Bill");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        jLabel41.setText("Debt Limit Amt");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        jCheckBox3.setText("Neighbourhood?");
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel212.add(jCheckBox3, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 5.0;
        gridBagConstraints.weighty = 1.0;
        jPanel212.add(jTextField21, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 0);
        jPanel212.add(jLabel113, gridBagConstraints);
   ...
   jCheckBox3.setSelected(false);   
    ...
    private void jSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTableMouseClicked
        ...
        jTextField16.setText(jSearchTable.getValueAt(jSearchTable.getSelectedRow(), 2).toString());
         jTextField21.setText(jSearchTable.getValueAt(jSearchTable.getSelectedRow(), 5).toString());
        ...
        try {
            ...
            if (j > 0) {
                ...
                java.sql.ResultSet rset11 = stmt11.executeQuery("select sum(debit-credit), sum(credit), sum(debit) from hp_patient_card where patient_no  ='"+jTextField9.getText()+"' AND visit_id = '"+jTextField16.getText()+"' AND (invoice_no NOT LIKE 'I%' OR invoice_no NOT LIKE 'O%')");
                while (rset11.next()){
                    jTextField17.setText(rset11.getObject(2).toString());
                        jTextField3111.setText(rset11.getObject(3).toString());
               jTextField3111.setText(rset11.getObject(1).toString());
                  ...
                  //  if(balance > 0){
                   ...
                   // }else{
                     ...
                     //   jTextField1.setText(rset11.getObject(0.00).toString());
                    //}
                }
...
//    java.sql.Statement pssq = connectDB.createStatement();
         ...
         pstmtAB.setString(1,jTextField9.getText());
                ...
                pstmtAB.executeUpdate();
                        ...
                        pstmt2x.setString(27,jTextField9.getText());
                ...
                pstmtA.setString(25,"IP");
                  pstmtA.setString(26,"OP");
                        ...
                        pstmtA.setString(31,jTextField21.getText());
                        pstmtA.setString(32,jTextField20.getText());
              ...
              //if (bill<balance){
                   ...
                   if (balance<Limit && balance>0){
                       ...
                       // pstmt21.setObject(26,"'now'");
                        ...
                        pstmt2.setString(27,jTextField20.getText());
                        pstmt2.executeUpdate();
                        ...
                        pstmt1.setString(31,jTextField21.getText());
                        pstmt1.setString(32,jTextField20.getText());
                        pstmt1.executeUpdate();
