 ...
 *
 * DiseaseCategory.java
 *
 * Created on Sep 10, 2003, 10:46 AM
*/
...
public class DiseaseCategory extends javax.swing.JFrame
{
    ...
    public DiseaseCategory(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select * from hp_disease_category");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        try {
            nBCachedRowSet1.setTableName("hp_disease_category");
        } catch (java.sql.SQLException e1) {
            e1.printStackTrace();
        }
        ...
        jTable1.setModel(new org.netbeans.lib.sql.models.TableModel(nBCachedRowSet1, new org.netbeans.lib.sql.models.TableModel.Column[] {
            new org.netbeans.lib.sql.models.TableModel.Column("category_code", "Category code", true),
            new org.netbeans.lib.sql.models.TableModel.Column("category_name", "Category name", true)
        }));
