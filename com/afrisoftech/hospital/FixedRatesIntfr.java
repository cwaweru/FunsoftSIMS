...
public class FixedRatesIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Service Code", "Service", "Normal Rate", "Special Rate"
            }
        ) {
        ...
        jComboBox2.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select '-' union all select category_description FROM pb_lab_maincategory WHERE department ilike '"+jComboBox1.getSelectedItem()+"'"));
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,1) != null){
                    ...
                    if(jButton1.getLabel().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE pb_operating_parameters SET service_type = '"+jTable1.getValueAt(i,1).toString()+"',rate = '"+jTable1.getValueAt(i,2).toString()+"',anaesthetist_rate = '"+jTable1.getValueAt(i,3).toString()+"' WHERE code = '"+jTable1.getValueAt(i,0).toString()+"' and sub_code = '"+jTextField2.getText().toString()+"'");
                        ...
                        if (j <= 0) {
                            ...
                            pstmt.setObject(10,jTextField2.getText());
                            pstmt.executeUpdate();
                        }
                    }
                }
