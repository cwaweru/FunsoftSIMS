 ...
 * @author  root
 */
public class DocAprovConfirmintfr extends javax.swing.JInternalFrame {
    ...
    public DocAprovConfirmintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel31.setBackground(new java.awt.Color(204, 204, 228));
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Cash", "Cheque", "Credit Card" }));
        ...
        jPanel3.setBackground(new java.awt.Color(204, 204, 228));
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Doctors Type", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jPanel4.setBackground(new java.awt.Color(204, 204, 228));
        ...
        jTabbedPane1.addTab("Doctor's Details", jPanel61);
 ...
 java.util.Calendar calendar = java.util.Calendar.getInstance();
        ...
        int exitOption = javax.swing.JOptionPane.showConfirmDialog(this, "Are you sure you woul like to un-approve?", "Caution before making changes!", javax.swing.JOptionPane.YES_NO_CANCEL_OPTION);
        
        if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
            
            try {
                connectDB.setAutoCommit(false);
                // if(jComboBox4.getSelectedItem().toString().equalsIgnoreCase("Cheque")){
                //         java.sql.PreparedStatement pstmt221C = connectDB.prepareStatement("begin work; UPDATE ac_doctors_ledger set ccard='"+jComboBox4.getSelectedItem().toString()+"', comiss_amount='"+jTextField2.getText()+"', credit_bal=0, per_paid=credit WHERE reference = '"+jTextField41.getText()+"' and acc_no= '"+jTextField911.getText()+"' AND input_date = '"+com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate())+"' AND PAID=true ;commit work");
               //         pstmt221C.executeUpdate();
                 //}else{
                               java.sql.PreparedStatement pstmt221C = connectDB.prepareStatement("begin work; UPDATE ac_doctors_ledger set ccard=null, comiss_amount=0, credit_bal=credit, per_paid=0 WHERE reference = '"+jTextField41.getText()+"' and acc_no= '"+jTextField911.getText()+"' AND input_date = '"+com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate())+"' AND PAID=true ;commit work");
                        pstmt221C.executeUpdate();
              
               //  }
                          //java.sql.PreparedStatement pstmt221Cdd = connectDB.prepareStatement("begin work; UPDATE HP_PHARMACY SET PAID = TRUE WHERE PATIENT_no = '"+jTextField911.getText()+"' AND date_PRESCRIBED = '"+com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate())+"' AND PAID=FALSE ;commit work");
...
// jPanel2.invalidate();
    ...
    private void jSearchTable221MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable221MouseClicked
        ...
        jTextField911.setText(jSearchTable221.getValueAt(jSearchTable221.getSelectedRow(), 1).toString());
        jTextField1.setText(jSearchTable221.getValueAt(jSearchTable221.getSelectedRow(), 0).toString());
            ...
            System.out.print("Nothing");
               ...
               if(jCheckBox1.isSelected()){
                ...
                if(jRadioButton1.isSelected()){
                    jSearchTable221.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select (first_name||' '||middle_name) as name,(staff_no) as DOC_CODE from pb_doctors_list where first_name||' '||middle_name ILIKE '%"+jTextField11321.getText()+"%'"));
                    
                    
                    jSearchScrollPane221.setViewportView(jSearchTable221);
                }else{
                     if(jRadioButton2.isSelected()){
                        jSearchTable221.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select (first_name||' '||middle_name) as name,(staff_no) as DOC_CODE from pb_doctors_list where staff_no  ilike '%"+jTextField11321.getText()+"%'"));
 ...
 int i = 0;
        ...
        jTextField41.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 3).toString());
       jTextField2.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 2).toString());
       jTextField3.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 5).toString());
    ...
    private void jTextField1132CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1132CaretUpdate
        if(this.jTextField1132.getCaretPosition() < 0){
           ...
           if(jCheckBox2.isSelected()){
            ...
            if(jRadioButton2.isSelected()){
                    jSearchTable22.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select patient_no as pat_no,patient_name, credit, reference, pat_inv as trans_no, input_date as date, user_name as user from ac_doctors_ledger where patient_no ILIKE '"+jTextField1132.getText()+"%'  and acc_no = '"+jTextField911.getText()+"'order by patient_no"));
            ...
            if(jRadioButton1.isSelected()){
                        jSearchTable22.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select patient_no as pat_no,patient_name, credit, reference, pat_inv as trans_no, input_date as date, user_name as user from ac_doctors_ledger where patient_name ILIKE '"+jTextField1132.getText()+"%'  and acc_no = '"+jTextField911.getText()+"' order by patient_no"));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
            ...
            try {
                connectDB.setAutoCommit(false);
                 if(jComboBox4.getSelectedItem().toString().equalsIgnoreCase("Cheque")){
                         java.sql.PreparedStatement pstmt221C = connectDB.prepareStatement("begin work; UPDATE ac_doctors_ledger set ccard='"+jComboBox4.getSelectedItem().toString()+"', comiss_amount='"+jTextField2.getText()+"', credit_bal=0, per_paid=credit WHERE reference = '"+jTextField41.getText()+"' and acc_no= '"+jTextField911.getText()+"' AND input_date = '"+jTextField3.getText()+"' AND PAID=true ;commit work");
                        pstmt221C.executeUpdate();
                 }else{
                            //   java.sql.PreparedStatement pstmt221C = connectDB.prepareStatement("begin work; UPDATE ac_doctors_ledger set ccard='"+jComboBox4.getSelectedItem().toString()+"', comiss_amount=0, credit_bal=0, per_paid=credit WHERE reference = '"+jTextField41.getText()+"' and acc_no= '"+jTextField911.getText()+"' AND input_date = '"+com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate())+"' AND PAID=true ;commit work");
                       java.sql.PreparedStatement pstmt221C = connectDB.prepareStatement("begin work; UPDATE ac_doctors_ledger set ccard='"+jComboBox4.getSelectedItem().toString()+"', comiss_amount=0, credit_bal=0, per_paid=credit WHERE reference = '"+jTextField41.getText()+"' and acc_no= '"+jTextField911.getText()+"' AND  input_date = '"+jTextField3.getText()+"' AND PAID=true ;commit work");
