 ...
 * @author  root
 */
public class ChangePatPaymodeIntfr_OKEY extends javax.swing.JInternalFrame {
    ...
    public ChangePatPaymodeIntfr_OKEY(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        if(jTextField111.getCaretPosition() < 1){
            ...
            if(jRadioButton2.isSelected()){
                ...
                if(jRadioButton1.isSelected()){
                    if(jCheckBox1.isSelected()){
                        jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, name, year_of_birth, residence,scheme_name,payer,account_no,last_visit from patient_select where patient_no ILIKE '%"+jTextField111.getText()+"%' order by patient_no"));
                        jSearchTable.setShowHorizontalLines(false);
                        jSearchScrollPane.setViewportView(jSearchTable);
                        
                    }else{
                        jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"SELECT patient_no, name, year_of_birth, residence,scheme_name,payer,account_no,last_visit from patient_select where name ILIKE '%"+jTextField111.getText()+"%' order by name"));
                        jSearchTable.setShowHorizontalLines(false);
                        jSearchScrollPane.setViewportView(jSearchTable);
                    }
                }
                ...
                if (jComboBox1.getSelectedItem().toString().equalsIgnoreCase("Scheme")) {
                    ...
                    try {
                        ...
                        if (jTextField4.getText().toString().equalsIgnoreCase("CASH")){
                            ...
                            java.sql.PreparedStatement pstmtx = connectDB.prepareStatement("begin work; UPDATE hp_patient_billing set payment_mode = '"+this.jComboBox1.getSelectedItem().toString()+"', paid = false WHERE patient_no  ='"+jTextField36.getText()+"' AND trans_date = '"+jTextField5.getText()+"' ;commit work");
                            pstmtx.executeUpdate();
                            ...
                            java.sql.PreparedStatement pstmtx1 = connectDB.prepareStatement("begin work; UPDATE hp_pharmacy set pay_mode = '"+this.jComboBox1.getSelectedItem().toString()+"', paid = false WHERE patient_no  ='"+jTextField36.getText()+"' AND date_prescribed = '"+jTextField5.getText()+"' ;commit work");
                            pstmtx1.executeUpdate();
                            
                            java.sql.PreparedStatement pstmtqx = connectDB.prepareStatement("begin work; UPDATE hp_patient_visit set payment = '"+this.jComboBox1.getSelectedItem().toString()+"' WHERE patient_no  ='"+jTextField36.getText()+"' AND date ='"+jTextField5.getText()+"';commit work");
                    ...
                    try {
                        ...
                        java.sql.PreparedStatement pstmtaCC = connectDB.prepareStatement("begin work; DELETE from credit_acc_slip WHERE patient_no  ='"+jTextField36.getText()+"' and pat_name  ='"+jTextField1.getText()+"' and account_no  = '"+jTextField3.getText()+"' and date='"+jTextField5.getText()+"' and payer ilike '"+jTextField6.getText()+"'and scheme ilike '"+jTextField4.getText()+"';commit work");
                        pstmtaCC.executeUpdate();
                        ...
                        java.sql.PreparedStatement pstmtq = connectDB.prepareStatement("begin work; UPDATE hp_patient_visit set payment = '"+this.jComboBox1.getSelectedItem().toString()+"' WHERE patient_no  ='"+jTextField36.getText()+"' AND date = '"+datePicker1.getDate()+"';commit work");
