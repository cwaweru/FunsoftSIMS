 ...
 * @author  root
 */
public class ChangePatPaymodeIntfr1 extends javax.swing.JInternalFrame {
    ...
    public ChangePatPaymodeIntfr1(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        if(jRadioButton2.isSelected()){
            ...
            if(jRadioButton1.isSelected()){
                try {
                    ...
                    java.sql.PreparedStatement pstmtx = connectDB.prepareStatement("begin work; UPDATE hp_patient_register set description = '-',pay_mode = '"+this.jComboBox1.getSelectedItem().toString()+"',payer = '-',account_no = '-',card_no ='-',expiry_date = null,member_name ='-' WHERE patient_no  ='"+jTextField36.getText()+"';commit work");
                    pstmtx.executeUpdate();
                    java.sql.PreparedStatement pstmtqx1 = connectDB.prepareStatement("begin work; UPDATE hp_patient_visit set payment = '"+this.jComboBox1.getSelectedItem().toString()+"' WHERE patient_no  ='"+jTextField36.getText()+"' AND date = '"+datePicker1.getDate()+"';commit work");
                ...
                if (jComboBox1.getSelectedItem().toString().equalsIgnoreCase("Scheme")) {
                    ...
                    try {
                        ...
                        java.sql.PreparedStatement pstmtx = connectDB.prepareStatement("begin work; UPDATE hp_patient_billing set payment_mode = '"+this.jComboBox1.getSelectedItem().toString()+"', paid = false WHERE patient_no  ='"+jTextField36.getText()+"' AND trans_date = '"+datePicker1.getDate()+"' ;commit work");
                        pstmtx.executeUpdate();
                        
                        java.sql.PreparedStatement pstmtx1 = connectDB.prepareStatement("begin work; UPDATE hp_pharmacy set pay_mode = '"+this.jComboBox1.getSelectedItem().toString()+"', paid = false WHERE patient_no  ='"+jTextField36.getText()+"' AND date_prescribed = '"+datePicker1.getDate()+"' ;commit work");
                        pstmtx1.executeUpdate();
                        
                        java.sql.PreparedStatement pstmtqx = connectDB.prepareStatement("begin work; UPDATE hp_patient_visit set payment = '"+this.jComboBox1.getSelectedItem().toString()+"' WHERE patient_no  ='"+jTextField36.getText()+"' AND date = '"+datePicker1.getDate()+"';commit work");
                    ...
                    try {
                        java.sql.PreparedStatement pstmt = connectDB.prepareStatement("begin work; UPDATE hp_patient_register set pay_mode = '"+this.jComboBox1.getSelectedItem().toString()+"' WHERE patient_no  ='"+jTextField36.getText()+"';commit work");
                        pstmt.executeUpdate();
