 ...
 * @author  root
 */
public class ReverseFinalInvIntfr extends javax.swing.JInternalFrame {
    ...
    public ReverseFinalInvIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
            ...
            */
            jSearchTable221.addMouseListener(new java.awt.event.MouseAdapter() {
                ...
                public void mouseEntered(java.awt.event.MouseEvent evt) {
                    jSearchTable221MouseEntered(evt);
                }
            });
            ...
            setVisible(true);
            getAccessibleContext().setAccessibleName("Rversing a final invoice");
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 0;
            ...
            jPanel31.setBorder(javax.swing.BorderFactory.createTitledBorder("Invoice Details"));
            ...
            jPanel31.add(jTextField82, gridBagConstraints);

            jLabel102.setText("Dispatch No.");
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 1;
            gridBagConstraints.gridy = 8;
            gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
            gridBagConstraints.insets = new java.awt.Insets(0, 30, 0, 0);
            jPanel31.add(jLabel102, gridBagConstraints);
            ...
            jButton11.setText("Reverse Invoice");
            ...
            jTabbedPane1.addTab("Reverse Final Invoices", jPanel61);
    ...
    private void jSearchTable221MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable221MouseEntered
// TODO add your handling code here:
    }//GEN-LAST:event_jSearchTable221MouseEntered
    ...
    private void jSearchTable221MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable221MouseClicked
        ...
        jTextField14.setText(jSearchTable221.getValueAt(jSearchTable221.getSelectedRow(), 1).toString());
        ...
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("select SCHEME,account_no,PAYER,AMOUNT AS DEBIT,AMOUNT AS AMOUNT,ex_disp_no from FINAL_INVOICES where invoice_no ='"+jTextField911.getText()+"'");
            while (rset.next()){
                ...
                jTextField82.setText(rset.getObject(6).toString());   
    ...
    private void jTextField11321CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11321CaretUpdate
        if(this.jTextField11321.getCaretPosition() < 2){
            ...
            jSearchTable221.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select invoice_no,PATIENT_no as pat_no,PATIENT_name,date,reference from FINAL_INVOICES  where invoice_no ILIKE '"+jTextField11321.getText()+"%' order by invoice_no"));
    ...
    private void jSearchTable22MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable22MouseClicked
        ...
        jTextField61.setText(jSearchTable22.getValueAt(jSearchTable22.getSelectedRow(), 3).toString());
        jTextField123.setText(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(), 4).toString());
    ...
    private void jTextField1132CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1132CaretUpdate
        if(this.jTextField1132.getCaretPosition() < 2){
            ...
            jSearchTable22.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select invoice_no,admission_no as pat_no,item as name,date,reference_no from ac_debtors  where invoice_no ILIKE '"+jTextField1132.getText()+"%' order by invoice_no"));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        try{
            ...
            try {
                ...
                if(jTextField81.getText().toString().equalsIgnoreCase("C00080") & jTextField911.getText().toString().startsWith("0")){
                           java.sql.PreparedStatement pstmt3wr = connectDB.prepareStatement("INSERT INTO HP_PATIENT_CARD(patient_no, service,  patient_category,  payment_mode,  reference,  card_no,  scheme,  card_name,  isurer,  expiry_date,  doctor,  debit,  credit,"+
                        "date,  activity_code,  main_service,  dosage,  scheme_staff_no,  paid,  transaction_type,  collected,  description,  invoice_no,  user_name, cash_point,  ip_no,  billing_time,  visit_id,  requisition_no,  result_collected) SELECT patient_no,  service,"+
                        "patient_category,  payment_mode,  reference||'-'||'Rev',  card_no,  scheme,  card_name,  isurer,  expiry_date,  'Reversal of invoice',  credit,  debit,  date,  activity_code,  main_service,  dosage,  scheme_staff_no,  paid,  transaction_type,  collected,  description, " +
                        " invoice_no,  user_name,  cash_point,  ip_no,  billing_time,  visit_id,  requisition_no,  result_collected from hp_patient_card where patient_no = '"+jTextField14.getText()+"' AND reference = '"+jTextField911.getText()+"' and service = 'N.H.I.F'");
                pstmt3wr.executeUpdate();
                
                      java.sql.PreparedStatement pstmt3wrc = connectDB.prepareStatement("insert into ac_debtors (activity_code,  dealer,  item,  admission_no,  payee,  reason,  account_no,  receipt_no,  cheque_no,  journal_no,  reference_no,  transaction_type,  debit,  credit,  date," +
                        "  invoice_no,  description,  approved,  paid,  user_name,  cash_point,  balance,  sent,  credit_bal,  dispatch_no,  dispatch_date,  provision,  prov_amt, prov_date,  prov_user,  write_off,  wrt_amt,  wrt_date, wrt_user,  member_no) select activity_code,  dealer,  'Reversal wrong Inv-'||invoice_no, " +
                        "  admission_no, payee,  reason,  account_no,  receipt_no,  cheque_no,  journal_no,  reference_no||'-'||'Rev',  'Invoice reversal',  credit,  debit,  date,  invoice_no,  description,  approved,  paid,  user_name,  cash_point,  0,  sent,  credit_bal,  dispatch_no,  dispatch_date," +
                        "  provision,  prov_amt,  prov_date,  prov_user,  write_off,  wrt_amt,  wrt_date,  wrt_user,  member_no from ac_debtors where invoice_no = '"+jTextField911.getText()+"'  and admission_no = '"+jTextField14.getText()+"'  and reference_no = '"+jTextField122.getText()+"'  and account_no = '"+jTextField81.getText()+"' ");
                pstmt3wrc.executeUpdate();
                       ...
                       java.sql.PreparedStatement pstmt3wr = connectDB.prepareStatement("INSERT INTO HP_PATIENT_CARD(patient_no, service,  patient_category,  payment_mode,  reference,  card_no,  scheme,  card_name,  isurer,  expiry_date,  doctor,  debit,  credit,"+
                        "date,  activity_code,  main_service,  dosage,  scheme_staff_no,  paid,  transaction_type,  collected,  description,  invoice_no,  user_name, cash_point,  ip_no,  billing_time,  visit_id,  requisition_no,  result_collected) SELECT patient_no,  service,"+
                        "patient_category,  payment_mode,  reference||'-'||'Rev',  card_no,  scheme,  card_name,  isurer,  expiry_date,  'Reversal of invoice',  credit,  debit,  date,  activity_code,  main_service,  dosage,  scheme_staff_no,  paid,  transaction_type,  collected,  description, " +
                        " invoice_no,  user_name,  cash_point,  ip_no,  billing_time,  visit_id,  requisition_no,  result_collected from hp_patient_card where patient_no = '"+jTextField14.getText()+"' AND invoice_NO = '"+jTextField911.getText()+"'");
                pstmt3wr.executeUpdate();
                ...
                java.sql.PreparedStatement pstmt3wrcd = connectDB.prepareStatement("update ac_debtors  set balance=0, sent=true  WHERE invoice_no = '"+jTextField911.getText()+"' and reference_no = '"+jTextField122.getText()+"' and admission_no = '"+jTextField14.getText()+"' ");
                pstmt3wrcd.executeUpdate();
...
//        searchButton2Clicked();        // Add your handling code here:
    ...
    private void jTextField113CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField113CaretUpdate
        ...
        if(this.jTextField113.getCaretPosition() < 2){
            ...
            jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select invoice_no,admission_no as pat_no,item as name,date,reference_no from ac_debtors  where invoice_no ILIKE '"+jTextField113.getText()+"%' order by invoice_no"));
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        try {
            ...
            java.sql.Statement stmt = connectDB.createStatement();
            java.sql.ResultSet rset = stmt.executeQuery("select payee,account_no,dealer,debit,balance,dispatch_no from ac_debtors where invoice_no ='"+jTextField9.getText()+"'");
            while (rset.next()){
                // jComboBox6.setSelectedItem(rset.getObject(1).toString());
 ...
 */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            java.sql.PreparedStatement pstmt22 = connectDB.prepareStatement("UPDATE ac_debtors set payee = '"+jTextField7.getText()+"',dealer = '"+jTextField4.getText()+"',account_no = '"+jTextField8.getText()+"',balance = '"+jTextField2.getText()+"',debit = '"+jTextField2.getText()+"',date = '"+jTextField6.getText()+"',journal_no = '"+jTextField12.getText()+"', DISPATCH_no = '"+jTextField16.getText()+"' WHERE invoice_no = '"+jTextField9.getText()+"'");
            pstmt22.executeUpdate();
            // if(jTextField9.getText().toString().toUpperCase().startsWith("O")){
            java.sql.PreparedStatement pstmt222 = connectDB.prepareStatement("UPDATE hp_patient_card set date = '"+jTextField6.getText()+"',credit ='"+jTextField2.getText()+"' WHERE invoice_no = '"+jTextField9.getText()+"' and service = 'Invoice' AND reference='"+jTextField17.getText()+"'");
            pstmt222.executeUpdate();
            
            java.sql.PreparedStatement pstmt221 = connectDB.prepareStatement("UPDATE hp_patient_register set CARD_no ='"+jTextField12.getText()+"',member_name = '"+jTextField11.getText()+"' WHERE patient_no = '"+jTextField10.getText()+"'");
