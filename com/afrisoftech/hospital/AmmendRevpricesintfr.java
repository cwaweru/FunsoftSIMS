 ...
 * @author  root
 */
public class AmmendRevpricesintfr extends javax.swing.JInternalFrame {
    ...
    public AmmendRevpricesintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Description", "Gl Code", "Code", "Rate", "Rate2"
            }
        ) {
        ...
        */
        ...
        jComboBox2.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select main_service from pb_operating_parameters"));
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(jTextField111.getCaretPosition() > 2){
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,gl_account,code ,rate ,anaesthetist_rate FROM pb_operating_parameters WHERE service_type ILIKE '"+jTextField111.getText()+"%' and main_service ilike '"+this.jComboBox2.getSelectedItem().toString()+"%' order by service_type"));
            
        /*    try {
                searchRowSet.execute("select service_type,gl_account,code ,rate ,anaesthetist_rate FROM pb_operating_parameters WHERE service_type ILIKE '"+jTextField111.getText()+"%' and main_service ilike '"+this.jComboBox2.getSelectedItem().toString()+"%' order by service_type");
         
                jSearchTable.setModel(new org.netbeans.lib.sql.models.TableModel(searchRowSet, new org.netbeans.lib.sql.models.TableModel.Column[] {
                    new org.netbeans.lib.sql.models.TableModel.Column("service_type", "Desc.", false),
                     new org.netbeans.lib.sql.models.TableModel.Column("gl_account", "GlCode", false),
                    ...
                    new org.netbeans.lib.sql.models.TableModel.Column("anaesthetist_rate", "rate2", false)
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,4) != null){
                    java.sql.PreparedStatement pstmt3 = connectDB.prepareStatement("UPDATE pb_operating_parameters SET gl_account = '"+jTable1.getValueAt(i,1).toString()+"',code = '"+jTable1.getValueAt(i,2).toString()+"',rate = '"+jTable1.getValueAt(i,3).toString()+"',anaesthetist_rate = '"+jTable1.getValueAt(i,4).toString()+"' WHERE service_type = '"+jTable1.getValueAt(i,0).toString()+"' and main_service ilike '"+jComboBox2.getSelectedItem().toString()+"%'");
