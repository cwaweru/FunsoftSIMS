 ...
 * @author  root
 */
public class NationalityIntfr extends javax.swing.JInternalFrame {
    ...
    public NationalityIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter Country Name & Code here"));
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try{
            ...
            java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("DELETE from pb_country WHERE country_code = '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),0).toString()+"'");
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getText().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE pb_country SET country_name = '"+jTable1.getValueAt(i,1).toString()+"' WHERE country_code = '"+jTable1.getValueAt(i,0).toString()+"'");
                        pstmt311.executeUpdate();
                    }else{
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into pb_country values(?,initcap(?))");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select country_code,country_name from pb_country ORDER BY country_name"));
