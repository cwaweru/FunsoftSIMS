 ...
 * @author  root
 */
public class BedCategoryIntfr extends javax.swing.JInternalFrame {
    ...
    public BedCategoryIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Set beds Category here."));
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Category", "Bed Rate", "Nursing Care", "Admission Rate"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("select category,rate,nursing,adm_rate from hp_bed_category ORDER BY category");
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getLabel().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE hp_bed_category SET rate = '"+jTable1.getValueAt(i,1).toString()+"',nursing = '"+jTable1.getValueAt(i,2).toString()+"',adm_rate = '"+jTable1.getValueAt(i,3).toString()+"' WHERE category = '"+jTable1.getValueAt(i,0).toString()+"'");
                        pstmt311.executeUpdate();
                        
                    }else{
                        java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hp_bed_category values(?,?,?,?)");
