...
public class SampleDbOptim implements java.lang.Runnable {
    ...
    public static void main(java.lang.String[] args) {
        ...
        new SampleDbOptim().SampleDbOptim();
    ...
    public void dbOptim(){
        ...
        try {
            ...
            vacuumingDB = rt_backup.exec("vacuumdb -U postgres --analyze -d medic");
            ...
            if (vacuumingDB_return == 0) {
                ...
                javax.swing.JOptionPane.showMessageDialog(new javax.swing.JFrame(), "Optimization of the MEDIC database successfully completed on "+backup_date_stamp);
                
            } else {
                
                javax.swing.JOptionPane.showMessageDialog(new javax.swing.JFrame(), "Optimization of the MEDIC database failed at "+backup_date_stamp);
