 ...
 * @author  root
 */
public class PatCreditInvAmmendIntfr_1 extends javax.swing.JInternalFrame {
    ...
    public PatCreditInvAmmendIntfr_1(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        jSearchDialog228 = new javax.swing.JDialog();
        ...
        jSearchTable25 = new com.afrisoftech.dbadmin.JTable();
        ...
        */
        ...
        //try {
            ...
            */
            ...
            jSearchDialog228.getContentPane().setLayout(new java.awt.GridBagLayout());

            jSearchDialog228.setModal(true);
            jSearchDialog228.setUndecorated(true);
            ...
            jSearchTable25.setToolTipText("Click on the target row to select the patient from the search.");
            ...
            */
            ...
            gridBagConstraints.weightx = 1.0;
            gridBagConstraints.weighty = 1.0;
            jSearchDialog228.getContentPane().add(jSearchPanel25, gridBagConstraints);
            ...
            setMaximizable(true);
            setResizable(true);
            setTitle("Patient Debit or Credit Note");
            ...
            jPanel31.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "SelectInvoice details. The invoice selected will either be Debited or Credited", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 51, 51)));
            ...
            jCheckBox2.setText("Self Paying");
            ...
            jCheckBox5.setText("Scheme Paying");
            ...
            javax.swing.table.TableColumn dateEditor = jTable11.getColumnModel().getColumn(0);
            com.afrisoftech.lib.DateCellEditor dateCellEditor = new com.afrisoftech.lib.DateCellEditor(new com.afrisoftech.lib.DatePicker(new com.afrisoftech.lib.DatePicker(), jTable11);
                ...
                /*
                javax.swing.table.TableColumn dateEditor1 = jTable11.getColumnModel().getColumn(0);
                com.afrisoftech.lib.DateCellEditor dateCellEditor1 = new com.afrisoftech.lib.DateCellEditor(new com.afrisoftech.lib.DatePicker(), jTable11);
                ...
                */
                ...
                jTabbedPane1.addTab("Patient Debit/Credit Note", jPanel61);
...
// TODO add your handling code here:
  ...
  int i = 0;
        ...
        jTextField101.setText(jSearchTable25.getValueAt(jSearchTable25.getSelectedRow(), 1).toString());
        jTextField91.setText(jSearchTable25.getValueAt(jSearchTable25.getSelectedRow(), 0).toString());
        ...
        try {
           ...
           /* java.sql.Statement stmts1 = connectDB.createStatement();
            ...
            java.sql.ResultSet rsets = stmts.executeQuery("select count(invoice_no) from hp_ADMISSION where invoice_no ='"+jTextField91.getText()+"'");
            while (rsets.next()){
            ...
            if(invno>0){
                ...
                java.sql.ResultSet rset = stmt.executeQuery("select WARD_CODE,PATIENT_no,PATIENT_NAME,balance,balance,PATIENT_NAME from HP_ADMISSION where invoice_no ='"+jTextField91.getText()+"'");
                while (rset.next()){
        ...
        jSearchDialog228.dispose();// TODO add your handling code here:
    ...
    private void jTextField1135CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1135CaretUpdate
     if(this.jTextField1135.getCaretPosition() < 2){
            System.out.print("Nothing");
        }else{
            jSearchTable25.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select DISTINCT invoice_no,patient_no as pat_no from hp_ADMISSION  where invoice_no ILIKE '"+jTextField1135.getText()+"%'  group by invoice_no,patient_no order by invoice_no"));
...
// TODO add your handling code here:
 ...
 if (jTable11.getSelectedColumn() == 1) {
        ...
        }  else if (jTable11.getSelectedColumn() == 0) {
    ...
    private void jTextField112CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField112CaretUpdate
        if(jTextField112.getCaretPosition() > 2){
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type as product,rate as selling_price,gl_code,main_service as department FROM pricelist WHERE service_type ILIKE '"+jTextField112.getText()+"%' UNION SELECT product, selling_price, gl_code, department FROM discounts WHERE product ILIKE '"+jTextField112.getText()+"%'"));
 ...
 if(jCheckBox5.isSelected()){
   ...
   searchButton228Clicked();     
    ...
    private void searchButton22Clicked() {
      ...
      private void searchButton228Clicked() {
        ...
        jSearchDialog228.setSize(400,200);
        
        jSearchDialog228.setLocation(point);
        
        jSearchDialog228.show();
    }
                ...
                if (jRadioButton1.isSelected() && jCheckBox1.isSelected()){
                    for (int i = 0; i < jTable11.getRowCount(); i++){
                        ...
                        if (jTable11.getModel().getValueAt(i,0) != null){
                            ...
                            java.sql.Statement pssq = connectDB.createStatement();
                            java.sql.ResultSet rse121 = pssq.executeQuery("select main_service,gl_account from pb_operating_parameters where service_type ILIKE '"+jTable11.getModel().getValueAt(i,1).toString()+"%' union select department,gl_code from st_stock_prices where product ILIKE '"+jTable11.getModel().getValueAt(i,1).toString()+"%' union select main_service,gl_code from discounts where product ILIKE '"+jTable11.getModel().getValueAt(i,1).toString()+"%'");
                            while (rse121.next()){
                                   glCode = dbObject.getDBObject(rse121.getObject(1), "-");
                                glCode1 = dbObject.getDBObject(rse121.getObject(2), "-");
                        System.out.println("Department is "+glCode);
                            }
                                //  if(jTable11.getValueAt(i,1).toString().startsWith("Discount")){
                             //  glCode1= dbObject.getDBObject(rse121.getObject(2), "-");
                               // glCode = "Discount";
                           // }else{
                          ...
                          //  }
                            ...
                            pstmt2.setString(11,"");
                            pstmt2.setString(12,"");
                            pstmt2.setString(13,"Debit Note");
                            ...
                            pstmt2.setObject(18,com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker11.getDate()));
                            pstmt2.setString(19,crNote);
                            pstmt2.setBoolean(20,false);
                            pstmt2.setBoolean(21,false);
                            pstmt2.setBoolean(22,false);
              ...
              */
                    ...
                    if(jRadioButton2.isSelected() && jCheckBox1.isSelected()){
                        ...
                        System.out.println("Department is "+glCode);
                                ...
                                pstmt2.setString(11,"");
                                pstmt2.setString(12,"");
                                pstmt2.setString(13,"Credit Note");
                                pstmt2.setString(14,jTable11.getValueAt(i,1).toString());
                                pstmt2.setString(15,"Revenue");
                                pstmt2.setDouble(17,0.00);
                      ...
                      /*    java.sql.PreparedStatement pstmt22 = connectDB.prepareStatement("UPDATE ac_debtors set balance = balance - '"+balance+"',debit = debit - '"+balance+"'  WHERE invoice_no = '"+jTextField91.getText()+"'");
                 
                    pstmt22.executeUpdate();
                     java.sql.PreparedStatement pstmt223 = connectDB.prepareStatement("UPDATE HP_PATIENT_CARD set credit = credit - '"+balance+"'  WHERE invoice_no = '"+jTextField91.getText()+"' and service = 'Invoice'");
              ...
              */
               ...
               /*         
                if (jRadioButton1.isSelected() && jCheckBox2.isSelected()){
                    ...
                    pstmt21.setString(11,"");
                    pstmt21.setString(12,"");
                    pstmt21.setString(13,"Credit Note");
                    pstmt21.setString(14,"Doctors fees");
                 ...
                 */
                 if(jRadioButton2.isSelected() && jCheckBox1.isSelected() && jCheckBox5.isSelected()){ 
                java.sql.PreparedStatement pstmt22 = connectDB.prepareStatement("UPDATE ac_debtors set balance = balance - '"+balance+"',debit = debit - '"+balance+"'  WHERE invoice_no = '"+jTextField91.getText()+"'");
               ...
               }else     if(jRadioButton2.isSelected() && jCheckBox1.isSelected() && jCheckBox2.isSelected()){ 
                java.sql.PreparedStatement pstmt22 = connectDB.prepareStatement("UPDATE HP_ADMISSION set balance = balance - '"+balance+"' WHERE invoice_no = '"+jTextField91.getText()+"'");
                 ...
                 /*  if(jRadioButton2.isSelected() && jCheckBox2.isSelected()){ 
                    ...
                    pstmt22.executeUpdate();
                     java.sql.PreparedStatement pstmt2235 = connectDB.prepareStatement("UPDATE HP_PATIENT_CARD set credit = credit - '"+balance+"'  WHERE invoice_no = '"+jTextField91.getText()+"' and service = 'Invoice'");
                 pstmt2235.executeUpdate();
                
                    } 
                  */
                 if(jRadioButton1.isSelected() && jCheckBox1.isSelected() && jCheckBox5.isSelected()){ 
               java.sql.PreparedStatement pstmt224 = connectDB.prepareStatement("UPDATE ac_debtors set balance = balance + '"+balance+"',debit = debit + '"+balance+"'  WHERE invoice_no = '"+jTextField91.getText()+"'");
                 
                    pstmt224.executeUpdate();
                     java.sql.PreparedStatement pstmt2234 = connectDB.prepareStatement("UPDATE HP_PATIENT_CARD set credit = credit + '"+balance+"'  WHERE invoice_no = '"+jTextField91.getText()+"' and service = 'Invoice'");
                 pstmt2234.executeUpdate();
               }else if(jRadioButton1.isSelected() && jCheckBox1.isSelected() && jCheckBox2.isSelected()){ 
               java.sql.PreparedStatement pstmt224 = connectDB.prepareStatement("UPDATE HP_ADMISSION set balance = balance + '"+balance+"' WHERE invoice_no = '"+jTextField91.getText()+"'");
               ...
               java.sql.PreparedStatement pstmt224 = connectDB.prepareStatement("UPDATE ac_debtors set balance = balance + '"+balance+"',debit = debit + '"+balance+"'  WHERE invoice_no = '"+jTextField91.getText()+"'");
                    ...
                    pstmt224.executeUpdate();
                     java.sql.PreparedStatement pstmt22345 = connectDB.prepareStatement("UPDATE HP_PATIENT_CARD set credit = credit + '"+balance+"'  WHERE invoice_no = '"+jTextField91.getText()+"' and service = 'Invoice'");
              ...
              /* if(jRadioButton2.isSelected() && jCheckBox1.isSelected()){ 
               ...
               CreditFinalInPatientlnvPdf policy = new CreditFinalInPatientlnvPdf();
                policy.CreditFinalInPatientInvPdf(connectDB,crNote);
                   ...
                   if(jRadioButton1.isSelected() && jCheckBox1.isSelected()){ 
                DebitFinalInPatientlnvPdf policy = new DebitFinalInPatientlnvPdf();
               policy.DebitFinalInPatientlnvPdf(connectDB,crNote);
               }else 
                    if(jRadioButton1.isSelected() && jCheckBox2.isSelected()){ 
               DebitFinalInPatientlnvPdf policy = new DebitFinalInPatientlnvPdf();
               policy.DebitFinalInPatientlnvPdf(connectDB,crNote);
 ...
 */
  ...
  /*  private void populateTable1(java.lang.String patient_no) {
    ...
    private javax.swing.JDialog jSearchDialog228;
