 ...
 * @author  root
 */
public class GeneralDocIntfr extends javax.swing.JInternalFrame {
    ...
    private GeneralDocIntfr.SearchThread searchThread = null;
    private GeneralDocIntfr.SearchServicesThread searchServicesThread = null;
    ...
    public GeneralDocIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        searchThread = new GeneralDocIntfr.SearchThread();
    ...
    private void initComponents() {
        ...
        */
        ...
        jPanel11.setBorder(javax.swing.BorderFactory.createTitledBorder("Select out patient here"));
        ...
        jPanel111.setBorder(javax.swing.BorderFactory.createTitledBorder("Select in patient here"));
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel211.add(jTextField52, gridBagConstraints);

        jLabel212.setText("Revenue Dep.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 10, 0, 0);
        jPanel211.add(jLabel212, gridBagConstraints);
...
jTextField1.setText("-");
 ...
 try {
            ...
            while (rset2.next()){
                jTextField52.setText(rset2.getObject(1).toString());
            }
        } catch (java.sql.SQLException sqe) {
            sqe.printStackTrace();
             ...
             */
                for (int i = 0; i < jTable111.getRowCount(); i++){
                    if (jTable111.getValueAt(i,0) != null){
                        ...
                        pstmt21.setString(20,jTextField211.getText());
                        pstmt21.setString(21,jTextField411.getText());
                        
                         if(jTextField2.getText().toString().equalsIgnoreCase("-")){
                            pstmt21.setString(22,"");
                        }else{
                           pstmt21.setString(22,jTextField2.getText());
                        }
    ...
    private void jSearchTable211MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable211MouseClicked
        ...
        if(bal>(limit+rect)){
            ...
            try {
                ...
                java.sql.Statement stmt1 = connectDB.createStatement();
                java.sql.ResultSet rset1 = stmt1.executeQuery("select category,CASE WHEN DESCRIPTION ILIKE 'SCHEME' THEN 'SCHEME' ELSE 'CASH' END AS pay_mode,case WHEN pay_mode not ilike  'SCHEME' then description else 'SELF' END AS payer from hp_inpatient_register where patient_no  ='"+jTextField11311.getText()+"'");
                while (rset1.next()){
                    jTextField211.setText(rset1.getObject(1).toString());
                    jTextField711.setText(rset1.getObject(2).toString());
                     jTextField411.setText(rset1.getObject(3).toString());
                }
            } catch (java.sql.SQLException sqe) {
                sqe.printStackTrace();
                //  System.out.println("Insert not successful");
                ...
                for (int i = 0; i < jTable11.getRowCount(); i++){
                    if (jTable11.getValueAt(i,0) != null){
                      /*  java.sql.Statement stm121 = connectDB.createStatement();
                        ...
                        pstmt211.setString(21,jTextField41.getText());
                         if(jTextField2.getText().toString().equalsIgnoreCase("-")){
                            pstmt211.setString(22,"");
                        }else{
                           pstmt211.setString(22,jTextField2.getText());
                        }
  ...
  */
    ...
    private void jSearchTable21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable21MouseClicked
        ...
        try {
            ...
            java.sql.Statement stmt1 = connectDB.createStatement();
            java.sql.ResultSet rset1 = stmt1.executeQuery("select category,pay_mode,CASE WHEN pay_mode ilike 'cash' OR pay_mode ilike 'credit card' OR pay_mode ilike 'cheque' THEN 'SELF' ELSE payer END AS payer from hp_patient_register where patient_no  ='"+jTextField91.getText()+"'");
            while (rset1.next()){
