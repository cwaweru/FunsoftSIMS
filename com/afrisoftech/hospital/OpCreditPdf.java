...
public class OpCreditPdf implements java.lang.Runnable {
    java.lang.String MNo = null;
    
    com.afrisoftech.lib.DBObject dbObject;
    
    java.lang.String Inv1 = null;
    
    java.lang.String Inv2 = null;
    ...
    public void OpCreditPdf(java.sql.Connection connDb, java.lang.String inv1, java.lang.String inv2) {
                    ...
                    try {
                        ...
                        for (int j = 0; j < listofStaffNos.length; j++) {
                            ...
                            try {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where reference = '"+listofStaffNos[j]+"' AND paid = true and credit != 0.00 ");
                                java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(credit) from hp_patient_card where reference = '"+listofStaffNos[j]+"' AND paid = true and credit != 0.00");
                                ...
                                while (rset12.next())
                                    table.getDefaultCell().setColspan(3);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("Credit Note Date.: "+dbObject.getDBObject(rset12.getObject(1), "-"), pFontHeader);
                                table.addCell(phrase);
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase("CR Note No.: "+dbObject.getDBObject(rset11.getObject(1), "-"), pFontHeader);
                                //  phrase = new Phrase("Invoice No. ", pFontHeader);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            pSet1.setString(1,Inv1.toString());
            pSet1.setString(2,Inv2.toString());
