 ...
 * @author  root
 */
public class XrayProceduresIntfr extends javax.swing.JInternalFrame {
    ...
    private XrayProceduresIntfr.SearchThread searchThread = null;
    private XrayProceduresIntfr.SearchServicesThread searchServicesThread = null;
    ...
    public XrayProceduresIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        searchThread = new XrayProceduresIntfr.SearchThread();
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select distinct UPPER(activity) from pb_activity  where activity_category ilike 'IX' "));
