 ...
 * @author  root
 */
public class CorporateIntfr extends javax.swing.JInternalFrame {
    ...
    public CorporateIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Corporation Tax Disallowables");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Set disallowables."));
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(this.jTextField111.getCaretPosition() < 3){
            ...
            jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select code,activity FROM pb_activity WHERE activity ilike '"+jTextField111.getText()+"%' order by activity"));
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into ac_corporate_disallowables values(?,?)");
