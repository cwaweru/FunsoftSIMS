 ...
 * @author  root
 */
public class BudgetDeptsIntfr extends javax.swing.JInternalFrame {
    ...
    public BudgetDeptsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Budget Departments Setup");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter Department Name & Code here"));
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    if(jButton1.getText().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE pb_budget_departments SET dept_name = '"+jTable1.getValueAt(i,1).toString()+"' WHERE dept_code = '"+jTable1.getValueAt(i,0).toString()+"'");
                        pstmt311.executeUpdate();
                    }else{
                        java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into pb_budget_departments values(?,initcap(?))");
