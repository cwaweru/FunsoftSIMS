        ...
        */
        ...
        //try {
            ...
            */
            ...
            jTabbedPane1.addTab("Ammend Invoice Details/Payer", jPanel6);
            ...
            jTabbedPane1.addTab("Merge Invoices", jPanel61);
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        this.jTextField14.setText(java.lang.String.valueOf(netPay));
          ...
          java.sql.Statement stm1 = connectDB.createStatement();
            ...
            java.sql.PreparedStatement pstmt22BB = connectDB.prepareStatement("begin work;UPDATE ac_debtors set reason=account_no, account_no = '-', debit = 0, balance=0, write_off = true  WHERE invoice_no = '"+jTextField911.getText()+"'; commit work");
        ...
        try {
           ...
           // pstmt22.executeUpdate();
            ...
            pstmt22.executeUpdate();
                   ...
                   java.sql.PreparedStatement pstmt223 = connectDB.prepareStatement("UPDATE final_invoices set scheme = '"+jTextField7.getText()+"',payer = '"+jTextField4.getText()+"',account_no = '"+jTextField8.getText()+"',amount = '"+java.lang.Double.parseDouble(jTextField2.getText())+"', date = '"+jTextField6.getText()+"', ex_disp_no = '"+jTextField16.getText()+"' WHERE invoice_no = '"+jTextField9.getText()+"'");
