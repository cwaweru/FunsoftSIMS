 ...
 * @author  root
 */
public class SpecimensIntfr extends javax.swing.JInternalFrame {
    ...
    public SpecimensIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder(null, "Set  lab specimens  here.", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 51, 255)));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
              javax.swing.JFrame off = new Specimen(connectDB, pConnDB);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into pb_lab_specimen values(?,?,?,?)");
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    ...
                    if (jTable1.getModel().getValueAt(i,1) == null){
                        ...
                        javax.swing.JOptionPane.showMessageDialog(this,"Enter Specimen","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
                    }else{
