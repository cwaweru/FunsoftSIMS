...
public class NocReceiptsPdf implements java.lang.Runnable {
    ...
    com.lowagie.text.Font pFontHeader = FontFactory.getFont(FontFactory.HELVETICA, java.lang.Integer.parseInt(System.getProperty("receiptFontSize")), Font.NORMAL);
    com.lowagie.text.Font pFontHeader1 = FontFactory.getFont(FontFactory.HELVETICA, java.lang.Integer.parseInt(System.getProperty("receiptTitleFontSize")), Font.BOLD);
   ...
   // public void ReceiptsPdf(java.sql.Connection connDb, java.lang.String begindate, java.lang.String endate, java.lang.String combox) {
         ...
         public void NocReceiptsPdf(java.sql.Connection connDb, java.lang.String combox) {
   
        MNo = combox;
        
        connectDB = connDb;
        
        pageMargin = java.lang.Float.parseFloat(System.getProperty("receiptPageMargin"));
    ...
    public void generatePdf(java.lang.String memNo) {
        ...
        try {
            ...
            com.lowagie.text.Document docPdf = new com.lowagie.text.Document(new Rectangle(java.lang.Float.parseFloat(System.getProperty("papersize_width")), java.lang.Float.parseFloat(System.getProperty("papersize_legnth"))), pageMargin, pageMargin, pageMargin, pageMargin);
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset5 = st5.executeQuery("select CASE WHEN (main_service = 'Cost Of Sales') THEN 'Pharmacy Drugs' ELSE main_service END as service,sum(dosage),sum(credit) from hp_patient_card where patient_no = '"+MNo+"' AND transaction_type = 'Receipts' AND paid = false AND credit > 0  AND date::date = current_date group by main_service");
                            java.sql.ResultSet rset6 = st6.executeQuery("select CASE WHEN (payment_mode = 'Cash') THEN 'Cash' ELSE card_name||' '||card_no END AS payment_mode, current_user,cash_point from hp_patient_card where patient_no = '"+MNo+"' AND transaction_type = 'Receipts' AND paid = false  AND date::date = current_date");
                   ...
                   */
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                           table.getDefaultCell().setColspan(6);
                           phrase = new Phrase("Thank You.We wish You a quick recovery" , pFontHeader);
                            table.addCell(phrase);
                            ...
                            java.sql.PreparedStatement pstmt41 = connectDB.prepareStatement("UPDATE hp_pharmacy SET paid ='true' WHERE patient_no = '"+MNo+"' AND date_prescribed = current_date");
