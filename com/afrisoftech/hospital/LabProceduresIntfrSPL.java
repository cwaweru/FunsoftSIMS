 ...
 * @author  root
 */
public class LabProceduresIntfrSPL extends javax.swing.JInternalFrame {
    ...
    private LabProceduresIntfrSPL.SearchThread searchThread = null;
    private LabProceduresIntfrSPL.SearchServicesThread searchServicesThread = null;
    ...
    public LabProceduresIntfrSPL(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        searchThread = new LabProceduresIntfrSPL.SearchThread();
        ...
        if(this.jCheckBox42.isSelected()){
            ...
            if(jTextField11.getCaretPosition() < 1){
                ...
                if(jRadioButton1.isSelected()){
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate,'"+jTextField12.getText()+"',code FROM pb_operating_parameters WHERE code ILIKE '%"+jTextField11.getText()+"%' AND sub_code ilike '"+jTextField22.getText()+"' UNION ALL select product,selling_price,'"+jTextField12.getText()+"' as service_type,product_id FROM st_stock_prices WHERE product ILIKE '"+jTextField11.getText()+"%' AND sub_code ILIKE '"+jTextField22.getText()+"' order by service_type"));
                }else{
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,anaesthetist_rate,'"+jTextField12.getText()+"',code FROM pb_operating_parameters WHERE code ILIKE '%"+jTextField11.getText()+"%' AND sub_code  ilike '"+jTextField22.getText()+"' UNION ALL select product,selling_price,'"+jTextField12.getText()+"' as service_type,product_id FROM st_stock_prices WHERE product ILIKE '"+jTextField11.getText()+"%' AND sub_code ILIKE '"+jTextField22.getText()+"' order by service_type"));
            ...
            if(jTextField11.getCaretPosition() < 1){
                ...
                if(jRadioButton1.isSelected()){
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate as price,'"+jTextField12.getText()+"' as glcode,code FROM pb_operating_parameters WHERE service_type ILIKE '%"+jTextField11.getText()+"%' AND sub_code ilike '"+jTextField22.getText()+"' UNION ALL select product as service_type,selling_price,'"+jTextField12.getText()+"',product_idFROM st_stock_prices WHERE product ILIKE '%"+jTextField11.getText()+"%' AND sub_code ILIKE '"+jTextField22.getText()+"' order by service_type"));
                }else{
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,anaesthetist_rate as price,'"+jTextField12.getText()+"' as glcode,code FROM pb_operating_parameters WHERE service_type ILIKE '%"+jTextField11.getText()+"%' AND sub_code ilike '"+jTextField22.getText()+"' UNION ALL select product as service_type,selling_price,'"+jTextField12.getText()+"',product_id FROM st_stock_prices WHERE product ILIKE '%"+jTextField11.getText()+"%' AND sub_code ILIKE '"+jTextField22.getText()+"' order by service_type"));
                ...
                jTextField3.setText("0.00");*/
                        ...
                        if(this.jCheckBox21.isSelected()){
                            ...
                            if (this.datePicker1.getDate().before(admDate)){
                                ...
                                if (!(jTextField7.getText().equals("Cash"))){
