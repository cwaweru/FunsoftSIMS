...
public class SampleThread implements java.lang.Runnable {
    ...
    public void backupImmediate(){
        ...
        try {
            ...
            System.out.println(path2BackupFiles+"MEDIC_"+backup_date_stamp+".sql");
            
            java.lang.Process backup_proc;
            
            backup_proc = rt_backup.exec("pg_dump -f "+path2BackupFiles+"MEDIC_"+backup_date_stamp+".sql fhok", new String[]{"PGUSER=postgres, PGPASSWORD=pilsiner"});
            ...
            if (backup_proc_return == 0) {
                ...
                javax.swing.JOptionPane.showMessageDialog(new javax.swing.JFrame(), "Backup of the MEDIC database successfully completed on "+backup_date_stamp);
                
            } else {
                
                javax.swing.JOptionPane.showMessageDialog(new javax.swing.JFrame(), "Backup of the MEDIC database failed at "+backup_date_stamp);
