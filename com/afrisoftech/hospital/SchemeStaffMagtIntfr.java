 ...
 * @author  root
 */
public class SchemeStaffMagtIntfr extends javax.swing.JInternalFrame {
    ...
    public SchemeStaffMagtIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        */
        ...
        //try {
            ...
            */
            ...
            setIconifiable(true);
            setMaximizable(true);
            setTitle("Scheme Staff Management");
            ...
            jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                    "Staff No.", "Staff Name", "Expiry Date", "OP Limit", "IP Limit"
                }
            ) {
            ...
            */
            ...
            jTabbedPane1.addTab("Scheme Staff Members", jPanel1);
            ...
            jTable11.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                    "Dependnts No.", "Dependants Name", "Relation", "Birth DAte"
                }
            ));
            ...
            */
            java.lang.Object[] strCmb = {"Spouce","Son","Daughter"};
            ...
            jLabel211.setText("Main Scheme Name");
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 0;
            gridBagConstraints.gridy = 0;
            gridBagConstraints.weightx = 1.0;
            ...
            jTabbedPane1.addTab("Dependants", jPanel11);
    ...
    private void jSearchTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable2MouseClicked
        ...
        jTable1.setValueAt(jSearchTable2.getValueAt(jSearchTable2.getSelectedRow(),3),jTable1.getSelectedRow(), 3);
    ...
    private void jTextField11112CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11112CaretUpdate
        jSearchTable2.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select staff_no,staff_name,expiry_date as date,limit_amount FROM hp_schemestaff WHERE staff_no ILIKE '"+jTextField11112.getText()+"%' AND account_no = '"+jTextField2.getText()+"' order by staff_no"));
        
      /*      searchRowSet2.execute("select staff_no,staff_name,expiry_date as date,limit_amount FROM hp_schemestaff WHERE staff_no ILIKE '"+jTextField11112.getText()+"%' AND account_no = '"+jTextField2.getText()+"' order by staff_no");
            ...
            jSearchTable2.setModel(new org.netbeans.lib.sql.models.TableModel(searchRowSet2, new org.netbeans.lib.sql.models.TableModel.Column[] {
                ...
                new org.netbeans.lib.sql.models.TableModel.Column("date", "Exp Date", false),
                new org.netbeans.lib.sql.models.TableModel.Column("limit_amount", "Limit", false)
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // com.afrisoftech.hospital.SchemeDependPdf policy = new SchemeDependPdf();
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        try {
            ...
            java.sql.ResultSet rset = stmt.executeQuery("select account_no from ac_schemes where scheme_name ='"+this.jComboBox1.getSelectedItem().toString()+"' and payer_name ilike '"+this.jTextField361.getText()+"'");
            while (rset.next())
    ...
    private void jSearchTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTable1MouseClicked
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select scheme_name from ac_schemes where payer_name ='"+jTextField361.getText()+"'"));
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        if(jTextField1111.getCaretPosition() < 3){
            ...
            jSearchTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select distinct payer_name as name from ac_schemes where payer_name ILIKE '"+jTextField1111.getText().toString()+"%' order by payer_name"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            // java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hp_schemestaff values(?,?,initcap(?),?,?,?,?,?,?,?,?)");
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    java.sql.PreparedStatement pstmt = connectDB.prepareStatement("delete from hp_schemestaff  WHERE staff_no = '"+jTable1.getModel().getValueAt(i,0).toString()+"' and account_no = '"+this.jTextField2.getText()+"'");
                    pstmt.executeUpdate();
                    java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("delete from pb_scheme_dependants  WHERE member_no = '"+jTable1.getModel().getValueAt(i,0).toString()+"' and company = '"+this.jComboBox1.getSelectedItem().toString()+"'");
                    pstmt1.executeUpdate();
                    
                    java.sql.PreparedStatement pstmt11 = connectDB.prepareStatement("insert into pb_scheme_deletions values(?, ?, ?, ?,?, ?)");//, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?)");
                    
                    pstmt11.setObject(6,jTextField2.getText());
                    pstmt11.setObject(5,jComboBox1.getSelectedItem().toString());
                    pstmt11.setObject(1,jTable1.getValueAt(i,0));
                    pstmt11.setObject(2,jTable1.getValueAt(i,1));
                    pstmt11.setObject(4,"'now'");
                    pstmt11.setObject(3,User);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,0) != null){
                    java.sql.PreparedStatement pstmt = connectDB.prepareStatement("UPDATE hp_schemestaff set staff_name = '"+jTable1.getModel().getValueAt(i,1).toString()+"',expiry_date ='"+jTable1.getModel().getValueAt(i,2).toString()+"',limit_amount ='"+jTable1.getModel().getValueAt(i,3).toString()+"',provider = '"+this.jTextField361.getText()+"', sheme_name = '"+this.jComboBox1.getSelectedItem().toString()+"',account_no = '"+this.jTextField2.getText()+"' WHERE staff_no = '"+jTable1.getModel().getValueAt(i,0).toString()+"' and account_no = '"+this.jTextField2.getText()+"'");
                    pstmt.executeUpdate();
                }
            }
            //     pstmt.executeUpdate();
