...
public class LabProceduresIntfr extends javax.swing.JInternalFrame {
    ...
    private LabProceduresIntfr.SearchThread searchThread = null;
    private LabProceduresIntfr.SearchServicesThread searchServicesThread = null;
    ...
    public LabProceduresIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        searchThread = new LabProceduresIntfr.SearchThread();
    ...
    private void initComponents() {
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Laboratory Procedures");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Service", "Quantity", "Price", "Total", "GL Code", "SP"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class, java.lang.Object.class
        ...
        jLabel2.setText("Patient Source");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT '-' UNION ALL SELECT distinct UPPER(activity) from pb_activity  where activity_category ilike 'IL' "));
        ...
        setBounds(0, 0, 813, 577);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
this.jCheckBox4.setEnabled(true);// TODO add your handling code here:
...
jCheckBox4.setEnabled(false);// TODO add your handling code here:
...
// TODO add your handling code here:
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        ...
        if (jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 1) != null) {
            ...
            if (jTable1.getSelectedColumn() == jTable1.getSelectedColumn()) {
                    float priceEdited = java.lang.Float.parseFloat(jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString());
                     jTextField12.setText(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(priceEdited));
                  double realPrice = java.lang.Double.parseDouble(jTextField5.getText().toString());
                  double changedPrice = java.lang.Double.parseDouble(jTextField12.getText().toString());
          float price1 = java.lang.Float.parseFloat(jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString());
             
        if (changedPrice < realPrice){
                    javax.swing.JOptionPane.showMessageDialog(this,"You cannot sell at a price lower than set price","Comfirmation Message!",javax.swing.JOptionPane.INFORMATION_MESSAGE);
            ...
            for (int r = 0; r < jTable1.getColumnCount(); r++ ) {
                ...
                float total = qty*price;
                jTable1.setValueAt(total, jTable1.getSelectedRow(), 3);
              //  jTextField5.setText(com.afrisoftech.lib.CurrencyFormatter.getFormattedDouble(total));
                 //double realPrice = java.lang.Double.parseDouble(jTextField5.getText());
 ...
 */
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (jTable1.getSelectedColumn() == 0) {
                ...
                this.jTextField12.setText("0.00");
...
/*        jTable1.setValueAt(jSearchTable.getValueAt(jSearchTable.getSelectedRow(),0),jTable1.getSelectedRow(), 0);
        ...
        //double price = java.lang.Double.parseDouble(jSearchTable.getValueAt(jSearchTable.getSelectedRow(), 1).toString());
       jTextField5.setText(jSearchTable.getValueAt(jSearchTable.getSelectedRow(), 1).toString());  
...
/*        if(this.jCheckBox42.isSelected()){
            ...
            if(jTextField11.getCaretPosition() < 1){
                ...
                if(jRadioButton1.isSelected()){
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate,gl_account,code FROM pb_operating_parameters WHERE code ILIKE '%"+jTextField11.getText()+"%' AND main_service ilike '"+jComboBox1.getSelectedItem()+"%' UNION ALL select product,selling_price as rate,gl_code as service_type,product_id FROM st_stock_prices WHERE product ILIKE '"+jTextField11.getText()+"%' AND department ilike  '"+jComboBox1.getSelectedItem()+"' order by service_type"));
                }else{
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate,gl_account,code FROM pb_operating_parameters WHERE code ILIKE '%"+jTextField11.getText()+"%' AND main_service ilike '"+jComboBox1.getSelectedItem()+"%' UNION ALL select product,selling_price as rate,gl_code as service_type,product_id FROM st_stock_prices WHERE product ILIKE '"+jTextField11.getText()+"%' AND department ilike  '"+jComboBox1.getSelectedItem()+"' order by service_type"));
            ...
            if(jTextField11.getCaretPosition() < 1){
                ...
                if(jRadioButton1.isSelected()){
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate as price,gl_account as glcode FROM pb_operating_parameters WHERE service_type ILIKE '%"+jTextField11.getText()+"%' AND main_service ILIKE '"+jComboBox1.getSelectedItem()+"%' UNION ALL select product as service_type,selling_price as rate,gl_code FROM st_stock_prices WHERE product ILIKE '"+jTextField11.getText()+"%' AND department ilike '"+jComboBox1.getSelectedItem()+"%' order by service_type"));
                }else{
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate as price,gl_account as glcode FROM pb_operating_parameters WHERE service_type ILIKE '%"+jTextField11.getText()+"%' AND main_service ILIKE '"+jComboBox1.getSelectedItem()+"%' UNION ALL select product as service_type,selling_price as rate,gl_code FROM st_stock_prices WHERE product ILIKE '"+jTextField11.getText()+"%' AND department ilike '"+jComboBox1.getSelectedItem()+"%' order by service_type"));
        ...
        */
          if(jComboBox1.getSelectedItem().toString().equalsIgnoreCase("LAB FEE - AAR(SPECIAL)")){
            ...
            if(jTextField11.getCaretPosition() < 1){
                ...
                if(jRadioButton1.isSelected()){
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate,'"+jTextField13.getText()+"'as gl_code,code FROM pb_operating_parameters WHERE code ILIKE '%"+jTextField11.getText()+"%' AND gl_account ilike '"+jTextField13.getText()+"' UNION ALL select product,selling_price,'"+jTextField13.getText()+"' as service_type,product_id FROM st_stock_prices WHERE product ILIKE '"+jTextField11.getText()+"%' AND sub_code ILIKE '"+jTextField22.getText()+"' order by service_type"));
                }else{
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,anaesthetist_rate,'"+jTextField13.getText()+"',code FROM pb_operating_parameters WHERE code ILIKE '%"+jTextField11.getText()+"%' AND gl_account  ilike '"+jTextField13.getText()+"' UNION ALL select product,selling_price,'"+jTextField13.getText()+"' as service_type,product_id FROM st_stock_prices WHERE product ILIKE '"+jTextField11.getText()+"%' AND sub_code ILIKE '"+jTextField22.getText()+"' order by service_type"));
            ...
            if(jTextField11.getCaretPosition() < 1){
                ...
                if(jRadioButton1.isSelected()){
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate as price,'"+jTextField13.getText()+"' as glcode,code FROM pb_operating_parameters WHERE service_type ILIKE '%"+jTextField11.getText()+"%' AND gl_account ilike '"+jTextField13.getText()+"' UNION ALL select product as service_type,selling_price,'"+jTextField13.getText()+"',product_id FROM st_stock_prices WHERE product ILIKE '%"+jTextField11.getText()+"%' AND sub_code ILIKE '"+jTextField22.getText()+"' order by service_type"));
                }else{
            ...
            if(jTextField11.getCaretPosition() < 1){
                ...
                if(jRadioButton1.isSelected()){
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate,'"+jTextField13.getText()+"'as gl_code,code FROM pb_operating_parameters WHERE code ILIKE '%"+jTextField11.getText()+"%' AND sub_code ilike '"+jTextField22.getText()+"' and gl_account not ilike '10201-002-AAR' UNION ALL select product,selling_price,'"+jTextField13.getText()+"' as service_type,product_id FROM st_stock_prices WHERE product ILIKE '"+jTextField11.getText()+"%' AND sub_code ILIKE '"+jTextField22.getText()+"' order by service_type"));
                }else{
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,anaesthetist_rate,'"+jTextField13.getText()+"',code FROM pb_operating_parameters WHERE code ILIKE '%"+jTextField11.getText()+"%' AND sub_code  ilike '"+jTextField22.getText()+"' and gl_account not ilike '10201-002-AAR' UNION ALL select product,selling_price,'"+jTextField13.getText()+"' as service_type,product_id FROM st_stock_prices WHERE product ILIKE '"+jTextField11.getText()+"%' AND sub_code ILIKE '"+jTextField22.getText()+"' order by service_type"));
            ...
            if(jTextField11.getCaretPosition() < 1){
                ...
                if(jRadioButton1.isSelected()){
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate as price,'"+jTextField13.getText()+"' as glcode,code FROM pb_operating_parameters WHERE service_type ILIKE '%"+jTextField11.getText()+"%' AND sub_code ilike '"+jTextField22.getText()+"' and gl_account not ilike '10201-002-AAR' UNION ALL select product as service_type,selling_price,'"+jTextField13.getText()+"',product_id FROM st_stock_prices WHERE product ILIKE '%"+jTextField11.getText()+"%' AND sub_code ILIKE '"+jTextField22.getText()+"' order by service_type"));
                }else{
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,anaesthetist_rate as price,'"+jTextField13.getText()+"' as glcode,code FROM pb_operating_parameters WHERE service_type ILIKE '%"+jTextField11.getText()+"%' AND sub_code ilike '"+jTextField22.getText()+"' and gl_account not ilike '10201-002-AAR' UNION ALL select product as service_type,selling_price,'"+jTextField13.getText()+"',product_id FROM st_stock_prices WHERE product ILIKE '%"+jTextField11.getText()+"%' AND sub_code ILIKE '"+jTextField22.getText()+"' order by service_type"));
...
try{
            ...
            while (rst11.next()){
                ...
                jTextField13.setText(rst11.getString(1));
