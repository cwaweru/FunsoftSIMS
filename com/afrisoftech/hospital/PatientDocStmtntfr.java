 ...
 * @author  root
 */
public class PatientDocStmtntfr extends javax.swing.JInternalFrame {
    ...
    public PatientDocStmtntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Patients Doc Statement View");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Service", "Doctor", "Total", "Paid ?"
            }
        ) {
      ...
      */
        ...
        try {
            if(jCheckBox21.isSelected()){
                ...
                java.sql.ResultSet rset = stmt.executeQuery("SELECT count(description) FROM ac_doctors_ledger WHERE patient_no = '"+patient_no+"'");
                ...
                if (j > 0){
                    ...
                    java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT input_date,description,doctor_name , credit, paid FROM ac_doctors_ledger WHERE patient_no = '"+patient_no+"' and input_date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker3.getDate().toString()+"' order by input_date");
