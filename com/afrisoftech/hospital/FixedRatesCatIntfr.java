 ...
 * @author  root
 */
public class FixedRatesCatIntfr extends javax.swing.JInternalFrame {
    ...
    public FixedRatesCatIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Fixed Service Category");
        setVisible(true);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Service Code", "Service", "Normal Rate", "Special Rate", "Category"
            }
        ) {
        ...
        cmbox2.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select category_description FROM pb_lab_maincategory"));
        ...
        jComboBox2.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select category_description FROM pb_lab_maincategory WHERE department = '"+jComboBox1.getSelectedItem()+"'"));
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select code,service_type as service,rate,anaesthetist_rate as special,sub_category as Category FROM pb_operating_parameters WHERE main_service ILIKE '"+jComboBox1.getSelectedItem().toString()+"%' order by service_type"));
        
        cmbox2 = new javax.swing.JComboBox();
        
        cmbox2.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select category_description FROM pb_lab_maincategory where department ILIKE '"+jComboBox1.getSelectedItem().toString()+"%'"));
...
// Add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = 0;
        jTable1.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select code,service_type,rate as general,anaesthetist_rate as special_rate from pb_operating_parameters WHERE gl_account ilike '"+jTextField1.getText()+"' ORDER BY service_type"));
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getModel().getValueAt(i,4) != null){
                   ...
                   // if(jButton1.getLabel().equalsIgnoreCase("Update")){
                        java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("UPDATE pb_operating_parameters SET service_type = '"+jTable1.getValueAt(i,1).toString()+"',rate = '"+jTable1.getValueAt(i,2).toString()+"',anaesthetist_rate = '"+jTable1.getValueAt(i,3).toString()+"',sub_category = '"+jTable1.getValueAt(i,4).toString()+"' WHERE code = '"+jTable1.getValueAt(i,0).toString()+"'");
                        pstmt311.executeUpdate();
                        
                        
                   /* }else{
                        java.sql.Statement stmtTable11 = connectDB.createStatement();
                        java.sql.ResultSet rsetTable11 = stmtTable11.executeQuery("SELECT count(service_type)  FROM pb_operating_parameters WHERE code ilike  '"+jTable1.getValueAt(i,0).toString()+"%' and rate = '"+jTable1.getValueAt(i,2).toString()+"' AND anaesthetist_rate = '"+jTable1.getValueAt(i,3).toString()+"'");
