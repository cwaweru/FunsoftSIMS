 ...
 * @author  root
 */
public class PettyCashDirectPymIntfr extends javax.swing.JInternalFrame {
    ...
    public PettyCashDirectPymIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        jTable1 = new com.afrisoftech.dbadmin.JTable(){
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Double.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class
            };
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Purpose", "Reason", "Qty", "Amount", "Gl Acc", "Donor", "Proj", "Unit", "Staff/Veh"
            }
        ) {
            Class[] types = new Class [] {
        ...
        cmbox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select DISTINCT code from ac_project ORDER BY code"));
                ...
                try {
                    //  for (int i = 0; i < jTable1.getRowCount(); i++){
                        //      if (jTable1.getModel().getValueAt(jTable1.getSelectedRow(),6) != null){
                            ...
                            java.sql.ResultSet rset = stmt.executeQuery("select branch_code from ac_project WHERE code ilike '"+cmbox1.getSelectedItem()+"'");
                            while (rset.next()){
        ...
        */
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select DISTINCT UPPER(department_name) as department_name  from pb_departments ORDER BY department_name"));
    ...
    private void jComboBox12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox12ActionPerformed
        jComboBox13.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select branch_code from ac_project WHERE code ilike '"+jComboBox12.getSelectedItem()+"'"));
...
//                policy.PettyNgoPayVoucherPdf(connectDB,voucherNo);
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        ...
        if (jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 3) != null) {
            ...
            if (jTable1.getSelectedColumn() == jTable1.getSelectedColumn()) {
                ...
                //   double Total = java.lang.Double.parseDouble(java.lang.Double.toString(com.afrisoftech.lib.CurrencyFormatter.parseFormattedString(jTextField3.getText().toString())));
    ...
    private void populateTable1(java.lang.String patient_no) {
        ...
        try {
            ...
            if (j > 0) {
                ...
                java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT description,status,1,credit,code,donor,proj,branch,staff_veh  FROM ac_petty_cash WHERE voucher_no = '"+patient_no+"' and date = '"+datePicker1.getDate()+"' and credit > 0");
        ...
        try{
            ...
            try{
                ...
                if(jRadioButton1.isSelected()){
                    ...
                    java.sql.ResultSet rse1211 = stm1211.executeQuery("select current_user");
                    while (rse1211.next()){
                        
                        userName = rse121.getObject(1).toString();
                    }
                    java.sql.Statement stm1 = connectDB.createStatement();
                    ...
                    for (int i = 0; i < jTable1.getRowCount(); i++){
                        if (jTable1.getModel().getValueAt(i,0) != null){
                            ...
                            pstmt21.setObject(23,jTable1.getValueAt(i,5).toString());
                            pstmt21.setObject(24,jTable1.getValueAt(i,6).toString());
                            pstmt21.setObject(25,jTable1.getValueAt(i,7).toString());
                            pstmt21.setObject(26,jTable1.getValueAt(i,8).toString());
                    ...
                    if(jRadioButton2.isSelected()){
                        ...
                        for (int i = 0; i < jTable1.getRowCount(); i++){
                            if (jTable1.getModel().getValueAt(i,0) != null){
                                ...
                                pstmt21.setString(3,jTextField4.getText());
                                pstmt21.setObject(4,jTable1.getValueAt(i,0).toString());
                                pstmt21.setDouble(5,java.lang.Double.valueOf(jTable1.getModel().getValueAt(i,3).toString()));
  ...
  /*  cmbox2 = new javax.swing.JComboBox();
    ...
    cmbox2.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select branch_code from ac_project WHERE code ilike '"+jTable1.getModel().getValueAt(jTable1.getSelectedRow(),6)+"'"));
    javax.swing.table.TableColumn n = this.jTable1.getColumn("Unit");
    n.setCellEditor(new javax.swing.DefaultCellEditor(cmbox2));
    cmbox2.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
          ...
          try {
            String branch = null;
            java.sql.Statement pst1 = connectDB.createStatement();
            java.sql.ResultSet rs1 = pst1.executeQuery("select branch_code from ac_project WHERE code ilike '"+jTable1.getValueAt(jTable1.getSelectedRow(),6)+"'");
            while (rs1.next()){
                branch = rs1.getObject(1).toString();
