 ...
 * @author  root
 */
public class AsseInsuranceIntfr extends javax.swing.JInternalFrame {
    ...
    public AsseInsuranceIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder("Select asset tag no here"));
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "SELECT tag_no from asset_registration ORDER BY tag_no"));
        ...
        jScrollPane1.setBorder(new javax.swing.border.TitledBorder("Risk Covered"));
        ...
        jPanel2.setBorder(new javax.swing.border.TitledBorder("Insurance Details"));
        jLabel6.setText("Insurer");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 1;
        ...
        jLabel7.setText("Replacement Cost");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 3;
        ...
        jLabel8.setText("Replacement Date");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jLabel12.setText("Risk/Category");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        try {
            ...
            java.sql.ResultSet rst = pstmt.executeQuery("select asset_name,make from asset_registration where tag_no = '"+jComboBox1.getSelectedItem()+"'");
            while (rst.next()){
                jTextField3.setText(rst.getObject(1).toString());
                jTextField2.setText(rst.getObject(2).toString());
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into asset_insurance values(?, ?,?,?,?,?,?,?,?,?,?,?)");
            pstmt.setObject(1,jComboBox1.getSelectedItem());
            pstmt.setString(2,jTextField3.getText());
            if(jTextField7.getText().equals("")){
                javax.swing.JOptionPane.showMessageDialog(this, "You must enter insurance details","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
            }else{
            ...
            pstmt.setString(8,jTextField10.getText());
