 ...
 * @author  root
 */
public class FinaliseConfirmintfr extends javax.swing.JInternalFrame {
    ...
    public FinaliseConfirmintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
...
// jPanel2.invalidate();
        ...
        if(this.jTextField11321.getCaretPosition() < 2){
            ...
            if(jRadioButton2.isSelected()){
                if(jCheckBox2.isSelected()){
                    jSearchTable221.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select patient_no as pat_no,SECOND_NAME||' '||FIRST_NAME,'Scheme' from hp_patient_register where PATIENT_NO ILIKE '%"+jTextField11321.getText()+"%' order by FIRST_name"));
   ...
   */
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        int exitOption = javax.swing.JOptionPane.showConfirmDialog(this, "Are you sure charges of Patient No : '"+jTextField911.getText()+"' are finalised\n Date : '"+com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate())+"'?", "Caution before Activating Account!", javax.swing.JOptionPane.YES_NO_CANCEL_OPTION);
        ...
        if (exitOption == javax.swing.JOptionPane.YES_OPTION) {
            ...
            try {
                connectDB.setAutoCommit(false);
                         ...
                         java.sql.PreparedStatement pstmt221C = connectDB.prepareStatement("begin work; UPDATE hp_patient_BILLING set PAID=TRUE WHERE patient_no = '"+jTextField911.getText()+"' AND TRANS_date = '"+com.afrisoftech.lib.SQLDateFormat.getSQLDate(datePicker1.getDate())+"' AND PAID=FALSE ;commit work");
