 ...
 * @author  root
 */
public class DentalProceduresIntfr extends javax.swing.JInternalFrame {
    ...
    private DentalProceduresIntfr.SearchThread searchThread = null;
    private DentalProceduresIntfr.SearchServicesThread searchServicesThread = null;
    ...
    public DentalProceduresIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        searchThread = new DentalProceduresIntfr.SearchThread();
    ...
    private void initComponents() {
        ...
        */
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tooth", "Surface", "Procedure", "Code", "Price", "Total", "GL Code"
            }
        ) {
        ...
        java.lang.Object[] strCmb = {"t1","t2","t3"};

        javax.swing.JComboBox cmBox = new javax.swing.JComboBox(strCmb);

        javax.swing.table.TableColumn teditor = this.jTable1.getColumn("Tooth");

        teditor.setCellEditor(new javax.swing.DefaultCellEditor(cmBox));

        java.lang.Object[] strCmb1 = {"f1","f2","f3"};

        javax.swing.JComboBox cmBox1 = new javax.swing.JComboBox(strCmb1);

        javax.swing.table.TableColumn teditor1 = this.jTable1.getColumn("Surface");
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select distinct UPPER(activity) from pb_activity  where activity_category ilike 'ID' "));
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("Comments"));
...
// TODO add your handling code here:
    ...
    private void jSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTableMouseClicked
        jTable1.setValueAt(jSearchTable.getValueAt(jSearchTable.getSelectedRow(),0),jTable1.getSelectedRow(), 2);
    ...
    private void jTextField11CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField11CaretUpdate
        if(this.jCheckBox42.isSelected()){
            ...
            if(jTextField11.getCaretPosition() < 1){
                ...
                if(jRadioButton1.isSelected()){
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,rate as price,gl_account as glcode,code FROM pb_operating_parameters WHERE service_type ILIKE '%"+jTextField11.getText()+"%' AND main_service ILIKE '"+jComboBox1.getSelectedItem()+"%' UNION ALL select product as service_type,selling_price,gl_code,product_id FROM st_stock_prices WHERE product ILIKE '"+jTextField11.getText()+"%' AND department ilike '"+jComboBox1.getSelectedItem()+"%' order by service_type"));
                }else{
                    jSearchTable.setModel(com.afrisoftech.dbadmin.TableModel.createTableVectors(connectDB,"select service_type,anaesthetist_rate as price,gl_account as glcode,code FROM pb_operating_parameters WHERE service_type ILIKE '%"+jTextField11.getText()+"%' AND main_service ILIKE '"+jComboBox1.getSelectedItem()+"%' UNION ALL select product as service_type,selling_price,gl_code,product_id FROM st_stock_prices WHERE product ILIKE '"+jTextField11.getText()+"%' AND department ilike '"+jComboBox1.getSelectedItem()+"%' order by service_type"));
                ...
                if(this.jCheckBox11.isSelected() || jCheckBox6.isSelected()){
                    for (int i = 0; i < jTable1.getRowCount(); i++){
                        if (jTable1.getValueAt(i,0) != null){
                            ...
                            java.sql.ResultSet rse121 = stm121q.executeQuery("select activity from pb_activity where code ='"+jTable1.getValueAt(i,6).toString()+"'");
                            ...
                            if(this.jTextField7.getText().equalsIgnoreCase("Scheme")){
                                ...
                                pstmt2.setString(5,jTable1.getValueAt(i,2).toString());
                                pstmt2.setDouble(6,java.lang.Double.valueOf(jTable1.getValueAt(i,3).toString()));
                                pstmt2.setDouble(7,java.lang.Double.valueOf(jTable1.getValueAt(i,5).toString()));
                                pstmt2.setObject(8,jTable1.getValueAt(i,6).toString());
                                ...
                                pstmt24.setObject(1,jTable1.getValueAt(i,6).toString());
                                ...
                                pstmt24.setString(14,jTable1.getValueAt(i,2).toString());
                                pstmt24.setString(15,"Revenue");
                                pstmt24.setDouble(16,0.00);
                                pstmt24.setDouble(17,java.lang.Double.valueOf(jTable1.getValueAt(i,5).toString()));
                    ...
                    for (int i = 0; i < jTable1.getRowCount(); i++){
                        if (jTable1.getValueAt(i,0) != null){
                            ...
                            java.sql.ResultSet rsBx = pstBx.executeQuery("select count(product) from st_stock_prices where product = '"+jTable1.getValueAt(i,2)+"' and gl_code =  '"+jTable1.getValueAt(i,6)+"'");
                            ...
                            if (itemInt > 0){
                                ...
                                java.sql.ResultSet rsB = pstB.executeQuery("select transfer_price,units,department from st_stock_prices where product = '"+jTable1.getValueAt(i,2)+"' and gl_code =  '"+jTable1.getValueAt(i,6)+"'");
                                ...
                                java.sql.ResultSet rs111 = pst211.executeQuery("select cost_of_sale,stock_code from pb_departments where income_account = '"+jTable1.getValueAt(i,6)+"'");
                                while (rs111.next()){
                                ...
                                java.sql.ResultSet rse1211q = stm1211q.executeQuery("select units from st_stock_prices where product ='"+jTable1.getModel().getValueAt(i,2).toString()+"'");
                                while (rse1211q.next()){
                                ...
                                pstmt1.setDouble(3,java.lang.Double.valueOf("1"));
                                pstmt1.setDouble(4,java.lang.Double.valueOf(jTable1.getValueAt(i,5).toString()));
                                ...
                                pstmt1a.setObject(3,jTable1.getValueAt(i,2));
                                ...
                                pstmt2a.setString(14,jTable1.getValueAt(i,2).toString());
                                ...
                                pstmt33.setObject(2,jTable1.getValueAt(i,2).toString());
                                pstmt33.setDouble(3,0.00);
                                pstmt33.setDouble(7,0.00);
                                pstmt33.setDouble(5,java.lang.Double.valueOf(jTable1.getValueAt(i,4).toString()));
                            ...
                            */
                                ...
                                for (int i = 0; i < jTable1.getRowCount(); i++){
                                    if (jTable1.getValueAt(i,0) != null){
                                        ...
                                        pstmt2.setString(12,"");
                                        pstmt2.setString(13,"");
                                        pstmt2.setString(14,jTable1.getValueAt(i,2).toString());
                        ...
                        for (int i = 0; i < jTable1.getRowCount(); i++){
                            if (jTable1.getValueAt(i,0) != null){
                                ...
                                if (itemInt > 0){
                                    ...
                                    qty = java.lang.Double.parseDouble("1");
                                    amount = price*qty;
                                    if (amount > 10000){
                                        amount = (qty*sellPrice)*0.67;
                                    }else{
                                    ...
                                    pstmt1.setDouble(4,java.lang.Double.valueOf(jTable1.getValueAt(i,5).toString()));
                                    pstmt1.setObject(5,jTable1.getValueAt(i,2).toString());
                                    pstmt1.setDouble(7,java.lang.Double.valueOf(jTable1.getValueAt(i,4).toString()));
