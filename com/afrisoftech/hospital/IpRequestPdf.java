...
public class IpRequestPdf implements java.lang.Runnable {
    ...
    public void IpRequestPdf(java.sql.Connection connDb, java.lang.String combox, java.lang.String name, java.lang.String amount, java.lang.String receipt, java.lang.String paymode) {
                    ...
                    */
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset5 = st5.executeQuery("select service,dosage,debit,ROUND(sum(debit/dosage)) from hp_patient_card where patient_no = '"+MNo+"' and cash_point = '"+Receipt+"' group by service,dosage,debit");
                            java.sql.ResultSet rset6 = st6.executeQuery("select distinct user_name from hp_patient_card where cash_point = '"+Receipt+"'");
                             java.sql.ResultSet rset61 = st61.executeQuery("select distinct main_service from hp_patient_card where cash_point = '"+Receipt+"'");
