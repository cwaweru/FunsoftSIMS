 ...
 * @author  root
 */
public class BillingNoViewIntfr extends javax.swing.JInternalFrame {
    ...
    public BillingNoViewIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Bill Insert No Tracking");
        try {
            setSelected(true);
