 ...
 * @author  root
 */
public class LabProceduresIntfrOLD extends javax.swing.JInternalFrame {
    ...
    private LabProceduresIntfrOLD.SearchThread searchThread = null;
    private LabProceduresIntfrOLD.SearchServicesThread searchServicesThread = null;
    ...
    public LabProceduresIntfrOLD(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        searchThread = new LabProceduresIntfrOLD.SearchThread();
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select distinct UPPER(activity) from pb_activity  where activity_category ilike 'IL' "));
