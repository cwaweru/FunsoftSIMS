 ...
 * @author  root
 */
public class GeneralViewIntfr extends javax.swing.JInternalFrame {
    ...
    public GeneralViewIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select distinct revenue_code as main_service  from hp_patient_billing order by revenue_code"));
      ...
      */
        ...
        try {
            if(jCheckBox21.isSelected()){
                ...
                java.sql.ResultSet rset = stmt.executeQuery("SELECT count(service) FROM hp_patient_card WHERE patient_no = '"+patient_no+"' and main_service ILIKE '"+jComboBox1.getSelectedItem()+"'");
                ...
                if (j > 0){
                    ...
                    java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT date::date,service, dosage, debit, paid FROM hp_patient_card WHERE patient_no = '"+patient_no+"' and main_service ILIKE '"+this.jComboBox1.getSelectedItem()+"' and date::date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker3.getDate().toString()+"' ORDER BY date");
    ...
    private void populateTable2(java.lang.String patient_no) {
        ...
        try {
            if(jCheckBox11.isSelected()){
                ...
                java.sql.ResultSet rset = stmt.executeQuery("SELECT count(service) FROM hp_patient_billing WHERE patient_no = '"+patient_no+"' and revenue_code ILIKE '"+jComboBox1.getSelectedItem()+"'");
                ...
                if (j > 0){
                    ...
                    java.sql.ResultSet rsetTable1 = stmtTable1.executeQuery("SELECT trans_date,service, quantity, amount, paid FROM hp_patient_billing WHERE patient_no = '"+patient_no+"' and revenue_code ILIKE '"+this.jComboBox1.getSelectedItem()+"' and trans_date between '"+this.datePicker1.getDate().toString()+"' and '"+this.datePicker3.getDate().toString()+"' order by trans_date");
