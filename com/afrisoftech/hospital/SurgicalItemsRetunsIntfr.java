 ...
 * @author  root
 */
public class SurgicalItemsRetunsIntfr extends javax.swing.JInternalFrame {
    ...
    public SurgicalItemsRetunsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Surgical Items Adjustments");
    ...
    private void jComboBox111ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox111ActionPerformed
        ...
        try {
            ...
            while (rs111.next()){
                jTextField7.setText(rs111.getObject(1).toString());
...
//        this.tableModelTableChanged();
        ...
        try {
            ...
            java.sql.ResultSet rset = stmtz.executeQuery("select visit_id  from hp_admission where patient_no ILIKE '%"+jTextField36.getText().toString()+"%' and discharge = false AND visit_id IS NOT NULL order by visit_id desc LIMIT 1");
            while (rset.next()){
            ...
            while (rstq.next()){
                ...
                if( this.jCheckBox1.isSelected()||this.jCheckBox2.isSelected()){
                    if (!(jTextField4.getText().equals("Cash"))){
                        java.sql.Statement stm1 = connectDB.createStatement();
                        java.sql.ResultSet rse1 = stm1.executeQuery("select pay_mode,account_no,description,payer,payer,expiry_date,account_no from hp_patient_register where patient_no ='"+jTextField36.getText()+"'");
                        while (rse1.next()){
                ...
                while (rst.next()){
                    ...
                    while (rst11.next()){
                        ...
                        java.sql.Statement pst211 = connectDB.createStatement();
                        java.sql.ResultSet rs111 = pst211.executeQuery("select code,activity from pb_activity where activity_category = 'CS' and code ilike '%"+jTextField7.getText()+"%'");
                        while (rs111.next()){
                                    ...
                                    while (rsB.next()){
                                        ...
                                        while (rse1212.next()){
                                            ...
                                            if( this.jCheckBox1.isSelected() || this.jCheckBox3.isSelected()){
                                                ...
                                                java.sql.PreparedStatement pstmt33 = connectDB.prepareStatement("insert into st_sub_stores values(?,?,?,?,?, numeric_uminus(?),?,?,?,?,?,?,?,?)");
                                                ...
                                                java.sql.PreparedStatement pstmt21 = connectDB.prepareStatement("insert into hp_patient_visit values(?,?,?,?,?,?, ?, ?,  numeric_uminus(?), ?, ?, ?, ?,?,?,?)");
                                                ...
                                                if( this.jCheckBox2.isSelected()){
                                                    ...
                                                    java.sql.PreparedStatement pstmt812 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_credit = ytd_credit + '"+jTable1.getValueAt(i,3).toString()+"' where code = '"+patientAcc+"'");
                                                    ...
                                                    java.sql.PreparedStatement pstmt8122 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_debit = ytd_debit + '"+jTable1.getValueAt(i,3).toString()+"' where code = '"+jTable1.getValueAt(i,4).toString()+"'");
                                                    ...
                                                    pstmt33.setObject(9,"");
                                                    //pstmt33.setString(11,code);
                                                    pstmt33.setString(13,jComboBox111.getSelectedItem().toString());
                                                    pstmt33.setString(11,userName);
                 ...
                 */
                                                    ...
                                                    pstmt1a.setString(20,"Returns");
                                                    pstmt1a.setObject(5,"00");
                                                    ...
                                                    java.sql.PreparedStatement pstmt8124 = connectDB.prepareStatement("UPDATE pb_activity SET ytd_debit = ytd_debit + '"+amount+"' where code = '"+actCode+"'");
                                                    pstmt8124.executeUpdate();
           ...
           */
            ...
            //      javax.swing.JOptionPane.showMessageDialog(this, "Insert Done Successfully","Confirmation Message",javax.swing.JOptionPane.INFORMATION_MESSAGE);
                    ...
                    if(this.jCheckBox1.isSelected() ||jTextField4.getText().equals("Scheme")){
                     
                        java.sql.Statement stm1 = connectDB.createStatement();
                        java.sql.ResultSet rse1 = stm1.executeQuery("select card_no,scheme,card_name,isurer,expiry_date,scheme_staff_no from hp_patient_card where patient_no ='"+jTextField36.getText()+"'");
                        while (rse1.next())
                            // payMode = rse1.getObject(1).toString();
                            cardNo = rse1.getObject(1).toString();
                        scheme = rse1.getObject(2).toString();
                        cardName = rse1.getObject(3).toString();
                        isurer = rse1.getObject(4).toString();
                        expDate = rse1.getObject(5).toString();
                        staffNo = rse1.getObject(6).toString();
