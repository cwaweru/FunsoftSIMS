 ...
 * @author  root
 */
public class WardProceduresIntfr extends javax.swing.JInternalFrame {
    ...
    private WardProceduresIntfr.SearchThread searchThread = null;
    private WardProceduresIntfr.SearchServicesThread searchServicesThread = null;
    ...
    public WardProceduresIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        searchThread = new WardProceduresIntfr.SearchThread();
    ...
    private void initComponents() {
        ...
        */
        ...
        jComboBox1.setModel(com.afrisoftech.lib.ComboBoxModel.ComboBoxModel(connectDB, "select distinct UPPER(activity) from pb_activity  where activity_category ilike 'IW' "));
