                 ...
                 */
                    ...
                    try {
                        ...
                        try {
                            ...
                            // java.sql.ResultSet rsetd = std.executeQuery("select discharge_date from ac_debtors where invoice_no = '"+memNo+"'");
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery(" select date::date,initcap(service) as service,dosage,reference,debit-credit from hp_patient_card where invoice_no = '"+memNo+"' and paid = 'true' and service != 'N.H.I.F' AND service not ilike 'Receipt' AND service != 'Invoice' order by date::date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit - credit) from hp_patient_card where invoice_no = '"+memNo+"' and service != 'N.H.I.F' and service not ilike 'Receipt' and paid = 'true' and service != 'Invoice'");
                            
                            java.sql.ResultSet rset11 = st11.executeQuery(" select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where invoice_no = '"+memNo+"' AND (service = 'N.H.I.F' OR service ilike 'Receipt') order by date::date");// union select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where patient_no = '"+memNo+"' and credit > 0 order by date");
                            java.sql.ResultSet rsetTotals1 = st21.executeQuery("select sum(credit) from hp_patient_card where invoice_no = '"+memNo+"' and (service = 'N.H.I.F' OR service ilike 'Receipt')");
