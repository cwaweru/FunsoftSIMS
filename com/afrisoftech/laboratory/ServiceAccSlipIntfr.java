...
public class ServiceAccSlipIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset3.setCommand("select activity from pb_activity WHERE  activity_category = 'E' order by activity ");
        ...
        if(jTextField113.getCaretPosition() < 3){
            ...
            if(this.jCheckBox3.isSelected()){
                try {
                    ...
                    searchRowSet2.execute("SELECT patient_no, (upper(second_name||' '||first_name||' '||last_name)) as name, pay_mode from hp_patient_register where patient_no ILIKE '"+jTextField113.getText()+"%' and last_visit > current_date - 20 order by second_name");
                    ...
                    jSearchTable2.setModel(new org.netbeans.lib.sql.models.TableModel(searchRowSet2, new org.netbeans.lib.sql.models.TableModel.Column[] {
                        ...
                        new org.netbeans.lib.sql.models.TableModel.Column("pay_mode", "Pay Mode", false)
                ...
                try {
                    ...
                    searchRowSet2.execute("SELECT patient_no, (upper(second_name||' '||first_name||' '||last_name)) as name,pay_mode from hp_patient_register where second_name||' '||first_name||' '||last_name ILIKE '"+jTextField113.getText()+"%' and last_visit > current_date - 20 order by second_name");
