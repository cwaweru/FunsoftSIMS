...
public class FinalDescInvoiceByinvPdf implements java.lang.Runnable {
                    ...
                    try {
                        ...
                        for (int j = 0; j < listofStaffNos.length; j++) {
                            ...
                            try {
                                ...
                                table.addCell(phrase);
                                table.getDefaultCell().setColspan(1);
                                phrase = new Phrase("Running KShs",pFontHeader1);
                                table.addCell(phrase);
                                table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                                ...
                                for (int k = 0; k < listofStaffNos1.length; k++) {
                                    ...
                                    java.sql.ResultSet rset1 = st1.executeQuery("select date::date,initcap(service) as service,dosage,reference,credit from hp_patient_card where invoice_no = '"+listofStaffNos[j]+"' AND paid = true and credit != 0.00 AND main_service = '"+listofStaffNos1[k]+"' ");
                                  ...
                                  //  table.getDefaultCell().setBorder(Rectangle.BOTTOM | Rectangle.TOP);
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    table.getDefaultCell().setColspan(2);
                                    phrase = new Phrase(listofStaffNos1[k].toString() +" Gross ",pFontHeader11);
                                ...
                                while (rsetTotals.next()) {
                                    ...
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase("Grand Total.", pFontHeader11);
    ...
    public java.lang.Object[] getListofStaffNos1(java.lang.Object InvoiceNo) {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT distinct main_service FROM hp_patient_card WHERE invoice_no = '"+InvoiceNo+"' and debit > 0 order by main_service");
