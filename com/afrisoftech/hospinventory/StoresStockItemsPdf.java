      ...
      */
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select product,units,transfer_price,selling_price from st_stock_prices WHERE department = '"+bank+"' order by product");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
