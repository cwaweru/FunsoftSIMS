 ...
 * @author  root
 */
public class AmmendMainStockpricesintfr extends javax.swing.JInternalFrame {
    ...
    public AmmendMainStockpricesintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
        ...
        try {
          ...
          //  java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into st_stock_prices values( ?,?,?,?,?,?,?,?,?,?,?)");
            for (int i = 0; i < jTable1.getRowCount(); i++){
                ...
                java.sql.PreparedStatement pstmt3 = connectDB.prepareStatement("UPDATE st_stock_item SET buying_price = '"+jTable1.getValueAt(i,4).toString()+"',reorder_level = '"+jTable1.getValueAt(i,3).toString()+"',units = '"+jTable1.getValueAt(i,2).toString()+"',packaging = '"+jTable1.getValueAt(i,5).toString()+"'  WHERE description = '"+jTable1.getValueAt(i,0).toString()+"' and department ilike '"+jComboBox2.getSelectedItem().toString()+"%'");
