...
searchButton2Clicked(); 
 ...
 private void populateTable1(java.lang.String patient_no) {
        ...
        try {
            ...
            java.sql.ResultSet rsetTable = stmtTable.executeQuery("SELECT item,units,quantity,unit_price,net_value FROM st_orders WHERE order_no ilike '"+jTextField36.getText()+"'");
...
//        jTextField9.setText("");
    ...
    private void postbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_postbtnActionPerformed
        ...
        try {
            ...
            java.sql.PreparedStatement pstmt311 = connectDB.prepareStatement("delete from st_orders WHERE order_no = '"+jTextField36.getText()+"'");
                ...
                for (int i = 0; i< jTable1.getRowCount(); i++) {
                    ...
                    java.sql.PreparedStatement pstmt2 = connectDB.prepareStatement("insert into st_orders values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?)");
                       ...
                       pstmt2.setObject(1,jTextField361.getText());
                        ...
                        pstmt2.setObject(13,jTextField36.getText());
            ...
            policy.OrdersPdf(connectDB, jTextField361.getText(), this.datePicker1.getDate().toString());
