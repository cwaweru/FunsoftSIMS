...
public class StatisticalSalesPerUserPdf implements java.lang.Runnable {
    ...
    public void StatisticalSalesPerUserPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                      ...
                      java.sql.ResultSet rset = st.executeQuery("select distinct current_date,store_name from st_sub_stores WHERE transaction_no ILIKE 'T%' and trans_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and sub_store ilike '"+bank+"'");
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Sales Summary(Users) - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        table.getDefaultCell().setBorder(Rectangle.BOTTOM);
                         ...
                         table.getDefaultCell().setColspan(5);
                          ...
                          Phrase  phrase = new Phrase("Sales By Users", pFontHeader1);
                       ...
                       // table.getDefaultCell().setColspan(2);
                        ...
                        table.addCell(phrase);
                             table.getDefaultCell().setColspan(1);
                        phrase = new Phrase("Presn",pFontHeader);
                        table.addCell(phrase);
                       ...
                       // table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select distinct(user_name),count(distinct(prescription_no)),count(prescription_no),sum(amount),round(sum(amount)/count(prescription_no),2) from hp_pharmacy hp where main_service ilike '"+bank+"' and user_name !='' and date_prescribed BETWEEN '"+beginDate+"' AND '"+endDate+"'  group by user_name ORDER BY  user_name");
