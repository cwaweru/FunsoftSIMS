...
public class PendingReqPerDepPdf implements java.lang.Runnable {
    ...
    public void PendingReqPerDepPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Pending Requisations By Store - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,10,25,10,8,10,10,10};
                        ...
                        table.getDefaultCell().setColspan(5);
                         Phrase phrase = new Phrase("", pFontHeader);
                           ...
                           try {
                                ...
                                phrase = new Phrase(bank + " Pending Requisitions Period : " +dateFormat.format(endDate11)+" - "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        phrase = new Phrase("Req. Date",pFontHeader);
                        table.addCell(phrase);
                        ...
                        table.addCell(phrase);
                        phrase = new Phrase("Qty Iss",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select requisation,requisition_no,item_description,units,qty_issued-quantity,qty_issued,price,round((price*qty_issued),2) from st_receive_requisation where  (quantity-qty_issued) >0 and date  BETWEEN '"+beginDate+"' AND '"+endDate+"' and cost_center ilike '"+bank+"' order by date");// WHERE transaction_no NOTNULL AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY transaction_no ASC");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
