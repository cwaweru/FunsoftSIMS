...
public class StockPricesPdf implements java.lang.Runnable {
    java.lang.String supp2Use = null;
    ...
    public void StockPricesPdf(java.lang.String supName, java.sql.Connection connDb) {
    ...
    public void generatePdf(java.lang.String supName) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Stock Prices - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {30,20,15,10,10,10};
                        ...
                        Phrase phrase = new Phrase(supName + " Stock Prices as at: " +date, pFontHeader);
                        ...
                        phrase = new Phrase("Price KShs",pFontHeader);
                        table.addCell(phrase);
                        ...
                        phrase = new Phrase("Credit Pd",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select description,unit,price,vat,discount_rate,credit_period from st_product_list where supplier ='"+supName+"'");// WHERE transaction_no NOTNULL AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY transaction_no ASC");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
