...
public class OutstOrdersPdf implements java.lang.Runnable {
    ...
    public void OutstOrdersPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("OutStanding Orders - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select order_no,supplier,item,units,quantity,net_value,date_due from st_orders WHERE received = false AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY date");
                            
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(net_value) from st_orders WHERE received = false AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
