...
public class StocksTransAgeingPdf implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    public void StocksTransAgeingPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Stock Transfers  Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                   ...
                   */
                     ...
                     */
                        ...
                        try {
                            ...
                            phrase = new Phrase("Stocks Transfer as at " +dateFormat.format(endDate2), pFontHeader);
                        ...
                        try {
                            ...
                            */
                                    ...
                                    java.sql.PreparedStatement pset1 = connectDB.prepareStatement("select ROUND(sum(ss.issuing/sp.packaging),0) from st_sub_stores ss,st_stock_item sp WHERE ss.item = ? and ss.item = sp.description and ss.transaction_no ilike 'T%'  AND ss.trans_date < '"+rangeDates[rangeDates.length - 1][0]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
  ...
  */
                               ...
                               */
                                  //  while (rset112.next()){
                                    ...
                                    while (rset111.next()){
                                        table.getDefaultCell().setColspan(2);
                                         phrase = new Phrase(dbObject.getDBObject(rset111.getObject(1), "-"),pFontHeader1);
