...
public class WeeklyStoresDrugMvtPdf implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    public void WeeklyStoresDrugMvtPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Weekly Transfers  Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase(memNo + " Weekly Transfers as at " +dateFormat.format(endDate2), pFontHeader);
                        ...
                        for (int x = 0; x < rangeDates.length; x++) {
                            ...
                            try {
                                ...
                                if (x < 1) {
                                    ...
                                    com.afrisoftech.lib.DateFormatter dateFormatterCurrent = new com.afrisoftech.lib.DateFormatter(endDate, "w");
                                    com.afrisoftech.lib.DateFormatter yearFormatterCurrent1 = new com.afrisoftech.lib.DateFormatter(endDate, "yy");
                                    ...
                                    phrase = new Phrase("Week ["+monthStringCurrent+"/"+yearStringCurrent1+"]" ,pFontHeader);
                                } else {
                                    phrase = new Phrase("Week ["+monthString+"/"+yearStringCurrent+"]", pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.Statement stmta1 = connectDB.createStatement();
                                 java.sql.PreparedStatement pSeta1 = connectDB.prepareStatement("SELECT count(product) FROM st_stock_prices where  product = '"+listofAct[i]+"' and department ilike '"+memNo+"%'");
                                java.sql.PreparedStatement pset22 = connectDB.prepareStatement("select product FROM st_stock_prices where  product = ? and department ilike '"+memNo+"%'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
                                    ...
                                    */
                                    ...
                                    for (int t = 0; t < rangeDates.length; t++) {
                                        java.sql.Statement st01 = connectDB.createStatement();
                                          java.sql.PreparedStatement pset = connectDB.prepareStatement("select ROUND(sum(sub_store_issiuing),0) from st_sub_stores WHERE item = ? and sub_store_issiuing > 0 AND sub_store ILIKE '"+memNo+"' AND trans_date between '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            //    java.sql.Connection connDB = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/sako","postgres","pilsiner");
                ...
                java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT item FROM st_sub_stores where item  IS NOT NULL and item  !='' and sub_store_issiuing > 0 and sub_store ilike '"+memNo+"%' and trans_date between '"+beginDate+"' and '"+endDate+"' order by item ");
