...
public class OrderedItemsPdf implements java.lang.Runnable {
    ...
    public void OrderedItemsPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,18,20,10,10,17,13};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select order_no,supplier,item,units,quantity,net_value,date_due from st_orders WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY date");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(net_value) from st_orders WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
