...
javax.swing.JInternalFrame other = new DirectOrderingFuelintfr(connectDB, pConnDB);
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(this.jTextField111.getCaretPosition() < 3){
            ...
            try {
                searchRowSet.execute("select description,units,buying_price as price FROM st_stock_item WHERE description ILIKE '"+jTextField111.getText()+"%' AND department = '"+jComboBox2.getSelectedItem().toString()+"' order by description");
