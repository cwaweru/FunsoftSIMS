...
public class DrugFlowPdf implements java.lang.Runnable {
    ...
    public void DrugFlowPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate,java.lang.String combox,java.lang.String combox1) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,15,35,10,15,20,20};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select trans_date::date,'' ,issiued_to,receiving,sub_store_issiuing,price,total from stock_movement where item ilike '"+memNo1+"' and store_name ilike '"+memNo+"%' AND trans_date BETWEEN '"+beginDate+"' AND '"+endDate+"' order by trans_date");
                            java.sql.ResultSet rset1q = st1q.executeQuery("select sum(receiving) from stock_movement where item ilike '"+memNo1+"%' and store_name ilike '"+memNo+"%' AND trans_date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            java.sql.ResultSet rset4 = st4.executeQuery("select transfer_price from st_stock_prices where product ilike '"+memNo1+"%' and department ilike '"+memNo+"%'");
                            java.sql.ResultSet rset11 = st11.executeQuery("select sum(receiving-sub_store_issiuing) from stock_movement where item ilike '"+memNo1+"%' and store_name ilike '"+memNo+"%' AND trans_date < '"+beginDate+"'");
                            ...
                            phrase = new Phrase("Drug Movement : " +memNo1, pFontHeader11);
                            table.addCell(phrase);
