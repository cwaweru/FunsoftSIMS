...
public class DiagnosisPdf implements java.lang.Runnable {
    ...
    public void DiagnosisPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                         ...
                         java.sql.ResultSet rset1 = st2.executeQuery("SELECT distinct date_prescribed,patient_no,patient_name,doctor from hp_pharmacy where date_prescribed BETWEEN '"+beginDate+"' AND '"+endDate+"' and disease ILIKE '"+listofAct1[k].toString()+"' order by date_prescribed,patient_name");
                               table.getDefaultCell().setColspan(1);
