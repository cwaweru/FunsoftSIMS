...
public class StockItemsPdf implements java.lang.Runnable {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase(bank + "Stock Items : ", com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,10));
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st2.executeQuery("SELECT item_code,description,units,buying_price from st_stock_item where department ilike '"+bank+"%' order by description");
