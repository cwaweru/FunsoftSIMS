...
public class AllOrdersPdf implements java.lang.Runnable {
    java.lang.String order2Use = null;
    ...
    public void AllOrdersPdf(java.lang.String orderNo,java.sql.Connection connDb) {
    ...
    public void generatePdf(java.lang.String orderNos) {
      ...
      */
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset41 = st31.executeQuery("select supplier from st_orders where order_no =  '"+orderNos+"'");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            while (rset41.next())
                                supName = rset41.getString(1);
                            ...
                            java.sql.Statement st6 = connectDB.createStatement();
                            java.sql.ResultSet rset3 = st3.executeQuery("select hospital_name,postal_code||' '||box_no||' '||town,main_telno||' '||other_telno,initcap(street),main_faxno,email,initcap(building_name),room_no from pb_hospitalprofile");
                            java.sql.ResultSet rset2 = st2.executeQuery("select supplier_name,short_name,postal_address||' '||town,tel1||' '||tel2,initcap(street),initcap(avenue),fax_no,email_address,initcap(building_name) from st_suppliers WHERE supplier_name = '"+supName+"'");// and date ='"+beginDate+"'");
                            java.sql.ResultSet rset4 = st4.executeQuery("select order_no,date from st_orders where order_no =  '"+orderNos+"'");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            java.sql.ResultSet rset5 = st5.executeQuery("select date_due from st_orders where order_no = '"+orderNos+"'");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                           ...
                           while (rset1.next())
                            ...
                            while (rset3.next())
                                ...
                                while(rset4.next())
                                    ...
                                    table1.addCell(phrase);
                                    table1.getDefaultCell().setColspan(3);
                                    phrase = new Phrase("Purchase Order No. "+"\t" +rset4.getObject(1).toString(), pFontHeader);
                                    table1.addCell(phrase);
                                    table1.getDefaultCell().setColspan(3);
                                    
                                    phrase = new Phrase("Purchase Order Date: "+"\t" +rset4.getObject(2).toString(), pFontHeader);
                                    table1.addCell(phrase);
                                    table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
               ...
               */
                ...
                try{
                    ...
                    int headerwidths[] = {24,15,10,10,6,10,6,10,14};
       ...
       */
        ...
        */
                    try {
                        ...
                        //  java.sql.Connection conDb = java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/purchase","postgres","pilsiner");
                        // java.sql.Statement st3 = conDb.createStatement();
                        // java.sql.Statement st2 = conDb.createStatement();
                        // java.sql.Statement st1 = conDb.createStatement();
                        // java.sql.Statement st4 = conDb.createStatement();
                        // java.sql.Statement st5 = conDb.createStatement();
                        //  java.sql.Statement st6 = conDb.createStatement();
                        
                        ///  java.sql.ResultSet rset = st.executeQuery("select DISTINCT member_code, member_name,date from shares_refund order by member_code");
                        // java.sql.ResultSet rset3 = st3.executeQuery("select company_name,short_name,postal_address||' '||town,tel1||' '||tel2,initcap(street),initcap(avenue),fax_no,email_address,initcap(building_name),room_no from company_profile");
                        // java.sql.ResultSet rset2 = st2.executeQuery("select supplier_name,short_name,postal_address||' '||town,tel1||' '||tel2,initcap(street),initcap(avenue),fax_no,email_address,initcap(building_name),room_no from suppliers WHERE supplier_name = 'Nakumat'");
                        // java.sql.ResultSet rset4 = st4.executeQuery("select order_no,date from orders");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                        // java.sql.ResultSet rset5 = st5.executeQuery("select date_due from orders");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                        
                        
                        java.sql.ResultSet rset1 = st1.executeQuery("select initcap(item),quantity,units,unit_price,discount,discount_value,vat,vat_amount,net_value from st_orders where order_no ='"+orderNos+"'");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
