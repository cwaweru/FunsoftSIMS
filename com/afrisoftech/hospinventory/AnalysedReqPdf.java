...
public class AnalysedReqPdf implements java.lang.Runnable {
    ...
    public void AnalysedReqPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Analysed Requisations - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,30,25,15,10,10};
                        ...
                        Phrase phrase = new Phrase("Analysed Requisations as at: " +endDate, pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select requisation,cost_center,item_description,units,quantity,date_due from st_receive_requisation where analysed = true");// WHERE transaction_no NOTNULL AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' ORDER BY transaction_no ASC");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
