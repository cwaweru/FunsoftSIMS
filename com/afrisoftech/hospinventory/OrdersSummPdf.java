...
public class OrdersSummPdf implements java.lang.Runnable {
    ...
    public void OrdersSummPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,12,24,13,13};
                        ...
                        Phrase phrase = new Phrase("", pFontHeader);
                            ...
                            try {
                                ...
                                phrase = new Phrase("Orders Summary :     Period : From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), pFontHeader);
                       ...
                       // table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select distinct(order_no),date,upper(supplier),sum(net_value),date_due from st_orders WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' group by order_no,date,supplier,date_due ORDER BY date,order_no");
