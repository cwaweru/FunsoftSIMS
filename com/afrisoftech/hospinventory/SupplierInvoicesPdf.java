...
public class SupplierInvoicesPdf implements java.lang.Runnable {
    ...
    public void SupplierInvoicesPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate ) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Supplier Inv - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,14,30,15,10,20};
                        ...
                        Phrase phrase = new Phrase("");
                         try {
                                ...
                                phrase = new Phrase("Supplier Invoices List :     Period : From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), pFontHeader);
                      ...
                      //  table.addCell(phrase);
                        ...
                        phrase = new Phrase("Value KShs",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select invoice_no,date,dealer,sum(credit),sum(debit) from ac_accounts_payable WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and transaction_type ILIKE 'Stock Delivery' GROUP BY invoice_no,date,dealer ORDER BY date");
                          //  java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(credit),sum(debit),sum(credit) from ac_accounts_payable WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and transaction_type ILIKE 'Stock Delivery'");
