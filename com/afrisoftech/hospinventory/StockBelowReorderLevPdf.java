...
public class StockBelowReorderLevPdf implements java.lang.Runnable {
    ...
    public void StockBelowReorderLevPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Stock Below Level - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Stock Below Reorder Level as at: " +date, pFontHeader);
