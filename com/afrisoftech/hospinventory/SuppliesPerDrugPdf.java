                ...
                */
                  ...
                  */
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,25,20,10,10,20};
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select date,item,supplier,quantity_received,price_per_item,debit from st_stock_cardex where item ilike '"+memNo1+"' AND date BETWEEN '"+beginDate+"' AND '"+endDate+"' and quantity_received > 0 order by date");// UNION ALL SELECT trans_date,store_name,user_name,issuing,total from st_sub_stores where (sub_store = 'Pharmacy' OR sub_store = 'IP Pharmacy') and item ilike '"+memNo+"' AND trans_date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                           // java.sql.ResultSet rset1q = st1q.executeQuery("select sum(quantity) from hp_pharmacy where description ilike '"+memNo1+"%' and main_service ilike '"+memNo+"%' AND date_prescribed BETWEEN '"+beginDate+"' AND '"+endDate+"'");// UNION ALL SELECT trans_date,store_name,user_name,issuing,total from st_sub_stores where (sub_store = 'Pharmacy' OR sub_store = 'IP Pharmacy') and item ilike '"+memNo+"' AND trans_date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            //java.sql.ResultSet rset4 = st4.executeQuery("select transfer_price from st_stock_prices where product ilike '"+memNo1+"%' and department ilike '"+memNo+"%'");// UNION ALL SELECT trans_date,store_name,user_name,issuing,total from st_sub_stores where (sub_store = 'Pharmacy' OR sub_store = 'IP Pharmacy') and item ilike '"+memNo+"' AND trans_date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            java.sql.ResultSet rset11 = st11.executeQuery("select sum(quantity_instock),sum(quantity_instock*buying_price) from st_stock_item where description ilike '"+memNo1+"%'");// UNION ALL SELECT trans_date,store_name,user_name,issuing,total from st_sub_stores where (sub_store = 'Pharmacy' OR sub_store = 'IP Pharmacy') and item ilike '"+memNo+"' AND trans_date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                         ...
                         /*   while (rset1q.next()){
                            ...
                            while (rset4.next()){
                                ...
                                phrase = new Phrase("Purchase Qty BF  " + new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(openingBal+closingBal)),pFontHeader);
                                ...
                                phrase = new Phrase("Purchase Amt BF  " +new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf((openingBal+closingBal)*buyingPrice)),pFontHeader);
                          ...
                          */
                           ...
                           phrase = new Phrase("Supplier",pFontHeader1);
                            ...
                            while (rset1.next()){
                                ...
                                osBalanceAmt1 = osBalanceAmt1 + rset1.getDouble(6);
                                table.addCell(phrase);
