...
public class OrdersSummBySuppPdf implements java.lang.Runnable {
    int numberSeq = 0;
    ...
    public void OrdersSummBySuppPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String receipt) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Orders(Summary) - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {8,12,12,13,13};
                        ...
                        try {
                            ...
                            phrase = new Phrase(Receipt +" Orders Summary :     Period : From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select distinct(order_no),date,sum(net_value),date_due from st_orders WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' and supplier ilike '"+Receipt+"' group by order_no,date,supplier,date_due ORDER BY date,order_no");
