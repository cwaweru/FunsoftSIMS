            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        table.addCell(phrase);
                        table.getDefaultCell().setColspan(1);
                        phrase = new Phrase("Comp Qty",pFontHeader);
                        table.addCell(phrase);
                        
                        phrase = new Phrase("Qty Counted",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select product_code,description,comp_total,qty_counted,expired,damaged,st_variances,stock_value from st_stock_count  WHERE input_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and department ilike '"+bank+"' ORDER BY description");
