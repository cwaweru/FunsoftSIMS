 ...
 * @author  root
 */
public class AmendSubStoreBalancesintfr extends javax.swing.JInternalFrame {
    ...
    public AmendSubStoreBalancesintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Sub Store Opening Balances");
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder(null, "Select Sub store here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10)));
        jLabel1.setText(" Sub Store");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(jTextField111.getCaretPosition() > 2){
            try {
                ...
                searchRowSet1.execute("select product,units  FROM st_stock_prices WHERE product ILIKE '"+jTextField111.getText()+"%' and department ilike '"+this.jComboBox1.getSelectedItem().toString()+"%' order by product");
            ...
            try {
                ...
                for (int i = 0; i< jTable1.getRowCount(); i++) {
                    ...
                    if (jTable1.getModel().getValueAt(i,2) != null){
                        ...
                        java.sql.ResultSet rs6 = pstmt6.executeQuery("select product_id,balance,transfer_price from st_stock_prices where product ilike '"+jTable1.getValueAt(i,0)+"' and department = '"+jComboBox1.getSelectedItem().toString()+"'");
                        while (rs6.next())
                        ...
                        java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("UPDATE st_stock_prices set balance = "+new java.lang.Double(quantity)+" where department = '"+jComboBox1.getSelectedItem().toString()+"' and product = '"+jTable1.getValueAt(i,0).toString()+"'");
