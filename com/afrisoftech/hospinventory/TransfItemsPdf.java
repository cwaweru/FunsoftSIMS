...
public class TransfItemsPdf implements java.lang.Runnable {
    ...
    public void TransfItemsPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase  phrase = new Phrase("Transfered Items", pFontHeader1);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select ss.trans_date::date,ss.item,ROUND(sum(ss.issuing)),ss.user_name,ss.issiued_to,ss.sub_store,sum(ss.price),sum(ss.total) from st_sub_stores ss WHERE ss.transaction_no ILIKE 'T%' and ss.trans_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND (ss.store_name ilike 'main%' or ss.store_name ilike 'general%') GROUP BY ss.trans_date,ss.item,ss.user_name,ss.issiued_to,ss.sub_store ORDER BY ss.trans_date");
