 ...
 * @author  root
 */
public class MainStoreBalancesIntfr extends javax.swing.JInternalFrame {
    ...
    public MainStoreBalancesIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Main Store Stock Count");
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder("Select Sub store here"));
        ...
        jPanel2.setBorder(new javax.swing.border.TitledBorder("Enter items & their balances"));
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Description", "Units", "Saleable Qty.", "Expired Qty.", "Damaged Qty.", "Start Time", "End Time"
            }
        ) {
            ...
            for (int i = 0; i< jTable1.getRowCount(); i++) {
                ...
                if (jTable1.getModel().getValueAt(i,2) != null){
                    ...
                    if (jTable1.getValueAt(i,5) == null){
                        ...
                        pstmt.setObject(11,jTable1.getValueAt(i,5));
                    }
                    
                     if (jTable1.getValueAt(i,6) == null){
                        pstmt.setObject(12,"'now'");
                    }else{
                        pstmt.setObject(12,jTable1.getValueAt(i,6));
                    }
                   // pstmt.setObject(11,jTextField1.getText());
                   // pstmt.setObject(12,jTextField2.getText());
                    ...
                    java.sql.PreparedStatement pstmt31 = connectDB.prepareStatement("UPDATE st_stock_item set quantity_instock = quantity_instock + "+new java.lang.Double(quantities)+" where department = '"+jComboBox1.getSelectedItem().toString()+"' and description = '"+jTable1.getValueAt(i,0).toString()+"'");
