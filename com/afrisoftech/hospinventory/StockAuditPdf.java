...
public class StockAuditPdf implements java.lang.Runnable {
    ...
    public void StockAuditPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {25,10,10,15,10,15};
                        ...
                        try {
                            ...
                            phrase = new Phrase("Stock Audit Report :     Period : From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                               ...
                               */
                                ...
                                // java.sql.Statement pSet1 = connectDB.createStatement();
                                java.sql.ResultSet rset11 = st1.executeQuery("select count(item) from st_stock_cardex WHERE date < '"+beginDate+"' AND item = '"+listofAct[i]+"'");
                                
                                
                                java.sql.ResultSet rset = st21.executeQuery("select item,SUM(quantity_received - sub_store_issuing) from st_stock_cardex WHERE date < '"+beginDate+"' AND item = '"+listofAct[i]+"' group by item");
                                
                                java.sql.ResultSet rset1 = st2.executeQuery("select SUM(quantity_received) from st_stock_cardex WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND item = '"+listofAct[i]+"' group by item");
                                
                                java.sql.ResultSet rset12 = st31.executeQuery("select count(item) from st_stock_cardex WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND item = '"+listofAct[i]+"'");
                                
                                java.sql.ResultSet rset2 = st3.executeQuery("select SUM(quantity) from stock_audit WHERE date_prescribed BETWEEN '"+beginDate+"' AND '"+endDate+"' AND description = '"+listofAct[i]+"' group by description");
                                ...
                                closing = (opStock+supplies)-sales;
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT DISTINCT item FROM st_stock_cardex");
