...
public class PrescriptionsPerDocPdf implements java.lang.Runnable {
    ...
    public void PrescriptionsPerDocPdf(java.sql.Connection connDb,java.util.Date begindate, java.util.Date endate,java.lang.String combox) {
        bank = combox;
        connectDB = connDb;
         beginDate = begindate;
        endDate = endate;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Prescriptions Per doctor - Page: ", pFontHeader1), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {15,30,30,10,20};
                        ...
                        table.getDefaultCell().setColspan(3);
                         ...
                         phrase = new Phrase(bank + "Prescriptions :  Period From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), com.lowagie.text.FontFactory.getFont(FontFactory.HELVETICA_BOLD,10));
                        ...
                        try {
                         ...
                         java.sql.ResultSet rset1 = st2.executeQuery("SELECT date_prescribed,patient_name,description,quantity,amount from hp_pharmacy where doctor ilike '"+bank+"' and date_prescribed between '"+beginDate+"' AND '"+endDate+"' order by date_prescribed,description");
                                ...
                                while (rset1.next()) {
                                    ...
                                    table.addCell(phrase);
                                     ...
                                     phrase = new Phrase(dbObject.getDBObject(rset1.getObject(4), "0.00"),pFontNum);
