 ...
 * @author  root
 */
public class CloseSupplierAccIntfr extends javax.swing.JInternalFrame {
    ...
    public CloseSupplierAccIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Close / Activate Supplier's Account");
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder(null, "Select Supplier Name ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(0, 0, 255)));
...
private void searchButtonClicked() {
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
       if(this.jTextField111.getCaretPosition() < 3){
            ...
            try {
                searchRowSet.execute("select distinct supplier_name as name,code from st_suppliers where supplier_name ILIKE '"+jTextField111.getText()+"%' order by supplier_name");
