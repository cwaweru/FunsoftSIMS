 ...
 * @author  root
 */
public class AdjustStockpricesintfr extends javax.swing.JInternalFrame {
    ...
    public AdjustStockpricesintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Adjust Stock Selling & Buying Prices");
        ...
        */
        ...
        jCheckBox1.setText("Excempt Pharmacy");
 ...
 if(jTextField111.getCaretPosition() > 2){
            ...
            try {
                searchRowSet.execute("select distinct product,product_id,units ,transfer_price ,selling_price FROM st_stock_prices WHERE product ILIKE '"+jTextField111.getText()+"%' order by product");
        ...
        try {
          ...
          //  java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into st_stock_prices values( ?,?,?,?,?,?,?,?,?,?,?)");
            for (int i = 0; i < jTable1.getRowCount(); i++){
                ...
                java.sql.PreparedStatement pstmt3 = connectDB.prepareStatement("UPDATE st_stock_prices SET transfer_price = '"+jTable1.getValueAt(i,3).toString()+"',selling_price = '"+jTable1.getValueAt(i,4).toString()+"' WHERE product = '"+jTable1.getValueAt(i,0).toString()+"' and department not like 'Phar%'");
                    pstmt3.executeUpdate();
                    }else{
                        java.sql.PreparedStatement pstmt3 = connectDB.prepareStatement("UPDATE st_stock_prices SET transfer_price = '"+jTable1.getValueAt(i,3).toString()+"',selling_price = '"+jTable1.getValueAt(i,4).toString()+"' WHERE product = '"+jTable1.getValueAt(i,0).toString()+"'");
                    pstmt3.executeUpdate();
                    }
                    //pstmt.executeUpdate();
