...
public class ItemsWithPriceVarPdf implements java.lang.Runnable {
    ...
    public void ItemsWithPriceVarPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Items With Price Variation - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {30,30,10,10, 10,10};
                        ...
                        Phrase phrase = new Phrase("Items With Price Variation", pFontHeader);
                        ...
                        phrase = new Phrase("Preset BP",pFontHeader);
                        table.addCell(phrase);
                        ...
                        */
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select distinct(sc.item),sc.supplier,sc.price_per_item,st.buying_price,sc.price_per_item-st.buying_price as variance,round(((sc.price_per_item-st.buying_price)*100/st.buying_price),2) from st_stock_cardex sc, st_stock_item st where sc.price_per_item != st.buying_price  and sc.item = st.description and sc.quantity_received >0 and sc.date > current_date - (st_ordering_constants.average_day)::integer order by variance desc");
                            ...
                            while (rset.next()) {
                               ...
                               phrase = new Phrase(dbObject.getDBObject(rset.getObject(2), "-"), pFontHeader1);
                                ...
                                table.addCell(phrase);
                                 phrase = new Phrase(dbObject.getDBObject(rset.getObject(6), "0"), pFontHeader1);
                                table.addCell(phrase);
                            }
