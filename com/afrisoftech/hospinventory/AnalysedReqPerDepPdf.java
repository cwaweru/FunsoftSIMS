...
public class AnalysedReqPerDepPdf implements java.lang.Runnable {
    ...
    public void AnalysedReqPerDepPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Requisations By Store - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,10,25,10,8,10,10};
                        ...
                        table.getDefaultCell().setColspan(5);
                         Phrase phrase = new Phrase("", pFontHeader);
                           ...
                           try {
                                ...
                                phrase = new Phrase(bank + " Requisitions Period : " +dateFormat.format(endDate11)+" - "+dateFormat.format(endDate1), pFontHeader);
