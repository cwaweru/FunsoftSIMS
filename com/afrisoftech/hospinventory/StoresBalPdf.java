...
public class StoresBalPdf implements java.lang.Runnable {
    ...
    public void StoresBalPdf(java.sql.Connection connDb, java.util.Date begindate, java.util.Date endate, java.lang.String combox) {
    ...
    public void generatePdf() {
      ...
      */
                    ...
                    try {
                        ...
                        phrase = new Phrase(bank +  "  Stock Balance as at : " +date, pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select product,sum(transfer_price),sum(balance),sum(balance*transfer_price) from st_stock_prices WHERE department = '"+bank+"' and balance!=0 group by product order by product");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
