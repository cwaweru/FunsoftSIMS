...
public class OrderingConsIntfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder(null, "Enter Avg & lead time Constants  here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 10)));
        ...
        jLabel21.setText("Reorder Level (Days)");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if(jTextField2.getText().equals("")){
                javax.swing.JOptionPane.showMessageDialog(this, "You must lead Time","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
            }else{
                pstmt.setString(2,jTextField2.getText());
            } 
            if(jTextField21.getText().equals("")){
                javax.swing.JOptionPane.showMessageDialog(this, "You must ENTER Reorder Level","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
            }else{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            ...
            java.sql.ResultSet rs1 = pstmt1.executeQuery("select average_day,read_time,reorder_level from st_ordering_constants"); //from orders where supplier ='"+jTable1.getValueAt(i,4).toString()+"'");
