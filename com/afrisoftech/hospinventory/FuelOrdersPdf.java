...
public class FuelOrdersPdf implements java.lang.Runnable {
    ...
    public void FuelOrdersPdf(java.sql.Connection connDb,java.lang.String combox, java.lang.String order) {
      ...
      */
                        ...
                        try {
                          ...
                          //  java.sql.ResultSet rset3 = st3.executeQuery("select hospital_name,box_no,main_telno||' '||other_telno,initcap(street),initcap(town),main_faxno,email,initcap(building_name),room_no from pb_hospitalprofile");
                            java.sql.ResultSet rset2 = st2.executeQuery("select supplier_name,short_name,postal_address,tel1,initcap(street),initcap(avenue),fax_no,email_address,initcap(building_name) from st_suppliers WHERE supplier_name ='"+selectSupp+"'");
                            java.sql.ResultSet rset4 = st4.executeQuery("select order_no,date from st_orders where order_no = '"+OrderNo+"'");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            java.sql.ResultSet rset5 = st5.executeQuery("select date_due from st_orders where order_no = '"+OrderNo+"'");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                           ...
                           /* while (rset3.next())
                            ...
                            table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Fax:"+"\t"+ rset3.getObject(6).toString(), pFontHeader);
                            ...
                            table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Email:"+"\t"+rset3.getObject(7).toString(), pFontHeader);
                            ...
                            */
                            ...
                            phrase = new Phrase("Order Date: "+"\t" +rset4.getObject(2).toString(), pFontHeader);
                            table1.addCell(phrase);
               ...
               */
                            ...
                            table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("To: "+rset2.getObject(1).toString(), pFontHeader3);
                            table1.addCell(phrase);
                            ...
                            table1.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("Address: "+"\t" +rset2.getString(3), pFontHeader);
                            table1.addCell(phrase);
                    ...
                    try{
                        ...
                        int headerwidths[] = {19,10,8,10,6,10,6,8,14,10};
                        ...
                        phrase = new Phrase("Milage ", pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select initcap(item),quantity,units,unit_price,discount,discount_value,vat,vat_amount,net_value,mileage from st_orders where order_no = '"+OrderNo+"'");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            ...
                            while (rset1.next()) {
                                ...
                                phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rset1.getString(10)),pFontHeader2);
