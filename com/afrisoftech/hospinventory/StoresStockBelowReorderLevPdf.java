...
public class StoresStockBelowReorderLevPdf implements java.lang.Runnable {
    ...
    public void StoresStockBelowReorderLevPdf(java.sql.Connection connDb,java.lang.String combox) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase(bank + "Stock Below Reorder Level as at: " +date, pFontHeader);
                      ...
                      //  table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_CENTER);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select product,sum(balance),sum(transfer_price),sum(balance*transfer_price) from st_stock_prices WHERE department = '"+bank+"' and balance <= 0 group by product order by product");// tn,debit_note db WHERE tn.policy_no != '' and tn.policy_no = db.policy_no GROUP BY tn.policy_no,db.policy_class");
                            ...
                            while (rset.next()) {
                               ...
                               table.getDefaultCell().setColspan(1);
                                ...
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                //  table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(dbObject.getDBObject(rset.getObject(2), "0.0"), pFontHeader1);
