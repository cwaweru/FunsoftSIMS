 ...
 * @author  root
 */
public class Issiuingintfr extends javax.swing.JInternalFrame {
    ...
    public Issiuingintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jComboBox11.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset1, "store_name", null, null, null));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Desc.", "Units", "Package", "Main Store Bal.", "Store Bal", "Qty Issued", "Price", "Total"
            }
        ) {
        ...
        jTable11.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Desc.", "Units", "M/Store Bal.", "Qty Issued", "Price", "Value"
            }
        ) {
            Class[] types = new Class [] {
    ...
    private void jButton71ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton71ActionPerformed
        ...
        try {
            ...
            java.sql.ResultSet rs1 = pst21.executeQuery("select 'I'||currval('issiuing_seq')");
            while (rs1.next()){
           ...
           /* java.sql.Statement pst2 = connectDB.createStatement();
            ...
            for (int i = 0; i< jTable11.getRowCount(); i++) {
                ...
                if (jTable11.getModel().getValueAt(i,4) != null){
                   ...
                   pstmt2.setObject(1,jTextField3.getText());
                    pstmt2.setObject(2,jComboBox111.getSelectedItem());
                    pstmt2.setString(3,"");
            ...
            for (int i = 0; i< jTable1.getRowCount(); i++) {
                if (jTable1.getModel().getValueAt(i,5) != null){
                    ...
                    pstmt32.executeUpdate();
                          ...
                          java.sql.PreparedStatement pstmt312 = connectDB.prepareStatement("UPDATE st_stock_prices SET balance = balance + "+new java.lang.Double(quantity*pack)+", requisition = requisition - "+new java.lang.Double(quantity*pack)+" WHERE product = '"+jTable1.getValueAt(i,0).toString()+"' AND department = '"+jComboBox2.getSelectedItem().toString()+"'");
                    pstmt312.executeUpdate();
                      }
                    //    java.sql.PreparedStatement pstmt11 = connectDB.prepareStatement("update st_receive_requisation set issiued = 'true' where cost_center ='"+jComboBox11.getSelectedItem()+"' AND item_description = '"+jTable1.getValueAt(i,0).toString()+"'");
                    //    pstmt11.executeUpdate();
                }
            }*/
            connectDB.commit();
    ...
    private void jComboBox111ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox111ActionPerformed
        try {
            ...
            java.sql.ResultSet rs = pstmt.executeQuery("select cons_gl_code from pb_departments where department_name ilike '"+jComboBox111.getSelectedItem().toString()+"'");
            while (rs.next()){
    ...
    private void jSearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchTableMouseClicked
        ...
        if(this.jCheckBox1.isSelected()){
            try {
                ...
                java.sql.ResultSet rs1 = pstmt1.executeQuery("select quantity_instock,packaging from st_stock_item where description ILIKE '"+jTable1.getValueAt(jTable1.getSelectedRow(),0)+"%' AND department ilike '"+jComboBox2.getSelectedItem().toString()+"%'");
            ...
            try {
                java.sql.Statement pstmt1 = connectDB.createStatement();
                java.sql.ResultSet rs1 = pstmt1.executeQuery("select balance,'1' from st_stock_prices where product ILIKE '"+jTable1.getValueAt(jTable1.getSelectedRow(),0)+"%' AND department ilike '"+this.jComboBox2.getSelectedItem().toString()+"%'");
                java.sql.Statement pst = connectDB.createStatement();
                while (rs1.next()){
        ...
        //  java.sql.Statement pstmt = connectDB.createStatement();
        //  java.sql.ResultSet rs = pstmt.executeQuery("select requisition from st_stock_prices where product ILIKE '"+jTable1.getValueAt(jTable1.getSelectedRow(),0)+"%' and department ILIKE '"+jComboBox11.getSelectedItem().toString()+"%'");
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        if(jTextField111.getCaretPosition() > 2){
            try {
                ...
                searchRowSet.execute("select DISTINCT description,units,buying_price,packaging FROM st_stock_item WHERE description ILIKE '"+jTextField111.getText()+"%' and st_stock_prices.product ilike description AND st_stock_prices.department = '"+jComboBox11.getSelectedItem()+"' order by description");
    ...
    private void jTable1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyReleased
        if (jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 5) != null) {
            ...
            if (jTable1.getSelectedColumn() == 5) {
                ...
                double Total = java.lang.Double.parseDouble(java.lang.Double.toString(com.afrisoftech.lib.CurrencyFormatter.parseFormattedString(jTextField2.getText().toString())));
                double tableSum = java.lang.Double.parseDouble(resFloat.toString());
            ...
            if (jTable1.getModel().getValueAt(j,0) != null){
                ...
                try {
                    java.sql.Statement stmtTable111 = connectDB.createStatement();
                        java.sql.ResultSet rsetTable111 = stmtTable111.executeQuery("SELECT sum(quantity_instock) FROM st_stock_item WHERE department = '"+jComboBox2.getSelectedItem().toString()+"' and description = '"+jTable1.getValueAt(j,0).toString()+"'");
            ...
            try {
                ...
                for (int i = 0; i< jTable1.getRowCount(); i++) {
                    if (jTable1.getModel().getValueAt(i,5) != null){
                        ...
                        pstmt11.setDouble(5,uprice/pack);
                        ...
                        if(this.jCheckBox1.isSelected()){
                            java.sql.PreparedStatement pstmt32 = connectDB.prepareStatement("UPDATE st_stock_item SET quantity_instock = quantity_instock - "+new java.lang.Double(quantity)+" WHERE description = '"+jTable1.getValueAt(i,0).toString()+"' AND department = '"+jComboBox2.getSelectedItem().toString()+"'");
                            pstmt32.executeUpdate();
                        }else{
                            java.sql.PreparedStatement pstmt312 = connectDB.prepareStatement("UPDATE st_stock_prices SET balance = balance + "+new java.lang.Double(quantity*pack)+", requisition = requisition - "+new java.lang.Double(quantity*pack)+" WHERE product = '"+jTable1.getValueAt(i,0).toString()+"' AND department = '"+jComboBox2.getSelectedItem().toString()+"'");
                            pstmt312.executeUpdate();
