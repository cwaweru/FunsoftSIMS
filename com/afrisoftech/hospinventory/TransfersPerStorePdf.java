...
public class TransfersPerStorePdf implements java.lang.Runnable {
    ...
    public void TransfersPerStorePdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase  phrase = new Phrase("Transfered Items By Store", pFontHeader1);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select ss.trans_date::date,ss.item,sum(ss.issuing),ss.transaction_no,ss.issiued_to,ss.sub_store,sum(price),round(sum(total),2) from st_sub_stores ss WHERE transaction_no ILIKE 'T%' and ss.trans_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and ss.sub_store ilike '"+bank+"' AND ss.issuing > 0 group by ss.trans_date,ss.item,ss.transaction_no,ss.issiued_to,ss.sub_store ORDER BY ss.trans_date,ss.transaction_no");
