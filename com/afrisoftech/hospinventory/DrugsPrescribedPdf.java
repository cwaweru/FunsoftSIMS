            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {11,20,8,20,10,8,15};
                        ...
                        Phrase phrase = new Phrase("Drug Prescribed", pFontHeader);
                        ...
                        table.addCell(phrase);
                        phrase = new Phrase("Man Prno.",pFontHeader);
                        table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select patient_no,initcap(patient_name),prescription_no,initcap(description),quantity,manual_pr,amount from hp_pharmacy where date_prescribed between '"+beginDate+"' and '"+endDate+"' and main_service ilike 'pharmacy' order by prescription_no,description");
