 ...
 * @author  root
 */
public class OrderingPricexemptintfr extends javax.swing.JInternalFrame {
    ...
    public OrderingPricexemptintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        */
        ...
        jComboBox2.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (crset3, "department_name", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Code", "Description", "Units", "Qty"
            }
        ) {
            Class[] types = new Class [] {
    ...
    private void jTextField111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField111CaretUpdate
        ...
        try {
            searchRowSet.execute("select description,units,item_code FROM st_stock_item WHERE description ILIKE '"+jTextField111.getText()+"%' order by description");
            ...
            jSearchTable.setModel(new org.netbeans.lib.sql.models.TableModel(searchRowSet, new org.netbeans.lib.sql.models.TableModel.Column[] {
                ...
                new org.netbeans.lib.sql.models.TableModel.Column("item_code", "Stock Code", false)
...
//        jTextField2.setText("0.00");
    ...
    private void postbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_postbtnActionPerformed
        ...
        try {
            ...
            while (rs1.next()){
                ...
                for (int i = 0; i< jTable1.getRowCount(); i++) {
                    ...
                    if (jTable1.getModel().getValueAt(i,0) != null){
                        ...
                        pstmt2.setObject(4,jTable1.getValueAt(i,3));
                        pstmt2.setObject(5,"0.00");
                        pstmt2.setObject(6,"0.00");
                        pstmt2.setObject(7,"0.00");
                        pstmt2.setObject(8,"0.00");
                        pstmt2.setObject(9,"0.00");
                        pstmt2.setObject(10,"0.00");
            ...
            com.afrisoftech.hospinventory.UnpricedOrdersPdf policy = new com.afrisoftech.hospinventory.UnpricedOrdersPdf();
            policy.UnpricedOrdersPdf(connectDB, jComboBox1.getSelectedItem().toString(), this.datePicker1.getDate().toString());
