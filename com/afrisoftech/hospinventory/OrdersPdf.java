               ...
               */
                    ...
                    try{
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select initcap(item),quantity,units,unit_price,discount,discount_value,vat,vat_amount,net_value from st_orders where order_no = '"+OrderNo+"'");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
