...
public class PrescByUserSummPdf implements java.lang.Runnable {
    ...
    public void PrescByUserSummPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("", pFontHeader);
                            ...
                            try {
                                ...
                                phrase = new Phrase("Prescriptions By Pharmacist Summary :     Period : From "  +dateFormat.format(endDate11)+" To "+dateFormat.format(endDate1), pFontHeader);
                       ...
                       // Phrase phrase = new Phrase("Patients List As At:" +endDate, pFontHeader);
                        ...
                        table.addCell(phrase);
                         phrase = new Phrase("Pharmacist",pFontHeader);
                        table.addCell(phrase);
                       ...
                       // table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select distinct upper(user_name),count(distinct(prescription_no)),sum(amount) from hp_pharmacy where date_prescribed BETWEEN '"+beginDate+"' AND '"+endDate+"' and main_service ilike 'phar%' and user_name  is not null group by upper(user_name) order by upper(user_name) ");
