 ...
 * Stores.java
 *
 * Created on Jun 30, 2003, 09:41 AM
*/
...
public class Stores extends javax.swing.JFrame
{
    ...
    public Stores(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select * from stores");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        try {
            nBCachedRowSet1.setTableName("stores");
        } catch (java.sql.SQLException e1) {
            e1.printStackTrace();
        }
        ...
        jTable1.setModel(new org.netbeans.lib.sql.models.TableModel(nBCachedRowSet1, new org.netbeans.lib.sql.models.TableModel.Column[] {
            ...
            new org.netbeans.lib.sql.models.TableModel.Column("store_id", "Store id", true),
