...
public class GRTPdf implements java.lang.Runnable {
    ...
    public void GRTPdf(java.sql.Connection connDb,java.lang.String begindate,java.lang.String endate, java.lang.String supp,java.lang.String invno) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("G.R.T", pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select DISTINCT invoice_no,store,date from st_stock_cardex WHERE  delivery_note_no = '"+invNo+"'");
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase("GRT NO:" +invNo, pFontHeader1);
                            table.addCell(phrase);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st21.executeQuery("select distinct received_by from st_stock_cardex WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND supplier = '"+suppName+"' and delivery_note_no = '"+invNo+"'");
                            
                            
                            java.sql.ResultSet rset = st.executeQuery("select item,sub_store_receiving,units,price_per_item,credit,quantity_ordered from st_stock_cardex WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND supplier = '"+suppName+"' and delivery_note_no = '"+invNo+"' ORDER BY item");
                            java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT sum(credit),sum(quantity_ordered) from st_stock_cardex WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"' AND supplier = '"+suppName+"' and delivery_note_no = '"+invNo+"'");
                            ...
                            table.addCell(phrase);
                            table.getDefaultCell().setColspan(1);
                            phrase = new Phrase("RETURNED BY :", pFontHeader1);
                            table.addCell(phrase);
