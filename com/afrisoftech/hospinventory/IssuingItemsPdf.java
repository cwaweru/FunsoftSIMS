...
public class IssuingItemsPdf implements java.lang.Runnable {
    ...
    public void IssuingItemsPdf(java.sql.Connection connDb, java.lang.String receipt) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {50,15,10,10,15};
                        ...
                        Phrase phrase = new Phrase("Issued Items" , pFontHeader);
                        
                        table.addCell(phrase);
                        table.getDefaultCell().setColspan(2);
                        phrase = new Phrase("Iss No. : "+Receipt , pFontHeader);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset2 = st2.executeQuery("select distinct store_name,sub_store,issiued_to,user_name from st_sub_stores WHERE transaction_no = '"+ Receipt+"'");
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select initcap(item),units,issuing ,price,total from st_sub_stores WHERE transaction_no = '"+Receipt+"' ORDER BY item");
                            //  java.sql.ResultSet rsetTotals = st2.executeQuery("SELECT SUM(net_value) from orders WHERE received = false");// WHERE date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
                            java.sql.Statement stt = connectDB.createStatement();
                          ...
                          */
                            ...
                            phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(rsett.getString(1)),pFontHeader);
