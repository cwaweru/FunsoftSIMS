...
public class DailyOutPatRevenueRepPdf implements java.lang.Runnable {
                        ...
                        table.getDefaultCell().setColspan(4);
                         Phrase phrase = new Phrase("", pFontHeader);
                            ...
                            try {
                                ...
                                phrase = new Phrase("Daily Revenue Breakdown(OP):  Period : "  +dateFormat.format(endDate11)+" ------ "+dateFormat.format(endDate1), pFontHeader);
                        ...
                        for (int j = 0; j < listofStaffNos.length; j++) {
                          ...
                          //  while (rsetTotals1.next()) {
                              ...
                              table.getDefaultCell().setColspan(1);
                                    ...
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalancebf1)),pFontNum);
                                  //osBalancebf1 = osBalancebf1 + rset1.getDouble(1);
                                    ...
                                    phrase = new Phrase(new com.afrisoftech.sys.Format2Currency().Format2Currency(java.lang.String.valueOf(osBalancebf2)),pFontNum);
   ...
   public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT distinct UPPER(main) from oprev_view  order by UPPER(main)");
