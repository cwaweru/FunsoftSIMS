...
public class IssuedItemsPerStorePdf implements java.lang.Runnable {
    ...
    public void IssuedItemsPerStorePdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate,java.lang.String combox) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,25,10,10,15,10,14};
                        ...
                        table.getDefaultCell().setBorder(Rectangle.BOTTOM);
                         ...
                         table.getDefaultCell().setColspan(7);
                          ...
                          Phrase  phrase = new Phrase("Issiued Items By Store", pFontHeader1);
                        ...
                        phrase = new Phrase("Issued To",pFontHeader);
                        table.addCell(phrase);
                          phrase = new Phrase("Cost Center",pFontHeader);
                       // table.addCell(phrase);
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select ss.trans_date::date,ss.item,sum(ss.issuing),ss.user_name,ss.issiued_to,ss.sub_store,sum(sp.buying_price),round(sum(sp.buying_price*ss.issuing),2) from st_sub_stores ss,st_stock_item sp WHERE transaction_no ILIKE 'I%' and ss.item = sp.description and ss.trans_date::date BETWEEN '"+beginDate+"' AND '"+endDate+"' and ss.sub_store ilike '"+bank+"' group by ss.trans_date,ss.item,ss.user_name,ss.issiued_to,ss.sub_store ORDER BY ss.trans_date");
