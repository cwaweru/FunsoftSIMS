...
public class CreditNoteintfr extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        crset11.setCommand("select distinct invoice_no from st_stock_cardex where invoice_no !=''");
        ...
        */
        ...
        postbtn.setText("Ok");
        postbtn.setToolTipText("click to save data");
        ...
        resetbtn.setToolTipText("Click to print the G.R.T");
        ...
        cancelbtn.setToolTipText("clears all the fields");
        ...
        jButton1.setToolTipText("deletes the selected row in table");
       ...
       /*     java.sql.Statement ps = connectDB.createStatement();
            ...
            for (int i = 0; i< jTable1.getRowCount(); i++) {
                if (jTable1.getModel().getValueAt(i,9) != null){
                    ...
                    pstmt.setString(14,"");
                    pstmt.setString(15,"");
                    pstmt.setObject(16,jComboBox1.getSelectedItem());
                    pstmt.setString(17,"");
            ...
            java.sql.ResultSet rs111z = pst21z.executeQuery("select count(invoice_no) from ac_accounts_payable where invoice_no ILIKE '"+jTextField7.getText()+"' AND dealer ilike '"+jComboBox1.getSelectedItem().toString()+"'");
            while (rs111z.next()){
            ...
            if (invoices <1){
                ...
                java.sql.PreparedStatement pstmt8121 = connectDB.prepareStatement("UPDATE ac_accounts_payable SET credit = credit + '"+jTextField2.getText()+"',balance = balance + '"+jTextField2.getText()+"',vat = vat + '"+jTextField1.getText()+"',vat_balance = vat_balance + '"+jTextField1.getText()+"' where dealer = '"+jComboBox1.getSelectedItem().toString()+"' AND invoice_no ilike '"+jTextField2.getText()+"%'");
                pstmt8121.executeUpdate();
            }
            ...
            policy.GRTPdf(connectDB, this.datePicker1.getDate().toLocaleString(), this.datePicker1.getDate().toLocaleString(),this.jTextField7.getText().toString(),this.jTextField3.getText().toString());
          /*  jTextField7.setText("");
            jTextField3.setText("");
            ...
            try {
                ...
                for (int i = 0; i< jTable1.getRowCount(); i++) {
                    if (jTable1.getModel().getValueAt(i,9) != null){
                        ...
                        pstmt.setObject(3,jTable1.getValueAt(i,0));
                        pstmt.setObject(4,null);
                        pstmt.setObject(5,jTable1.getValueAt(i,9));
                        pstmt.setDouble(6,price);
                        pstmt.setObject(7,jTable1.getValueAt(i,1));
                        ...
                        pstmt.setString(18,datePicker1.getDate().toString());
                        pstmt.setString(19,jComboBox2.getSelectedItem().toString());
                        pstmt.setString(20,"Stock Returns");
                        pstmt.setObject(21,"0.00");
                        pstmt.setObject(22,jTable1.getValueAt(i,6));
                        pstmt.setString(23,jTextField6.getText());
                        if(jTextField3.getText().equals("")){
                            javax.swing.JOptionPane.showMessageDialog(this,"Credit Note No Missing","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
                        }else{
                              pstmt.setString(24,jTextField91.getText());
                        }
                        pstmt.setString(25,jComboBox2.getSelectedItem().toString());
                        pstmt.setString(26,transNo);
                        pstmt.setString(27,"00");
                     ...
                     java.sql.PreparedStatement pstmt1 = connectDB.prepareStatement("insert into ac_accounts_payable values(?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,numeric_uminus(?),?)");
                pstmt1.setObject(1,accountCode);
                pstmt1.setObject(2,jTextField7.getText());
                pstmt1.setString(3,Stock);
                ...
                pstmt1.setString(8,"");
                pstmt1.setString(9,"");
                pstmt1.setString(10,StocktransNo);
                pstmt1.setString(11,transNo);
                pstmt1.setString(12,"Stock Returns");
                pstmt1.setString(14,"00");
                pstmt1.setObject(13,jTextField2.getText());
                pstmt1.setString(15,datePicker1.getDate().toString());
                if(jTextField3.getText().equals("")){
                    javax.swing.JOptionPane.showMessageDialog(this,"Credit No Missing","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
                }else{
                        pstmt1.setString(16,jTextField91.getText());
                }
                pstmt1.setString(17,glType);
                pstmt1.setString(18,"false");
                pstmt1.setString(19,"false");
