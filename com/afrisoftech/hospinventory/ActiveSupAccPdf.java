...
public class ActiveSupAccPdf implements java.lang.Runnable {
    ...
    public void ActiveSupAccPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.lowagie.text.HeaderFooter footer = new com.lowagie.text.HeaderFooter(new Phrase("Active Accounts - Page: ",pFontHeader), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        Phrase phrase = new Phrase("Active Accounts(Supplier)", pFontHeader);
                        ...
                        table.addCell(phrase);
                        phrase = new Phrase("VAT No",pFontHeader);
                        table.addCell(phrase);
                       /* table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                        ...
                        */
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset = st.executeQuery("select code,supplier_name,date,pin_no,initcap(vat_no) from st_suppliers where closed = 'false' order by supplier_name");
                            
                            java.sql.Statement st1 = connectDB.createStatement();
                            
                            java.sql.ResultSet rset1 = st1.executeQuery("select count(supplier_name) from st_suppliers where closed = false");
