...
public class WeeklyTransfersPdf implements java.lang.Runnable {
    double Credit = 0.00;
    // double current = 0.00;
    //double over30 = 0.00;
    // double over60 = 0.00;
    ...
    public void WeeklyTransfersPdf(java.sql.Connection connDb,java.util.Date begindate,java.util.Date endate) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            phrase = new Phrase("Weekly Transfers as at " +dateFormat.format(endDate2), pFontHeader);
                        ...
                        try {
                            ...
                            for (int i = 0; i < listofAct.length; i++) {
                                ...
                                java.sql.PreparedStatement pSeta1 = connectDB.prepareStatement("SELECT count(description) FROM st_stock_item where  description = '"+listofAct[i]+"' and department ilike 'main%'");
                                ...
                                if (name > 0){
                                  ...
                                  */
                                    ...
                                    for (int t = 0; t < rangeDates.length; t++) {
                                        ...
                                        java.sql.PreparedStatement pset = connectDB.prepareStatement("select ROUND(sum(ss.issuing/sp.packaging),0) from st_sub_stores ss,st_stock_item sp WHERE ss.item = ? and ss.transaction_no ilike 'T%' and ss.item = sp.description AND ss.trans_date between '"+rangeDates[t][0]+"' AND '"+rangeDates[t][1]+"'");//< '"+endDate+"'::date and date > '"+endDate+"'::date - 30 group by dealer");
    ...
    public java.lang.Object[] getListofActivities() {
        ...
        try {
            ...
            java.sql.PreparedStatement pSet1 = connectDB.prepareStatement("SELECT DISTINCT item FROM st_sub_stores where item  IS NOT NULL and item  !='' and issuing > 0 and transaction_no ilike 'T%' and trans_date between '"+beginDate+"' and '"+endDate+"' order by item ");
