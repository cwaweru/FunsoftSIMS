...
public class UnpricedRepPdf implements java.lang.Runnable {
    ...
    public void UnpricedRepPdf(java.sql.Connection connDb,java.lang.String combox) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        java.sql.ResultSet rset2 = st6.executeQuery("select sum(discount_value),sum(vat_amount),sum(net_value) from st_orders where order_no ='"+OrderNo+"'");// where member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
              ...
              try {
                            ...
                            java.sql.ResultSet rset2 = st2.executeQuery("select supplier_name,short_name,postal_address||' '||town,tel1||' '||tel2,initcap(street),initcap(avenue),fax_no,email_address,initcap(building_name) from st_suppliers WHERE st_orders.order_no ='"+OrderNo+"' AND st_orders.supplier = supplier_name");
                    ...
                    try{
                       ...
                       table.getDefaultCell().setColspan(1);
                        ...
                        try {
                            ...
                            java.sql.ResultSet rset1 = st1.executeQuery("select code,initcap(item),units,quantity from st_orders where order_no ='"+OrderNo+"'");// where supplier_name = 'Uchumi'member_no = '"+memNo+"'  AND date BETWEEN '"+beginDate+"' AND '"+endDate+"'");
