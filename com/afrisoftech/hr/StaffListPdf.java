...
public class StaffListPdf implements java.lang.Runnable {
    ...
    public void StaffListPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    int headerwidths[] = {10,50,10,10,20};
                    ...
                    phrase = new Phrase("Company Staff Register  " , pFontHeader3);
                    ...
                    try{
                        ...
                        java.sql.ResultSet rset = st2.executeQuery("select staff_id,initcap(first_name||' '||second_name||' '||others) AS staff_names,gender,birth_date,remarks from hr.hr_staffresume_fileinfo");
