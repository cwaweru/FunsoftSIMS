 ...
 * @author  postgres
 */
public class ProfessionalQualificationIntfr extends javax.swing.JInternalFrame {
    ...
    public ProfessionalQualificationIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        qualificationidTxt = new javax.swing.JTextField();
        ...
        qulitiondescTxt = new javax.swing.JTextField();
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Professional Qualification");
        setVisible(true);
        ...
        subMainPanel.setAlignmentX(10.0F);
        buttonPanel.setLayout(new java.awt.GridBagLayout());

        buttonPanel.setBorder(new javax.swing.border.TitledBorder(""));
        jLabel1.setText("Please register professional qualifications here");
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(qualificationidTxt, gridBagConstraints);

        departmentLbl.setText("Departments");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(qulitiondescTxt, gridBagConstraints);
...
try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_professional_qualification (qualification_id,department,main_domain,qualification_desc,remarks) values(?,?,?,?,?)");
            pstmt.setObject(1,qualificationidTxt.getText());
            pstmt.setObject(2,departmentCbx.getSelectedItem().toString());
            pstmt.setObject(3,"");
            pstmt.setObject(4,qulitiondescTxt.getText());
            pstmt.setObject(5,jTextPane1.getText());
            pstmt.executeUpdate();
            connectDB.commit();
    ...
    private javax.swing.JTextField qulitiondescTxt;
    private javax.swing.JTextField qualificationidTxt;
