 ...
 * @author  postgres
 */
public class TypeofContractsInfr extends javax.swing.JInternalFrame {
    ...
    public TypeofContractsInfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
 ...
 try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_types_of_contracts (contract_id,contract_type,remarks) values(?,?,?)");
              
            pstmt.setObject(1,contractidnoTxt.getText());
            pstmt.setObject(2,contractTypeTxt.getText());
