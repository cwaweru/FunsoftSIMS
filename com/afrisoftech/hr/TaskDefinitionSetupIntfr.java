 ...
 * @author  postgres
 */
public class TaskDefinitionSetupIntfr extends javax.swing.JInternalFrame {
    ...
    public TaskDefinitionSetupIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Please setup your Tasks here");
        ...
        jPanel81.setBorder(new javax.swing.border.TitledBorder(null, "Task Description", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12)));
        ...
        fieldsPanel.add(jPanel81, gridBagConstraints);
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_task_adminsetup (task_id,task_desc) values(?,?)");
            pstmt.setObject(1,idNo.getText());
            pstmt.setObject(2,jTextArea1.getText());
            pstmt.executeUpdate();
            connectDB.commit();
