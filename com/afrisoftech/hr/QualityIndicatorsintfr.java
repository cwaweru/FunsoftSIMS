 ...
 * @author  postgres
 */
public class QualityIndicatorsintfr extends javax.swing.JInternalFrame {
    ...
    public QualityIndicatorsintfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        indicatoridTxt = new javax.swing.JTextField();
        indicatornameLbl = new javax.swing.JLabel();
        indicatornameTxt = new javax.swing.JTextField();
        ...
        jLabel1.setText("Please register quality indicators here");
        ...
        indicatoridLbl.setText("Indicator ID:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(indicatoridTxt, gridBagConstraints);

        indicatornameLbl.setText("Indicator Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(indicatornameTxt, gridBagConstraints);
    ...
    boolean chb = false;
        ...
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_quality_indicator (indicator_id,indicator_name,qualifiable_amount,percentage) values(?,upper(?),?,?)");
            pstmt.setObject(1,indicatoridTxt.getText());
            pstmt.setObject(2,indicatornameTxt.getText());
    ...
    private javax.swing.JTextField indicatoridTxt;
    private javax.swing.JButton previousAction;
    private javax.swing.JTextField indicatornameTxt;
