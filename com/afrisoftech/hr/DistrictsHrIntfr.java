 ...
 * @author  root
 */
public class DistrictsHrIntfr extends javax.swing.JInternalFrame {
    ...
    public DistrictsHrIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel1.setBorder(new javax.swing.border.TitledBorder(null, "Enter  code & name of the district  here", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 10)));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try {
           java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_districts values(?, initcap(?))");
             if(jTextField1.getText().equals("")){
               javax.swing.JOptionPane.showMessageDialog(this, "You must enter District code","Error Message!",javax.swing.JOptionPane.ERROR_MESSAGE);
           }else{
