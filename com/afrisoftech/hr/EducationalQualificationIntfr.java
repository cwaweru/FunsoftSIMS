 ...
 * @author  postgres
 */
public class EducationalQualificationIntfr extends javax.swing.JInternalFrame {
    ...
    public EducationalQualificationIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Education Level Qualification");
        setVisible(true);
        ...
        jLabel1.setText("Please register Education levels qualifications here");
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++){
                if (jTable1.getValueAt(i,0) != null){
                    java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_education_qlf(qualification_id,qualification_desc) values(?,upper(?))");
