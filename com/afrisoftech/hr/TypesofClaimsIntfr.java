 ...
 * @author  postgres
 */
public class TypesofClaimsIntfr extends javax.swing.JInternalFrame {
    ...
    public TypesofClaimsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        claimidLbl = new javax.swing.JLabel();
        claimidTxt = new javax.swing.JTextField();
        claimdescriptionLbl = new javax.swing.JLabel();
        claimdescriptionTxt = new javax.swing.JTextField();
        companytoclaimfromLbl = new javax.swing.JLabel();
        remarksLbl = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        remarksTxtA = new javax.swing.JTextArea();
        companytoclaimfromCbx = new javax.swing.JComboBox();
        ...
        nBCachedRowSet1.setCommand("select DISTINCT institution from hr.hr_policy_covers");
        ...
        jLabel1.setText("Please register types of claims here");
        ...
        claimidLbl.setText("Claim ID:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(claimidLbl, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(claimidTxt, gridBagConstraints);

        claimdescriptionLbl.setText("Claim Description");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(claimdescriptionLbl, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(claimdescriptionTxt, gridBagConstraints);

        companytoclaimfromLbl.setText("Company to claim from");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(companytoclaimfromLbl, gridBagConstraints);
        ...
        companytoclaimfromCbx.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet1, "institution", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(companytoclaimfromCbx, gridBagConstraints);
 ...
 try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_type_of_claim(claim_id,company_to_claim_from,claim_description,remarks) values(?,upper(?),?,?)");
            pstmt.setObject(1,claimidTxt.getText());
            pstmt.setObject(2,claimdescriptionTxt.getText());
            pstmt.setObject(3,companytoclaimfromCbx.getSelectedItem().toString()); 
            pstmt.setObject(4,remarksTxtA.getText()); 
    ...
    private javax.swing.JComboBox companytoclaimfromCbx;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JButton clearAction;
    private javax.swing.JPanel actionsPanel;
    private javax.swing.JLabel jLabel2;
    private javax.swing.JTextField claimdescriptionTxt;
    private javax.swing.JPanel spacerPanel;
    private javax.swing.JPanel dataPanel;
    private javax.swing.JPanel fieldsPanel;
    private javax.swing.JLabel claimdescriptionLbl;
    ...
    private javax.swing.JTextField claimidTxt;
    private javax.swing.JTextArea remarksTxtA;
    private javax.swing.JLabel companytoclaimfromLbl;
    ...
    private javax.swing.JLabel claimidLbl;
