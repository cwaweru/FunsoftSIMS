 ...
 * @author  postgres
 */
public class RetirementBenefitsIntfr extends javax.swing.JInternalFrame {
    ...
    public RetirementBenefitsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        benefitidLbl = new javax.swing.JLabel();
        benefitidTxt = new javax.swing.JTextField();
        ...
        jLabel1.setText("Please register retirement benefits here");
        ...
        benefitidLbl.setText("Benefit ID:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(benefitidLbl, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(benefitidTxt, gridBagConstraints);
        ...
        jScrollPane1.setBorder(new javax.swing.border.TitledBorder(null, "Comments", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(102, 102, 255)));
        ...
        setSize(new java.awt.Dimension(635, 300));
        setLocation((screenSize.width-635)/2,(screenSize.height-300)/2);
 ...
 try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_retirement_benefits (benefit_id,description,remarks) values(?,upper(?),?)");
            pstmt.setObject(1,benefitidTxt.getText());
            pstmt.setObject(2,descriptionTxt.getText());
            pstmt.setObject(3,remarksTxtA.getText()); 
    ...
    private javax.swing.JTextField benefitidTxt;
    ...
    private javax.swing.JLabel benefitidLbl;
