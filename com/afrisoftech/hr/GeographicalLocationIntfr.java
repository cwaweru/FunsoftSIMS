 ...
 * @author  postgres
 */
public class GeographicalLocationIntfr extends javax.swing.JInternalFrame {
    ...
    public GeographicalLocationIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        countrynameCbx = new javax.swing.JComboBox();
        ...
        nBCachedRowSet11.setCommand("select DISTINCT country_name from hr.hr_country");
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Geographical Locations");
        setVisible(true);
        ...
        jLabel1.setText("Please register geographical locations here");
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(locationidLbl, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(locationidTxt, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(locationnameLbl, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(locationnameTxt, gridBagConstraints);
        ...
        countrynameCbx.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet11, "country_name", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(countrynameCbx, gridBagConstraints);
...
try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_geographical_locations (location_id,location_name,country,continent) values(?,upper(?),?,?)");
            pstmt.setObject(1,locationidTxt.getText());
            pstmt.setObject(2,locationnameTxt.getText());
            pstmt.setObject(3,countrynameCbx.getSelectedItem().toString());
    ...
    private javax.swing.JComboBox countrynameCbx;
