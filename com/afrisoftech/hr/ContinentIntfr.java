 ...
 * @author  postgres
 */
public class ContinentIntfr extends javax.swing.JInternalFrame {
    ...
    public ContinentIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        continentidLbl = new javax.swing.JLabel();
        continentidTxt = new javax.swing.JTextField();
        continentnameLbl = new javax.swing.JLabel();
        continentnameTxt = new javax.swing.JTextField();
        ...
        jLabel1.setText("Please register your continent here");
        ...
        continentidLbl.setText("Continent ID:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(continentidLbl, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(continentidTxt, gridBagConstraints);

        continentnameLbl.setText("Continent Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(continentnameLbl, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(continentnameTxt, gridBagConstraints);
...
try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_continent (continent_id,continent_name) values(?,upper(?))");
            pstmt.setObject(1,continentidTxt.getText());
            pstmt.setObject(2,continentnameTxt.getText());
    ...
    private javax.swing.JLabel continentidLbl;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel continentnameLbl;
    ...
    private javax.swing.JTextField continentidTxt;
    ...
    private javax.swing.JTextField continentnameTxt;
