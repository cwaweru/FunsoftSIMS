 ...
 * @author  postgres
 */
public class JobDesignationIntfr extends javax.swing.JInternalFrame {
    ...
    public JobDesignationIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jobIdNoLbl = new javax.swing.JLabel();
        jobIdNoTxt = new javax.swing.JTextField();
        departmentsLbl = new javax.swing.JLabel();
        departmentscbx = new javax.swing.JComboBox();
        sectionsLbl = new javax.swing.JLabel();
        jobdesignationsLbl = new javax.swing.JLabel();
        jobdesignationsTxt = new javax.swing.JTextField();
        sectionscbx1 = new javax.swing.JComboBox();
        ...
        nBCachedRowSet2.setCommand("select DISTINCT upper(section) as section from hr.hr_sections order by section");
        ...
        jLabel1.setText("Please register Job designations here");
        ...
        jobIdNoLbl.setText("Job ID No");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(jobIdNoLbl, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(jobIdNoTxt, gridBagConstraints);
        ...
        departmentscbx.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet1, "name", null, null, null));
        departmentscbx.setSelectedItem(null);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        ...
        jobdesignationsLbl.setText("Job Designations");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(jobdesignationsLbl, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(jobdesignationsTxt, gridBagConstraints);

        sectionscbx1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet2, "section", null, null, null));
        sectionscbx1.setSelectedItem(null);
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(sectionscbx1, gridBagConstraints);
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_job_designation (job_group_id,department,sections,designation) values(?,?,?,?)");
              
            pstmt.setObject(1,jobIdNoTxt.getText());
            pstmt.setObject(2,departmentscbx.getSelectedItem().toString());
            pstmt.setObject(3,sectionscbx1.getSelectedItem().toString());
            pstmt.setObject(4,jobdesignationsTxt.getText());
            pstmt.executeUpdate();
            connectDB.commit();
    ...
    private javax.swing.JTextField jobdesignationsTxt;
    private javax.swing.JComboBox sectionscbx1;
    ...
    private javax.swing.JTextField jobIdNoTxt;
    ...
    private javax.swing.JLabel jobIdNoLbl;
    private javax.swing.JLabel jobdesignationsLbl;
