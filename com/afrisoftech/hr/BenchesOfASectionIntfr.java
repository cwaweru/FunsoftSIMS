 ...
 * @author  postgres
 */
public class BenchesOfASectionIntfr extends javax.swing.JInternalFrame {
    ...
    public BenchesOfASectionIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select DISTINCT upper(section) as section from hr.hr_sections order by section");
        ...
        jLabel1.setText("Please register your benches in selected section");
        ...
        idNoLbl.setText("Section Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(idNoLbl, gridBagConstraints);

        jComboBox1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet1, "section", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bench Id", "Bench Name", "Bench Leader"
            }
        ));
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_section_benches(section,bench_id,bench_desc,supervisor) values(?,?,?,?)");
        ...
        }// TODO add your handling code here:ndling code here:
