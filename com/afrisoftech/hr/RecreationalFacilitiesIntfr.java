 ...
 * @author  postgres
 */
public class RecreationalFacilitiesIntfr extends javax.swing.JInternalFrame {
    ...
    public RecreationalFacilitiesIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        facilityidLbl = new javax.swing.JLabel();
        facilityidTxt = new javax.swing.JTextField();
        facilitynameLbl = new javax.swing.JLabel();
        facilitynameTxt = new javax.swing.JTextField();
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Recreational Facilities");
        setVisible(true);
        ...
        jLabel1.setText("Please register recreational facilities here");
        ...
        facilityidLbl.setText("Facility ID:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(facilityidLbl, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(facilityidTxt, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(facilitynameLbl, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(facilitynameTxt, gridBagConstraints);
        ...
        jScrollPane2.setBorder(new javax.swing.border.TitledBorder("Remarks"));
 ...
 try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_recreational_facilities (facility_id,facility_name,description,remarks) values(?,upper(?),?,?)");
            pstmt.setObject(1,facilityidTxt.getText());
            pstmt.setObject(2,facilitynameTxt.getText());
    ...
    private javax.swing.JLabel facilityidLbl;
    ...
    private javax.swing.JTextField facilityidTxt;
    ...
    private javax.swing.JTextField facilitynameTxt;
