 ...
 * @author  postgres
 */
public class GradeMeritsIntfr extends javax.swing.JInternalFrame {
    ...
    public GradeMeritsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        meritidTxt = new javax.swing.JTextField();
        parcentageChkbx = new javax.swing.JCheckBox();
        meritnameLbl = new javax.swing.JLabel();
        meritnameTxt = new javax.swing.JTextField();
        qualifiableamountLbl = new javax.swing.JLabel();
        qualifiableamountTxt = new javax.swing.JTextField();
        ...
        jLabel1.setText("Please register grades and merits here");
        ...
        meritidLbl.setText("Merit ID:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(meritidLbl, gridBagConstraints);

        meritidTxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                meritidTxtActionPerformed(evt);
            }
        });
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(meritidTxt, gridBagConstraints);

        parcentageChkbx.setText("Percentage");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(parcentageChkbx, gridBagConstraints);

        meritnameLbl.setText("Merit Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weightx = 1.0;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(meritnameTxt, gridBagConstraints);

        qualifiableamountLbl.setText("Qualifiable Amount");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(qualifiableamountTxt, gridBagConstraints);
    ...
    private void meritidTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_meritidTxtActionPerformed
        // Add your handling code here:
    }//GEN-LAST:event_meritidTxtActionPerformed
    ...
    boolean chb = false;
        ...
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_grades_merits (merit_id,merit_name,qualifiable_amount,percentage,remarks) values(?,upper(?),?,?,?)");
            pstmt.setObject(1,meritidTxt.getText());
            pstmt.setObject(2,meritnameTxt.getText());
            pstmt.setObject(3,qualifiableamountTxt.getText());
            pstmt.setBoolean(4,chb);
            pstmt.setObject(5,remarksTxtA.getText());
            pstmt.executeUpdate();
            connectDB.commit();
    ...
    private javax.swing.JTextField qualifiableamountTxt;
    ...
    private javax.swing.JCheckBox parcentageChkbx;
    ...
    private javax.swing.JTextField meritnameTxt;
    ...
    private javax.swing.JTextField meritidTxt;
