...
public class MemosPdf implements java.lang.Runnable {
    ...
    public void MemosPdf(java.sql.Connection connDb) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    int headerwidths[] = {10,40,10,20,20};
                    ...
                    phrase = new Phrase("Memos Issued as on "+date+"" , pFontHeader3);
                    ...
                    phrase = new Phrase("Memo Code",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("memo Subject",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Issue Date.",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Memo Grade",pFontHeader1);
                    table.addCell(phrase);
                    
                    phrase = new Phrase("Loss To Company",pFontHeader1);
                   table.addCell(phrase);
                  ...
                  //  phrase = new Phrase("Remarks",pFontHeader1);
                   // table.addCell(phrase);
                    ...
                    try{
                        ...
                        java.sql.ResultSet rset = st2.executeQuery("select code,subject,date,grading,loss_2comp from hr.hr_memo order by date");
                        ...
                        while (rset.next()) {
                            ...
                            table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                            phrase = new Phrase(dbObject.getDBObject(rset.getObject(4), "-"), pFontHeader);
                           ...
                           // table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                           // phrase = new Phrase(dbObject.getDBObject(rset.getObject(6), "-"), pFontHeader);
