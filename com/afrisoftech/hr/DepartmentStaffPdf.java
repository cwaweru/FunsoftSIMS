...
public class DepartmentStaffPdf implements java.lang.Runnable {
    ...
    public void DepartmentStaffPdf(java.sql.Connection connDb,java.lang.String combox) {
      ...
      */
                ...
                "FunSoft Human Resources Management Systems                         Printed On: "+date+"               Page:",pFontHeader2), true);// FontFactory.getFont(com.lowagie.text.FontFactory.HELVETICA, 12, Font.BOLDITALIC,java.awt.Color.blue));
                    ...
                    try {
                        ...
                        int headerwidths[] = {10,30,10,15,15,20};
                        ...
                        phrase = new Phrase(dept + " Department Staff Information " , pFontHeader3);
                        ...
                        table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                        phrase = new Phrase("Staff names",pFontHeader);
                        table.addCell(phrase);
                        ...
                        phrase = new Phrase("Hire Date",pFontHeader);
                        table.addCell(phrase);                   
                    ...
                    table.getDefaultCell().setBorderColor(java.awt.Color.WHITE);
                        try {
                            ...
                            for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select staff_id,initcap(first_name||' '||second_name||' '||others) AS staff_names,gender,empmt_date from  hr.hr_staffresume_fileinfo where staff_id = '"+listofStaffNos[j]+"'");
                                java.sql.ResultSet rset2 = st2.executeQuery("select section,designation from hr.hr_contract_mgt where staff_id = '"+listofStaffNos[j]+"'");
