 ...
 * @author  postgres
 */
public class SectionsOfADepartmentIntfr extends javax.swing.JInternalFrame {
    ...
    public SectionsOfADepartmentIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Please register the different sections of the selected department");
        ...
        idNoLbl.setText("Department Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Section Id", "Section Name", "Section Leader"
            }
        ));
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_dept_sections(dept,section_id,section_name,section_leader) values(?,?,?,?)");
        ...
        }// TODO add your handling codng code here:
