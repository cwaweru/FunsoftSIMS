 ...
 * @author  postgres
 */
public class TpesOfDiscActionIntfr extends javax.swing.JInternalFrame {
    ...
    public TpesOfDiscActionIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Enter disciplinary action taken");
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_disciplinary_actions(action_id,action_desc) values(?,?)");
