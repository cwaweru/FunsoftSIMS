 ...
 * @author  postgres
 */
public class ContractTerminationReasonsIntfr extends javax.swing.JInternalFrame {
    ...
    public ContractTerminationReasonsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Reasons For Termination Of Contract");
        setVisible(true);
        ...
        jLabel1.setText("Please enter the standard reasons");
        ...
        roleorresponsiblityLbl.setText(" Description");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_contr_termination_setup (reason_id,reason_desc) values(?,?)");
