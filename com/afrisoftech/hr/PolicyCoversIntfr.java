 ...
 * @author  postgres
 */
public class PolicyCoversIntfr extends javax.swing.JInternalFrame {
    ...
    public PolicyCoversIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        policyidLbl = new javax.swing.JLabel();
        policyidTxt = new javax.swing.JTextField();
        descriptionLbl = new javax.swing.JLabel();
        descriptionTxt = new javax.swing.JTextField();
        institutionofferingcoverLbl = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        jTextPane1 = new javax.swing.JTextPane();
        ceillingamountLbl = new javax.swing.JLabel();
        ceillingamountTxt = new javax.swing.JTextField();
        ...
        jLabel1.setText("Please register policy covers here");
        ...
        policyidLbl.setText("Policy ID:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(policyidLbl, gridBagConstraints);

        policyidTxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                policyidTxtActionPerformed(evt);
            }
        });
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(policyidTxt, gridBagConstraints);

        descriptionLbl.setText("Policy Description");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(descriptionLbl, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(descriptionTxt, gridBagConstraints);

        institutionofferingcoverLbl.setText("Institutions offering Cover");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(institutionofferingcoverLbl, gridBagConstraints);
        ...
        ceillingamountLbl.setText("Ceilling Amount");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(ceillingamountLbl, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(ceillingamountTxt, gridBagConstraints);
        ...
        setBounds(0, 0, 648, 300);
    }//GEN-END:initComponents

    private void policyidTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_policyidTxtActionPerformed
        // Add your handling code here:
    }//GEN-LAST:event_policyidTxtActionPerformed
 ...
 try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_policy_covers (policy_id,policy,institution,amount) values(?,upper(?),?,?)");
            pstmt.setObject(1,policyidTxt.getText());
            pstmt.setObject(2,descriptionTxt.getText());
            
            pstmt.setObject(3,jTextPane1.getText()); 
           pstmt.setObject(4,ceillingamountTxt.getText()); 
            pstmt.executeUpdate();
            connectDB.commit();
    ...
    private javax.swing.JLabel ceillingamountLbl;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JTextPane jTextPane1;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel institutionofferingcoverLbl;
    private javax.swing.JButton clearAction;
    private javax.swing.JPanel actionsPanel;
    private javax.swing.JLabel jLabel2;
    private javax.swing.JTextField policyidTxt;
    ...
    private javax.swing.JLabel policyidLbl;
    ...
    private javax.swing.JTextField ceillingamountTxt;
