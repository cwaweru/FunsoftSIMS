 ...
 * @author  postgres
 */
public class InterviewDispositionIntfr extends javax.swing.JInternalFrame {
    ...
    public InterviewDispositionIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        roleorresponsibilityTxt1 = new javax.swing.JTextField();
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Interview  Disposition Reasons");
        setVisible(true);
        ...
        jLabel1.setText("Please register the different interview types");
        ...
        roleorresponsiblityLbl.setText("Disposition Description");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.weightx = 1.0;
        ...
        roleorresponsiblityLbl1.setText("Disposition Reason ID");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(roleorresponsibilityTxt1, gridBagConstraints);
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_interview_disposition(reason_code,reason_desc) values(?,?)");
            pstmt.setObject(1,roleorresponsibilityTxt1.getText());
    ...
    private javax.swing.JTextField roleorresponsibilityTxt1;
