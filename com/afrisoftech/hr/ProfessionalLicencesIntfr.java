 ...
 * @author  postgres
 */
public class ProfessionalLicencesIntfr extends javax.swing.JInternalFrame {
    ...
    public ProfessionalLicencesIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        licenceidLbl = new javax.swing.JLabel();
        licenceidTxt = new javax.swing.JTextField();
        licencenoLbl = new javax.swing.JLabel();
        licencenoTxt = new javax.swing.JTextField();
        qualificationLbl = new javax.swing.JLabel();
        qualificationCbx = new javax.swing.JComboBox();
        departmentrequiringlicenceLbl = new javax.swing.JLabel();
        ...
        nBCachedRowSet1.setCommand("select DISTINCT qualifiable_amount from hr.hr_quality_indicator order by qualifiable_amount");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        nBCachedRowSet11.setCommand("select DISTINCT department_name from hr.hr_department");
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Professional Licencies");
        setVisible(true);
        ...
        jLabel1.setText("Please register professional licencies here");
        ...
        licenceidLbl.setText("Licence ID:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(licenceidLbl, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(licenceidTxt, gridBagConstraints);

        licencenoLbl.setText("Licence No.(Description)");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(licencenoLbl, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(licencenoTxt, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(qualificationLbl, gridBagConstraints);

        qualificationCbx.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet1, "qualifiable_amount", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(qualificationCbx, gridBagConstraints);

        departmentrequiringlicenceLbl.setText("Department Requiring Licence");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(departmentrequiringlicenceLbl, gridBagConstraints);

        jComboBox1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet11, "department_name", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
           try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_professional_licence(licence_id,qualification_name,licence_no,department) values(?,upper(?),?,?)");
            pstmt.setObject(1,licenceidTxt.getText());
            pstmt.setObject(2,qualificationCbx.getSelectedItem().toString());
            pstmt.setObject(3,licencenoTxt.getText());
    ...
    private javax.swing.JLabel departmentrequiringlicenceLbl;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JButton clearAction;
    private javax.swing.JPanel actionsPanel;
    private javax.swing.JLabel jLabel2;
    private javax.swing.JPanel spacerPanel;
    private javax.swing.JTextField licencenoTxt;
    ...
    private javax.swing.JLabel licenceidLbl;
    private javax.swing.JPanel helpPanel;
    private javax.swing.JPanel subMainPanel;
    private javax.swing.JComboBox qualificationCbx;
    private org.netbeans.lib.sql.NBCachedRowSet nBCachedRowSet1;
    private javax.swing.JButton deleteAction;
    private javax.swing.JButton lastAction;
    private javax.swing.JPanel buttonPanel;
    private javax.swing.JPanel labelPanel;
    private javax.swing.JLabel licencenoLbl;
    private javax.swing.JTextField licenceidTxt;
