 ...
 * @author  postgres
 */
public class StaffAccessingPolicyInfr extends javax.swing.JInternalFrame {
    ...
    public StaffAccessingPolicyInfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet2.setCommand("select distinct policy from hr.hr_policy_covers order by policy");
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Staff Accessing Policies");
        setVisible(true);
        ...
        jLabel1.setText("Please register staff accessing cover");
        ...
        idNoLbl.setText("Policy Description");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(idNoLbl, gridBagConstraints);

        roleorresponsiblityLbl.setText("Staff Names");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        ...
        jComboBox1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet2, "policy", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_policy_accesstaff (policy_desc,staff_name) values(?,?)");
