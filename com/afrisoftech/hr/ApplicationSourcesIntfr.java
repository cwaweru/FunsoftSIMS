 ...
 * @author  postgres
 */
public class ApplicationSourcesIntfr extends javax.swing.JInternalFrame {
    ...
    public ApplicationSourcesIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Setup your different sources of Job Applications");
        ...
        roleorresponsiblityLbl.setText("Source Description");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_app_sources (source_code,source_desc,remarks) values(?,?,?)");
