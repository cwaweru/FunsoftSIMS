 ...
 * @author  postgres
 */
public class UnionTerminationReasonsIntfr extends javax.swing.JInternalFrame {
    ...
    public UnionTerminationReasonsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Reasons For Termination From Union");
        setVisible(true);
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_union_termination(union_code,desc) values(?,?)");
