 ...
 * @author  postgres
 */
public class JobGroupsIntfr extends javax.swing.JInternalFrame {
    ...
    public JobGroupsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet1.setCommand("select DISTINCT family_desc FROM hr.hr_job_family ORDER BY family_desc");
        ...
        jLabel1.setText("Please register job groups here");
        ...
        idNoLbl.setText("Classification ID No: ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        ...
        roleorresponsiblityLbl.setText("Classification Description");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.weightx = 1.0;
        ...
        departmentsLbl.setText("Job Family/Group");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(departmentsLbl, gridBagConstraints);

        departmentsCbx.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet1, "family_desc", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_job_groupings(group_id,group_desc,department) values(?,?,?)");
            pstmt.setObject(1,idNo.getText());
            pstmt.setObject(2,roleorresponsibilityTxt.getText());
            pstmt.setString(3,departmentsCbx.getSelectedItem().toString());
            pstmt.executeUpdate();
            connectDB.commit();
