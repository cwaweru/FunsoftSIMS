 ...
 * @author  postgres
 */
public class ManagementHierachiesIntfr extends javax.swing.JInternalFrame {
    ...
    public ManagementHierachiesIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        managementlevelidLbl = new javax.swing.JLabel();
        mngtlevelidTxt = new javax.swing.JTextField();
        ...
        mainmanagementlevelLbl = new javax.swing.JLabel();
        mainmngtlevelCbx = new javax.swing.JComboBox();
        managementleveldesignationLbl = new javax.swing.JLabel();
        mngtleveldesigTxt = new javax.swing.JTextField();
        ...
        nBCachedRowSet11.setCommand("select DISTINCT section from hr.hr_sections");
        nBCachedRowSet11.setConnectionSource(pConnDB);
        nBCachedRowSet2.setCommand("select disinct level_desc hr.hr_management_levels ");
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Management Hierachies");
        setVisible(true);
        ...
        jLabel1.setText("Please register management hierachies here");
        ...
        managementlevelidLbl.setText("Management Level ID:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(managementlevelidLbl, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(mngtlevelidTxt, gridBagConstraints);
        ...
        departmentsCbx.setFont(new java.awt.Font("Dialog", 0, 12));
        ...
        sectionsCbx.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet11, "section", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        mainmanagementlevelLbl.setText("Main Management Level");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(mainmanagementlevelLbl, gridBagConstraints);

        mainmngtlevelCbx.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet2, "level", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(mainmngtlevelCbx, gridBagConstraints);

        managementleveldesignationLbl.setText("Management Level Designation");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(managementleveldesignationLbl, gridBagConstraints);

        mngtleveldesigTxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mngtleveldesigTxtActionPerformed(evt);
            }
        });
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(mngtleveldesigTxt, gridBagConstraints);

        jScrollPane1.setBorder(new javax.swing.border.TitledBorder("Comments"));
        jScrollPane1.setViewportView(commentsTxtA);
        ...
        setBounds(0, 0, 629, 300);
    }//GEN-END:initComponents

    private void mngtleveldesigTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mngtleveldesigTxtActionPerformed
        // Add your handling code here:
    }//GEN-LAST:event_mngtleveldesigTxtActionPerformed
   ...
   try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_management_hierachies (management_level_id,department,section,main_management_level,management_level_designation,remarks) values(?,?,?,?,?,?)");
            pstmt.setObject(1,mngtlevelidTxt.getText());
            pstmt.setObject(2,departmentsCbx.getSelectedItem().toString());
            pstmt.setObject(3,sectionsCbx.getSelectedItem().toString());
            pstmt.setObject(4,mainmngtlevelCbx.getSelectedItem().toString());
            pstmt.setObject(5,mngtleveldesigTxt.getText().toString());
            pstmt.setObject(6,commentsTxtA.getText());
            pstmt.executeUpdate();
            connectDB.commit();
    ...
    private javax.swing.JLabel managementlevelidLbl;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JLabel sectionsLbl;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JTextField mngtlevelidTxt;
    private org.netbeans.lib.sql.NBCachedRowSet nBCachedRowSet2;
    private javax.swing.JLabel managementleveldesignationLbl;
    private javax.swing.JLabel mainmanagementlevelLbl;
    ...
    private javax.swing.JTextField mngtleveldesigTxt;
    ...
    private javax.swing.JComboBox mainmngtlevelCbx;
