 ...
 * @author  postgres
 */
public class ReasonsForDisciplinaryActionIntfr extends javax.swing.JInternalFrame {
    ...
    public ReasonsForDisciplinaryActionIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Disciplinary Action reasons");
        setVisible(true);
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_disciplinary_reasons(reason_id,reason_desc) values(?,?)");
