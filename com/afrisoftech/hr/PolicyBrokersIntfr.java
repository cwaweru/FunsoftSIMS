 ...
 * @author  postgres
 */
public class PolicyBrokersIntfr extends javax.swing.JInternalFrame {
    ...
    public PolicyBrokersIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        nBCachedRowSet2.setCommand("select distinct upper(policy) as policy from hr.hr_policy_covers order by policy");
        ...
        jLabel1.setText("Please register the different brokers of the selected Policy");
        ...
        idNoLbl.setText("Policy Name");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(idNoLbl, gridBagConstraints);

        roleorresponsiblityLbl.setText("Brokers");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_policy_brokers (policy_name,broker) values(?,?)");
