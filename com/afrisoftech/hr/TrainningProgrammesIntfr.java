 ...
 * @author  postgres
 */
public class TrainningProgrammesIntfr extends javax.swing.JInternalFrame {
    ...
    public TrainningProgrammesIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        programmeidLbl = new javax.swing.JLabel();
        programmeidTxt = new javax.swing.JTextField();
        ...
        trainningperiodLbl = new javax.swing.JLabel();
        tranningperiodTxt = new javax.swing.JTextField();
        programmedescriptionLbl = new javax.swing.JLabel();
        programmedescriptionTxt = new javax.swing.JTextField();
        jPanel1 = new javax.swing.JPanel();
        companysponsoredChbx = new javax.swing.JCheckBox();
        overseasChbx = new javax.swing.JCheckBox();
        ...
        nBCachedRowSet1.setCommand("select DISTINCT department_name from hr.hr_department order by department_name");
        nBCachedRowSet1.setConnectionSource(pConnDB);
        nBCachedRowSet11.setCommand("select DISTINCT section from hr.hr_sections order by section");
        ...
        jLabel1.setText("Please register trainning progammes here");
        ...
        programmeidLbl.setText("Programme ID:");
        programmeidLbl.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(0, 30, 0, 0);
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(programmeidLbl, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(programmeidTxt, gridBagConstraints);
        ...
        trainningperiodLbl.setText("Trainning Period(days)");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(trainningperiodLbl, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(tranningperiodTxt, gridBagConstraints);

        programmedescriptionLbl.setText("Programme Description");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.insets = new java.awt.Insets(0, 30, 0, 0);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(programmedescriptionLbl, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(programmedescriptionTxt, gridBagConstraints);

        jPanel1.setLayout(new java.awt.GridBagLayout());

        jPanel1.setBorder(new javax.swing.border.TitledBorder("Specify sponsor"));
        companysponsoredChbx.setText("Company");
        buttonGroup1.add(companysponsoredChbx);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.insets = new java.awt.Insets(0, 30, 0, 0);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel1.add(companysponsoredChbx, gridBagConstraints);

        overseasChbx.setText("Overseas");
        buttonGroup1.add(overseasChbx);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.insets = new java.awt.Insets(0, 30, 0, 0);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel1.add(overseasChbx, gridBagConstraints);
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        ...
        if (companysponsoredChbx.isSelected()){
            training = companysponsoredChbx.getText();
        }else{
            if(overseasChbx.isSelected()){
                training = overseasChbx.getText();
            }else{
                training = jCheckBox1.getText();
            }
        }
        try {
            
            connectDB.setAutoCommit(false);
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_trainning_programmes(programme_id,department,sections,programme_desc,trainning_period,training_type) values(?,?,?,?,?,?)");
            
            pstmt.setObject(1,programmeidTxt.getText());
            pstmt.setObject(2,departmentCbx.getSelectedItem().toString());
            pstmt.setObject(3,sectionsCbx.getSelectedItem().toString());
            pstmt.setObject(4,programmedescriptionTxt.getText());
            pstmt.setObject(5,tranningperiodTxt.getText());
    ...
    private javax.swing.JLabel trainningperiodLbl;
    private javax.swing.JCheckBox companysponsoredChbx;
    private javax.swing.JTextField tranningperiodTxt;
    private javax.swing.JLabel sectionsLbl;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JTextField programmedescriptionTxt;
    ...
    private javax.swing.JCheckBox overseasChbx;
    ...
    private javax.swing.JTextField programmeidTxt;
    private javax.swing.ButtonGroup buttonGroup1;
    private javax.swing.JPanel helpPanel;
    private javax.swing.JLabel programmedescriptionLbl;
    ...
    private javax.swing.JLabel programmeidLbl;
