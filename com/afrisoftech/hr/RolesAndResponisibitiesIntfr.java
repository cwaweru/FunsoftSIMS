 ...
 * @author  postgres
 */
public class RolesAndResponisibitiesIntfr extends javax.swing.JInternalFrame {
    ...
    public RolesAndResponisibitiesIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Roles and Responsibities");
        setVisible(true);
        ...
        jLabel1.setText("Please register your Roles and Responsibilities here");
        ...
        idNoLbl.setText("Responsibility ID No: ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(departmentCmbx, gridBagConstraints);

        roleorresponsiblityLbl.setText("Role or \nResponsibility");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.weightx = 1.0;
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_roles_responsibilities (responsibility_id,department,role_responsibility) values(?,?,?)");
          //  java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_roles_responsibilities values(?,?,?)");
         
            pstmt.setObject(1,idNo.getText());
            pstmt.setObject(2,departmentCmbx.getSelectedItem().toString());
            pstmt.setObject(3,roleorresponsibilityTxt.getText());
            pstmt.executeUpdate();
            connectDB.commit();
