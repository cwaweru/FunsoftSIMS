...
public class RetireesListPdf implements java.lang.Runnable {
    ...
    public void RetireesListPdf(java.sql.Connection connDb, java.util.Date endate) {
    ...
    public void generatePdf() {
      ...
      */
                    ...
                    try {
                        ...
                        int headerwidths[] = {12,18,10,10,20,10,20};
                        ...
                        phrase1 = new Phrase( "Employees Elligible for Retirement As On "+date+"", pFontHeader3);
                        ...
                        phrase1 = new Phrase("Birth Date. : " , pFontHeader);
                        table1.addCell(phrase1);
                        
                        phrase1 = new Phrase("Staff Names :", pFontHeader);
                        table1.addCell(phrase1);
                        
                        phrase1 = new Phrase("NSSF No. :",pFontHeader);
                        table1.addCell(phrase1);
                        
                        
                        phrase1 = new Phrase("NHIF No. : ", pFontHeader);
                        table1.addCell(phrase1);
                        
                        phrase1 = new Phrase("Department  " , pFontHeader);
                        table1.addCell(phrase1);
                        
                        
                        phrase1 = new Phrase("Job Title  " , pFontHeader);
                        table1.addCell(phrase1);
                        
                        phrase1 = new Phrase("Retirement Date  " , pFontHeader);
                        table1.addCell(phrase1);
                        ...
                        try {
                            ...
                            for (int j = 0; j < listofStaffNos.length; j++) {
                                ...
                                java.sql.ResultSet rset1 = st1.executeQuery("select birth_date,initcap(first_name||' '||second_name||' '||others) AS staff_names,nssf_no,nhif_no,dept,designation,retirement_date from  hr.hr_staffresume_fileinfo WHERE retirement_date ILIKE '"+endDate+"' and staff_id = '"+listofStaffNos[j]+"' order by birth_date");
                                ...
                                while (rset1.next()) {
                                    ...
                                    phrase1 = new Phrase(rset1.getObject(6).toString(), pFontHeader1);
                                    table1.addCell(phrase1);
                                    
                                    
                                    phrase1 = new Phrase(rset1.getObject(7).toString(), pFontHeader1);
                                    table1.addCell(phrase1);
    ...
    public java.lang.Object[] getListofStaffNos() {
        ...
        try {
            ...
            java.sql.ResultSet rSet1 = stmt1.executeQuery("SELECT distinct staff_id from hr.hr_staffresume_fileinfo WHERE retirement_date <= '"+endDate+"'");
