 ...
 * @author  postgres
 */
public class EmployeeStatusIntfr extends javax.swing.JInternalFrame {
    ...
    public EmployeeStatusIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Please register Employee Status here");
        ...
        roleorresponsiblityLbl.setText("Satatus Description");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.weightx = 1.0;
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_employee_status(status_id,status_desc) values(?,?)");
