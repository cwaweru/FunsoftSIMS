 ...
 * @author  root
 */
public class CompNameHRIntfr extends javax.swing.JInternalFrame {
    ...
    public CompNameHRIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_period_setup(period_from,period_to,company_name,short_name) values(?,?,?,?)");
