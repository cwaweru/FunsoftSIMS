 ...
 * @author  postgres
 */
public class EmploymentBenefitsIntfr extends javax.swing.JInternalFrame {
    ...
    public EmploymentBenefitsIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        benefittileLbl = new javax.swing.JLabel();
        ...
        jLabel1.setText("Please register employment benefits here");
        ...
        benefittileLbl.setText("Benefit Title");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        fieldsPanel.add(benefittileLbl, gridBagConstraints);
        ...
        jComboBox1.setModel(new org.netbeans.lib.sql.models.ComboBoxModel (nBCachedRowSet1, "department_name", null, null, null));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
           try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_employment_benefits (benefit_id,benefit_title,department,remarks) values(?,upper(?),?,?)");
    ...
    private javax.swing.JLabel benefittileLbl;
