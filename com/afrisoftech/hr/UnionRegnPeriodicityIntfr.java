 ...
 * @author  postgres
 */
public class UnionRegnPeriodicityIntfr extends javax.swing.JInternalFrame {
    ...
    public UnionRegnPeriodicityIntfr(java.sql.Connection connDb, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Union Subscription Periodicity");
        setVisible(true);
        ...
        jLabel1.setText("Please setup periodicity for Union Subscription");
        ...
        idNoLbl.setText("Periodicity Code: ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
    ...
    private void newActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newActionActionPerformed
        try {
            ...
            java.sql.PreparedStatement pstmt = connectDB.prepareStatement("insert into hr.hr_union_reg_period (code,desc) values(?,?)");
