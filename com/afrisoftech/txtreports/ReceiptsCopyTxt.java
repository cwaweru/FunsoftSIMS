 ...
 */
public class ReceiptsCopyTxt implements java.lang.Runnable {
    ...
    public ReceiptsCopyTxt(java.sql.Connection connDb, java.lang.String combox) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
        ...
        biz.systempartners.txtreports.Phrase.HORIZONTAL_ALIGNMENT_RIGHT};
         ...
         textReport = new biz.systempartners.txtreports.TextReport(java.lang.Integer.parseInt(System.getProperty("rcptlinesperpage")), java.lang.Integer.parseInt(System.getProperty("rcptcharactersperline")), txtReportFile);
        ...
        Object reportName[] = { "RECEIPT COPY "};
        ...
        try{
            ...
            java.sql.ResultSet rset1 = st1.executeQuery("select distinct date from ac_cash_collection where receipt_no = '"+Receipt+"'");
            java.sql.ResultSet rset5 = st5.executeQuery("select upper(description),sum(debit) from ac_cash_collection where receipt_no = '"+Receipt+"' group by description");
            java.sql.ResultSet rset6 = st6.executeQuery("select distinct user_name,cash_point,payment_mode||' '||cheque_no from ac_cash_collection where receipt_no = '"+Receipt+"'");
            java.sql.ResultSet rset11 = st11.executeQuery("select cb.dealer,cb.account_no from ac_cash_collection cb where cb.receipt_no = '"+Receipt+"'");
            ...
            if (rHeader.equalsIgnoreCase("True")){
                ...
                while (rset11.next()){
                    Name = dbObject.getDBObject(rset11.getObject(1), "-");
                    MNo = dbObject.getDBObject(rset11.getObject(2), "-");
                }
                ...
                while (rset6.next()){
                    ...
                    Paymode = dbObject.getDBObject(rset6.getObject(3), "-");
                ...
                table21.addCell("Patient No     "+MNo.toUpperCase());
                ...
                table21.addCell(" Name       " +Name.toUpperCase());
                
                table21.addCell("                ");
                
                /*
                 
                table4.addCell("Receipt : "+MNo);
                 
                table4.addCell("Date : "+dates);
                 
                table21.addCell("Received from "+Name.toUpperCase());
                ...
                if (rHeader.equalsIgnoreCase("FALSE")){
                    ...
                    table21.addCell("             "+MNo.toUpperCase());
