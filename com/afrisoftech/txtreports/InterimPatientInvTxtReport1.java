 ...
 */
public class InterimPatientInvTxtReport1 implements java.lang.Runnable {
    ...
    java.lang.Runtime rt = null;
        ...
        public InterimPatientInvTxtReport1(java.sql.Connection connDb, java.lang.String combox, java.util.Date begindate, boolean printPreview) {
    ...
    private void writeReport(java.io.RandomAccessFile txtRandomAccessFile){
     ...
     //   
        ...
        Object reportName[] = { "Interim Invoice".toUpperCase() };
        ...
        try{
            ...
            java.sql.ResultSet rset1 = st1.executeQuery("select date::date,initcap(service) as service,dosage,reference,debit-credit from hp_patient_card where patient_no = '"+memNo+"' AND date::date >= '"+beginDate+"' and paid = 'false' AND (reference IS NULL OR reference != '') and (service != 'N.H.I.F' AND service NOT ILIKE 'Receipt%' AND service not ilike 'Receipt Adj') order by date::date,reference");
            java.sql.ResultSet rsetTotals = st2.executeQuery("select sum(debit - credit) from hp_patient_card where patient_no = '"+memNo+"' AND date::date >= '"+beginDate+"' and (service != 'N.H.I.F' and service NOT ILIKE 'Receipt%' AND service not ilike 'Receipt Adj') and paid = 'false'");
            java.sql.ResultSet rset11 = st11.executeQuery("select date::date,initcap(service) as service,dosage,reference,credit-debit from hp_patient_card where patient_no = '"+memNo+"' AND date::date >= '"+beginDate+"' AND (service = 'N.H.I.F' OR service ilike 'Receipt%' or service ilike 'Receipt Adj') AND invoice_no NOT LIKE 'I%' AND invoice_no NOT LIKE 'O%' order by date::date");
            java.sql.ResultSet rsetTotals1 = st21.executeQuery("select sum(credit-debit) from hp_patient_card where patient_no = '"+memNo+"' AND date::date >= '"+beginDate+"' and (service = 'N.H.I.F' OR service = 'Receipt' or service ilike 'Receipt Adj') AND invoice_no NOT LIKE 'I%' AND invoice_no NOT LIKE 'O%'");
            ...
            while (rsetc.next()){
                ...
                wards = dbObject.getDBObject(rsetc.getObject(2), "-");
                dDate = dbObject.getDBObject(rsetc.getObject(5), "-");
                bedNo = dbObject.getDBObject(rsetc.getObject(3), "-");
                doc = dbObject.getDBObject(rsetc.getObject(4), "-");
            }
