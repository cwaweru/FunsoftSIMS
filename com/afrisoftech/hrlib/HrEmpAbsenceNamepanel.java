 ...
 * @author  root
 */
public class HrEmpAbsenceNamepanel extends javax.swing.JDialog {
    ...
    public HrEmpAbsenceNamepanel(java.awt.Frame parent, org.netbeans.lib.sql.pool.PooledConnectionSource pconnDB, boolean modal, int repName, java.sql.Connection connectDb) {
    ...
    private void jTextField1111CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1111CaretUpdate
        ...
        try {
            searchRowSet1.execute("select staff_id,initcap(first_name||' '||second_name||' '||others) AS staff_names from hr.hr_staffresume_fileinfo where first_name||' '||second_name||' '||others ILIKE '"+jTextField1111.getText().toString()+"%' ORDER BY staff_names");
    ...
    public void getReport(int reportName) {
        ...
        switch (reportName) {
         ...
         /*   case 2:
            ...
            {
                com.afrisoftech.hr.EmployeeProfPdf policy = new com.afrisoftech.hr.EmployeeProfPdf();
                
                policy.EmployeeProfPdf(connectDB,jTextField36.getText());
         ...
         case 4:
            ...
            {
                com.afrisoftech.hr.IndividualAbsencePdf policy = new com.afrisoftech.hr.IndividualAbsencePdf();
                
                 policy.IndividualAbsencePdf(connectDB,jTextField36.getText());
